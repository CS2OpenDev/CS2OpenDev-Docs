...
**Derived by:** [CBaseAnimGraph](../client/CBaseAnimGraph.md)
...
| `0xaf0` | `m_CRenderComponent` | CRenderComponent* |  | `MNotSaved` |
| `0xaf8` | `m_CHitboxComponent` | CHitboxComponent |  |  |
| `0xb10` | `m_pChoreoComponent` | CChoreoComponent* |  |  |
| `0xb18` | `m_nDestructiblePartInitialStateDestructed0` | HitGroup_t |  |  |
| `0xb1c` | `m_nDestructiblePartInitialStateDestructed1` | HitGroup_t |  |  |
| `0xb20` | `m_nDestructiblePartInitialStateDestructed2` | HitGroup_t |  |  |
| `0xb24` | `m_nDestructiblePartInitialStateDestructed3` | HitGroup_t |  |  |
| `0xb28` | `m_nDestructiblePartInitialStateDestructed4` | HitGroup_t |  |  |
...
| `0xb48` | `m_pDestructiblePartsSystemComponent` | CDestructiblePartsComponent* |  |  |
| `0xc70` | `m_bInitModelEffects` | bool |  | `MNotSaved` |
| `0xc71` | `m_bDoingModelEffects` | bool |  | `MNotSaved` |
| `0xc74` | `m_iOldHealth` | int32 |  | `MNotSaved` |
| `0xc78` | `m_nRenderMode` | RenderMode_t |  |  |
| `0xc79` | `m_nRenderFX` | RenderFx_t |  |  |
| `0xc7a` | `m_bAllowFadeInView` | bool |  |  |
| `0xc98` | `m_clrRender` | Color |  |  |
| `0xca0` | `m_vecRenderAttributes` | C_UtlVectorEmbeddedNetworkVar< EntityRenderAttribute_t > |  |  |
| `0xd20` | `m_bRenderToCubemaps` | bool |  |  |
| `0xd21` | `m_bNoInterpolate` | bool |  |  |
| `0xd28` | `m_Collision` | CCollisionProperty |  |  |
| `0xde0` | `m_Glow` | CGlowProperty |  |  |
...
| `0xe4d` | `m_nRequiredDecalRtEncoding` | DecalRtEncoding_t |  |  |
| `0xe50` | `m_bodyGroupChoices` | CUtlOrderedMap< CGlobalSymbol, int32 > |  |  |
| `0xe78` | `m_vecViewOffset` | CNetworkViewOffsetVector |  |  |
| `0xf58` | `m_pClientAlphaProperty` | CClientAlphaProperty* |  | `MNotSaved` |
