...
| `0x1208` | `m_pWeaponServices` | CPlayer_WeaponServices* |  |  |
| `0x1210` | `m_pItemServices` | CPlayer_ItemServices* |  |  |
| `0x1218` | `m_pAutoaimServices` | CPlayer_AutoaimServices* |  |  |
| `0x1220` | `m_pObserverServices` | CPlayer_ObserverServices* |  |  |
| `0x1228` | `m_pWaterServices` | CPlayer_WaterServices* |  |  |
| `0x1230` | `m_pUseServices` | CPlayer_UseServices* |  |  |
| `0x1238` | `m_pFlashlightServices` | CPlayer_FlashlightServices* |  |  |
| `0x1240` | `m_pCameraServices` | CPlayer_CameraServices* |  |  |
| `0x1248` | `m_pMovementServices` | CPlayer_MovementServices* |  |  |
| `0x1258` | `m_ServerViewAngleChanges` | C_UtlVectorEmbeddedNetworkVar< ViewAngleServerChange_t > |  | `MNotSaved` |
| `0x12c0` | `v_angle` | QAngle |  |  |
| `0x12cc` | `v_anglePrevious` | QAngle |  |  |
| `0x12d8` | `m_iHideHUD` | uint32 |  |  |
| `0x12e0` | `m_skybox3d` | sky3dparams_t |  |  |
| `0x1370` | `m_flDeathTime` | GameTime_t |  |  |
| `0x1374` | `m_vecPredictionError` | Vector |  | `MNotSaved` |
| `0x1380` | `m_flPredictionErrorTime` | GameTime_t |  | `MNotSaved` |
| `0x13a0` | `m_vecLastCameraSetupLocalOrigin` | Vector |  | `MNotSaved` |
| `0x13ac` | `m_flLastCameraSetupTime` | GameTime_t |  | `MNotSaved` |
...
| `0x13d0` | `m_hController` | CHandle< CBasePlayerController > |  |  |
| `0x13d4` | `m_hDefaultController` | CHandle< CBasePlayerController > |  |  |
