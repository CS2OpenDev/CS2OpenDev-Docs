...
**Derived by:** [C_BasePlayerPawn](../client/C_BasePlayerPawn.md)
...
| `0x1180` | `m_hMyWearables` | C_NetworkUtlVectorBase< CHandle< C_EconWearable > > |  | `MNotSaved` |
| `0x1198` | `m_leftFootAttachment` | AttachmentHandle_t |  | `MNotSaved` |
| `0x1199` | `m_rightFootAttachment` | AttachmentHandle_t |  | `MNotSaved` |
