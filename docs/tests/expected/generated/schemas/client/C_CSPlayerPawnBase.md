...
**Derived by:** [C_CSPlayerPawn](../client/C_CSPlayerPawn.md)
...
| `0x13f0` | `m_pPingServices` | CCSPlayer_PingServices* |  |  |
| `0x13f8` | `m_previousPlayerState` | CSPlayerState |  |  |
| `0x13fc` | `m_iPlayerState` | CSPlayerState |  |  |
| `0x1400` | `m_bHasMovedSinceSpawn` | bool |  |  |
| `0x1404` | `m_flLastSpawnTimeIndex` | GameTime_t |  |  |
| `0x1408` | `m_iProgressBarDuration` | int32 |  |  |
| `0x140c` | `m_flProgressBarStartTime` | float32 |  |  |
| `0x1410` | `m_flClientDeathTime` | GameTime_t |  |  |
...
| `0x142c` | `m_flClientHealthFadeChangeTimestamp` | GameTime_t |  |  |
...
| `0x1478` | `m_hOriginalController` | CHandle< CCSPlayerController > |  |  |
