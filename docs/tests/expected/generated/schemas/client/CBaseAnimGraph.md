...
[Schemas](../../schemas.md) / [client](../client.md) / CBaseAnimGraph
...
**Derived by:** [C_BaseCombatCharacter](../client/C_BaseCombatCharacter.md)
...
146 fields (17 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_graphControllerManager` | CAnimGraphControllerManager |  |  |
| `0x1048` | `m_pMainGraphController` | CAnimGraphControllerPtr |  | The primary animation-graph controller instance for this entity. |
...
| `0x1078` | `m_OnExternalChoreoGraphChanged` | CEntityIOOutput |  |  |
| `0x1098` | `m_bAnimGraphUpdateEnabled` | bool |  |  |
| `0x1099` | `m_bAnimationUpdateScheduled` | bool |  | `MNotSaved` |
| `0x109c` | `m_vecForce` | Vector |  | `MNotSaved` |
| `0x10a8` | `m_nForceBone` | int32 |  | `MNotSaved` |
| `0x10b0` | `m_pClientsideRagdoll` | [CBaseAnimGraph](../client/CBaseAnimGraph.md)* |  | `MNotSaved` |
| `0x10b8` | `m_bBuiltRagdoll` | bool |  | `MNotSaved` |
| `0x10c8` | `m_pRagdollControl` | IPhysicsRagdollControl* |  | `MPhysPtr` |
| `0x10d0` | `m_RagdollPose` | PhysicsRagdollPose_t |  |  |
