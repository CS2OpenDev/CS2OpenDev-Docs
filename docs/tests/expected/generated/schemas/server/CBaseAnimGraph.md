...
**Derived by:** [CBaseCombatCharacter](../server/CBaseCombatCharacter.md)
...
| `0x770` | `m_graphControllerManager` | CAnimGraphControllerManager |  |  |
| `0x808` | `m_pMainGraphController` | CAnimGraphControllerPtr |  | The primary animation-graph controller instance for this entity. |
| `0x810` | `m_bInitiallyPopulateInterpHistory` | bool |  |  |
| `0x818` | `m_OnLayerCycleUpdated` | CEntityOutputTemplate< float32 > |  |  |
| `0x838` | `m_OnExternalChoreoGraphChanged` | CEntityIOOutput |  |  |
| `0x850` | `m_pChoreoServices` | IChoreoServices* |  | `MKV3TransferSaveOpsForField GetChoreoServicesSaveRestoreOps` |
...
| `0x878` | `m_pRagdollControl` | IPhysicsRagdollControl* |  | `MPhysPtr` |
| `0x880` | `m_RagdollPose` | PhysicsRagdollPose_t |  |  |
