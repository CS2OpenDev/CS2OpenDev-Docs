...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseCombatCharacter
...
**Derived by:** [CBasePlayerPawn](../server/CBasePlayerPawn.md)
...
153 fields (10 declared here, 143 inherited). Offsets are absolute from the object base.
...
| `0x968` | `m_hMyWearables` | CNetworkUtlVectorBase< CHandle< CEconWearable > > |  | Handles to the character's equipped wearable items (gloves, agent model pieces). `MNotSaved` |
...
| `0x9c8` | `m_vecRelationships` | CUtlVector< RelationshipOverride_t > |  |  |
| `0x9e0` | `m_strRelationships` | CUtlSymbolLarge |  |  |
| `0x9e8` | `m_eHull` | Hull_t |  |  |
| `0x9ec` | `m_nNavHullIdx` | uint32 |  |  |
| `0x9f0` | `m_movementStats` | CMovementStatsProperty |  |  |
