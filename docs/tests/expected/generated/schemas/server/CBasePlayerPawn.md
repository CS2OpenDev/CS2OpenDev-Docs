...
178 fields (25 declared here, 153 inherited). Offsets are absolute from the object base.
...
| `0xa30` | `m_pWeaponServices` | CPlayer_WeaponServices* |  | Weapon-handling component (active weapon, switch timing). |
| `0xa38` | `m_pItemServices` | CPlayer_ItemServices* |  | Carried-item component (defuser, helmet). |
| `0xa40` | `m_pAutoaimServices` | CPlayer_AutoaimServices* |  |  |
| `0xa48` | `m_pObserverServices` | CPlayer_ObserverServices* |  | Spectator component, active while the pawn is dead or observing. |
| `0xa50` | `m_pWaterServices` | CPlayer_WaterServices* |  |  |
| `0xa58` | `m_pUseServices` | CPlayer_UseServices* |  |  |
| `0xa60` | `m_pFlashlightServices` | CPlayer_FlashlightServices* |  |  |
| `0xa68` | `m_pCameraServices` | CPlayer_CameraServices* |  | View / camera component. |
| `0xa70` | `m_pMovementServices` | CPlayer_MovementServices* |  | Movement / input component. |
| `0xa80` | `m_ServerViewAngleChanges` | CUtlVectorEmbeddedNetworkVar< ViewAngleServerChange_t > |  | `MNotSaved` |
...
| `0xb98` | `m_fTimeLastHurt` | GameTime_t |  |  |
| `0xb9c` | `m_flDeathTime` | GameTime_t |  |  |
| `0xba0` | `m_fNextSuicideTime` | GameTime_t |  | `MNotSaved` |
| `0xba4` | `m_fInitHUD` | bool |  |  |
| `0xba8` | `m_pExpresser` | CAI_Expresser* |  |  |
| `0xbb0` | `m_hController` | CHandle< CBasePlayerController > |  |  |
| `0xbb4` | `m_hDefaultController` | CHandle< CBasePlayerController > |  |  |
