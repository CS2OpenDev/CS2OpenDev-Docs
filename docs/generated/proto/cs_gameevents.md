...
direction LR
  ...
  class CMsgTEFireBullets_Extra["CMsgTEFireBullets.Extra"] {
  ...
  CMsgTEFireBullets --> CMsgTEFireBullets_Extra : extra
...
| Field | Number | Type | Label | Description |
|-------|--------|------|-------|-------------|
| `origin` | 1 | [CMsgVector](networkbasetypes.md#cmsgvector) | optional | World-space muzzle position from which the bullet was fired. |
| `angles` | 2 | [CMsgQAngle](networkbasetypes.md#cmsgqangle) | optional | Aim angles (pitch, yaw) at the moment of fire. |
| `weapon_id` | 3 | uint32 | optional | Item definition index (item_definition_index_t) of the weapon fired. Maps to entries in items_game.txt. *(default: `16777215`)* |
...
| `ent_origin` | 13 | [CMsgVector](networkbasetypes.md#cmsgvector) | optional | World-space origin of the firing entity (may differ from muzzle origin for some weapon types). |
...
| `extra` | 16 | [CMsgTEFireBullets.Extra](#cmsgtefirebulletsextra) | optional | Optional nested Extra message with additional precision data for demo analysis. |
...
| Field | Number | Type | Label | Description |
|-------|--------|------|-------|-------------|
| `aim_punch` | 1 | [CMsgQAngle](networkbasetypes.md#cmsgqangle) | optional |  |
| `attack_tick_count` | 2 | int32 | optional |  |
| `attack_tick_frac` | 3 | float | optional |  |
| `render_tick_count` | 4 | int32 | optional |  |
| `render_tick_frac` | 5 | float | optional |  |
| `inaccuracy_move` | 6 | float | optional |  |
| `inaccuracy_air` | 7 | float | optional |  |
...
| `victim_pos` | 3 | [CMsgVector](networkbasetypes.md#cmsgvector) | optional | World-space position of the victim at the moment of impact. |
