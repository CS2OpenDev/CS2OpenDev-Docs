...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_DirectionVector
...
**Metadata:** `MPropertyDescription Specifies a basis direction vector ( Forward, Left, or UP).`, `MPropertyFriendlyName Direction Vector`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropDirection_t](../!GlobalTypes/SmartPropDirection_t.md) |  |  |
