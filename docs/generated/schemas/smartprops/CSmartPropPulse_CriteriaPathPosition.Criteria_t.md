...
|--------|-------|------|------|-------------|
| `0x0` | `m_PlaceAtPositions` | [SmartPropPathPositions_t](../!GlobalTypes/SmartPropPathPositions_t.md) |  | `MPropertyDescription Specifies the method to use to determine which positions this element should be placed at along the path.` |
