...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropOperation_SetPosition
...
**Metadata:** `MPropertyDescription Set the position of the current transform.`, `MPropertyFriendlyName Transform: Set Position`, `MVDataClassGroup Transform`
