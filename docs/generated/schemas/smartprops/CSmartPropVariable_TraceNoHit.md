...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_TraceNoHit
...
**Metadata:** `MPropertyDescription Specified what to do when a trace does not hit a surface.`, `MPropertyFriendlyName Trace Miss Behavior`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [TraceNoHitResult_t](../!GlobalTypes/TraceNoHitResult_t.md) |  |  |
