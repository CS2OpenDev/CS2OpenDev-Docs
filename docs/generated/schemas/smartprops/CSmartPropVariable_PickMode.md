...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_PickMode
...
**Metadata:** `MPropertyDescription Specifies how a fit on line element will pick which child elements it will place.`, `MPropertyFriendlyName Fit on Line Pick Mode`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [PickMode_t](../!GlobalTypes/PickMode_t.md) |  |  |
