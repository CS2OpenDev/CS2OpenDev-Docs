...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_ChoiceSelectionMode
...
**Metadata:** `MPropertyDescription Specifies the method by which a child element is selected from a list.`, `MPropertyFriendlyName Selection Mode`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropChoiceSelectionMode_t](../!GlobalTypes/SmartPropChoiceSelectionMode_t.md) |  |  |
