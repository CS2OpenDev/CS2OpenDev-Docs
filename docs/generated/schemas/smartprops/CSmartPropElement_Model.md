...
| `0x248` | `m_nDetailObjectFadeLevel` | [SmartPropDetailFadeLevel_t](../smartprops/SmartPropDetailFadeLevel_t.md) |  | `MPropertyDescription Controls the size at which a model marked as a detail object will fade out.` `MPropertyFriendlyName Fade Level` `MPropertySuppressExpr m_bDetailObject == false` |
