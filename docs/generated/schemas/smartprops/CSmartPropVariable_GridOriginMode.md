...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_GridOriginMode
...
**Metadata:** `MPropertyDescription Specifies where the origin of a child element is placed realative to each grid cell.`, `MPropertyFriendlyName Grid Origin`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropGridOriginBasis_t](../!GlobalTypes/SmartPropGridOriginBasis_t.md) |  |  |
