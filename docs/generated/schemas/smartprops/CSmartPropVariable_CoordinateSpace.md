...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_CoordinateSpace
...
**Metadata:** `MPropertyDescription Specifies a coordinate space in which a point or vector value is defined.`, `MPropertyFriendlyName Coordinate Space`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropSpace_t](../!GlobalTypes/SmartPropSpace_t.md) |  |  |
