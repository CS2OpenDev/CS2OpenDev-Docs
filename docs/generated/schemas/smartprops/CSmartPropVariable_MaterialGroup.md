...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_MaterialGroup

# CSmartPropVariable_MaterialGroup

**Kind:** class · **Size:** 288 bytes (`0x120`) · **Align:** 8 · **Module:** smartprops
...
| `0x38` | `m_sModelName` | CResourceNameTyped< CWeakHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > > |  | `MPropertyDescription Model containing the set of material groups to select.` `MPropertyProvidesEditContextString ToolEditContext_ID_VMDL` |
| `0x118` | `m_DefaultValue` | CModelMaterialGroupName |  | `MPropertyDescription Default material group (skin) to assign to the variable value.` `MPropertyFriendlyName Default Material Group` |
