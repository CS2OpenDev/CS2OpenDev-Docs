...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_PathPositions
...
**Metadata:** `MPropertyDescription Specifies the set of positions that are valid for path placement.`, `MPropertyFriendlyName Path Positions`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropPathPositions_t](../!GlobalTypes/SmartPropPathPositions_t.md) |  |  |
