...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_DistributionMode
...
**Metadata:** `MPropertyDescription Specifies a distribution mode used to determine how certain elements distribute instances of their children within a space.`, `MPropertyFriendlyName Distribution Mode`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [SmartPropDistributionMode_t](../!GlobalTypes/SmartPropDistributionMode_t.md) |  |  |
