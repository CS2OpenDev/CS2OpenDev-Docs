...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_Model
...
**Metadata:** `MPropertyDescription Model Asset Variable`, `MPropertyFriendlyName Model`
...
| `0x38` | `m_DefaultValue` | CResourceNameTyped< CWeakHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > > |  | `MPropertyFriendlyName Default Model` |
