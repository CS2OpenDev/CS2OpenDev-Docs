---
layout: default
title: CSmartPropVariable_SurfaceProperty
nav_exclude: true
---

[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_SurfaceProperty
...
**Metadata:** `MPropertyDescription Surface Property Variable`, `MPropertyFriendlyName Surface Property`
...
| `0x38` | `m_DefaultValue` | CUtlString |  | `MPropertyCustomFGDType surface_properties` `MPropertyFriendlyName Default Surface Property` |
