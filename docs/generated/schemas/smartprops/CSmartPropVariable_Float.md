...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_Float
...
| `0x38` | `m_DefaultValue` | float32 |  |  |
| `0x3c` | `m_flParamaterMinValue` | float32 |  | `MPropertyReadonlyExpr m_bExposeAsParameter == false` `MPropertySortPriority -1` |
| `0x40` | `m_flParamaterMaxValue` | float32 |  | `MPropertyReadonlyExpr m_bExposeAsParameter == false` `MPropertySortPriority -1` |
