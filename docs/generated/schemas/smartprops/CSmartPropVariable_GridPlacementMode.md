...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_GridPlacementMode
...
**Metadata:** `MPropertyDescription Specifies how to place elements within a grid.`, `MPropertyFriendlyName Grid Placement`, `MVDataClassGroup Enumerator Types`
