...
[Schemas](../../schemas.md) / [smartprops](../smartprops.md) / CSmartPropVariable_ApplyColorMode
...
**Metadata:** `MPropertyDescription Specifies how a color tint value is to be applied with respect to the existing color tint`, `MPropertyFriendlyName Tint Mode`, `MVDataClassGroup Enumerator Types`
...
| `0x38` | `m_DefaultValue` | [ApplyColorMode_t](../!GlobalTypes/ApplyColorMode_t.md) |  |  |
