...
**Kind:** class · **Size:** 8 bytes (`0x8`) · **Align:** 255 · **Module:** rendersystemdx11
...
|--------|-------|------|------|-------------|
| `0x0` | `m_bDepthTestEnable` | bitfield:1 |  |  |
| `0x0` | `m_bDepthWriteEnable` | bitfield:1 |  |  |
| `0x0` | `m_depthFunc` | bitfield:4 |  |  |
