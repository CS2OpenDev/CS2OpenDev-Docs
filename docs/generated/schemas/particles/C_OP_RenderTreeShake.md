...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderTreeShake
...
30 fields (10 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_flPeakStrength` | float32 |  | `MPropertyFriendlyName peak strength` |
| `0x22c` | `m_nPeakStrengthFieldOverride` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName peak strength field override` |
| `0x230` | `m_flRadius` | float32 |  | `MPropertyFriendlyName radius` |
| `0x234` | `m_nRadiusFieldOverride` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName strength field override` |
| `0x238` | `m_flShakeDuration` | float32 |  | `MPropertyFriendlyName shake duration after end` |
| `0x23c` | `m_flTransitionTime` | float32 |  | `MPropertyFriendlyName amount of time taken to smooth between different shake parameters` |
| `0x240` | `m_flTwistAmount` | float32 |  | `MPropertyFriendlyName Twist amount (-1..1)` |
| `0x244` | `m_flRadialAmount` | float32 |  | `MPropertyFriendlyName Radial Amount (-1..1)` |
| `0x248` | `m_flControlPointOrientationAmount` | float32 |  | `MPropertyFriendlyName Control Point Orientation Amount (-1..1)` |
| `0x24c` | `m_nControlPointForLinearDirection` | int32 |  | `MPropertyFriendlyName Control Point for Orientation Amount` |
