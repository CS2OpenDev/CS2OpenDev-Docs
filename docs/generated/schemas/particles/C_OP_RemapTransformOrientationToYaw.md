...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapTransformOrientationToYaw
...
| `0x240` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_rotation` `MPropertyFriendlyName rotation field` |
| `0x244` | `m_flRotOffset` | float32 |  | `MPropertyFriendlyName rotation offset` |
| `0x248` | `m_flSpinStrength` | float32 |  | `MPropertyFriendlyName spin strength` |
