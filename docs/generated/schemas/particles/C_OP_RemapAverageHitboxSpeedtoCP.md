...
| `0x1e0` | `m_nInControlPointNumber` | int32 |  | `MPropertyFriendlyName input control point` |
| `0x1e4` | `m_nOutControlPointNumber` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1e8` | `m_nField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName Output component` |
| `0x1ec` | `m_nHitboxDataType` | [ParticleHitboxDataSelection_t](../!GlobalTypes/ParticleHitboxDataSelection_t.md) |  | `MPropertyFriendlyName hitbox data` |
| `0x1f0` | `m_flInputMin` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input minimum` |
| `0x360` | `m_flInputMax` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input maximum` |
| `0x4d0` | `m_flOutputMin` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x640` | `m_flOutputMax` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x7b0` | `m_nHeightControlPointNumber` | int32 |  | `MPropertyFriendlyName intersection height CP` `MPropertySuppressExpr m_nHitboxDataType != PARTICLE_HITBOX_AVERAGE_SPEED` |
| `0x7b8` | `m_vecComparisonVelocity` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName comparison velocity` `MPropertySuppressExpr m_nHitboxDataType != PARTICLE_HITBOX_AVERAGE_SPEED` |
| `0xe70` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
