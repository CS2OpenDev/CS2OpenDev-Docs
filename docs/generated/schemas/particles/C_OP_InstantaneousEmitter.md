...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_InstantaneousEmitter

# C_OP_InstantaneousEmitter

**Kind:** class · **Size:** 1608 bytes (`0x648`) · **Align:** 8 · **Module:** particles
...
26 fields (8 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_nParticlesToEmit` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyAttributeRange 1 1000` `MPropertyFriendlyName num to emit` |
...
| `0x4c0` | `m_flInitFromKilledParentParticles` | float32 |  | `MPropertyFriendlyName emission scale from parent particle events` |
| `0x4c4` | `m_nEventType` | [EventTypeSelection_t](../!GlobalTypes/EventTypeSelection_t.md) |  | `MPropertyFriendlyName emission parent particle event type` `MPropertySuppressExpr m_flInitFromKilledParentParticles == 0` |
| `0x4c8` | `m_flParentParticleScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName emission scale from parent particle count` |
| `0x638` | `m_nMaxEmittedPerFrame` | int32 |  | `MPropertyFriendlyName maximum emission per frame` |
| `0x63c` | `m_nSnapshotControlPoint` | int32 |  | `MPropertyFriendlyName control point with snapshot data` |
| `0x640` | `m_strSnapshotSubset` | CUtlString |  | `MPropertyFriendlyName snapshot subset` `MPropertySuppressExpr m_nSnapshotControlPoint < 0` |
