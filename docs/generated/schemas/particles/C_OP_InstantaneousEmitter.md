...
| `0x4c4` | `m_nEventType` | [EventTypeSelection_t](../particles/EventTypeSelection_t.md) |  | `MPropertyFriendlyName emission parent particle event type` `MPropertySuppressExpr m_flInitFromKilledParentParticles == 0` |
