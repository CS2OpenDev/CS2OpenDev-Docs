...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DriveCPFromGlobalSoundFloat
...
| `0x1e0` | `m_nOutputControlPoint` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1e4` | `m_nOutputField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output field` |
...
| `0x1f0` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x1f4` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x1f8` | `m_StackName` | CUtlString |  | `MPropertyFriendlyName sound stack name` |
| `0x200` | `m_OperatorName` | CUtlString |  | `MPropertyFriendlyName sound operator name` |
| `0x208` | `m_FieldName` | CUtlString |  | `MPropertyFriendlyName sound field name` |
