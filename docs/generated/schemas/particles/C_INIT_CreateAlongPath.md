...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateAlongPath

# C_INIT_CreateAlongPath

**Kind:** class · **Size:** 592 bytes (`0x250`) · **Align:** 16 · **Module:** particles
...
| `0x230` | `m_bUseRandomCPs` | bool |  | `MPropertyFriendlyName randomly select sequential CP pairs between start and end points` |
| `0x234` | `m_vEndOffset` | Vector |  | `MPropertyFriendlyName Offset from control point for path end` `MVectorIsCoordinate` |
| `0x240` | `m_bSaveOffset` | bool |  | `MPropertyFriendlyName save offset` |
