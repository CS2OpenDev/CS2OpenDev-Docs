...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MaintainSequentialPath
...
| `0x1d8` | `m_fMaxDistance` | float32 |  | `MPropertyFriendlyName maximum distance` |
| `0x1dc` | `m_flNumToAssign` | float32 |  | `MPropertyFriendlyName particles to map from start to end` |
| `0x1e0` | `m_flCohesionStrength` | float32 |  | `MPropertyFriendlyName cohesion strength` |
| `0x1e4` | `m_flTolerance` | float32 |  | `MPropertyFriendlyName control point movement tolerance` |
| `0x1e8` | `m_bLoop` | bool |  | `MPropertyFriendlyName restart behavior (0 = bounce, 1 = loop )` |
| `0x1e9` | `m_bUseParticleCount` | bool |  | `MPropertyFriendlyName use existing particle count` |
| `0x1f0` | `m_PathParams` | [CPathParameters](../particles/CPathParameters.md) |  |  |
