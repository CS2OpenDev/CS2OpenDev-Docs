...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetFloatAttributeToVectorExpression

# C_OP_SetFloatAttributeToVectorExpression

**Kind:** class · **Size:** 4296 bytes (`0x10c8`) · **Align:** 8 · **Module:** particles
...
23 fields (6 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_nExpression` | [VectorFloatExpressionType_t](../!GlobalTypes/VectorFloatExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
...
| `0xf50` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
| `0x10c0` | `m_nOutputField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
