...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_VelocityFromCP
...
| `0x1e0` | `m_velocityInput` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName velocity` |
| `0x898` | `m_transformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MParticleInputOptional` `MPropertyFriendlyName local space` |
| `0x900` | `m_flVelocityScale` | float32 |  | `MPropertyFriendlyName velocity scale` |
| `0x904` | `m_bDirectionOnly` | bool |  | `MPropertyFriendlyName direction only` |
