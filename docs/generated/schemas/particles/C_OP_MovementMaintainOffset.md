...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MovementMaintainOffset
...
| `0x1d8` | `m_vecOffset` | Vector |  | `MPropertyFriendlyName desired offset` `MVectorIsCoordinate` |
| `0x1e4` | `m_nCP` | int32 |  | `MPropertyFriendlyName local space CP` |
| `0x1e8` | `m_bRadiusScale` | bool |  | `MPropertyFriendlyName scale by radius` |
