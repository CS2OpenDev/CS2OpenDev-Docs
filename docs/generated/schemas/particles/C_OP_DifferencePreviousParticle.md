...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DifferencePreviousParticle
...
| `0x1d8` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field` |
...
| `0x1e0` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName difference minimum` |
| `0x1e4` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName difference maximum` |
| `0x1e8` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x1ec` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x1f0` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x1f4` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within specified difference` |
| `0x1f5` | `m_bSetPreviousParticle` | bool |  | `MPropertyFriendlyName also set ouput to previous particle` |
