...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetCPOrientationToGroundNormal
...
| `0x1d8` | `m_flInterpRate` | float32 |  | `MPropertyFriendlyName interpolation rate` |
| `0x1dc` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName max trace length` |
