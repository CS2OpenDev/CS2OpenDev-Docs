...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_Cull
...
| `0x1d8` | `m_flCullPerc` | float32 |  | `MPropertyFriendlyName cull percentage` |
| `0x1dc` | `m_flCullStart` | float32 |  | `MPropertyFriendlyName cull start time` |
| `0x1e0` | `m_flCullEnd` | float32 |  | `MPropertyFriendlyName cull end time` |
| `0x1e4` | `m_flCullExp` | float32 |  | `MPropertyFriendlyName cull time exponent` |
