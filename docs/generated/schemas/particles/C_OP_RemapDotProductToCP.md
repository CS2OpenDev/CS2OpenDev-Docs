...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapDotProductToCP

# C_OP_RemapDotProductToCP

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1968 bytes (`0x7b0`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nInputCP1` | int32 |  | `MPropertyFriendlyName first input control point` |
| `0x1e4` | `m_nInputCP2` | int32 |  | `MPropertyFriendlyName second input control point` |
| `0x1e8` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1ec` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output component` |
| `0x1f0` | `m_flInputMin` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input minimum (-1 to 1)` |
| `0x360` | `m_flInputMax` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input maximum (-1 to 1)` |
