...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_OscillateVectorSimple
...
| `0x1d8` | `m_Rate` | Vector |  | `MPropertyFriendlyName oscillation rate` `MVectorIsSometimesCoordinate m_nField` |
| `0x1e4` | `m_Frequency` | Vector |  | `MPropertyFriendlyName oscillation frequency` |
| `0x1f0` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName oscillation field` |
| `0x1f4` | `m_flOscMult` | float32 |  | `MPropertyFriendlyName oscillation multiplier` |
| `0x1f8` | `m_flOscAdd` | float32 |  | `MPropertyFriendlyName oscillation start phase` |
| `0x1fc` | `m_bOffset` | bool |  | `MPropertyFriendlyName offset instead of accelerate position` |
