...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_VectorFieldSnapshot

# C_OP_VectorFieldSnapshot

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2592 bytes (`0xa20`) · **Align:** 8 · **Module:** particles
...
| `0x1dc` | `m_nAttributeToWrite` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName extra velocity field to write` |
| `0x1e0` | `m_nLocalSpaceCP` | int32 |  | `MPropertyFriendlyName local space control point number` |
| `0x1e8` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
| `0x358` | `m_vecScale` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName Component Scale` |
| `0xa10` | `m_flBoundaryDampening` | float32 |  | `MPropertyFriendlyName Boundary Dampening` |
| `0xa14` | `m_bSetVelocity` | bool |  | `MPropertyFriendlyName Set Velocity` |
| `0xa15` | `m_bLockToSurface` | bool |  | `MPropertyFriendlyName Lock to Surface` |
| `0xa18` | `m_flGridSpacing` | float32 |  | `MPropertyFriendlyName Vector Field Grid Spacing Override` |
