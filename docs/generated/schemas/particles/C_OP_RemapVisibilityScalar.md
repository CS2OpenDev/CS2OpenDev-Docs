...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapVisibilityScalar
...
| `0x1e0` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName visibility minimum` |
| `0x1e4` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName visibility maximum` |
...
| `0x1f0` | `m_flRadiusScale` | float32 |  | `MPropertyFriendlyName radius scale` |
