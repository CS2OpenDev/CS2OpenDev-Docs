...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetAttributeToScalarExpression

# C_OP_SetAttributeToScalarExpression

**Kind:** class · **Size:** 1632 bytes (`0x660`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_nExpression` | [ScalarExpressionType_t](../!GlobalTypes/ScalarExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
| `0x1e0` | `m_flInput1` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName input 1` |
| `0x350` | `m_flInput2` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName input 2` |
| `0x4c0` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
| `0x630` | `m_nOutputField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x634` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
