...
| `0x1d8` | `m_nExpression` | [ScalarExpressionType_t](../particles/ScalarExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
...
| `0x634` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
