...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapAverageScalarValuetoCP
...
| `0x1e0` | `m_nExpression` | [SetStatisticExpressionType_t](../!GlobalTypes/SetStatisticExpressionType_t.md) |  | `MPropertyFriendlyName expression type` |
| `0x1e8` | `m_flDecimalPlaces` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName mode # of decimal places` `MPropertySuppressExpr m_nExpression != SET_EXPRESSION_MODE` |
| `0x358` | `m_nOutControlPointNumber` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x35c` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output field` |
| `0x360` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName input attribute to evaluate` |
| `0x368` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
