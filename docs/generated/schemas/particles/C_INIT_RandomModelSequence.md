...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomModelSequence

# C_INIT_RandomModelSequence

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1000 bytes (`0x3e8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_ActivityName` | char[256] |  | `MPropertyFriendlyName activity` `MPropertySuppressExpr mod != dota` |
| `0x2e0` | `m_SequenceName` | char[256] |  | `MPropertyFriendlyName sequence` `MPropertySuppressExpr mod == dota` |
| `0x3e0` | `m_hModel` | CStrongHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > |  | `MPropertyFriendlyName model` |
