...
| `0x1d8` | `m_RateMin` | float32 |  | `MPropertyFriendlyName oscillation rate min` |
| `0x1dc` | `m_RateMax` | float32 |  | `MPropertyFriendlyName oscillation rate max` |
| `0x1e0` | `m_FrequencyMin` | float32 |  | `MPropertyFriendlyName oscillation frequency min` |
| `0x1e4` | `m_FrequencyMax` | float32 |  | `MPropertyFriendlyName oscillation frequency max` |
| `0x1e8` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName oscillation field` |
| `0x1ec` | `m_bProportional` | bool |  | `MPropertyFriendlyName proportional 0/1` |
| `0x1ed` | `m_bProportionalOp` | bool |  | `MPropertyFriendlyName start/end proportional` |
| `0x1f0` | `m_flStartTime_min` | float32 |  | `MPropertyFriendlyName start time min` |
| `0x1f4` | `m_flStartTime_max` | float32 |  | `MPropertyFriendlyName start time max` |
| `0x1f8` | `m_flEndTime_min` | float32 |  | `MPropertyFriendlyName end time min` |
| `0x1fc` | `m_flEndTime_max` | float32 |  | `MPropertyFriendlyName end time max` |
| `0x200` | `m_flOscMult` | float32 |  | `MPropertyFriendlyName oscillation multiplier` |
| `0x204` | `m_flOscAdd` | float32 |  | `MPropertyFriendlyName oscillation start phase` |
