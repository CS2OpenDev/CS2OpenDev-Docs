...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_SequenceFromCP
...
| `0x1e0` | `m_bKillUnused` | bool |  | `MPropertyFriendlyName kill unused` |
| `0x1e1` | `m_bRadiusScale` | bool |  | `MPropertyFriendlyName offset propotional to radius` |
| `0x1e4` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point` |
| `0x1e8` | `m_vecOffset` | Vector |  | `MPropertyFriendlyName per particle spatial offset` `MVectorIsCoordinate` |
