...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ControlPointToRadialScreenSpace
...
| `0x1e0` | `m_nCPIn` | int32 |  | `MPropertyFriendlyName source Control Point in World` |
| `0x1e4` | `m_vecCP1Pos` | Vector |  | `MPropertyFriendlyName Source Control Point offset` `MVectorIsCoordinate` |
| `0x1f0` | `m_nCPOut` | int32 |  | `MPropertyFriendlyName Set control point number` |
| `0x1f4` | `m_nCPOutField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName Output field 0-2 X/Y/Z` |
| `0x1f8` | `m_nCPSSPosOut` | int32 |  | `MPropertyFriendlyName Ss Pos and Dot OUT CP` |
