...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_AgeNoise
...
| `0x1e0` | `m_bAbsVal` | bool |  | `MPropertyFriendlyName absolute value` |
| `0x1e1` | `m_bAbsValInv` | bool |  | `MPropertyFriendlyName invert absolute value` |
| `0x1e4` | `m_flOffset` | float32 |  | `MPropertyFriendlyName time coordinate offset` |
| `0x1e8` | `m_flAgeMin` | float32 |  | `MPropertyFriendlyName start age minimum` |
| `0x1ec` | `m_flAgeMax` | float32 |  | `MPropertyFriendlyName start age maximum` |
| `0x1f0` | `m_flNoiseScale` | float32 |  | `MPropertyFriendlyName time noise coordinate scale` |
| `0x1f4` | `m_flNoiseScaleLoc` | float32 |  | `MPropertyFriendlyName spatial noise coordinate scale` |
| `0x1f8` | `m_vecOffsetLoc` | Vector |  | `MPropertyFriendlyName spatial coordinate offset` `MVectorIsCoordinate` |
