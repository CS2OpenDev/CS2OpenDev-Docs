...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_TwistAroundAxis
...
| `0x1e8` | `m_fForceAmount` | float32 |  | `MPropertyFriendlyName amount of force` |
| `0x1ec` | `m_TwistAxis` | Vector |  | `MPropertyFriendlyName twist axis` `MVectorIsCoordinate` |
| `0x1f8` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName object local space axis 0/1` |
| `0x1fc` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point` |
