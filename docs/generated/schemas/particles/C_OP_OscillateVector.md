...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_OscillateVector
...
| `0x1d8` | `m_RateMin` | Vector |  | `MPropertyFriendlyName oscillation rate min` `MVectorIsSometimesCoordinate m_nField` |
| `0x1e4` | `m_RateMax` | Vector |  | `MPropertyFriendlyName oscillation rate max` `MVectorIsSometimesCoordinate m_nField` |
| `0x1f0` | `m_FrequencyMin` | Vector |  | `MPropertyFriendlyName oscillation frequency min` `MVectorIsSometimesCoordinate m_nField` |
| `0x1fc` | `m_FrequencyMax` | Vector |  | `MPropertyFriendlyName oscillation frequency max` `MVectorIsSometimesCoordinate m_nField` |
| `0x208` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName oscillation field` |
| `0x20c` | `m_bProportional` | bool |  | `MPropertyFriendlyName proportional 0/1` |
| `0x20d` | `m_bProportionalOp` | bool |  | `MPropertyFriendlyName start/end proportional` |
| `0x20e` | `m_bOffset` | bool |  | `MPropertyFriendlyName offset instead of accelerate position` |
| `0x210` | `m_flStartTime_min` | float32 |  | `MPropertyFriendlyName start time min` |
| `0x214` | `m_flStartTime_max` | float32 |  | `MPropertyFriendlyName start time max` |
| `0x218` | `m_flEndTime_min` | float32 |  | `MPropertyFriendlyName end time min` |
| `0x21c` | `m_flEndTime_max` | float32 |  | `MPropertyFriendlyName end time max` |
| `0x220` | `m_flOscMult` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName oscillation multiplier` |
| `0x390` | `m_flOscAdd` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName oscillation start phase` |
| `0x500` | `m_flRateScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName rate scale` |
