...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetToCP
...
| `0x1dc` | `m_vecOffset` | Vector |  | `MPropertyFriendlyName offset` |
| `0x1e8` | `m_bOffsetLocal` | bool |  | `MPropertyFriendlyName offset in local space` |
