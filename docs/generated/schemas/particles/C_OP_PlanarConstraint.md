...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PlanarConstraint

# C_OP_PlanarConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1248 bytes (`0x4e0`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_PointOnPlane` | Vector |  | `MPropertyFriendlyName plane point` `MVectorIsCoordinate` |
| `0x1e4` | `m_PlaneNormal` | Vector |  | `MPropertyFriendlyName plane normal` |
| `0x1f0` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1f4` | `m_bGlobalOrigin` | bool |  | `MPropertyFriendlyName global origin` |
| `0x1f5` | `m_bGlobalNormal` | bool |  | `MPropertyFriendlyName global normal` |
| `0x1f8` | `m_flRadiusScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName radius scale` |
| `0x368` | `m_flMaximumDistanceToCP` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName falloff distance from control point` |
| `0x4d8` | `m_bUseOldCode` | bool |  | `MPropertyFriendlyName use old code` |
