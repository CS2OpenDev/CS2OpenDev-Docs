...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ClampVector
...
| `0x1e0` | `m_vecOutputMin` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName output minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x898` | `m_vecOutputMax` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName output maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
