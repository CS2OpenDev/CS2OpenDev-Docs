...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderStatusEffectCitadel

# C_OP_RenderStatusEffectCitadel

**Kind:** class · **Size:** 600 bytes (`0x258`) · **Align:** 8 · **Module:** particles
...
| `0x230` | `m_pTextureNormal` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName normal texture` |
| `0x238` | `m_pTextureMetalness` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName metalness texture` |
| `0x240` | `m_pTextureRoughness` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName roughness texture` |
| `0x248` | `m_pTextureSelfIllum` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName self illum texture` |
| `0x250` | `m_pTextureDetail` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName detail texture` |
