...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetSingleControlPointPosition
...
| `0x1e0` | `m_bSetOnce` | bool |  | `MPropertyFriendlyName only set position once` |
| `0x1e4` | `m_nCP1` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e8` | `m_vecCP1Pos` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName control point location` |
| `0x8a0` | `m_transformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MParticleInputOptional` `MPropertyFriendlyName transform to offset positions from` |
