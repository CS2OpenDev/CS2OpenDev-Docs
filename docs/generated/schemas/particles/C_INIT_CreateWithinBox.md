...
| `0x1e0` | `m_vecMin` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName min` `MVectorIsCoordinate` |
| `0x898` | `m_vecMax` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName max` `MVectorIsCoordinate` |
| `0xf50` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0xf54` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName use local space` |
| `0xf58` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
| `0xf60` | `m_bUseNewCode` | bool |  | `MPropertyFriendlyName use new code` |
