...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetVec
...
| `0x1d8` | `m_InputValue` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName value` |
| `0x890` | `m_nOutputField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x894` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x898` | `m_Lerp` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName interpolation` |
| `0xa08` | `m_bNormalizedOutput` | bool |  | `MPropertyFriendlyName normalize result` |
