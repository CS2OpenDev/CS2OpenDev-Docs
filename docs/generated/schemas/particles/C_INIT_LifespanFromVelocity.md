...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_LifespanFromVelocity
...
| `0x1e0` | `m_vecComponentScale` | Vector |  | `MPropertyFriendlyName bias distance` `MVectorIsCoordinate` |
| `0x1ec` | `m_flTraceOffset` | float32 |  | `MPropertyFriendlyName trace offset` |
| `0x1f0` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName maximum trace length` |
| `0x1f4` | `m_flTraceTolerance` | float32 |  | `MPropertyFriendlyName trace recycle tolerance` |
| `0x1f8` | `m_nMaxPlanes` | int32 |  | `MPropertyFriendlyName maximum points to cache` |
| `0x200` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName trace collision group` |
| `0x280` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x290` | `m_bIncludeWater` | bool |  | `MPropertyFriendlyName collide with water` |
