...
| `0x228` | `m_cubeWidth` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  | `MPropertyFriendlyName cube width` |
| `0x398` | `m_cutoffRadius` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  | `MPropertyFriendlyName cutoff radius` |
| `0x508` | `m_renderRadius` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  | `MPropertyFriendlyName render radius` |
| `0x678` | `m_nVertexCountKb` | uint32 |  | `MPropertyAttributeRange 0 1024` `MPropertyFriendlyName (optional) vertex buffer size (k)` |
| `0x67c` | `m_nIndexCountKb` | uint32 |  | `MPropertyAttributeRange 0 1024` `MPropertyFriendlyName (optional) index buffer size (k)` |
| `0x680` | `m_nScaleCP` | int32 |  | `MPropertyFriendlyName scale CP (cube width/cutoff/render = x/y/z)` |
| `0x688` | `m_MaterialVars` | CUtlVector< [MaterialVariable_t](../particles/MaterialVariable_t.md) > |  | `MPropertyAutoExpandSelf` `MPropertyFriendlyName material variables` `MPropertySortPriority 600` |
| `0x6b8` | `m_hMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
