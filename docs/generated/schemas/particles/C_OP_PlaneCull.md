...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PlaneCull
...
| `0x1d8` | `m_nPlaneControlPoint` | int32 |  | `MPropertyFriendlyName control point for point on plane` |
| `0x1e0` | `m_vecPlaneDirection` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName plane normal` |
| `0x898` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName use local space` |
| `0x89c` | `m_flPlaneOffset` | float32 |  | `MPropertyFriendlyName cull plane offset` |
