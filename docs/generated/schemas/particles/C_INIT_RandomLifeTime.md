...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomLifeTime
...
| `0x1e0` | `m_fLifetimeMin` | float32 |  | `MPropertyAttributeRange 0 20` `MPropertyFriendlyName lifetime min` |
| `0x1e4` | `m_fLifetimeMax` | float32 |  | `MPropertyAttributeRange 0 20` `MPropertyFriendlyName lifetime max` |
| `0x1e8` | `m_fLifetimeRandExponent` | float32 |  | `MPropertyFriendlyName lifetime random exponent` |
