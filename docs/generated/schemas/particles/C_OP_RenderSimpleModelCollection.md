...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderSimpleModelCollection

# C_OP_RenderSimpleModelCollection

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1432 bytes (`0x598`) · **Align:** 8 · **Module:** particles
...
29 fields (9 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_bCenterOffset` | bool |  | `MPropertyFriendlyName center mesh` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
| `0x230` | `m_hModel` | CStrongHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > |  | `MPropertyFriendlyName model` `MPropertyStartGroup Model` |
| `0x238` | `m_modelInput` | [CParticleModelInput](../particleslib/CParticleModelInput.md) |  | `MPropertyFriendlyName input model override` |
| `0x298` | `m_fSizeCullScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName size cull scale` `MPropertyStartGroup Rendering` |
| `0x408` | `m_bDisableShadows` | bool |  | `MPropertyFriendlyName disable shadows` |
| `0x409` | `m_bDisableMotionBlur` | bool |  | `MPropertyFriendlyName disable motion blur` |
| `0x40a` | `m_bAcceptsDecals` | bool |  | `MPropertyFriendlyName accept decals` |
| `0x410` | `m_fDrawFilter` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName render filter` |
| `0x580` | `m_nAngularVelocityField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName angular velocity attribute (improves motion blur)` |
