...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_NoiseEmitter

# C_OP_NoiseEmitter

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 544 bytes (`0x220`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_flEmissionDuration` | float32 |  | `MPropertyFriendlyName emission duration` |
| `0x1e4` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emission start time` |
| `0x1e8` | `m_flEmissionScale` | float32 |  | `MParticleMaxVersion 1` `MPropertyFriendlyName scale emission to used control points` |
| `0x1ec` | `m_nScaleControlPoint` | int32 |  | `MPropertyFriendlyName emission count scale control point` |
| `0x1f0` | `m_nScaleControlPointField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName emission count scale control point field` |
| `0x1f4` | `m_nWorldNoisePoint` | int32 |  | `MPropertyFriendlyName world noise scale control point` |
| `0x1f8` | `m_bAbsVal` | bool |  | `MPropertyFriendlyName absolute value` |
| `0x1f9` | `m_bAbsValInv` | bool |  | `MPropertyFriendlyName invert absolute value` |
| `0x1fc` | `m_flOffset` | float32 |  | `MPropertyFriendlyName time coordinate offset` |
| `0x200` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName emission minimum` |
| `0x204` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName emission maximum` |
| `0x208` | `m_flNoiseScale` | float32 |  | `MPropertyFriendlyName time noise coordinate scale` |
| `0x20c` | `m_flWorldNoiseScale` | float32 |  | `MPropertyFriendlyName world spatial noise coordinate scale` |
| `0x210` | `m_vecOffsetLoc` | Vector |  | `MPropertyFriendlyName spatial coordinate offset` `MVectorIsCoordinate` |
| `0x21c` | `m_flWorldTimeScale` | float32 |  | `MPropertyFriendlyName world time noise coordinate scale` |
