...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateFromCPs
...
| `0x1e0` | `m_nIncrement` | int32 |  | `MPropertyFriendlyName control point increment amount` |
| `0x1e4` | `m_nMinCP` | int32 |  | `MPropertyFriendlyName starting control point` |
| `0x1e8` | `m_nMaxCP` | int32 |  | `MParticleMinVersion 2` `MPropertyFriendlyName ending control point` |
| `0x1f0` | `m_nDynamicCPCount` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName dynamic control point count` |
