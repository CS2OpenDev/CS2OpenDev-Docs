...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointsToModelParticles

# C_OP_SetControlPointsToModelParticles

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 744 bytes (`0x2e8`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
| `0x258` | `m_AttachmentName` | char[128] |  | `MPropertyFriendlyName attachment to follow` |
| `0x2d8` | `m_nFirstControlPoint` | int32 |  | `MPropertyFriendlyName First control point to set` |
| `0x2dc` | `m_nNumControlPoints` | int32 |  | `MPropertyFriendlyName # of control points to set` |
| `0x2e0` | `m_nFirstSourcePoint` | int32 |  | `MPropertyFriendlyName first particle to copy` |
| `0x2e4` | `m_bSkin` | bool |  | `MPropertyFriendlyName use skinning instead of hitboxes` |
| `0x2e5` | `m_bAttachment` | bool |  | `MPropertyFriendlyName follow attachment` |
