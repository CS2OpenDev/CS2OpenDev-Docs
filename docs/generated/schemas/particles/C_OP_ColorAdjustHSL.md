...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ColorAdjustHSL
...
| `0x1d8` | `m_flHueAdjust` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName hue adjust` |
| `0x348` | `m_flSaturationAdjust` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName saturation adjust` |
| `0x4b8` | `m_flLightnessAdjust` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName lightness adjust` |
