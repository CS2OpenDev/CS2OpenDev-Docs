...
29 fields (12 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_nSnapshotControlPointNumber` | int32 |  | `MPropertyFriendlyName snapshot control point number` |
| `0x1dc` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e0` | `m_bRandom` | bool |  | `MPropertyFriendlyName random order` |
| `0x1e4` | `m_nRandomSeed` | int32 |  | `MPropertyFriendlyName random seed` |
| `0x1e8` | `m_bSetNormal` | bool |  | `MPropertyFriendlyName set normal` |
| `0x1e9` | `m_bSetRadius` | bool |  | `MPropertyFriendlyName set radius` |
| `0x1ec` | `m_nIndexType` | [SnapshotIndexType_t](../!GlobalTypes/SnapshotIndexType_t.md) |  | `MPropertyFriendlyName Snapshot Read Type` |
| `0x1f0` | `m_flReadIndex` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Snapshot Index` `MPropertySuppressExpr m_nIndexType != SNAPSHOT_INDEX_DIRECT` |
| `0x360` | `m_flIncrement` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName particle increment amount` `MPropertySuppressExpr m_nIndexType != SNAPSHOT_INDEX_INCREMENT` |
| `0x4d0` | `m_nFullLoopIncrement` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Full Loop Increment Amount` `MPropertySuppressExpr m_nIndexType != SNAPSHOT_INDEX_INCREMENT` |
| `0x640` | `m_nSnapShotStartPoint` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Snapshot start point` `MPropertySuppressExpr m_nIndexType != SNAPSHOT_INDEX_INCREMENT` |
| `0x7b0` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
