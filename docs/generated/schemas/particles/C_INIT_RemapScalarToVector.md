...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RemapScalarToVector

# C_INIT_RemapScalarToVector

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 552 bytes (`0x228`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName input field` |
| `0x1e4` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1e8` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input minimum` |
| `0x1ec` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input maximum` |
| `0x1f0` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName output minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1fc` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName output maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x208` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emitter lifetime start time (seconds)` |
| `0x20c` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName emitter lifetime end time (seconds)` |
| `0x210` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x214` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x218` | `m_bLocalCoords` | bool |  | `MPropertyFriendlyName use local system` |
| `0x21c` | `m_flRemapBias` | float32 |  | `MPropertyFriendlyName remap bias` |
