...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateWithinCapsuleTransform

# C_INIT_CreateWithinCapsuleTransform

**Kind:** class · **Size:** 5880 bytes (`0x16f8`) · **Align:** 8 · **Module:** particles
...
29 fields (11 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x4c0` | `m_fHeight` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName capsule height` |
| `0x630` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName input position transform` |
| `0x698` | `m_fSpeedMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName speed min` |
| `0x808` | `m_fSpeedMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName speed max` |
| `0x978` | `m_fSpeedRandExp` | float32 |  | `MPropertyFriendlyName speed random exponent` |
| `0x980` | `m_LocalCoordinateSystemSpeedMin` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName speed in local coordinate system min` `MVectorIsCoordinate` |
| `0x1038` | `m_LocalCoordinateSystemSpeedMax` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName speed in local coordinate system max` `MVectorIsCoordinate` |
| `0x16f0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName Output vector` |
| `0x16f4` | `m_nFieldVelocity` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName Velocity vector` |
