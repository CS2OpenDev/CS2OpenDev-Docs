...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_InheritFromPeerSystem
...
| `0x1d8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName read field` |
| `0x1dc` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName written field` |
| `0x1e0` | `m_nIncrement` | int32 |  | `MPropertyFriendlyName particle neighbor increment amount` |
| `0x1e4` | `m_nGroupID` | int32 |  | `MPropertyFriendlyName group id` |
