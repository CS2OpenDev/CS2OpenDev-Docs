...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapParticleCountOnScalarEndCap
...
| `0x1dc` | `m_nInputMin` | int32 |  | `MPropertyFriendlyName input minimum` |
| `0x1e0` | `m_nInputMax` | int32 |  | `MPropertyFriendlyName input maximum` |
...
| `0x1ec` | `m_bBackwards` | bool |  | `MPropertyFriendlyName count back from last particle` |
