...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LockToSavedSequentialPath
...
**Metadata:** `MParticleMaxVersion 7`, `MParticleReplacementOp C_OP_LockToSavedSequentialPathV2`
...
| `0x1dc` | `m_flFadeStart` | float32 |  | `MPropertyFriendlyName start fade time` |
| `0x1e0` | `m_flFadeEnd` | float32 |  | `MPropertyFriendlyName end fade time` |
| `0x1e4` | `m_bCPPairs` | bool |  | `MPropertyFriendlyName Use sequential CP pairs between start and end point` |
