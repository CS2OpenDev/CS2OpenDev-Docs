...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_OscillateScalarSimple

# C_OP_OscillateScalarSimple

**Kind:** class · **Size:** 528 bytes (`0x210`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_Rate` | float32 |  | `MPropertyFriendlyName oscillation rate` |
| `0x1dc` | `m_Frequency` | float32 |  | `MPropertyFriendlyName oscillation frequency` |
| `0x1e0` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName oscillation field` |
| `0x1e4` | `m_flOscMult` | float32 |  | `MPropertyFriendlyName oscillation multiplier` |
| `0x1e8` | `m_flOscAdd` | float32 |  | `MPropertyFriendlyName oscillation start phase` |
