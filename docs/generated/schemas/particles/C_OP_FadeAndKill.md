...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_FadeAndKill
...
| `0x1d8` | `m_flStartFadeInTime` | float32 |  | `MPropertyFriendlyName start fade in time` |
| `0x1dc` | `m_flEndFadeInTime` | float32 |  | `MPropertyFriendlyName end fade in time` |
| `0x1e0` | `m_flStartFadeOutTime` | float32 |  | `MPropertyFriendlyName start fade out time` |
| `0x1e4` | `m_flEndFadeOutTime` | float32 |  | `MPropertyFriendlyName end fade out time` |
| `0x1e8` | `m_flStartAlpha` | float32 |  | `MPropertyFriendlyName start alpha` |
| `0x1ec` | `m_flEndAlpha` | float32 |  | `MPropertyFriendlyName end alpha` |
| `0x1f0` | `m_bForcePreserveParticleOrder` | bool |  | `MPropertyFriendlyName force preserving particle order` |
