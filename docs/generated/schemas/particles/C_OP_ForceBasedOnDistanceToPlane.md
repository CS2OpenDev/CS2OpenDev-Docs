...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ForceBasedOnDistanceToPlane
...
| `0x1e8` | `m_flMinDist` | float32 |  | `MPropertyFriendlyName min distance from plane` |
| `0x1ec` | `m_vecForceAtMinDist` | Vector |  | `MPropertyFriendlyName force at min distance` `MVectorIsCoordinate` |
| `0x1f8` | `m_flMaxDist` | float32 |  | `MPropertyFriendlyName max distance from plane` |
| `0x1fc` | `m_vecForceAtMaxDist` | Vector |  | `MPropertyFriendlyName force at max distance` `MVectorIsCoordinate` |
| `0x208` | `m_vecPlaneNormal` | Vector |  | `MPropertyFriendlyName plane normal` `MVectorIsCoordinate` |
| `0x214` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x218` | `m_flExponent` | float32 |  | `MPropertyFriendlyName exponent` |
