...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomRadius
...
| `0x1e0` | `m_flRadiusMin` | float32 |  | `MPropertyAttributeRange biased 0 500` `MPropertyFriendlyName radius min` |
| `0x1e4` | `m_flRadiusMax` | float32 |  | `MPropertyAttributeRange biased 0 500` `MPropertyFriendlyName radius max` |
| `0x1e8` | `m_flRadiusRandExponent` | float32 |  | `MPropertyAttributeRange -2 2` `MPropertyFriendlyName radius random exponent` |
