...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetFromCPSnapshot

# C_OP_SetFromCPSnapshot

**Kind:** class · **Size:** 1624 bytes (`0x658`) · **Align:** 8 · **Module:** particles
...
30 fields (13 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName snapshot control point number` |
| `0x1e0` | `m_strSnapshotSubset` | CUtlString |  | `MPropertyFriendlyName snapshot subset` `MPropertySuppressExpr m_nControlPointNumber < 0` |
| `0x1e8` | `m_nAttributeToRead` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName field to read` |
| `0x1ec` | `m_nAttributeToWrite` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName field to write` |
| `0x1f0` | `m_nLocalSpaceCP` | int32 |  | `MPropertyFriendlyName local space control point number` |
| `0x1f4` | `m_bRandom` | bool |  | `MPropertyFriendlyName random order` |
| `0x1f5` | `m_bReverse` | bool |  | `MPropertyFriendlyName reverse order` |
| `0x1f8` | `m_nRandomSeed` | int32 |  | `MPropertyFriendlyName random seed` |
| `0x200` | `m_nSnapShotStartPoint` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Snapshot start point` |
| `0x370` | `m_nSnapShotIncrement` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Snapshot increment amount` |
| `0x4e0` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
| `0x650` | `m_bSubSample` | bool |  | `MPropertyFriendlyName Sub-Sample Between Input Points` |
| `0x651` | `m_bPrev` | bool |  | `MPropertyFriendlyName Position also sets Previous Position` |
