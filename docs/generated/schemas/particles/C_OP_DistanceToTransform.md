...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DistanceToTransform

# C_OP_DistanceToTransform

**Kind:** class · **Size:** 3928 bytes (`0xf58`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_flInputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance minimum` |
| `0x350` | `m_flInputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance maximum` |
| `0x4c0` | `m_flOutputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x630` | `m_flOutputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x7a0` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName transform input` |
| `0x808` | `m_bLOS` | bool |  | `MPropertyFriendlyName ensure line of sight` |
| `0x809` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName LOS collision group` |
| `0x88c` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x890` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName maximum trace length` |
| `0x894` | `m_flLOSScale` | float32 |  | `MPropertyFriendlyName LOS Failure Scalar` |
| `0x898` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x89c` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within specified distance` |
| `0x89d` | `m_bAdditive` | bool |  | `MPropertyFriendlyName output is additive` |
| `0x8a0` | `m_vecComponentScale` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName component scale` |
