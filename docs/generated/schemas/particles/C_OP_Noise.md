...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_Noise
...
| `0x1dc` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x1e0` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x1e4` | `m_fl4NoiseScale` | float32 |  | `MPropertyFriendlyName noise coordinate scale` |
| `0x1e8` | `m_bAdditive` | bool |  | `MPropertyFriendlyName additive` |
| `0x1ec` | `m_flNoiseAnimationTimeScale` | float32 |  | `MPropertyFriendlyName Noise animation time scale` |
