...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InheritFromParentParticles
...
| `0x1e0` | `m_flScale` | float32 |  | `MPropertyFriendlyName scale` |
| `0x1e4` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName inherited field` |
| `0x1e8` | `m_nIncrement` | int32 |  | `MPropertyFriendlyName particle increment amount` |
| `0x1ec` | `m_bRandomDistribution` | bool |  | `MPropertyFriendlyName random parent particle distribution` |
| `0x1f0` | `m_nRandomSeed` | int32 |  | `MPropertyFriendlyName random seed` |
