...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ReinitializeScalarEndCap
...
| `0x1dc` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName minimum` |
| `0x1e0` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName maximum` |
