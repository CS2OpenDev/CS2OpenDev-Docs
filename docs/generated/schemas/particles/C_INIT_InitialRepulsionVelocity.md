...
| `0x1e0` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName collision group` |
| `0x260` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x264` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName minimum velocity` `MVectorIsCoordinate` |
| `0x270` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName maximum velocity` `MVectorIsCoordinate` |
| `0x27c` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x280` | `m_bPerParticle` | bool |  | `MPropertyFriendlyName per particle world collision tests` |
| `0x281` | `m_bTranslate` | bool |  | `MPropertyFriendlyName offset instead of accelerate` |
| `0x282` | `m_bProportional` | bool |  | `MPropertyFriendlyName offset proportional to radius 0/1` |
| `0x284` | `m_flTraceLength` | float32 |  | `MPropertyFriendlyName trace length` |
| `0x288` | `m_bPerParticleTR` | bool |  | `MPropertyFriendlyName use radius for per particle trace length` |
| `0x289` | `m_bInherit` | bool |  | `MPropertyFriendlyName inherit from parent` |
| `0x28c` | `m_nChildCP` | int32 |  | `MPropertyFriendlyName control points to broadcast to children (n + 1)` |
| `0x290` | `m_nChildGroupID` | int32 |  | `MPropertyFriendlyName child group ID to affect` |
