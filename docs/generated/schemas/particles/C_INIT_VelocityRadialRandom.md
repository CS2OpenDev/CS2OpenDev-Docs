...
| `0x1e0` | `m_bPerParticleCenter` | bool |  | `MPropertyFriendlyName per-particle center point` |
| `0x1e4` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` `MPropertySuppressExpr m_bPerParticleCenter == true` |
| `0x1e8` | `m_vecPosition` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName radial center point` `MPropertySuppressExpr m_bPerParticleCenter == false` |
| `0x8a0` | `m_vecFwd` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName radial center forward` `MPropertySuppressExpr m_bPerParticleCenter == false` |
| `0xf58` | `m_fSpeedMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName random speed min` |
| `0x10c8` | `m_fSpeedMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName random speed max` |
| `0x1238` | `m_vecLocalCoordinateSystemSpeedScale` | Vector |  | `MPropertyFriendlyName local space scale` |
| `0x1245` | `m_bIgnoreDelta` | bool |  | `MPropertyFriendlyName ignore delta time` |
