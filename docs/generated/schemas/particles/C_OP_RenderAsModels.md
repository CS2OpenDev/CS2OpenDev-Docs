...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderAsModels
...
28 fields (8 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_ModelList` | CUtlVector< [ModelReference_t](../particles/ModelReference_t.md) > |  | `MParticleRequireDefaultArrayEntry` `MPropertyFriendlyName models` |
| `0x244` | `m_flModelScale` | float32 |  | `MPropertyFriendlyName scale factor for radius` |
| `0x248` | `m_bFitToModelSize` | bool |  | `MPropertyFriendlyName scale model to match particle size` |
| `0x249` | `m_bNonUniformScaling` | bool |  | `MPropertyFriendlyName non-uniform scaling` |
| `0x24c` | `m_nXAxisScalingAttribute` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName X axis scaling scalar field` |
| `0x250` | `m_nYAxisScalingAttribute` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName Y axis scaling scalar field` |
| `0x254` | `m_nZAxisScalingAttribute` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName Z axis scaling scalar field` |
| `0x258` | `m_nSizeCullBloat` | int32 |  | `MPropertyAttributeChoiceName particlefield_size_cull_bloat` `MPropertyFriendlyName model size cull bloat` |
