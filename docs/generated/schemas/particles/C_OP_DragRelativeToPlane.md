...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DragRelativeToPlane

# C_OP_DragRelativeToPlane

**Kind:** class · **Size:** 2944 bytes (`0xb80`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_flDragAtPlane` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName dampening` |
| `0x348` | `m_flFalloff` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName falloff` |
| `0x4b8` | `m_bDirectional` | bool |  | `MPropertyFriendlyName dampen on only one side of plane` |
| `0x4c0` | `m_vecPlaneNormal` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName plane normal` `MVectorIsCoordinate` |
| `0xb78` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
