...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SpringToVectorConstraint

# C_OP_SpringToVectorConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 3664 bytes (`0xe50`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_flRestLength` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName slack` |
| `0x348` | `m_flMinDistance` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName minimum segment length %` |
| `0x4b8` | `m_flMaxDistance` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName maximum segment length %` |
| `0x628` | `m_flRestingLength` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName resting spacing` |
| `0x798` | `m_vecAnchorVector` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName anchor vector` |
