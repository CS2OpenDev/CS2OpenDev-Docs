...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PercentageBetweenTransforms

# C_OP_PercentageBetweenTransforms

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 712 bytes (`0x2c8`) · **Align:** 8 · **Module:** particles
...
| `0x1e4` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x1e8` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x1f0` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName strarting transform` |
| `0x258` | `m_TransformEnd` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName end transform` |
| `0x2c0` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x2c4` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within input range` |
| `0x2c5` | `m_bRadialCheck` | bool |  | `MPropertyFriendlyName treat distance between points as radius` |
