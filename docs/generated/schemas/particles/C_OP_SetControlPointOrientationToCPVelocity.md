...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointOrientationToCPVelocity
...
| `0x1e0` | `m_nCPInput` | int32 |  | `MPropertyFriendlyName control point input for velocity` |
| `0x1e4` | `m_nCPOutput` | int32 |  | `MPropertyFriendlyName control point output for orientation` |
