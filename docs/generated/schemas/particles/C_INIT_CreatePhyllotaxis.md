...
| `0x1e4` | `m_nScaleCP` | int32 |  | `MPropertyFriendlyName scale size multiplier from CP` |
| `0x1e8` | `m_nComponent` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName scale CP component 0/1/2 X/Y/Z` |
| `0x1ec` | `m_fRadCentCore` | float32 |  | `MPropertyFriendlyName center core radius` |
| `0x1f0` | `m_fRadPerPoint` | float32 |  | `MPropertyFriendlyName radius multiplier` |
| `0x1f4` | `m_fRadPerPointTo` | float32 |  | `MPropertyFriendlyName radius max (-1 procedural growth)` |
...
| `0x20e` | `m_bUseOrigRadius` | bool |  | `MPropertyFriendlyName scale radius from initial value` |
