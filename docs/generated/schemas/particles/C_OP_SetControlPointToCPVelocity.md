...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointToCPVelocity

# C_OP_SetControlPointToCPVelocity

**Kind:** class · **Size:** 2224 bytes (`0x8b0`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nCPInput` | int32 |  | `MPropertyFriendlyName control point input` |
| `0x1e4` | `m_nCPOutputVel` | int32 |  | `MPropertyFriendlyName control point number to set velocity` |
| `0x1e8` | `m_bNormalize` | bool |  | `MPropertyFriendlyName normalize output` |
| `0x1ec` | `m_nCPOutputMag` | int32 |  | `MPropertyFriendlyName control point number to set magnitude` |
| `0x1f0` | `m_nCPField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName control point field for magnitude` |
| `0x1f8` | `m_vecComparisonVelocity` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName comparison velocity` |
