...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MovementPlaceOnGround

# C_OP_MovementPlaceOnGround

**Kind:** class · **Size:** 2752 bytes (`0xac0`) · **Align:** 8 · **Module:** particles
...
35 fields (18 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_flOffset` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName offset` |
| `0x348` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName max trace length` |
| `0x34c` | `m_flTolerance` | float32 |  | `MPropertyFriendlyName CP movement tolerance` |
| `0x350` | `m_vecTraceDir` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName trace direction` |
| `0xa08` | `m_flTraceOffset` | float32 |  | `MPropertyFriendlyName trace offset` |
| `0xa0c` | `m_flLerpRate` | float32 |  | `MPropertyFriendlyName interpolation rate` |
| `0xa10` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName collision group` |
| `0xa90` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0xa94` | `m_nRefCP1` | int32 |  | `MPropertyFriendlyName reference CP 1` |
| `0xa98` | `m_nRefCP2` | int32 |  | `MPropertyFriendlyName reference CP 2` |
| `0xa9c` | `m_nLerpCP` | int32 |  | `MPropertyFriendlyName interploation distance tolerance cp` |
| `0xaa8` | `m_nTraceMissBehavior` | [ParticleTraceMissBehavior_t](../!GlobalTypes/ParticleTraceMissBehavior_t.md) |  | `MPropertyFriendlyName No Collision Behavior` |
| `0xaac` | `m_bIncludeShotHull` | bool |  | `MPropertyFriendlyName include default contents trace hulls` |
| `0xaad` | `m_bIncludeWater` | bool |  | `MPropertyFriendlyName include water` |
| `0xab0` | `m_bSetNormal` | bool |  | `MPropertyFriendlyName set normal` |
| `0xab1` | `m_bScaleOffset` | bool |  | `MPropertyFriendlyName treat offset as scalar of particle radius` |
| `0xab4` | `m_nPreserveOffsetCP` | int32 |  | `MPropertyFriendlyName preserve initial Z-offset relative to cp` |
| `0xab8` | `m_nIgnoreCP` | int32 |  | `MPropertyFriendlyName CP Entity to Ignore for Collisions` |
