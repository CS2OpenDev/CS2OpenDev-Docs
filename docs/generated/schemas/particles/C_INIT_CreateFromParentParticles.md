...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateFromParentParticles
...
| `0x1e0` | `m_flVelocityScale` | float32 |  | `MPropertyFriendlyName inherited velocity scale` |
| `0x1e4` | `m_flIncrement` | float32 |  | `MPropertyFriendlyName particle increment amount` |
| `0x1e8` | `m_bRandomDistribution` | bool |  | `MPropertyFriendlyName random parent particle distribution` |
| `0x1ec` | `m_nRandomSeed` | int32 |  | `MPropertyFriendlyName random seed` |
| `0x1f0` | `m_bSubFrame` | bool |  | `MPropertyFriendlyName sub frame interpolation` |
| `0x1f1` | `m_bSetRopeSegmentID` | bool |  | `MPropertyFriendlyName set rope segment id` |
