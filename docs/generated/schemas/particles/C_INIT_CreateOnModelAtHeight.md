...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateOnModelAtHeight

# C_INIT_CreateOnModelAtHeight

**Kind:** class · **Size:** 5176 bytes (`0x1438`) · **Align:** 8 · **Module:** particles
...
32 fields (14 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_bUseBones` | bool |  | `MPropertyFriendlyName use bones instead of hitboxes` |
| `0x1e1` | `m_bForceZ` | bool |  | `MPropertyFriendlyName force creation height to desired height` |
| `0x1e4` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e8` | `m_nHeightCP` | int32 |  | `MPropertyFriendlyName height override control point number` |
| `0x1ec` | `m_bUseWaterHeight` | bool |  | `MPropertyFriendlyName desired height is relative to water` |
| `0x1f0` | `m_flDesiredHeight` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName relative desired height` |
| `0x360` | `m_vecHitBoxScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName model hitbox scale` |
| `0xa18` | `m_vecDirectionBias` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName direction bias` `MVectorIsCoordinate` |
| `0x10d0` | `m_nBiasType` | [ParticleHitboxBiasType_t](../!GlobalTypes/ParticleHitboxBiasType_t.md) |  | `MPropertyFriendlyName bias type` |
| `0x10d4` | `m_bLocalCoords` | bool |  | `MPropertyFriendlyName bias in local space` |
| `0x10d5` | `m_bPreferMovingBoxes` | bool |  | `MPropertyFriendlyName bias prefers moving hitboxes` |
| `0x10d6` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
| `0x1158` | `m_flHitboxVelocityScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName hitbox velocity inherited scale` |
| `0x12c8` | `m_flMaxBoneVelocity` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName max hitbox velocity` |
