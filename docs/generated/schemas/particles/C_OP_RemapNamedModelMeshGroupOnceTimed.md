...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapNamedModelMeshGroupOnceTimed

# C_OP_RemapNamedModelMeshGroupOnceTimed

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 568 bytes (`0x238`) · **Align:** 8 · **Module:** particles

**Inherits from:** [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md)
...
26 fields (0 declared here, 26 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_hModel` | CStrongHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) |  |
| `0x1e0` | `m_inNames` | CUtlVector< CUtlString > | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName input names` |
| `0x1f8` | `m_outNames` | CUtlVector< CUtlString > | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName output names` |
| `0x210` | `m_fallbackNames` | CUtlVector< CUtlString > | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName fallback names when the input doesn't match` |
| `0x228` | `m_bModelFromRenderer` | bool | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName model from renderer` |
| `0x229` | `m_bProportional` | bool | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName remap time proportional` |
| `0x22c` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName input field` |
| `0x230` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x234` | `m_flRemapTime` | float32 | [C_OP_RemapNamedModelElementOnceTimed](../particles/C_OP_RemapNamedModelElementOnceTimed.md) | `MPropertyFriendlyName remap time` |
