...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderText
...
| `0x228` | `m_OutlineColor` | Color |  | `MPropertyFriendlyName outline color` |
| `0x230` | `m_DefaultText` | CUtlString |  | `MPropertyFriendlyName default text` |
