...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetGravityToCP
...
| `0x1e0` | `m_nCPInput` | int32 |  | `MPropertyFriendlyName control point to sample gravity` |
| `0x1e4` | `m_nCPOutput` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1e8` | `m_flScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName gravity scale` |
| `0x358` | `m_bSetPosition` | bool |  | `MPropertyFriendlyName set position to gravity vector` |
| `0x359` | `m_bSetOrientation` | bool |  | `MPropertyFriendlyName set orientation` |
| `0x35a` | `m_bSetZDown` | bool |  | `MPropertyFriendlyName set gravity orientation to Z Down (instead of X)` `MPropertySuppressExpr !m_bSetOrientation` |
