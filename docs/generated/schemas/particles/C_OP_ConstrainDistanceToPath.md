...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ConstrainDistanceToPath

# C_OP_ConstrainDistanceToPath

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 576 bytes (`0x240`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_fMinDistance` | float32 |  | `MPropertyFriendlyName minimum distance` |
| `0x1dc` | `m_flMaxDistance0` | float32 |  | `MPropertyFriendlyName maximum distance` |
| `0x1e0` | `m_flMaxDistanceMid` | float32 |  | `MPropertyFriendlyName maximum distance middle` |
| `0x1e4` | `m_flMaxDistance1` | float32 |  | `MPropertyFriendlyName maximum distance end` |
| `0x1f0` | `m_PathParameters` | [CPathParameters](../particles/CPathParameters.md) |  |  |
| `0x230` | `m_flTravelTime` | float32 |  | `MPropertyFriendlyName travel time` |
| `0x234` | `m_nFieldScale` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName travel time scale field` |
| `0x238` | `m_nManualTField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName manual time placement field` |
