...
| `0x1668` | `m_flSpeed` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName speed` `MPropertySuppressExpr m_nType != PARTICLE_VOLUMETRIC_SMOKE_TYPE_TRACE` |
