...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_GlobalLight
...
| `0x1dc` | `m_bClampLowerRange` | bool |  | `MPropertyFriendlyName clamp minimum light value to initial color` |
| `0x1dd` | `m_bClampUpperRange` | bool |  | `MPropertyFriendlyName clamp maximum light value to initial color` |
