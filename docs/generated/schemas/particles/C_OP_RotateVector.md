...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RotateVector

# C_OP_RotateVector

**Kind:** class · **Size:** 880 bytes (`0x370`) · **Align:** 8 · **Module:** particles
...
| `0x1dc` | `m_vecRotAxisMin` | Vector |  | `MPropertyFriendlyName rotation axis min` `MVectorIsCoordinate` |
| `0x1e8` | `m_vecRotAxisMax` | Vector |  | `MPropertyFriendlyName rotation axis max` `MVectorIsCoordinate` |
| `0x1f4` | `m_flRotRateMin` | float32 |  | `MPropertyFriendlyName rotation rate min` |
| `0x1f8` | `m_flRotRateMax` | float32 |  | `MPropertyFriendlyName rotation rate max` |
| `0x1fc` | `m_bNormalize` | bool |  | `MPropertyFriendlyName normalize output` |
| `0x200` | `m_flScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName per particle scale` |
