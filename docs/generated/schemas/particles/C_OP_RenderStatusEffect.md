...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderStatusEffect

# C_OP_RenderStatusEffect

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 608 bytes (`0x260`) · **Align:** 8 · **Module:** particles
...
| `0x228` | `m_pTextureColorWarp` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName color warp texture (3d)` |
| `0x230` | `m_pTextureDetail2` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName detail 2 texture` |
| `0x238` | `m_pTextureDiffuseWarp` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName diffuse warp texture (3d)` |
| `0x240` | `m_pTextureFresnelColorWarp` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName fresnel color warp texture (3d)` |
| `0x248` | `m_pTextureFresnelWarp` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName fresnel warp texture` |
| `0x250` | `m_pTextureSpecularWarp` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName specular warp texture` |
| `0x258` | `m_pTextureEnvMap` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  | `MPropertyAttributeEditor AssetBrowse( vtex, *showassetpreview )` `MPropertyFriendlyName environment map texture` |
