...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LocalAccelerationForce
...
| `0x1e8` | `m_nCP` | int32 |  | `MPropertyFriendlyName local space control point` |
| `0x1ec` | `m_nScaleCP` | int32 |  | `MPropertyFriendlyName scale control point` |
| `0x1f0` | `m_vecAccel` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName local space acceleration` |
