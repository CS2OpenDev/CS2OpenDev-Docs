...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LockPoints
...
| `0x1d8` | `m_nMinCol` | int32 |  | `MPropertyFriendlyName min column/particle index to affect` |
| `0x1dc` | `m_nMaxCol` | int32 |  | `MPropertyFriendlyName max column/particle index to affect` |
| `0x1e0` | `m_nMinRow` | int32 |  | `MPropertyFriendlyName min row/particle index to affect` |
| `0x1e4` | `m_nMaxRow` | int32 |  | `MPropertyFriendlyName max row/particle index to affect` |
| `0x1e8` | `m_nControlPoint` | int32 |  | `MPropertyFriendlyName control point to lock to` |
| `0x1ec` | `m_flBlendValue` | float32 |  | `MPropertyFriendlyName amount of current position to preserve` |
