...
[Schemas](../../schemas.md) / [particles](../particles.md) / CGeneralSpin

# CGeneralSpin

**Kind:** class · **Size:** 496 bytes (`0x1f0`) · **Align:** 255 · **Module:** particles

**Inherits from:** [CParticleFunctionOperator](../particles/CParticleFunctionOperator.md)

**Derived by:** [C_OP_Spin](../particles/C_OP_Spin.md), [C_OP_SpinYaw](../particles/C_OP_SpinYaw.md)
...
| `0x1d8` | `m_nSpinRateDegrees` | int32 |  | `MPropertyFriendlyName spin rate degrees` |
| `0x1dc` | `m_nSpinRateMinDegrees` | int32 |  | `MPropertyFriendlyName spin rate min` |
| `0x1e4` | `m_fSpinRateStopTime` | float32 |  | `MPropertyFriendlyName spin stop time` |
