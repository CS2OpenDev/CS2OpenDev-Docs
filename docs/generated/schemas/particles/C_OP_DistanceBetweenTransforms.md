...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DistanceBetweenTransforms
...
| `0x1d8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x1e0` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName strarting transform` |
| `0x248` | `m_TransformEnd` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName end transform` |
| `0x2b0` | `m_flInputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance minimum` |
| `0x420` | `m_flInputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance maximum` |
| `0x590` | `m_flOutputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x700` | `m_flOutputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x870` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName maximum trace length` |
| `0x874` | `m_flLOSScale` | float32 |  | `MPropertyFriendlyName LOS Failure Scalar` |
| `0x878` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName LOS collision group` |
| `0x8f8` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x8fc` | `m_bLOS` | bool |  | `MPropertyFriendlyName ensure line of sight` |
| `0x900` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
