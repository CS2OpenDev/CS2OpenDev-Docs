...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapCPtoCP
...
| `0x1e0` | `m_nInputControlPoint` | int32 |  | `MPropertyFriendlyName input control point number` |
| `0x1e4` | `m_nOutputControlPoint` | int32 |  | `MPropertyFriendlyName output control point number` |
| `0x1e8` | `m_nInputField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName input field` |
| `0x1ec` | `m_nOutputField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output field` |
| `0x1f0` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input minimum` |
| `0x1f4` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input maximum` |
| `0x1f8` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x1fc` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x200` | `m_bDerivative` | bool |  | `MPropertyFriendlyName use the derivative` |
| `0x204` | `m_flInterpRate` | float32 |  | `MPropertyFriendlyName interpolation` |
