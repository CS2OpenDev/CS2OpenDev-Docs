...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateSequentialPath
...
**Metadata:** `MParticleMaxVersion 7`, `MParticleReplacementOp C_INIT_CreateSequentialPathV2`
...
| `0x1e0` | `m_fMaxDistance` | float32 |  | `MPropertyFriendlyName maximum distance` |
| `0x1e4` | `m_flNumToAssign` | float32 |  | `MPropertyFriendlyName particles to map from start to end` |
| `0x1e8` | `m_bLoop` | bool |  | `MPropertyFriendlyName restart behavior (0 = bounce, 1 = loop )` |
| `0x1e9` | `m_bCPPairs` | bool |  | `MPropertyFriendlyName use sequential CP pairs between start and end point` |
| `0x1ea` | `m_bSaveOffset` | bool |  | `MPropertyFriendlyName save offset` |
