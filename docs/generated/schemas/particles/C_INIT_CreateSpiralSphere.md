...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateSpiralSphere
...
| `0x1e0` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName input position transform` |
| `0x248` | `m_flDensity` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName density` |
...
| `0x528` | `m_flInitialSpeedMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName min initial speed` |
| `0x698` | `m_flInitialSpeedMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName max initial speed` |
| `0x808` | `m_bUseParticleCount` | bool |  | `MPropertyFriendlyName use particle count as density scale` |
