...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CPVelocityForce
...
| `0x1e8` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point` |
| `0x1f0` | `m_flScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName velocity scale` |
