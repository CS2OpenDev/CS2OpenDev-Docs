...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ConnectParentParticleToNearest
...
| `0x1d8` | `m_nFirstControlPoint` | int32 |  | `MPropertyFriendlyName control point to set` |
| `0x1dc` | `m_nSecondControlPoint` | int32 |  | `MPropertyFriendlyName Second Control point to set` |
| `0x1e0` | `m_bUseRadius` | bool |  | `MPropertyFriendlyName Take radius into account for distance` |
| `0x1e8` | `m_flRadiusScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Radius scale for distance calc` `MPropertySuppressExpr !m_bUseRadius` |
| `0x358` | `m_flParentRadiusScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Parent radius scale for distance calc` `MPropertySuppressExpr !m_bUseRadius` |
