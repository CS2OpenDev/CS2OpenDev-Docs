...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomRotationSpeed

# C_INIT_RandomRotationSpeed

**Kind:** class · **Size:** 512 bytes (`0x200`) · **Align:** 8 · **Module:** particles

**Inherits from:** [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md)
...
| `0x1e0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyAttributeChoiceName particlefield_rotation` `MPropertyFriendlyName rotation field` |
| `0x1e4` | `m_flDegrees` | float32 | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyFriendlyName rotation initial` |
| `0x1e8` | `m_flDegreesMin` | float32 | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyFriendlyName rotation offset from initial min` |
| `0x1ec` | `m_flDegreesMax` | float32 | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyFriendlyName rotation offset from initial max` |
| `0x1f0` | `m_flRotationRandExponent` | float32 | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyFriendlyName rotation offset exponent` |
| `0x1f4` | `m_bRandomlyFlipDirection` | bool | [CGeneralRandomRotation](../particles/CGeneralRandomRotation.md) | `MPropertyFriendlyName randomly flip direction` |
