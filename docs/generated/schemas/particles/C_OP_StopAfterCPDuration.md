...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_StopAfterCPDuration
...
| `0x1e0` | `m_flDuration` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName duration at which to stop` |
| `0x350` | `m_bDestroyImmediately` | bool |  | `MPropertyFriendlyName destroy all particles immediately` |
| `0x351` | `m_bPlayEndCap` | bool |  | `MPropertyFriendlyName play end cap effect` |
