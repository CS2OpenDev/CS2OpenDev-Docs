...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RepeatedTriggerChildGroup

# C_OP_RepeatedTriggerChildGroup

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1600 bytes (`0x640`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nChildGroupID` | int32 |  | `MPropertyFriendlyName group ID to affect` |
| `0x1e8` | `m_flClusterRefireTime` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Within-Cluster Refire Time` |
| `0x358` | `m_flClusterSize` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Within-Cluster Fire Count Before Cooldown` |
| `0x4c8` | `m_flClusterCooldown` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Cluster Cooldown Time` |
| `0x638` | `m_bLimitChildCount` | bool |  | `MPropertyFriendlyName limit active children to parent particle count` |
