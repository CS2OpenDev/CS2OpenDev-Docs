...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RemapTransformOrientationToRotations
...
| `0x248` | `m_vecRotation` | Vector |  | `MPropertyFriendlyName offset pitch/yaw/roll` |
| `0x254` | `m_bUseQuat` | bool |  | `MPropertyFriendlyName Use Quaternians Internally` |
| `0x255` | `m_bWriteNormal` | bool |  | `MPropertyFriendlyName Write normal instead of rotation` |
