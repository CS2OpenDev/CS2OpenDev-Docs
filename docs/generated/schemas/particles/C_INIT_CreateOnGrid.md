...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateOnGrid

# C_INIT_CreateOnGrid

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2696 bytes (`0xa88`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nXCount` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName X Dimension Count` |
| `0x350` | `m_nYCount` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Y Dimension Count` |
| `0x4c0` | `m_nZCount` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Z Dimension Count` |
| `0x630` | `m_nXSpacing` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName X Dimension Spacing` |
| `0x7a0` | `m_nYSpacing` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Y Dimension Spacing` |
| `0x910` | `m_nZSpacing` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Z Dimension Spacing` |
| `0xa80` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0xa84` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName use local space` |
| `0xa85` | `m_bCenter` | bool |  | `MPropertyFriendlyName center around control point` |
| `0xa86` | `m_bHollow` | bool |  | `MPropertyFriendlyName hollow` |
