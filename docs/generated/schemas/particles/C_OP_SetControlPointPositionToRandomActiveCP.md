...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointPositionToRandomActiveCP
...
| `0x1e4` | `m_nHeadLocationMin` | int32 |  | `MPropertyFriendlyName min active CP` |
| `0x1e8` | `m_nHeadLocationMax` | int32 |  | `MPropertyFriendlyName max active CP` |
| `0x1f0` | `m_flResetRate` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName reset rate` |
