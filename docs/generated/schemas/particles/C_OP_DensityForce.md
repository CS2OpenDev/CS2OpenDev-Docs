...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DensityForce
...
| `0x1e8` | `m_flRadiusScale` | float32 |  | `MPropertyFriendlyName Radius scale for particle influence` |
| `0x1ec` | `m_flForceScale` | float32 |  | `MPropertyFriendlyName Scale of force` |
| `0x1f0` | `m_flTargetDensity` | float32 |  | `MPropertyFriendlyName Target density` |
