...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RampScalarSpline

# C_OP_RampScalarSpline

**Kind:** class · **Size:** 560 bytes (`0x230`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_RateMin` | float32 |  | `MPropertyFriendlyName ramp rate min` |
| `0x1dc` | `m_RateMax` | float32 |  | `MPropertyFriendlyName ramp rate max` |
| `0x1e0` | `m_flStartTime_min` | float32 |  | `MPropertyFriendlyName start time min` |
| `0x1e4` | `m_flStartTime_max` | float32 |  | `MPropertyFriendlyName start time max` |
| `0x1e8` | `m_flEndTime_min` | float32 |  | `MPropertyFriendlyName end time min` |
| `0x1ec` | `m_flEndTime_max` | float32 |  | `MPropertyFriendlyName end time max` |
| `0x1f0` | `m_flBias` | float32 |  | `MPropertyFriendlyName bias` |
| `0x220` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName ramp field` |
| `0x224` | `m_bProportionalOp` | bool |  | `MPropertyFriendlyName start/end proportional` |
| `0x225` | `m_bEaseOut` | bool |  | `MPropertyFriendlyName ease out` |
