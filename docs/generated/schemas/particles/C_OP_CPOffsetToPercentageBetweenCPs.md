...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CPOffsetToPercentageBetweenCPs
...
| `0x1d8` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName percentage minimum` |
| `0x1dc` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName percentage maximum` |
| `0x1e0` | `m_flInputBias` | float32 |  | `MPropertyFriendlyName percentage bias` |
| `0x1e4` | `m_nStartCP` | int32 |  | `MPropertyFriendlyName starting control point` |
| `0x1e8` | `m_nEndCP` | int32 |  | `MPropertyFriendlyName ending control point` |
| `0x1ec` | `m_nOffsetCP` | int32 |  | `MPropertyFriendlyName offset control point` |
| `0x1f0` | `m_nOuputCP` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1f4` | `m_nInputCP` | int32 |  | `MPropertyFriendlyName input control point` |
| `0x1f8` | `m_bRadialCheck` | bool |  | `MPropertyFriendlyName treat distance between points as radius` |
| `0x1f9` | `m_bScaleOffset` | bool |  | `MPropertyFriendlyName treat offset as scale of total distance` |
| `0x1fc` | `m_vecOffset` | Vector |  | `MPropertyFriendlyName offset amount` `MVectorIsCoordinate` |
