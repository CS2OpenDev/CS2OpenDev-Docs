...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CollideWithSelf
...
| `0x1d8` | `m_flRadiusScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName particle radius scale` |
| `0x348` | `m_flMinimumSpeed` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName minimum speed for check` |
