...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapParticleCountToScalar

# C_OP_RemapParticleCountToScalar

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1960 bytes (`0x7a8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nInputMin` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input minimum` |
| `0x350` | `m_nInputMax` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input maximum` |
| `0x4c0` | `m_flOutputMin` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x630` | `m_flOutputMax` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x7a0` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName` |
| `0x7a4` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
