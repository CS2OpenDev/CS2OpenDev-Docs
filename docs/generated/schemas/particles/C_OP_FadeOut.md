...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_FadeOut
...
| `0x1d8` | `m_flFadeOutTimeMin` | float32 |  | `MPropertyFriendlyName fade out time min` |
| `0x1dc` | `m_flFadeOutTimeMax` | float32 |  | `MPropertyFriendlyName fade out time max` |
| `0x1e0` | `m_flFadeOutTimeExp` | float32 |  | `MPropertyFriendlyName fade out time exponent` |
| `0x1e4` | `m_flFadeBias` | float32 |  | `MPropertyFriendlyName fade bias` |
| `0x220` | `m_bProportional` | bool |  | `MPropertyFriendlyName proportional 0/1` |
| `0x221` | `m_bEaseInAndOut` | bool |  | `MPropertyFriendlyName ease in and out` |
