...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PositionOffsetToCP
...
| `0x1e0` | `m_nControlPointNumberStart` | int32 |  | `MPropertyFriendlyName creation control point number` |
| `0x1e4` | `m_nControlPointNumberEnd` | int32 |  | `MPropertyFriendlyName offset control point number` |
| `0x1e8` | `m_bLocalCoords` | bool |  | `MPropertyFriendlyName offset in local space 0/1` |
