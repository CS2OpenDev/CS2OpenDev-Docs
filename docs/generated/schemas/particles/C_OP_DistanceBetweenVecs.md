...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DistanceBetweenVecs

# C_OP_DistanceBetweenVecs

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5400 bytes (`0x1518`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_vecPoint1` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName first vector` |
| `0x898` | `m_vecPoint2` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName second vector` |
| `0xf50` | `m_flInputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance minimum` |
| `0x10c0` | `m_flInputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance maximum` |
| `0x1230` | `m_flOutputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x13a0` | `m_flOutputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x1510` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x1514` | `m_bDeltaTime` | bool |  | `MPropertyFriendlyName divide by deltatime (for comparing motion since last simulation)` |
