...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PercentageBetweenTransformsVector

# C_OP_PercentageBetweenTransformsVector

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 728 bytes (`0x2d8`) · **Align:** 8 · **Module:** particles
...
27 fields (10 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
...
| `0x1e4` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName output minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1f0` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName output maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x200` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName strarting transform` |
| `0x268` | `m_TransformEnd` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName end transform` |
| `0x2d0` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x2d4` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within input range` |
| `0x2d5` | `m_bRadialCheck` | bool |  | `MPropertyFriendlyName treat distance between points as radius` |
