...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_AddVectorToVector
...
| `0x1e0` | `m_vecScale` | Vector |  | `MPropertyFriendlyName component scale factor` |
| `0x1ec` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1f0` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field` |
| `0x1f4` | `m_vOffsetMin` | Vector |  | `MPropertyFriendlyName random offset min` |
| `0x200` | `m_vOffsetMax` | Vector |  | `MPropertyFriendlyName random offset max` |
| `0x20c` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
