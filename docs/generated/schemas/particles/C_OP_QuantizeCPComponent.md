...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_QuantizeCPComponent
...
| `0x1e0` | `m_flInputValue` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input` |
| `0x350` | `m_nCPOutput` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x354` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output component` |
| `0x358` | `m_flQuantizeValue` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName interval to snap to` |
