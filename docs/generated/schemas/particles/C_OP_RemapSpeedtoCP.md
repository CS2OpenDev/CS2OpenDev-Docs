...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapSpeedtoCP
...
| `0x1e8` | `m_nField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName Output field 0-2 X/Y/Z` |
...
| `0x1fc` | `m_bUseDeltaV` | bool |  | `MPropertyFriendlyName use delta of velocity instead of constant speed` |
