...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapDistanceToLineSegmentToScalar

# C_OP_RemapDistanceToLineSegmentToScalar

**Kind:** class · **Size:** 512 bytes (`0x200`) · **Align:** 8 · **Module:** particles

**Inherits from:** [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md)
...
25 fields (3 declared here, 22 inherited). Offsets are absolute from the object base.
...
| `0x1d8` | `m_nCP0` | int32 | [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md) | `MPropertyFriendlyName control point 0` |
| `0x1dc` | `m_nCP1` | int32 | [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md) | `MPropertyFriendlyName control point 1` |
| `0x1e0` | `m_flMinInputValue` | float32 | [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md) | `MPropertyFriendlyName min distance value` |
| `0x1e4` | `m_flMaxInputValue` | float32 | [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md) | `MPropertyFriendlyName max distance value` |
| `0x1e8` | `m_bInfiniteLine` | bool | [C_OP_RemapDistanceToLineSegmentBase](../particles/C_OP_RemapDistanceToLineSegmentBase.md) | `MPropertyFriendlyName use distance to an infinite line instead of a finite line segment` |
| `0x1f0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x1f4` | `m_flMinOutputValue` | float32 |  | `MPropertyFriendlyName output value at min distance` |
| `0x1f8` | `m_flMaxOutputValue` | float32 |  | `MPropertyFriendlyName output value at max distance` |
