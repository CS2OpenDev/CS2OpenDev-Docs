...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointFieldFromVectorExpression

# C_OP_SetControlPointFieldFromVectorExpression

**Kind:** class · **Size:** 4672 bytes (`0x1240`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nExpression` | [VectorFloatExpressionType_t](../!GlobalTypes/VectorFloatExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
| `0x1e8` | `m_vecInput1` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName input 1` |
| `0x8a0` | `m_vecInput2` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName input 2` |
| `0xf58` | `m_flLerp` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName lerp value` `MPropertySuppressExpr m_nExpression != VECTOR_EXPRESSION_LERP` |
| `0x10c8` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
| `0x1238` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x123c` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output component` |
