...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapCPtoVector
...
| `0x1d8` | `m_nCPInput` | int32 |  | `MPropertyFriendlyName input control point number` |
...
| `0x1e0` | `m_nLocalSpaceCP` | int32 |  | `MPropertyFriendlyName local space CP` |
...
| `0x214` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emitter lifetime start time (seconds)` |
| `0x218` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName emitter lifetime end time (seconds)` |
| `0x21c` | `m_flInterpRate` | float32 |  | `MPropertyFriendlyName interpolation scale` |
| `0x220` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x224` | `m_bOffset` | bool |  | `MPropertyFriendlyName offset position` |
| `0x225` | `m_bAccelerate` | bool |  | `MPropertyFriendlyName accelerate position` |
