...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LerpEndCapScalar
...
| `0x1dc` | `m_flOutput` | float32 |  | `MPropertyFriendlyName value to lerp to` |
| `0x1e0` | `m_flLerpTime` | float32 |  | `MPropertyFriendlyName lerp time` |
