...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_InheritFromParentParticlesV2
...
**Metadata:** `MParticleMinVersion 9`
...
| `0x1d8` | `m_flScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName scale` |
| `0x348` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName inherited field` |
| `0x350` | `m_nIncrement` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName particle increment amount` |
| `0x4c0` | `m_bSubSample` | bool |  | `MPropertyFriendlyName sub-sample parent particles` |
| `0x4c1` | `m_bRandomDistribution` | bool |  | `MPropertyFriendlyName random parent particle distribution` |
| `0x4c2` | `m_bReverse` | bool |  | `MPropertyFriendlyName start at last parent particle in reverse` |
| `0x4c4` | `m_nMissingParentBehavior` | [MissingParentInheritBehavior_t](../!GlobalTypes/MissingParentInheritBehavior_t.md) |  | `MPropertyFriendlyName behavior if parent particle dies` |
| `0x4c8` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
