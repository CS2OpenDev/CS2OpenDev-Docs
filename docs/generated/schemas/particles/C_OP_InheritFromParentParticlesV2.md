...
| `0x4c4` | `m_nMissingParentBehavior` | [MissingParentInheritBehavior_t](../particles/MissingParentInheritBehavior_t.md) |  | `MPropertyFriendlyName behavior if parent particle dies` |
