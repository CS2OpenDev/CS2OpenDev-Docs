...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ParentVortices
...
| `0x1e8` | `m_flForceScale` | float32 |  | `MPropertyFriendlyName amount of force` |
| `0x1ec` | `m_vecTwistAxis` | Vector |  | `MPropertyFriendlyName twist axis` `MVectorIsCoordinate` |
| `0x1f8` | `m_bFlipBasedOnYaw` | bool |  | `MPropertyFriendlyName flip twist axis with yaw` |
