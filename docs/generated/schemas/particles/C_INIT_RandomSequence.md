...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomSequence
...
| `0x1e0` | `m_nSequenceMin` | int32 |  | `MPropertyAttributeEditor SequencePicker( 1 )` `MPropertyFriendlyName sequence min` |
| `0x1e4` | `m_nSequenceMax` | int32 |  | `MPropertyAttributeEditor SequencePicker( 1 )` `MPropertyFriendlyName sequence max` |
| `0x1e8` | `m_bShuffle` | bool |  | `MPropertyFriendlyName shuffle` |
| `0x1e9` | `m_bLinear` | bool |  | `MPropertyFriendlyName linear` |
| `0x1f0` | `m_WeightedList` | CUtlVector< [SequenceWeightedList_t](../particles/SequenceWeightedList_t.md) > |  | `MPropertyFriendlyName weighted list` |
