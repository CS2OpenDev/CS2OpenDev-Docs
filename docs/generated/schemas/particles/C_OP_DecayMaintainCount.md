...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DecayMaintainCount
...
| `0x1d8` | `m_nParticlesToMaintain` | int32 |  | `MPropertyFriendlyName count to maintain` |
| `0x1dc` | `m_flDecayDelay` | float32 |  | `MPropertyFriendlyName decay delay` |
| `0x1e0` | `m_nSnapshotControlPoint` | int32 |  | `MPropertyFriendlyName snapshot control point for count` |
| `0x1e8` | `m_strSnapshotSubset` | CUtlString |  | `MPropertyFriendlyName snapshot subset` `MPropertySuppressExpr m_nSnapshotControlPoint < 0` |
| `0x1f0` | `m_bLifespanDecay` | bool |  | `MPropertyFriendlyName decay on lifespan` |
| `0x1f8` | `m_flScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName total count scale` |
| `0x368` | `m_bKillNewest` | bool |  | `MPropertyFriendlyName kill newest instead of oldest` |
