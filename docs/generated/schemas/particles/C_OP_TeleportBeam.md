...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_TeleportBeam
...
| `0x1d8` | `m_nCPPosition` | int32 |  | `MPropertyFriendlyName Position Control Point` |
| `0x1dc` | `m_nCPVelocity` | int32 |  | `MPropertyFriendlyName Velocity Control Point` |
| `0x1e0` | `m_nCPMisc` | int32 |  | `MPropertyFriendlyName Misc Control Point` |
| `0x1e4` | `m_nCPColor` | int32 |  | `MPropertyFriendlyName Color Control Point` |
| `0x1e8` | `m_nCPInvalidColor` | int32 |  | `MPropertyFriendlyName Invalid Color Control Point` |
| `0x1ec` | `m_nCPExtraArcData` | int32 |  | `MPropertyFriendlyName Extra Arc Data Point` |
| `0x1f0` | `m_vGravity` | Vector |  | `MPropertyFriendlyName Gravity` |
| `0x1fc` | `m_flArcMaxDuration` | float32 |  | `MPropertyFriendlyName Arc Duration Maximum` |
| `0x200` | `m_flSegmentBreak` | float32 |  | `MPropertyFriendlyName Segment Break` |
| `0x204` | `m_flArcSpeed` | float32 |  | `MPropertyFriendlyName Arc Speed` |
| `0x208` | `m_flAlpha` | float32 |  | `MPropertyFriendlyName Alpha` |
