...
| `0x290` | `m_nTraceSet` | [ParticleTraceSet_t](../particles/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x294` | `m_nSetParent` | [ParticleParentSetMode_t](../particles/ParticleParentSetMode_t.md) |  | `MPropertyFriendlyName set parent` |
