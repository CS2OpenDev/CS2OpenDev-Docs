...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DistanceBetweenCPsToCP
...
| `0x1e0` | `m_nStartCP` | int32 |  | `MPropertyFriendlyName starting control point` |
| `0x1e4` | `m_nEndCP` | int32 |  | `MPropertyFriendlyName ending control point` |
| `0x1e8` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1ec` | `m_nOutputCPField` | int32 |  | `MPropertyFriendlyName output control point field` |
| `0x1f0` | `m_bSetOnce` | bool |  | `MPropertyFriendlyName only set distance once` |
| `0x1f4` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName distance minimum` |
| `0x1f8` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName distance maximum` |
| `0x1fc` | `m_flOutputMin` | float32 |  | `MPropertyFriendlyName output minimum` |
| `0x200` | `m_flOutputMax` | float32 |  | `MPropertyFriendlyName output maximum` |
| `0x204` | `m_flMaxTraceLength` | float32 |  | `MPropertyFriendlyName maximum trace length` |
| `0x208` | `m_flLOSScale` | float32 |  | `MPropertyFriendlyName LOS Failure Scale` |
| `0x20c` | `m_bLOS` | bool |  | `MPropertyFriendlyName ensure line of sight` |
| `0x20d` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName LOS collision group` |
| `0x290` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x294` | `m_nSetParent` | [ParticleParentSetMode_t](../!GlobalTypes/ParticleParentSetMode_t.md) |  | `MPropertyFriendlyName set parent` |
