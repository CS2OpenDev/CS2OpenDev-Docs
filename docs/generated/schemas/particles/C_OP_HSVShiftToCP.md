...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_HSVShiftToCP
...
| `0x1e0` | `m_nColorCP` | int32 |  | `MPropertyFriendlyName Target color control point number` |
| `0x1e4` | `m_nColorGemEnableCP` | int32 |  | `MPropertyFriendlyName Color Gem Enable control point number` |
| `0x1e8` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName output control point number` |
| `0x1ec` | `m_DefaultHSVColor` | Color |  | `MPropertyFriendlyName Default HSV Color` |
