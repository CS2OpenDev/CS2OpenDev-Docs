...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PositionWarp

# C_INIT_PositionWarp

**Kind:** class · **Size:** 3952 bytes (`0xf70`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_vecWarpMin` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName warp min` `MVectorIsCoordinate` |
| `0x898` | `m_vecWarpMax` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName warp max` `MVectorIsCoordinate` |
| `0xf50` | `m_nScaleControlPointNumber` | int32 |  | `MPropertyFriendlyName warp scale control point number` |
| `0xf54` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0xf58` | `m_nRadiusComponent` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName radius scale component` |
| `0xf5c` | `m_flWarpTime` | float32 |  | `MPropertyFriendlyName warp transition time (treats min/max as start/end sizes)` |
| `0xf60` | `m_flWarpStartTime` | float32 |  | `MPropertyFriendlyName warp transition start time` |
| `0xf64` | `m_flPrevPosScale` | float32 |  | `MPropertyFriendlyName previous position sacale` |
| `0xf68` | `m_bInvertWarp` | bool |  | `MPropertyFriendlyName reverse warp (0/1)` |
| `0xf69` | `m_bUseCount` | bool |  | `MPropertyFriendlyName use particle count instead of time` |
