...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RestartAfterDuration
...
| `0x1d8` | `m_flDurationMin` | float32 |  | `MPropertyFriendlyName minimum restart time` |
| `0x1dc` | `m_flDurationMax` | float32 |  | `MPropertyFriendlyName maximum restart time` |
| `0x1e0` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point to scale duration` |
| `0x1e4` | `m_nCPField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName control point field X/Y/Z` |
| `0x1e8` | `m_nChildGroupID` | int32 |  | `MPropertyFriendlyName child group ID` |
| `0x1ec` | `m_bOnlyChildren` | bool |  | `MPropertyFriendlyName only restart children` |
