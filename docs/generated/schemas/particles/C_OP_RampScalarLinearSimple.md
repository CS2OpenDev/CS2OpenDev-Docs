...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RampScalarLinearSimple
...
| `0x1d8` | `m_Rate` | float32 |  | `MPropertyFriendlyName ramp rate` |
| `0x1dc` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName start time` |
| `0x1e0` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName end time` |
