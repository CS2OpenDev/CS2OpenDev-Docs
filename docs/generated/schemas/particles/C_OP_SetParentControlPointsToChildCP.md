...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetParentControlPointsToChildCP
...
| `0x1e4` | `m_nChildControlPoint` | int32 |  | `MPropertyFriendlyName control point to set` |
| `0x1e8` | `m_nNumControlPoints` | int32 |  | `MPropertyFriendlyName # of children to set` |
| `0x1ec` | `m_nFirstSourcePoint` | int32 |  | `MPropertyFriendlyName first parent control point to set from` |
| `0x1f0` | `m_bSetOrientation` | bool |  | `MPropertyFriendlyName set orientation` |
