...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ColorInterpolate
...
| `0x1d8` | `m_ColorFade` | Color |  | `MPropertyFriendlyName color fade` |
| `0x1e8` | `m_flFadeStartTime` | float32 |  | `MPropertyFriendlyName fade start time` |
| `0x1ec` | `m_flFadeEndTime` | float32 |  | `MPropertyFriendlyName fade end time` |
...
| `0x1f4` | `m_bEaseInOut` | bool |  | `MPropertyFriendlyName ease in and out` |
