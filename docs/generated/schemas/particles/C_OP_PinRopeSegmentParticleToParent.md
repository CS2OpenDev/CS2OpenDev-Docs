...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PinRopeSegmentParticleToParent
...
| `0x1d8` | `m_nParticleSelection` | [ParticleSelection_t](../!GlobalTypes/ParticleSelection_t.md) |  | `MPropertyFriendlyName particle to use` |
| `0x1e0` | `m_nParticleNumber` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName particle number/offset` |
| `0x350` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
