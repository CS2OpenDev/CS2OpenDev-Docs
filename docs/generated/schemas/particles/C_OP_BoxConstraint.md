...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_BoxConstraint
...
| `0x1d8` | `m_vecMin` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName min coords` |
| `0x890` | `m_vecMax` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName max coords` |
| `0xf48` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point` |
| `0xf4c` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName use local space` |
| `0xf4d` | `m_bAccountForRadius` | bool |  | `MPropertyFriendlyName Take radius into account` |
