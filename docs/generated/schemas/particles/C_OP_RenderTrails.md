...
| `0x2df0` | `m_nOrientationType` | [ParticleOrientationChoiceList_t](../particles/ParticleOrientationChoiceList_t.md) | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName orientation type` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
