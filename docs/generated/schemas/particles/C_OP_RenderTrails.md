...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderTrails

# C_OP_RenderTrails

**Kind:** class · **Size:** 17856 bytes (`0x45c0`) · **Align:** 8 · **Module:** particles

**Inherits from:** [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md)
...
113 fields (20 declared here, 93 inherited). Offsets are absolute from the object base.
...
| `0xd38` | `m_nColorBlendType` | [ParticleColorBlendType_t](../!GlobalTypes/ParticleColorBlendType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName color blend type` `MPropertySortPriority 700` |
| `0xd3c` | `m_nShaderType` | [SpriteCardShaderType_t](../!GlobalTypes/SpriteCardShaderType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName Shader` `MPropertySortPriority 600` `MPropertyStartGroup +Material` |
...
| `0x102c` | `m_nCropTextureOverride` | [ParticleSequenceCropOverride_t](../!GlobalTypes/ParticleSequenceCropOverride_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName Sheet Crop Behavior` `MPropertySortPriority 600` |
...
| `0x1044` | `m_nAnimationType` | [AnimationType_t](../!GlobalTypes/AnimationType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName animation type` `MPropertySortPriority 500` |
...
| `0x1784` | `m_nOutputBlendMode` | [ParticleOutputBlendMode_t](../!GlobalTypes/ParticleOutputBlendMode_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName output blend mode` `MPropertySortPriority 300` `MPropertyStartGroup +Color and alpha adjustments` |
...
| `0x1be4` | `m_nFogType` | [ParticleFogType_t](../!GlobalTypes/ParticleFogType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName Apply fog to particle` `MPropertySortPriority 300` |
...
| `0x1d5c` | `m_nPerParticleAlphaReference` | [SpriteCardPerParticleScale_t](../!GlobalTypes/SpriteCardPerParticleScale_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName alpha reference` `MPropertySortPriority 300` `MPropertyStartGroup Color and alpha adjustments/Alpha Reference` |
| `0x1d60` | `m_nPerParticleAlphaRefWindow` | [SpriteCardPerParticleScale_t](../!GlobalTypes/SpriteCardPerParticleScale_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName alpha reference window size` `MPropertySortPriority 300` |
| `0x1d64` | `m_nAlphaReferenceType` | [ParticleAlphaReferenceType_t](../!GlobalTypes/ParticleAlphaReferenceType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName alpha reference type` `MPropertySortPriority 300` |
...
| `0x2334` | `m_nRefractBlurType` | [BlurFilterType_t](../!GlobalTypes/BlurFilterType_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName refract blur type` `MPropertySortPriority 200` `MPropertySuppressExpr !m_bRefract` |
...
| `0x2444` | `m_nFeatheringMode` | [ParticleDepthFeatheringMode_t](../!GlobalTypes/ParticleDepthFeatheringMode_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName Depth feathering mode` `MPropertySortPriority 900` |
...
| `0x2b78` | `m_nSortMethod` | [ParticleSortingChoiceList_t](../!GlobalTypes/ParticleSortingChoiceList_t.md) | [CBaseRendererSource2](../particles/CBaseRendererSource2.md) | `MPropertyFriendlyName Sort Method` `MPropertySortPriority 900` |
...
| `0x2df0` | `m_nOrientationType` | [ParticleOrientationChoiceList_t](../!GlobalTypes/ParticleOrientationChoiceList_t.md) | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName orientation type` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
| `0x2df4` | `m_nOrientationControlPoint` | int32 | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName orientation control point` `MPropertySortPriority 750` `MPropertySuppressExpr m_nOrientationType != PARTICLE_ORIENTATION_ALIGN_TO_PARTICLE_NORMAL && m_nOrientationType != PARTICLE_ORIENTATION_SCREENALIGN_TO_PARTICLE_NORMAL` |
| `0x2df8` | `m_flMinSize` | float32 | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName minimum visual screen-size` `MPropertySortPriority 900` `MPropertyStartGroup Screenspace Fading and culling` |
| `0x2dfc` | `m_flMaxSize` | float32 | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName maximum visual screen-size` `MPropertySortPriority 900` |
| `0x2e00` | `m_flStartFadeSize` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName start fade screen-size` `MPropertySortPriority 900` |
| `0x2f70` | `m_flEndFadeSize` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName end fade and cull screen-size` `MPropertySortPriority 900` |
| `0x30e0` | `m_flSubPixelAAScale` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName sub-pixel AA scale` `MPropertySortPriority 1000` `MPropertySuppressExpr mod != hlx` |
| `0x3250` | `m_bClampV` | bool | [CBaseTrailRenderer](../particles/CBaseTrailRenderer.md) | `MPropertyFriendlyName Clamp Non-Sheet texture V coords` `MPropertySortPriority 800` `MPropertyStartGroup Trail UV Controls` |
| `0x3258` | `m_bEnableFadingAndClamping` | bool |  | `MPropertyFriendlyName enable fading and clamping` `MPropertySortPriority 1000` `MPropertyStartGroup Screenspace Fading and culling` |
| `0x325c` | `m_flStartFadeDot` | float32 |  | `MPropertyFriendlyName start fade dot product of normal vs view` `MPropertySortPriority 1000` |
| `0x3260` | `m_flEndFadeDot` | float32 |  | `MPropertyFriendlyName end fade dot product of normal vs view` `MPropertySortPriority 1000` |
| `0x3264` | `m_nPrevPntSource` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName Anchor point source` `MPropertySortPriority 800` `MPropertyStartGroup +Trail Length` |
| `0x3268` | `m_flMaxLength` | float32 |  | `MPropertyFriendlyName max length` `MPropertySortPriority 800` |
| `0x326c` | `m_flMinLength` | float32 |  | `MPropertyFriendlyName min length` `MPropertySortPriority 800` |
| `0x3270` | `m_bIgnoreDT` | bool |  | `MPropertyFriendlyName ignore delta time` `MPropertySortPriority 800` |
| `0x3274` | `m_flConstrainRadiusToLengthRatio` | float32 |  | `MPropertyFriendlyName constrain radius to no more than this times the length` `MPropertySortPriority 800` |
| `0x3278` | `m_flLengthScale` | float32 |  | `MPropertyFriendlyName amount to scale trail length by` |
| `0x327c` | `m_flLengthFadeInTime` | float32 |  | `MPropertyFriendlyName how long before a trail grows to its full length` |
| `0x3280` | `m_flRadiusHeadTaper` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName head taper scale` `MPropertySortPriority 800` `MPropertyStartGroup Trail Head & Tail` |
| `0x33f0` | `m_vecHeadColorScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName head color scale` |
| `0x3aa8` | `m_flHeadAlphaScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName head alpha scale` |
| `0x3c18` | `m_flRadiusTaper` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName tail taper scale` |
| `0x3d88` | `m_vecTailColorScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName tail color scale` |
| `0x4440` | `m_flTailAlphaScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName tail alpha scale` |
| `0x45b0` | `m_nHorizCropField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName texture UV horizontal Scale field` `MPropertySortPriority 800` `MPropertyStartGroup Trail UV Controls` |
| `0x45b4` | `m_nVertCropField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName texture UV vertical Scale field` |
| `0x45b8` | `m_flForwardShift` | float32 |  | `MPropertyFriendlyName Trail forward shift (fraction)` |
| `0x45bc` | `m_bFlipUVBasedOnPitchYaw` | bool |  | `MPropertyFriendlyName Flip U or V texcoords if pitch or yaw go over PI` |
