...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_OrientTo2dDirection

# C_OP_OrientTo2dDirection

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2208 bytes (`0x8a0`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_vecInput` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName direction input` `MVectorIsCoordinate` |
| `0x890` | `m_flRotOffset` | float32 |  | `MPropertyFriendlyName rotation offset` |
| `0x894` | `m_flSpinStrength` | float32 |  | `MPropertyFriendlyName spin strength` |
| `0x898` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_rotation` `MPropertyFriendlyName rotation field` |
