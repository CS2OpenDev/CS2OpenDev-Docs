...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SpinYaw

# C_OP_SpinYaw

**Kind:** class · **Size:** 496 bytes (`0x1f0`) · **Align:** 8 · **Module:** particles

**Inherits from:** [CGeneralSpin](../particles/CGeneralSpin.md)
...
| `0x1d8` | `m_nSpinRateDegrees` | int32 | [CGeneralSpin](../particles/CGeneralSpin.md) | `MPropertyFriendlyName spin rate degrees` |
| `0x1dc` | `m_nSpinRateMinDegrees` | int32 | [CGeneralSpin](../particles/CGeneralSpin.md) | `MPropertyFriendlyName spin rate min` |
| `0x1e4` | `m_fSpinRateStopTime` | float32 | [CGeneralSpin](../particles/CGeneralSpin.md) | `MPropertyFriendlyName spin stop time` |
