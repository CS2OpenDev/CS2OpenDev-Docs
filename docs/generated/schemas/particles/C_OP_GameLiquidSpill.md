...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_GameLiquidSpill

# C_OP_GameLiquidSpill

**Kind:** class · **Size:** 1664 bytes (`0x680`) · **Align:** 8 · **Module:** particles
...
| `0x228` | `m_flLiquidContentsField` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Liquid Contents ( negative for water, positive for oil, zero for noop )` |
| `0x398` | `m_flExpirationTime` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Expiration Time (seconds)` |
| `0x508` | `m_flRadius` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Radius` |
| `0x678` | `m_bCheckExposedToSky` | bool |  | `MPropertyFriendlyName Radially splashed points require exposure to sky` |
| `0x67c` | `m_nAmountAttribute` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName Attribute for Contribution Amount` |
