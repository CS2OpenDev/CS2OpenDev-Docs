...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CalculateVectorAttribute
...
| `0x1d8` | `m_vStartValue` | Vector |  | `MPropertyFriendlyName start value` |
| `0x1e4` | `m_nFieldInput1` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field 1` |
| `0x1e8` | `m_flInputScale1` | float32 |  | `MPropertyFriendlyName input scale 1` |
| `0x1ec` | `m_nFieldInput2` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field 2` |
| `0x1f0` | `m_flInputScale2` | float32 |  | `MPropertyFriendlyName input scale 2` |
| `0x1f4` | `m_nControlPointInput1` | [ControlPointReference_t](../particles/ControlPointReference_t.md) |  | `MPropertyFriendlyName control point input 1` |
| `0x208` | `m_flControlPointScale1` | float32 |  | `MPropertyFriendlyName control point scale 1` |
| `0x20c` | `m_nControlPointInput2` | [ControlPointReference_t](../particles/ControlPointReference_t.md) |  | `MPropertyFriendlyName control point input 2` |
| `0x220` | `m_flControlPointScale2` | float32 |  | `MPropertyFriendlyName control point scale 2` |
| `0x224` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x228` | `m_vFinalOutputScale` | Vector |  | `MPropertyFriendlyName final per component scale` |
