...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointFieldToWater
...
| `0x1e4` | `m_nDestCP` | int32 |  | `MPropertyFriendlyName dest CP` |
| `0x1e8` | `m_nCPField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName dest control point component` |
