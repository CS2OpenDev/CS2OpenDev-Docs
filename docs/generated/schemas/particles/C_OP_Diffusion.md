...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_Diffusion
...
| `0x1e0` | `m_nVoxelGridResolution` | int32 |  | `MPropertyFriendlyName Resolution to use for creating a voxel grid` |
