...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RopeSpringConstraint

# C_OP_RopeSpringConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1952 bytes (`0x7a0`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_flRestLength` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName slack` |
| `0x348` | `m_flMinDistance` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName minimum segment length %` |
| `0x4b8` | `m_flMaxDistance` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName maximum segment length %` |
| `0x628` | `m_flAdjustmentScale` | float32 |  | `MPropertyFriendlyName scale factor for spring correction` |
| `0x630` | `m_flInitialRestingLength` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName manual resting spacing` |
