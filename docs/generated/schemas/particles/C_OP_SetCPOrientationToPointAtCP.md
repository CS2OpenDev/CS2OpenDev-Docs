...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetCPOrientationToPointAtCP
...
| `0x1e0` | `m_nInputCP` | int32 |  | `MPropertyFriendlyName CP to point towards` |
| `0x1e4` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName CP to set` |
| `0x1e8` | `m_flInterpolation` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
| `0x358` | `m_b2DOrientation` | bool |  | `MPropertyFriendlyName 2D Orient` |
| `0x359` | `m_bAvoidSingularity` | bool |  | `MPropertyFriendlyName Avoid Vertical Axis Singularity` |
| `0x35a` | `m_bPointAway` | bool |  | `MPropertyFriendlyName Point Away` |
