...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LagCompensation
...
| `0x1d8` | `m_nDesiredVelocityCP` | int32 |  | `MPropertyFriendlyName desired velocity CP` |
| `0x1dc` | `m_nLatencyCP` | int32 |  | `MPropertyFriendlyName latency CP` |
| `0x1e0` | `m_nLatencyCPField` | int32 |  | `MPropertyFriendlyName latency CP field` |
| `0x1e4` | `m_nDesiredVelocityCPField` | int32 |  | `MPropertyFriendlyName desired velocity CP field override(for speed only)` |
