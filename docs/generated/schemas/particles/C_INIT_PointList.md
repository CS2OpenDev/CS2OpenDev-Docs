...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PointList
...
| `0x1e8` | `m_pointList` | CUtlVector< [PointDefinition_t](../particles/PointDefinition_t.md) > |  | `MPropertyFriendlyName point list` |
| `0x200` | `m_bPlaceAlongPath` | bool |  | `MPropertyFriendlyName space points along path` |
| `0x201` | `m_bClosedLoop` | bool |  | `MPropertyFriendlyName Treat path as a loop` |
| `0x204` | `m_nNumPointsAlongPath` | int32 |  | `MPropertyFriendlyName Numer of points along path` |
