...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderScreenVelocityRotate
...
22 fields (2 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_flRotateRateDegrees` | float32 |  | `MPropertyFriendlyName rotate rate(dps)` |
| `0x22c` | `m_flForwardDegrees` | float32 |  | `MPropertyFriendlyName forward angle` |
