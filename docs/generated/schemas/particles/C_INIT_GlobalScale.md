...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_GlobalScale
...
| `0x1e0` | `m_flScale` | float32 |  | `MPropertyFriendlyName scale amount` |
| `0x1e4` | `m_nScaleControlPointNumber` | int32 |  | `MPropertyFriendlyName scale control point number` |
| `0x1e8` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1ec` | `m_bScaleRadius` | bool |  | `MPropertyFriendlyName scale radius` |
| `0x1ed` | `m_bScalePosition` | bool |  | `MPropertyFriendlyName scale position` |
| `0x1ee` | `m_bScaleVelocity` | bool |  | `MPropertyFriendlyName scale velocity` |
