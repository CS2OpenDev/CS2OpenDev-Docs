...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ModelDampenMovement
...
| `0x1dc` | `m_bBoundBox` | bool |  | `MPropertyFriendlyName use only bounding box` |
| `0x1dd` | `m_bOutside` | bool |  | `MPropertyFriendlyName dampen outside instead of inside` |
| `0x1de` | `m_bUseBones` | bool |  | `MPropertyFriendlyName use bones instead of hitboxes` |
| `0x1df` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
| `0x260` | `m_vecPosOffset` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName test position offset` `MVectorIsCoordinate` |
| `0x918` | `m_fDrag` | float32 |  | `MPropertyAttributeRange -1 1` `MPropertyFriendlyName drag` |
