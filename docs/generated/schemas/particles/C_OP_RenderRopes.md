...
| `0x3414` | `m_nOrientationType` | [ParticleOrientationChoiceList_t](../!GlobalTypes/ParticleOrientationChoiceList_t.md) |  | `MPropertyFriendlyName orientation_type` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
