...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_VelocityMatchingForce
...
| `0x1d8` | `m_flDirScale` | float32 |  | `MPropertyFriendlyName direction matching strength` |
| `0x1dc` | `m_flSpdScale` | float32 |  | `MPropertyFriendlyName speed matching strength` |
| `0x1e0` | `m_flNeighborDistance` | float32 |  | `MPropertyFriendlyName neighbor distance` |
| `0x1e4` | `m_flFacingStrength` | float32 |  | `MPropertyFriendlyName facing strength falloff` |
| `0x1e8` | `m_bUseAABB` | bool |  | `MPropertyFriendlyName use AABB` `MPropertySuppressExpr m_flNeighborDistance > 0` |
| `0x1ec` | `m_nCPBroadcast` | int32 |  | `MPropertyFriendlyName control point to broadcast speed and direction to` |
