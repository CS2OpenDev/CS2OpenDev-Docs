...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_IntraParticleForce
...
| `0x1e8` | `m_flAttractionMinDistance` | float32 |  | `MPropertyFriendlyName min attraction distance` |
| `0x1ec` | `m_flAttractionMaxDistance` | float32 |  | `MPropertyFriendlyName max attraction distance` |
| `0x1f0` | `m_flAttractionMaxStrength` | float32 |  | `MPropertyFriendlyName max attraction force` |
| `0x1f4` | `m_flRepulsionMinDistance` | float32 |  | `MPropertyFriendlyName min repulsion distance` |
| `0x1f8` | `m_flRepulsionMaxDistance` | float32 |  | `MPropertyFriendlyName max repulsion distance` |
| `0x1fc` | `m_flRepulsionMaxStrength` | float32 |  | `MPropertyFriendlyName max repulsion force` |
| `0x200` | `m_bUseAABB` | bool |  | `MPropertyFriendlyName use aabbtree` |
