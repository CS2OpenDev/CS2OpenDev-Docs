...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LockToPointList
...
| `0x1e0` | `m_pointList` | CUtlVector< [PointDefinition_t](../particles/PointDefinition_t.md) > |  | `MPropertyFriendlyName point list` |
| `0x1f8` | `m_bPlaceAlongPath` | bool |  | `MPropertyFriendlyName space points along path` |
| `0x1f9` | `m_bClosedLoop` | bool |  | `MPropertyFriendlyName Treat path as a loop` |
| `0x1fc` | `m_nNumPointsAlongPath` | int32 |  | `MPropertyFriendlyName Numer of points along path` |
