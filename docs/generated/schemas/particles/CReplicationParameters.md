...
[Schemas](../../schemas.md) / [particles](../particles.md) / CReplicationParameters

# CReplicationParameters

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4552 bytes (`0x11c8`) · **Align:** 8 · **Module:** particles
...
| `0x2e8` | `m_vMinRandomDisplacement` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName min random displacement for child particles` |
| `0x9a0` | `m_vMaxRandomDisplacement` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName max random displacement for child particles` |
| `0x1058` | `m_flModellingScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Modelling scale` |
