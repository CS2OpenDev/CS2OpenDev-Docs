...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointPositions
...
| `0x1e0` | `m_bUseWorldLocation` | bool |  | `MPropertyFriendlyName set positions in world space` |
| `0x1e1` | `m_bOrient` | bool |  | `MPropertyFriendlyName inherit CP orientation` |
| `0x1e2` | `m_bSetOnce` | bool |  | `MPropertyFriendlyName only set position once` |
| `0x1e4` | `m_nCP1` | int32 |  | `MPropertyFriendlyName first control point number` |
| `0x1e8` | `m_nCP2` | int32 |  | `MPropertyFriendlyName second control point number` |
| `0x1ec` | `m_nCP3` | int32 |  | `MPropertyFriendlyName third control point number` |
| `0x1f0` | `m_nCP4` | int32 |  | `MPropertyFriendlyName fourth control point number` |
| `0x1f4` | `m_vecCP1Pos` | Vector |  | `MPropertyFriendlyName first control point location` `MVectorIsCoordinate` |
| `0x200` | `m_vecCP2Pos` | Vector |  | `MPropertyFriendlyName second control point location` `MVectorIsCoordinate` |
| `0x20c` | `m_vecCP3Pos` | Vector |  | `MPropertyFriendlyName third control point location` `MVectorIsCoordinate` |
| `0x218` | `m_vecCP4Pos` | Vector |  | `MPropertyFriendlyName fourth control point location` `MVectorIsCoordinate` |
| `0x224` | `m_nHeadLocation` | int32 |  | `MPropertyFriendlyName control point to offset positions from` |
