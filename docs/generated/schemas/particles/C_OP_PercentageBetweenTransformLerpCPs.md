...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PercentageBetweenTransformLerpCPs

# C_OP_PercentageBetweenTransformLerpCPs

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 720 bytes (`0x2d0`) · **Align:** 8 · **Module:** particles
...
| `0x1dc` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName percentage minimum` |
| `0x1e0` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName percentage maximum` |
| `0x1e8` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName strarting transform` |
| `0x250` | `m_TransformEnd` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName end transform` |
| `0x2b8` | `m_nOutputStartCP` | int32 |  | `MPropertyFriendlyName output starting control point number` |
| `0x2bc` | `m_nOutputStartField` | int32 |  | `MPropertyFriendlyName output starting control point field 0-2 X/Y/Z` |
| `0x2c0` | `m_nOutputEndCP` | int32 |  | `MPropertyFriendlyName output ending control point number` |
| `0x2c4` | `m_nOutputEndField` | int32 |  | `MPropertyFriendlyName output ending control point field 0-2 X/Y/Z` |
| `0x2c8` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x2cc` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within input range` |
| `0x2cd` | `m_bRadialCheck` | bool |  | `MPropertyFriendlyName treat distance between points as radius` |
