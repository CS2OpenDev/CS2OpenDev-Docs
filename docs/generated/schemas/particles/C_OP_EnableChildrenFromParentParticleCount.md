...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_EnableChildrenFromParentParticleCount

# C_OP_EnableChildrenFromParentParticleCount

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 864 bytes (`0x360`) · **Align:** 8 · **Module:** particles
...
| `0x1e4` | `m_nFirstChild` | int32 |  | `MPropertyFriendlyName first child to enable` |
| `0x1e8` | `m_nNumChildrenToEnable` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName max # of children to enable (-1 for max particle count)` |
| `0x358` | `m_bDisableChildren` | bool |  | `MPropertyFriendlyName remove children when particle count lowers` |
| `0x359` | `m_bPlayEndcapOnStop` | bool |  | `MPropertyFriendlyName play endcap when children are removed` `MPropertySuppressExpr !m_bDisableChildren` |
| `0x35a` | `m_bDestroyImmediately` | bool |  | `MPropertyFriendlyName destroy particles immediately when child is removed` `MPropertySuppressExpr !m_bDisableChildren` |
