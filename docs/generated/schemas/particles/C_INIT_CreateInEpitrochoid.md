...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateInEpitrochoid

# C_INIT_CreateInEpitrochoid

**Kind:** class · **Size:** 2072 bytes (`0x818`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nComponent1` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName first dimension 0-2 (-1 disables)` |
| `0x1e4` | `m_nComponent2` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName second dimension 0-2 (-1 disables)` |
| `0x1e8` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName input transform` |
| `0x250` | `m_flParticleDensity` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName particle density` |
| `0x3c0` | `m_flOffset` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName point offset` |
| `0x530` | `m_flRadius1` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName radius 1` |
| `0x6a0` | `m_flRadius2` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName radius 2` |
| `0x810` | `m_bUseCount` | bool |  | `MPropertyFriendlyName use particle count instead of creation time` |
| `0x811` | `m_bUseLocalCoords` | bool |  | `MPropertyFriendlyName local space` |
| `0x812` | `m_bOffsetExistingPos` | bool |  | `MPropertyFriendlyName offset from existing position` |
