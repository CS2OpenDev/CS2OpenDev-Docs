...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomAlpha
...
| `0x1e0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_alpha` `MPropertyFriendlyName alpha field` |
| `0x1e4` | `m_nAlphaMin` | int32 |  | `MPropertyAttributeRange 0 255` `MPropertyFriendlyName alpha min` |
| `0x1e8` | `m_nAlphaMax` | int32 |  | `MPropertyAttributeRange 0 255` `MPropertyFriendlyName alpha max` |
| `0x1f4` | `m_flAlphaRandExponent` | float32 |  | `MPropertyFriendlyName alpha random exponent` |
