...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MaintainEmitter

# C_OP_MaintainEmitter

**Kind:** class · **Size:** 1616 bytes (`0x650`) · **Align:** 8 · **Module:** particles
...
27 fields (9 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_nParticlesToMaintain` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName count to maintain` |
| `0x350` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emission start time` |
| `0x358` | `m_flEmissionDuration` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName emission duration` |
| `0x4c8` | `m_flEmissionRate` | float32 |  | `MPropertyFriendlyName emission rate` |
| `0x4cc` | `m_nSnapshotControlPoint` | int32 |  | `MPropertyFriendlyName control point with snapshot data` |
| `0x4d0` | `m_strSnapshotSubset` | CUtlString |  | `MPropertyFriendlyName snapshot subset` `MPropertySuppressExpr m_nSnapshotControlPoint < 0` |
| `0x4d8` | `m_bEmitInstantaneously` | bool |  | `MPropertyFriendlyName group emission times for new particles` |
| `0x4d9` | `m_bFinalEmitOnStop` | bool |  | `MPropertyFriendlyName perform final emit on stop` |
| `0x4e0` | `m_flScale` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName total count scale` |
