...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_BasicMovement

# C_OP_BasicMovement

**Kind:** class · **Size:** 3680 bytes (`0xe60`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_Gravity` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName gravity` `MVectorIsCoordinate` |
| `0x890` | `m_fDrag` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyAttributeRange -1 1` `MPropertyFriendlyName drag` |
| `0xa00` | `m_massControls` | [CParticleMassCalculationParameters](../particles/CParticleMassCalculationParameters.md) |  | `MPropertyFriendlyName Mass controls` |
| `0xe58` | `m_nMaxConstraintPasses` | int32 |  | `MPropertyFriendlyName max constraint passes` |
| `0xe5c` | `m_bUseNewCode` | bool |  | `MPropertyFriendlyName use new code` |
