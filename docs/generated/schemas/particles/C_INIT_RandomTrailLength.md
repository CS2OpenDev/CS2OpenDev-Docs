...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomTrailLength
...
| `0x1e0` | `m_flMinLength` | float32 |  | `MPropertyFriendlyName length min` |
| `0x1e4` | `m_flMaxLength` | float32 |  | `MPropertyFriendlyName length max` |
| `0x1e8` | `m_flLengthRandExponent` | float32 |  | `MPropertyFriendlyName length random exponent` |
