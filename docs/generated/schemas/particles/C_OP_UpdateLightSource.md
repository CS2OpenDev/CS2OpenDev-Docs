...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_UpdateLightSource
...
| `0x1d8` | `m_vColorTint` | Color |  | `MPropertyFriendlyName color tint` |
| `0x1dc` | `m_flBrightnessScale` | float32 |  | `MPropertyFriendlyName amount to multiply light brightness by` |
| `0x1e0` | `m_flRadiusScale` | float32 |  | `MPropertyFriendlyName amount to multiply particle system radius by to get light radius` |
| `0x1e4` | `m_flMinimumLightingRadius` | float32 |  | `MPropertyFriendlyName minimum radius for created lights` |
| `0x1e8` | `m_flMaximumLightingRadius` | float32 |  | `MPropertyFriendlyName maximum radius for created lights` |
| `0x1ec` | `m_flPositionDampingConstant` | float32 |  | `MPropertyFriendlyName amount of damping of changes` |
