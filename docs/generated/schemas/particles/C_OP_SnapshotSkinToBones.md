...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SnapshotSkinToBones
...
| `0x1d8` | `m_bTransformNormals` | bool |  | `MPropertyFriendlyName rotate normals` |
| `0x1d9` | `m_bTransformRadii` | bool |  | `MPropertyFriendlyName scale radii` |
| `0x1dc` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e0` | `m_flLifeTimeFadeStart` | float32 |  | `MPropertyFriendlyName lifetime fade start` |
| `0x1e4` | `m_flLifeTimeFadeEnd` | float32 |  | `MPropertyFriendlyName lifetime fade end` |
| `0x1e8` | `m_flJumpThreshold` | float32 |  | `MPropertyFriendlyName instant jump threshold` |
| `0x1ec` | `m_flPrevPosScale` | float32 |  | `MPropertyFriendlyName previous position scale` |
