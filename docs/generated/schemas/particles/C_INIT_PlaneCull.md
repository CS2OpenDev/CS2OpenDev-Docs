...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PlaneCull
...
| `0x1e0` | `m_nControlPoint` | int32 |  | `MPropertyFriendlyName control point of plane` |
| `0x1e8` | `m_flDistance` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName cull offset` |
| `0x358` | `m_bCullInside` | bool |  | `MPropertyFriendlyName flip cull normal` |
