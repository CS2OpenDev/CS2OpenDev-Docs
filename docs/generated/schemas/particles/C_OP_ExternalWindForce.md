...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ExternalWindForce
...
| `0x1e8` | `m_vecSamplePosition` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName sample position` |
| `0x8a0` | `m_vecScale` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName force scale` |
| `0xf58` | `m_bSampleWind` | bool |  | `MPropertyFriendlyName sample wind` |
| `0xf59` | `m_bSampleWater` | bool |  | `MPropertyFriendlyName sample water current` |
| `0xf5a` | `m_bDampenNearWaterPlane` | bool |  | `MPropertyFriendlyName dampen gravity/buoyancy near water plane` `MPropertySuppressExpr !m_bSampleWater` |
| `0xf5b` | `m_bSampleGravity` | bool |  | `MPropertyFriendlyName sample local gravity` |
| `0xf60` | `m_vecGravityForce` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName gravity force` `MPropertySuppressExpr m_bSampleGravity` |
