...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_NormalOffset
...
| `0x1e0` | `m_OffsetMin` | Vector |  | `MPropertyFriendlyName offset min` `MVectorIsCoordinate` |
| `0x1ec` | `m_OffsetMax` | Vector |  | `MPropertyFriendlyName offset max` `MVectorIsCoordinate` |
| `0x1f8` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1fc` | `m_bLocalCoords` | bool |  | `MPropertyFriendlyName offset in local space 0/1` |
| `0x1fd` | `m_bNormalize` | bool |  | `MPropertyFriendlyName normalize output 0/1` |
