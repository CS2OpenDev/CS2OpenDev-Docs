...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PositionOffset

# C_INIT_PositionOffset

**Kind:** class · **Size:** 4040 bytes (`0xfc8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_OffsetMin` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName offset min` `MVectorIsCoordinate` |
| `0x898` | `m_OffsetMax` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName offset max` `MVectorIsCoordinate` |
| `0xf50` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName transform input` |
| `0xfb8` | `m_bLocalCoords` | bool |  | `MPropertyFriendlyName offset in local space 0/1` |
| `0xfb9` | `m_bProportional` | bool |  | `MPropertyFriendlyName offset proportional to radius 0/1` |
| `0xfbc` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
