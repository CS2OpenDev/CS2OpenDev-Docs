...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateFromPlaneCache
...
| `0x1e0` | `m_vecOffsetMin` | Vector |  | `MPropertyFriendlyName local offset min` `MVectorIsCoordinate` |
| `0x1ec` | `m_vecOffsetMax` | Vector |  | `MPropertyFriendlyName local offset max` `MVectorIsCoordinate` |
| `0x1f9` | `m_bUseNormal` | bool |  | `MPropertyFriendlyName set normal` |
