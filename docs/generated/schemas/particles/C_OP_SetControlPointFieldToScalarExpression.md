...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointFieldToScalarExpression
...
| `0x1e0` | `m_nExpression` | [ScalarExpressionType_t](../!GlobalTypes/ScalarExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
| `0x1e8` | `m_flInput1` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input 1` |
| `0x358` | `m_flInput2` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName input 2` |
| `0x4c8` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
| `0x638` | `m_nOutputCP` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x63c` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName output component` |
| `0x640` | `m_flInterpolation` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
