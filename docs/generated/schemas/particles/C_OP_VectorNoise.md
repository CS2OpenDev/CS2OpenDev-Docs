...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_VectorNoise
...
| `0x1dc` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName output minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1e8` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName output maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1f4` | `m_fl4NoiseScale` | float32 |  | `MPropertyFriendlyName noise coordinate scale` |
| `0x1f8` | `m_bAdditive` | bool |  | `MPropertyFriendlyName additive` |
| `0x1f9` | `m_bOffset` | bool |  | `MPropertyFriendlyName offset instead of accelerate position` |
| `0x1fc` | `m_flNoiseAnimationTimeScale` | float32 |  | `MPropertyFriendlyName Noise animation time scale` |
