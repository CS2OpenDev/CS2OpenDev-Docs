...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InitialVelocityFromHitbox
...
| `0x1e0` | `m_flVelocityMin` | float32 |  | `MPropertyFriendlyName velocity minimum` |
| `0x1e4` | `m_flVelocityMax` | float32 |  | `MPropertyFriendlyName velocity maximum` |
| `0x1e8` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1ec` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
| `0x26c` | `m_bUseBones` | bool |  | `MPropertyFriendlyName use bones instead of hitboxes` |
