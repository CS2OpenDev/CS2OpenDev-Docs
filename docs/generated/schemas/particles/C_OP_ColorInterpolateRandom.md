...
| `0x1d8` | `m_ColorFadeMin` | Color |  | `MPropertyFriendlyName color fade min` |
| `0x1f4` | `m_ColorFadeMax` | Color |  | `MPropertyFriendlyName color fade max` |
| `0x204` | `m_flFadeStartTime` | float32 |  | `MPropertyFriendlyName fade start time` |
| `0x208` | `m_flFadeEndTime` | float32 |  | `MPropertyFriendlyName fade end time` |
| `0x20c` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x210` | `m_bEaseInOut` | bool |  | `MPropertyFriendlyName ease in and out` |
