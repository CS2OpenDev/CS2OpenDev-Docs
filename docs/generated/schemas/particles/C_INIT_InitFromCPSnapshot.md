...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InitFromCPSnapshot

# C_INIT_InitFromCPSnapshot

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1256 bytes (`0x4e8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName snapshot control point number` |
| `0x1e8` | `m_strSnapshotSubset` | CUtlString |  | `MPropertyFriendlyName snapshot subset` `MPropertySuppressExpr m_nControlPointNumber < 0` |
| `0x1f0` | `m_nAttributeToRead` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName field to read` |
| `0x1f4` | `m_nAttributeToWrite` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName field to write` |
| `0x1f8` | `m_nLocalSpaceCP` | int32 |  | `MPropertyFriendlyName local space control point number` |
| `0x1fc` | `m_bRandom` | bool |  | `MPropertyFriendlyName random order` |
| `0x1fd` | `m_bReverse` | bool |  | `MPropertyFriendlyName reverse order` `MPropertySuppressExpr m_bRandom == true` |
| `0x200` | `m_nSnapShotIncrement` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Snapshot increment amount` `MPropertySuppressExpr m_bRandom == true` |
| `0x370` | `m_nManualSnapshotIndex` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Manual Snapshot Index` `MPropertySuppressExpr m_bRandom == true` |
| `0x4e0` | `m_nRandomSeed` | int32 |  | `MPropertyFriendlyName random seed` `MPropertySuppressExpr m_bRandom == false` |
| `0x4e4` | `m_bLocalSpaceAngles` | bool |  | `MPropertyFriendlyName local space angles` |
