...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapCPtoScalar
...
| `0x1dc` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x1e0` | `m_nField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName input field 0-2 X/Y/Z` |
| `0x1e4` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input minimum` |
| `0x1e8` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input maximum` |
...
| `0x1f4` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emitter lifetime start time (seconds)` |
| `0x1f8` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName emitter lifetime end time (seconds)` |
| `0x1fc` | `m_flInterpRate` | float32 |  | `MPropertyFriendlyName interpolation scale` |
| `0x200` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
