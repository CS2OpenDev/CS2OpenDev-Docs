...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderGpuImplicit

# C_OP_RenderGpuImplicit

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1688 bytes (`0x698`) · **Align:** 8 · **Module:** particles
...
| `0x228` | `m_bUsePerParticleRadius` | bool |  | `MPropertyDescription Honors the per-particle radius (multiplied by radius scale) but is more expensive to render.  Some particles with large radii can make things much costlier` `MPropertySortPriority -1` |
| `0x22c` | `m_nVertexCountKb` | uint32 |  | `MPropertyAttributeRange 0 1024` `MPropertyFriendlyName (optional) vertex buffer size (k)` |
| `0x230` | `m_nIndexCountKb` | uint32 |  | `MPropertyAttributeRange 0 2048` `MPropertyFriendlyName (optional) index buffer size (k)` |
| `0x238` | `m_fGridSize` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  |  |
| `0x3a8` | `m_fRadiusScale` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  |  |
| `0x518` | `m_fIsosurfaceThreshold` | [CParticleCollectionRendererFloatInput](../particleslib/CParticleCollectionRendererFloatInput.md) |  | `MPropertyAttributeRange .1 .95` |
| `0x688` | `m_nScaleCP` | int32 |  | `MPropertyFriendlyName scale CP (grid size/particle radius/threshold = x/y/z)` |
| `0x690` | `m_hMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
