...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_FadeIn
...
| `0x1d8` | `m_flFadeInTimeMin` | float32 |  | `MPropertyFriendlyName fade in time min` |
| `0x1dc` | `m_flFadeInTimeMax` | float32 |  | `MPropertyFriendlyName fade in time max` |
| `0x1e0` | `m_flFadeInTimeExp` | float32 |  | `MPropertyFriendlyName fade in time exponent` |
| `0x1e4` | `m_bProportional` | bool |  | `MPropertyFriendlyName proportional 0/1` |
