...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderPoints
...
**Derived by:** [C_OP_RenderLights](../particles/C_OP_RenderLights.md)
...
21 fields (1 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_hMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
