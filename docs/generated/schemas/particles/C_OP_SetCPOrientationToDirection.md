...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetCPOrientationToDirection
...
| `0x1d8` | `m_nInputControlPoint` | int32 |  | `MPropertyFriendlyName input control point` |
| `0x1dc` | `m_nOutputControlPoint` | int32 |  | `MPropertyFriendlyName output control point` |
