...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_PositionWarpScalar
...
| `0x1e0` | `m_vecWarpMin` | Vector |  | `MPropertyFriendlyName warp min` `MVectorIsCoordinate` |
| `0x1ec` | `m_vecWarpMax` | Vector |  | `MPropertyFriendlyName warp max` `MVectorIsCoordinate` |
| `0x1f8` | `m_InputValue` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName warp amount` |
| `0x368` | `m_flPrevPosScale` | float32 |  | `MPropertyFriendlyName previous position scale` |
| `0x36c` | `m_nScaleControlPointNumber` | int32 |  | `MPropertyFriendlyName warp scale control point number` |
| `0x370` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
