...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapScalarOnceTimed
...
| `0x1d8` | `m_bProportional` | bool |  | `MPropertyFriendlyName remap time proportional` |
| `0x1dc` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName input field` |
...
| `0x1f4` | `m_flRemapTime` | float32 |  | `MPropertyFriendlyName remap time` |
