...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_DistanceToNeighborCull
...
| `0x1e0` | `m_flDistance` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName cull distance` |
| `0x350` | `m_bIncludeRadii` | bool |  | `MPropertyFriendlyName include particle radius` |
| `0x358` | `m_flLifespanOverlap` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName lifespan overlap percentage` |
| `0x4c8` | `m_nFieldModify` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName attribute to modify` |
| `0x4d0` | `m_flModify` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName modify amount` `MPropertySuppressExpr m_nFieldOutput == PARTICLE_ATTRIBUTE_UNUSED` |
| `0x640` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` `MPropertySuppressExpr m_nFieldOutput == PARTICLE_ATTRIBUTE_UNUSED` |
| `0x644` | `m_bUseNeighbor` | bool |  | `MPropertyFriendlyName use neighbor value for modify base` `MPropertySuppressExpr m_nFieldOutput == PARTICLE_ATTRIBUTE_UNUSED` |
