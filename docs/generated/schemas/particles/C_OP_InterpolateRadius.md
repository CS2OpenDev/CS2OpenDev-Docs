...
| `0x1d8` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName start time` |
| `0x1dc` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName end time` |
| `0x1e0` | `m_flStartScale` | float32 |  | `MPropertyFriendlyName radius start scale` |
| `0x1e4` | `m_flEndScale` | float32 |  | `MPropertyFriendlyName radius end scale` |
| `0x1e8` | `m_bEaseInAndOut` | bool |  | `MPropertyFriendlyName ease in and out` |
| `0x1ec` | `m_flBias` | float32 |  | `MPropertyFriendlyName scale bias` |
