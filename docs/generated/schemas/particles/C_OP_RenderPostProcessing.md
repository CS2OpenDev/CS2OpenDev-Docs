...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderPostProcessing

# C_OP_RenderPostProcessing

**Kind:** class · **Size:** 936 bytes (`0x3a8`) · **Align:** 8 · **Module:** particles
...
23 fields (3 declared here, 20 inherited). Offsets are absolute from the object base.
...
| `0x228` | `m_flPostProcessStrength` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Post Processing Strength` |
| `0x398` | `m_hPostTexture` | CStrongHandle< [InfoForResourceTypeCPostProcessingResource](../resourcesystem/InfoForResourceTypeCPostProcessingResource.md) > |  | `MPropertyAttributeEditor AssetBrowse( vpost, *showassetpreview )` `MPropertyFriendlyName Post Processing File` |
| `0x3a0` | `m_nPriority` | [ParticlePostProcessPriorityGroup_t](../!GlobalTypes/ParticlePostProcessPriorityGroup_t.md) |  | `MPropertyFriendlyName Post Processing Priority Group` |
