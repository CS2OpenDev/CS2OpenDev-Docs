...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderFlattenGrass
...
| `0x228` | `m_flFlattenStrength` | float32 |  | `MPropertyFriendlyName flattening strength` |
| `0x22c` | `m_nStrengthFieldOverride` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName strength field override` |
| `0x230` | `m_flRadiusScale` | float32 |  | `MPropertyFriendlyName radius scale` |
