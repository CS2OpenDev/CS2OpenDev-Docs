...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointFromObjectScale
...
| `0x1e0` | `m_nCPInput` | int32 |  | `MPropertyFriendlyName input control point number` |
| `0x1e4` | `m_nCPOutput` | int32 |  | `MPropertyFriendlyName output control point number` |
