...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MovementMoveAlongSkinnedCPSnapshot
...
| `0x1dc` | `m_nSnapshotControlPointNumber` | int32 |  | `MPropertyFriendlyName snapshot control point number` |
| `0x1e0` | `m_bSetNormal` | bool |  | `MPropertyFriendlyName set normal` |
| `0x1e1` | `m_bSetRadius` | bool |  | `MPropertyFriendlyName set radius` |
...
| `0x358` | `m_flTValue` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Snapshot Index T Value` |
