...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ReadFromNeighboringParticle

# C_OP_ReadFromNeighboringParticle

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1224 bytes (`0x4c8`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName read field` |
| `0x1dc` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName written field` |
| `0x1e0` | `m_nIncrement` | int32 |  | `MPropertyFriendlyName particle increment amount` |
| `0x1e8` | `m_DistanceCheck` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName maximum distance` |
| `0x358` | `m_flInterpolation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
