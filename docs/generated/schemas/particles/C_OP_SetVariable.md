...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetVariable

# C_OP_SetVariable

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2776 bytes (`0xad8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_variableReference` | [CParticleVariableRef](../particleslib/CParticleVariableRef.md) |  | `MPropertyFriendlyName Variable` |
| `0x230` | `m_transformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName Value` `MPropertySuppressExpr m_variableReference.m_variableType != PVAL_TRANSFORM` |
| `0x298` | `m_positionOffset` | Vector |  | `MPropertyFriendlyName Position Offset` `MPropertySuppressExpr m_variableReference.m_variableType != PVAL_TRANSFORM` |
| `0x2a4` | `m_rotationOffset` | QAngle |  | `MPropertyFriendlyName Rotation Offset` `MPropertySuppressExpr m_variableReference.m_variableType != PVAL_TRANSFORM` |
| `0x2b0` | `m_vecInput` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName Value` `MPropertySuppressExpr m_variableReference.m_variableType != PVAL_VEC3` |
| `0x968` | `m_floatInput` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Value` `MPropertySuppressExpr m_variableReference.m_variableType != PVAL_FLOAT` |
