...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_Decay
...
| `0x1d8` | `m_bRopeDecay` | bool |  | `MPropertyFriendlyName Reduce rope popping on decay` |
| `0x1d9` | `m_bForcePreserveParticleOrder` | bool |  | `MPropertyFriendlyName force preserving particle order` |
