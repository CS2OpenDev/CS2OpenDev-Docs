...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_WaterImpulseRenderer

# C_OP_WaterImpulseRenderer

**Kind:** class · **Size:** 4120 bytes (`0x1018`) · **Align:** 8 · **Module:** particles
...
| `0x228` | `m_vecPos` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName impulse position` |
| `0x8e0` | `m_flRadius` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName impulse radius` |
| `0xa50` | `m_flMagnitude` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName impulse magnitude` |
| `0xbc0` | `m_flShape` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName impulse wave roundness` |
| `0xd30` | `m_flWindSpeed` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName impulse wind speed (when wind is true)` |
| `0xea0` | `m_flWobble` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName impulse wobble radius` |
| `0x1010` | `m_bIsRadialWind` | bool |  | `MPropertyFriendlyName impulse is wind` |
| `0x1014` | `m_nEventType` | [EventTypeSelection_t](../!GlobalTypes/EventTypeSelection_t.md) |  | `MPropertyFriendlyName event type` |
