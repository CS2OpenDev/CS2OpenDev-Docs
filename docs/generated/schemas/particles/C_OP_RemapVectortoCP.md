...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapVectortoCP
...
| `0x1d8` | `m_nOutControlPointNumber` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1dc` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field` |
| `0x1e0` | `m_nParticleNumber` | int32 |  | `MPropertyFriendlyName particle number to read` |
