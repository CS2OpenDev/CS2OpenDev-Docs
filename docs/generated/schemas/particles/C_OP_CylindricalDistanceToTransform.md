...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CylindricalDistanceToTransform

# C_OP_CylindricalDistanceToTransform

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2168 bytes (`0x878`) · **Align:** 8 · **Module:** particles
...
28 fields (11 declared here, 17 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_flInputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName cylinder inner radius` |
| `0x350` | `m_flInputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName cylinder outer radius` |
| `0x4c0` | `m_flOutputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName cylinder inner output` |
| `0x630` | `m_flOutputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName cylinder outer output` |
| `0x7a0` | `m_TransformStart` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName cylindrical top transform` |
| `0x808` | `m_TransformEnd` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName cylindrical bottom transform` |
| `0x870` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x874` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within specified distance` |
| `0x875` | `m_bAdditive` | bool |  | `MPropertyFriendlyName output is additive` |
| `0x876` | `m_bCapsule` | bool |  | `MPropertyFriendlyName apply radius to ends (capsule)` |
