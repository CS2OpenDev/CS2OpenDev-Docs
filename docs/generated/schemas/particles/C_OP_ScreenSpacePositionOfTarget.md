...
| `0xa08` | `m_nBehindSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName behindness set value method` `MPropertySuppressExpr m_bOututBehindness == false` |
