...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ScreenSpacePositionOfTarget

# C_OP_ScreenSpacePositionOfTarget

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2576 bytes (`0xa10`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_vecTargetPosition` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName target position` `MVectorIsCoordinate` |
| `0x890` | `m_bOututBehindness` | bool |  | `MPropertyFriendlyName output behindness` |
| `0x894` | `m_nBehindFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName behindness output field` `MPropertySuppressExpr m_bOututBehindness == false` |
| `0x898` | `m_flBehindOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName behindness output remap` `MPropertySuppressExpr m_bOututBehindness == false` |
| `0xa08` | `m_nBehindSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName behindness set value method` `MPropertySuppressExpr m_bOututBehindness == false` |
