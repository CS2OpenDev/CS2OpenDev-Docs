...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ChooseRandomChildrenInGroup
...
| `0x1e8` | `m_flNumberOfChildren` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Number of Children to Use` |
