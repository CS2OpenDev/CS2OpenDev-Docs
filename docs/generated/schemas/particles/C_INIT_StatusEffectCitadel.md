...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_StatusEffectCitadel
...
| `0x1e0` | `m_flSFXColorWarpAmount` | float32 |  | `MPropertyFriendlyName $SFXColorWarpAmount` |
| `0x1e4` | `m_flSFXNormalAmount` | float32 |  | `MPropertyFriendlyName $SFXNormalAmount` |
| `0x1e8` | `m_flSFXMetalnessAmount` | float32 |  | `MPropertyFriendlyName $SFXMetalnessAmount` |
| `0x1ec` | `m_flSFXRoughnessAmount` | float32 |  | `MPropertyFriendlyName $SFXRoughnessAmount` |
| `0x1f0` | `m_flSFXSelfIllumAmount` | float32 |  | `MPropertyFriendlyName $SFXSelfIllumAmount` |
| `0x1f4` | `m_flSFXSScale` | float32 |  | `MPropertyFriendlyName $SFXTextureScale` |
| `0x1f8` | `m_flSFXSScrollX` | float32 |  | `MPropertyFriendlyName $SFXTextureScrollX` |
| `0x1fc` | `m_flSFXSScrollY` | float32 |  | `MPropertyFriendlyName $SFXTextureScrollY` |
| `0x200` | `m_flSFXSScrollZ` | float32 |  | `MPropertyFriendlyName $SFXTextureScrollZ` |
| `0x204` | `m_flSFXSOffsetX` | float32 |  | `MPropertyFriendlyName $SFXTextureOffsetX` |
| `0x208` | `m_flSFXSOffsetY` | float32 |  | `MPropertyFriendlyName $SFXTextureOffsetY` |
| `0x20c` | `m_flSFXSOffsetZ` | float32 |  | `MPropertyFriendlyName $SFXTextureOffsetZ` |
| `0x210` | `m_nDetailCombo` | [DetailCombo_t](../!GlobalTypes/DetailCombo_t.md) |  | `MPropertyFriendlyName D_DETAIL` |
| `0x214` | `m_flSFXSDetailAmount` | float32 |  | `MPropertyFriendlyName $SFXDetailAmount` |
| `0x218` | `m_flSFXSDetailScale` | float32 |  | `MPropertyFriendlyName $SFXDetailTextureScale` |
| `0x21c` | `m_flSFXSDetailScrollX` | float32 |  | `MPropertyFriendlyName $SFXDetailTextureScrollX` |
| `0x220` | `m_flSFXSDetailScrollY` | float32 |  | `MPropertyFriendlyName $SFXDetailTextureScrollY` |
| `0x224` | `m_flSFXSDetailScrollZ` | float32 |  | `MPropertyFriendlyName $SFXDetailTextureScrollZ` |
| `0x228` | `m_flSFXSUseModelUVs` | float32 |  | `MPropertyFriendlyName $SFXUseModelUVs` |
