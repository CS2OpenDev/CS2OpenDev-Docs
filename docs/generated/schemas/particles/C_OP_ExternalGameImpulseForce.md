...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ExternalGameImpulseForce
...
| `0x1e8` | `m_flForceScale` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName force scale` |
| `0x358` | `m_bRopes` | bool |  | `MPropertyFriendlyName rope shake` |
| `0x359` | `m_bRopesZOnly` | bool |  | `MPropertyFriendlyName limit rope impulses to Z` |
| `0x35a` | `m_bExplosions` | bool |  | `MPropertyFriendlyName explosions` |
| `0x35b` | `m_bParticles` | bool |  | `MPropertyFriendlyName particle systems` |
