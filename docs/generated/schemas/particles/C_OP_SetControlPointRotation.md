...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointRotation
...
| `0x1e0` | `m_vecRotAxis` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName rotation axis` `MVectorIsCoordinate` |
| `0x898` | `m_flRotRate` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName rotation rate` |
| `0xa08` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point` |
| `0xa0c` | `m_nLocalCP` | int32 |  | `MPropertyFriendlyName local space control point` |
