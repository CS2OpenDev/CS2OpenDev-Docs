...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomScalar
...
| `0x1e8` | `m_flExponent` | float32 |  | `MPropertyFriendlyName exponent` |
| `0x1ec` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
