...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapCrossProductOfTwoVectorsToVector

# C_OP_RemapCrossProductOfTwoVectorsToVector

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 3920 bytes (`0xf50`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_InputVec1` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName input vector 1` |
| `0x890` | `m_InputVec2` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName input vector 2` |
| `0xf48` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0xf4c` | `m_bNormalize` | bool |  | `MPropertyFriendlyName normalize output` |
