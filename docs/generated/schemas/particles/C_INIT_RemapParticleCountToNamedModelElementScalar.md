...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RemapParticleCountToNamedModelElementScalar

# C_INIT_RemapParticleCountToNamedModelElementScalar

**Kind:** class · **Size:** 560 bytes (`0x230`) · **Align:** 8 · **Module:** particles

**Inherits from:** [C_INIT_RemapParticleCountToScalar](../particles/C_INIT_RemapParticleCountToScalar.md)

**Derived by:** [C_INIT_RemapParticleCountToNamedModelBodyPartScalar](../particles/C_INIT_RemapParticleCountToNamedModelBodyPartScalar.md), [C_INIT_RemapParticleCountToNamedModelMeshGroupScalar](../particles/C_INIT_RemapParticleCountToNamedModelMeshGroupScalar.md), [C_INIT_RemapParticleCountToNamedModelSequenceScalar](../particles/C_INIT_RemapParticleCountToNamedModelSequenceScalar.md)
...
34 fields (4 declared here, 30 inherited). Offsets are absolute from the object base.
...
| `0x1fc` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) | [C_INIT_RemapParticleCountToScalar](../particles/C_INIT_RemapParticleCountToScalar.md) | `MPropertyFriendlyName set value method` |
...
| `0x210` | `m_hModel` | CStrongHandle< [InfoForResourceTypeCModel](../resourcesystem/InfoForResourceTypeCModel.md) > |  |  |
| `0x218` | `m_outputMinName` | CUtlString |  | `MPropertyFriendlyName output min name` |
| `0x220` | `m_outputMaxName` | CUtlString |  | `MPropertyFriendlyName output max name` |
| `0x228` | `m_bModelFromRenderer` | bool |  |  |
