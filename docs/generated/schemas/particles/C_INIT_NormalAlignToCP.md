...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_NormalAlignToCP
...
| `0x1e0` | `m_transformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName input` |
| `0x248` | `m_nControlPointAxis` | [ParticleControlPointAxis_t](../!GlobalTypes/ParticleControlPointAxis_t.md) |  | `MPropertyFriendlyName control point axis` |
