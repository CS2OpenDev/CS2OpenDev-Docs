...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_GameDecalRenderer

# C_OP_GameDecalRenderer

**Kind:** class · **Size:** 7224 bytes (`0x1c38`) · **Align:** 8 · **Module:** particles
...
| `0x1128` | `m_flDecalSize` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Decal Size` `MPropertySuppressExpr m_bUseGameDefaultDecalSize == true` |
| `0x1298` | `m_nDecalGroupIndex` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Decal Group Choice Index` `MPropertySuppressExpr m_bRandomlySelectDecalInGroup == false` |
| `0x1408` | `m_flDecalRotation` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Decal Rotation` `MPropertySuppressExpr m_bRandomDecalRotation == true` |
| `0x1578` | `m_vModulationColor` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName Decal Modulation Color` |
| `0x1c30` | `m_bUseGameDefaultDecalSize` | bool |  | `MPropertyFriendlyName Use Game's Default Decal Size` |
| `0x1c31` | `m_bRandomDecalRotation` | bool |  | `MPropertyFriendlyName Randomly Rotate Decal` |
| `0x1c32` | `m_bRandomlySelectDecalInGroup` | bool |  | `MPropertyFriendlyName Randomly Select Decal in Decal Group` |
| `0x1c33` | `m_bNoDecalsOnOwner` | bool |  | `MPropertyFriendlyName Dont Apply Decals to Owner` |
| `0x1c34` | `m_bVisualizeTraces` | bool |  | `MPropertyFriendlyName Debug Traces` |
