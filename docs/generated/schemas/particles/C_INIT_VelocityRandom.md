...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_VelocityRandom
...
| `0x1e8` | `m_fSpeedMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName random speed min` |
| `0x358` | `m_fSpeedMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName random speed max` |
| `0x4c8` | `m_LocalCoordinateSystemSpeedMin` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName speed in local coordinate system min` `MVectorIsCoordinate` |
| `0xb80` | `m_LocalCoordinateSystemSpeedMax` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName speed in local coordinate system max` `MVectorIsCoordinate` |
| `0x1238` | `m_bIgnoreDT` | bool |  | `MPropertyFriendlyName Ignore delta time (RenderTrails)` |
| `0x123c` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
