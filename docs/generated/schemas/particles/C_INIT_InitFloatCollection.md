...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InitFloatCollection
...
20 fields (2 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_InputValue` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName value` |
