...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_FadeOutSimple

# C_OP_FadeOutSimple

**Kind:** class · **Size:** 480 bytes (`0x1e0`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_flFadeOutTime` | float32 |  | `MPropertyFriendlyName proportional fade out time` |
| `0x1dc` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_alpha` `MPropertyFriendlyName alpha field` |
