...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderScreenShake
...
| `0x22c` | `m_flRadiusScale` | float32 |  | `MPropertyFriendlyName radius scale` |
| `0x230` | `m_flFrequencyScale` | float32 |  | `MPropertyFriendlyName frequence scale` |
| `0x234` | `m_flAmplitudeScale` | float32 |  | `MPropertyFriendlyName amplitude scale` |
| `0x238` | `m_nRadiusField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName radius field` |
...
| `0x240` | `m_nFrequencyField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName frequency field` |
| `0x244` | `m_nAmplitudeField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName amplitude field` |
| `0x248` | `m_nFilterCP` | int32 |  | `MPropertyFriendlyName control point of shake recipient (-1 = global)` |
