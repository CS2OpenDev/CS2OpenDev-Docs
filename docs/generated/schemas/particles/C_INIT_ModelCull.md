...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_ModelCull
...
| `0x1e4` | `m_bBoundBox` | bool |  | `MPropertyFriendlyName use only bounding box` |
| `0x1e5` | `m_bCullOutside` | bool |  | `MPropertyFriendlyName cull outside instead of inside` |
| `0x1e6` | `m_bUseBones` | bool |  | `MPropertyFriendlyName use bones instead of hitboxes` |
| `0x1e7` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
