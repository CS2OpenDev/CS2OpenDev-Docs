...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointToHand
...
| `0x1e4` | `m_nHand` | int32 |  | `MPropertyFriendlyName hand` |
| `0x1e8` | `m_vecCP1Pos` | Vector |  | `MPropertyFriendlyName control point offset` `MVectorIsCoordinate` |
| `0x1f4` | `m_bOrientToHand` | bool |  | `MPropertyFriendlyName use hand orientation` |
