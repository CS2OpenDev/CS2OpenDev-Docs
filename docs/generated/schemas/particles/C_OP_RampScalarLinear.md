...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RampScalarLinear
...
| `0x210` | `m_nField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName ramp field` |
| `0x214` | `m_bProportionalOp` | bool |  | `MPropertyFriendlyName start/end proportional` |
