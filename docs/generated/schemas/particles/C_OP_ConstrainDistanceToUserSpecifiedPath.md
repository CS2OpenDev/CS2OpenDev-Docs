...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ConstrainDistanceToUserSpecifiedPath
...
| `0x1dc` | `m_flMaxDistance` | float32 |  | `MPropertyFriendlyName maximum distance` |
| `0x1e0` | `m_flTimeScale` | float32 |  | `MPropertyFriendlyName Time scale` |
| `0x1e4` | `m_bLoopedPath` | bool |  | `MPropertyFriendlyName Treat path as a loop` |
| `0x1e8` | `m_pointList` | CUtlVector< [PointDefinitionWithTimeValues_t](../particles/PointDefinitionWithTimeValues_t.md) > |  | `MPropertyFriendlyName path points` |
