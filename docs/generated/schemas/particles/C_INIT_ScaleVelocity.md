...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_ScaleVelocity

# C_INIT_ScaleVelocity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2200 bytes (`0x898`) · **Align:** 8 · **Module:** particles
...
19 fields (1 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_vecScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName velocity scale` `MVectorIsCoordinate` |
