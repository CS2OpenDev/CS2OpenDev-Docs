...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapExternalWindToCP
...
| `0x1e0` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point to sample wind` |
| `0x1e4` | `m_nCPOutput` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1e8` | `m_vecScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName wind scale` |
| `0x8a0` | `m_bSetMagnitude` | bool |  | `MPropertyFriendlyName set magnitude instead of vector` |
| `0x8a4` | `m_nOutVectorField` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName magnitude output component` `MPropertySuppressExpr !m_bSetMagnitude` |
