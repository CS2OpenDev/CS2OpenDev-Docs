...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_SetHitboxToModel

# C_INIT_SetHitboxToModel

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2728 bytes (`0xaa8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nControlPointNumber` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e4` | `m_nForceInModel` | int32 |  | `MPropertyFriendlyName force to be inside model` |
| `0x1e8` | `m_bEvenDistribution` | bool |  | `MPropertyFriendlyName even distribution` |
| `0x1ec` | `m_nDesiredHitbox` | int32 |  | `MPropertyFriendlyName desired hitbox` |
| `0x1f0` | `m_vecHitBoxScale` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName model hitbox scale` |
| `0x8a8` | `m_vecDirectionBias` | Vector |  | `MPropertyFriendlyName direction bias` `MVectorIsCoordinate` |
| `0x8b4` | `m_bMaintainHitbox` | bool |  | `MPropertyFriendlyName maintain existing hitbox` |
| `0x8b5` | `m_bUseBones` | bool |  | `MPropertyFriendlyName use bones instead of hitboxes` |
| `0x8b6` | `m_HitboxSetName` | char[128] |  | `MPropertyFriendlyName hitbox set` |
| `0x938` | `m_flShellSize` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName hitbox shell thickness` |
