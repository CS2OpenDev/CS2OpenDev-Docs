...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_SetRigidAttachment
...
| `0x1e4` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName attribute to read from` |
| `0x1e8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName attribute to cache to` |
| `0x1ec` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName local space` |
