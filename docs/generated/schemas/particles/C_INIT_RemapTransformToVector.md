...
| `0x1e0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1e4` | `m_vInputMin` | Vector |  | `MPropertyFriendlyName input minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1f0` | `m_vInputMax` | Vector |  | `MPropertyFriendlyName input maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1fc` | `m_vOutputMin` | Vector |  | `MPropertyFriendlyName output minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x208` | `m_vOutputMax` | Vector |  | `MPropertyFriendlyName output maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x218` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName transform input` |
| `0x280` | `m_LocalSpaceTransform` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MParticleInputOptional` `MPropertyFriendlyName local space transform` |
| `0x2e8` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName emitter lifetime start time (seconds)` |
| `0x2ec` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName emitter lifetime end time (seconds)` |
| `0x2f0` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x2f4` | `m_bOffset` | bool |  | `MPropertyFriendlyName offset position` |
| `0x2f5` | `m_bAccelerate` | bool |  | `MPropertyFriendlyName accelerate position` |
| `0x2f8` | `m_flRemapBias` | float32 |  | `MPropertyFriendlyName remap bias` |
