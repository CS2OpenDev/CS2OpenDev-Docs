...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomVector
...
| `0x1e0` | `m_vecMin` | Vector |  | `MPropertyFriendlyName min` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1ec` | `m_vecMax` | Vector |  | `MPropertyFriendlyName max` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1f8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1fc` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
