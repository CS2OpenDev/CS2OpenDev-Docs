...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapTransformVisibilityToVector

# C_OP_RemapTransformVisibilityToVector

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 624 bytes (`0x270`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x1e0` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName transform input` |
| `0x248` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x24c` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName CP visibility minimum` |
| `0x250` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName CP visibility maximum` |
| `0x254` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName output minimum` |
| `0x260` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName output maximum` |
| `0x26c` | `m_flRadius` | float32 |  | `MPropertyFriendlyName visibility radius` |
