...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RandomForce
...
| `0x1e8` | `m_MinForce` | Vector |  | `MPropertyFriendlyName min force` `MVectorIsCoordinate` |
| `0x1f4` | `m_MaxForce` | Vector |  | `MPropertyFriendlyName max force` `MVectorIsCoordinate` |
