...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DampenToCP
...
| `0x1dc` | `m_flRange` | float32 |  | `MPropertyFriendlyName falloff range` |
| `0x1e0` | `m_flScale` | float32 |  | `MPropertyFriendlyName dampen scale` |
