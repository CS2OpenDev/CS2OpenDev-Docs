...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_InheritFromParentParticles

# C_OP_InheritFromParentParticles

**Kind:** class · **Size:** 488 bytes (`0x1e8`) · **Align:** 8 · **Module:** particles

**Inherits from:** [CParticleFunctionOperator](../particles/CParticleFunctionOperator.md)

**Metadata:** `MParticleMaxVersion 8`, `MParticleReplacementOp C_OP_InheritFromParentParticlesV2`
...
| `0x1d8` | `m_flScale` | float32 |  | `MPropertyFriendlyName scale` |
| `0x1dc` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield` `MPropertyFriendlyName inherited field` |
| `0x1e0` | `m_nIncrement` | int32 |  | `MPropertyFriendlyName particle increment amount` |
| `0x1e4` | `m_bRandomDistribution` | bool |  | `MPropertyFriendlyName random parent particle distribution` |
