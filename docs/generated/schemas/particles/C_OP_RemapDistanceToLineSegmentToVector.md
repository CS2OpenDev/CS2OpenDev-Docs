...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapDistanceToLineSegmentToVector
...
| `0x1f0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1f4` | `m_vMinOutputValue` | Vector |  | `MPropertyFriendlyName output value at min distance` |
| `0x200` | `m_vMaxOutputValue` | Vector |  | `MPropertyFriendlyName output value at max distance` |
