...
| `0x2f64` | `m_nOrientationType` | [ParticleOrientationChoiceList_t](../particles/ParticleOrientationChoiceList_t.md) |  | `MPropertyFriendlyName orientation type` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
