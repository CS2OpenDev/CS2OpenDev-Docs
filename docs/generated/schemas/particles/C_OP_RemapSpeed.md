...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapSpeed
...
| `0x1dc` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input minimum` |
| `0x1e0` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input maximum` |
...
| `0x1ec` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x1f0` | `m_bIgnoreDelta` | bool |  | `MPropertyFriendlyName ignore delta time` |
