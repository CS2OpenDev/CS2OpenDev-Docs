...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetPerChildControlPoint

# C_OP_SetPerChildControlPoint

**Kind:** class · **Size:** 1240 bytes (`0x4d8`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_nChildGroupID` | int32 |  | `MPropertyFriendlyName group ID to affect` |
| `0x1dc` | `m_nFirstControlPoint` | int32 |  | `MPropertyFriendlyName control point to set` |
| `0x1e0` | `m_nNumControlPoints` | int32 |  | `MPropertyFriendlyName # of children to set` |
| `0x1e8` | `m_nParticleIncrement` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName particle increment amount` |
| `0x358` | `m_nFirstSourcePoint` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName first particle to copy` |
| `0x4c8` | `m_bSetOrientation` | bool |  | `MPropertyFriendlyName set orientation from velocity` |
| `0x4cc` | `m_nOrientationField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName orientation vector` |
| `0x4d0` | `m_bNumBasedOnParticleCount` | bool |  | `MPropertyFriendlyName set number of children based on particle count` |
