...
| `0x4c0` | `m_nFalloffFunction` | [ParticleFalloffFunction_t](../particles/ParticleFalloffFunction_t.md) |  | `MPropertyFriendlyName force falloff function` |
...
| `0x638` | `m_nImpulseType` | [ParticleImpulseType_t](../particles/ParticleImpulseType_t.md) |  | `MPropertyFriendlyName impulse type` |
