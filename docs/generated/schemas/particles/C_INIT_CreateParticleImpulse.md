...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreateParticleImpulse
...
| `0x1e0` | `m_InputRadius` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName radius` |
| `0x350` | `m_InputMagnitude` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName magnitude` |
| `0x4c0` | `m_nFalloffFunction` | [ParticleFalloffFunction_t](../!GlobalTypes/ParticleFalloffFunction_t.md) |  | `MPropertyFriendlyName force falloff function` |
| `0x4c8` | `m_InputFalloffExp` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName exponential falloff exponent` |
| `0x638` | `m_nImpulseType` | [ParticleImpulseType_t](../!GlobalTypes/ParticleImpulseType_t.md) |  | `MPropertyFriendlyName impulse type` |
