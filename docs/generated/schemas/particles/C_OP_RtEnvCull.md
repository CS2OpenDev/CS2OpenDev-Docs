...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RtEnvCull

# C_OP_RtEnvCull

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 640 bytes (`0x280`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_vecTestDir` | Vector |  | `MPropertyFriendlyName test direction` `MVectorIsCoordinate` |
| `0x1e4` | `m_vecTestNormal` | Vector |  | `MPropertyFriendlyName cull normal` `MVectorIsCoordinate` |
| `0x1f0` | `m_bCullOnMiss` | bool |  | `MPropertyFriendlyName cull on miss` |
| `0x1f1` | `m_bStickInsteadOfCull` | bool |  | `MPropertyFriendlyName stick instead of cull` |
| `0x1f2` | `m_RtEnvName` | char[128] |  | `MPropertyFriendlyName ray trace environment name` |
| `0x274` | `m_nRTEnvCP` | int32 |  | `MPropertyFriendlyName ray trace environment cp` |
| `0x278` | `m_nComponent` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName rt env control point component` |
