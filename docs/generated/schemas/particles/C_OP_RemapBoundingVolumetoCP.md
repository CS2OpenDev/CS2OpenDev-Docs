...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapBoundingVolumetoCP
...
| `0x1e0` | `m_nOutControlPointNumber` | int32 |  | `MPropertyFriendlyName output control point` |
| `0x1e4` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input volume minimum in cubic units` |
| `0x1e8` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input volume maximum in cubic units` |
