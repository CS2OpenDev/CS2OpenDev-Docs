...
| `0x358` | `m_vForce` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName force to apply` `MVectorIsCoordinate` |
| `0xa10` | `m_nCP` | int32 |  | `MPropertyFriendlyName local space control point` |
