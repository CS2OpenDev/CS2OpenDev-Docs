...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PointVectorAtNextParticle
...
| `0x350` | `m_bPrevious` | bool |  | `MPropertyFriendlyName Point at Previous instead of next` |
