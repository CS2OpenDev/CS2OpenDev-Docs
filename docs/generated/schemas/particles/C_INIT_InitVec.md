...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InitVec

# C_INIT_InitVec

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2216 bytes (`0x8a8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_InputValue` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName value` |
| `0x898` | `m_nOutputField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x89c` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x8a0` | `m_bNormalizedOutput` | bool |  | `MPropertyFriendlyName normalize result` |
| `0x8a1` | `m_bWritePreviousPosition` | bool |  | `MPropertyFriendlyName set previous position` `MPropertySuppressExpr m_nOutputField != PARTICLE_ATTRIBUTE_XYZ` |
