...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomVectorComponent
...
| `0x1e0` | `m_flMin` | float32 |  | `MPropertyFriendlyName min` |
| `0x1e4` | `m_flMax` | float32 |  | `MPropertyFriendlyName max` |
| `0x1e8` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x1ec` | `m_nComponent` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName component 0/1/2 X/Y/Z` `MVectorIsSometimesCoordinate m_nFieldOutput` |
