...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CycleScalar
...
| `0x1d8` | `m_nDestField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName destination scalar field` |
| `0x1dc` | `m_flStartValue` | float32 |  | `MPropertyFriendlyName Value at start of cycle` |
| `0x1e0` | `m_flEndValue` | float32 |  | `MPropertyFriendlyName Value at end of cycle` |
| `0x1e4` | `m_flCycleTime` | float32 |  | `MPropertyFriendlyName Cycle time` |
| `0x1e8` | `m_bDoNotRepeatCycle` | bool |  | `MPropertyFriendlyName Do not repeat cycle` |
| `0x1e9` | `m_bSynchronizeParticles` | bool |  | `MPropertyFriendlyName Synchronize particles` |
| `0x1ec` | `m_nCPScale` | int32 |  | `MPropertyFriendlyName Scale Start/End Control Point` |
| `0x1f0` | `m_nCPFieldMin` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName start scale control point field` |
| `0x1f4` | `m_nCPFieldMax` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName end scale control point field` |
