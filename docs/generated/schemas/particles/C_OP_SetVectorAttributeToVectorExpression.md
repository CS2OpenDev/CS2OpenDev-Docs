...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetVectorAttributeToVectorExpression

# C_OP_SetVectorAttributeToVectorExpression

**Kind:** class · **Size:** 4400 bytes (`0x1130`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_nExpression` | [VectorExpressionType_t](../!GlobalTypes/VectorExpressionType_t.md) |  | `MPropertyFriendlyName expression` |
| `0x1e0` | `m_vInput1` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName input 1` |
| `0x898` | `m_vInput2` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName input 2` |
| `0xf50` | `m_flLerp` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName lerp value` `MPropertySuppressExpr m_nExpression != VECTOR_EXPRESSION_LERP` |
| `0x10c0` | `m_nOutputField` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName output field` |
| `0x10c4` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x10c8` | `m_bNormalizedOutput` | bool |  | `MPropertyFriendlyName normalize result` |
