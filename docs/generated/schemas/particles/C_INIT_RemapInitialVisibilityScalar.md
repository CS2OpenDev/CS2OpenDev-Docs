...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RemapInitialVisibilityScalar
...
| `0x1e8` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName visibility minimum` |
| `0x1ec` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName visibility maximum` |
