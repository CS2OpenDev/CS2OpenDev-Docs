...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapScalarEndCap
...
| `0x1d8` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName input field` |
...
| `0x1e0` | `m_flInputMin` | float32 |  | `MPropertyFriendlyName input minimum` |
| `0x1e4` | `m_flInputMax` | float32 |  | `MPropertyFriendlyName input maximum` |
