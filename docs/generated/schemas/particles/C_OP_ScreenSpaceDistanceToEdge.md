...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ScreenSpaceDistanceToEdge

# C_OP_ScreenSpaceDistanceToEdge

**Kind:** class · **Size:** 1264 bytes (`0x4f0`) · **Align:** 16 · **Module:** particles
...
| `0x1e0` | `m_flMaxDistFromEdge` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName max distance from edge` |
| `0x350` | `m_flOutputRemap` | [CParticleRemapFloatInput](../particleslib/CParticleRemapFloatInput.md) |  | `MPropertyFriendlyName output` |
| `0x4c0` | `m_nSetMethod` | [ParticleSetMethod_t](../particleslib/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
