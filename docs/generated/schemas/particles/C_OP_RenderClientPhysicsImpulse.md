...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RenderClientPhysicsImpulse

# C_OP_RenderClientPhysicsImpulse

**Kind:** class · **Size:** 1296 bytes (`0x510`) · **Align:** 8 · **Module:** particles
...
| `0x228` | `m_flRadius` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName radius` |
| `0x398` | `m_flMagnitude` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName magnitude` |
| `0x508` | `m_nSimIdFilter` | int32 |  | `MPropertyFriendlyName filter explosion to single simulation id` |
