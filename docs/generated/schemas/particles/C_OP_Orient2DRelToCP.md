...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_Orient2DRelToCP
...
| `0x1d8` | `m_flRotOffset` | float32 |  | `MPropertyFriendlyName rotation offset` |
| `0x1dc` | `m_flSpinStrength` | float32 |  | `MPropertyFriendlyName spin strength` |
| `0x1e0` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point` |
| `0x1e4` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_rotation` `MPropertyFriendlyName rotation field` |
