...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointPositionToTimeOfDayValue

# C_OP_SetControlPointPositionToTimeOfDayValue

**Kind:** class · **Size:** 632 bytes (`0x278`) · **Align:** 8 · **Module:** particles
...
| `0x1e4` | `m_pszTimeOfDayParameter` | char[128] |  | `MPropertyFriendlyName time-of-day parameter` |
| `0x264` | `m_vecDefaultValue` | Vector |  | `MPropertyFriendlyName default value` |
