...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_OffsetVectorToVector
...
23 fields (5 declared here, 18 inherited). Offsets are absolute from the object base.
...
| `0x1e0` | `m_nFieldInput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName input field` |
...
| `0x1e8` | `m_vecOutputMin` | Vector |  | `MPropertyFriendlyName output offset minimum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x1f4` | `m_vecOutputMax` | Vector |  | `MPropertyFriendlyName output offset maximum` `MVectorIsSometimesCoordinate m_nFieldOutput` |
| `0x200` | `m_randomnessParameters` | [CRandomNumberGeneratorParameters](../particles/CRandomNumberGeneratorParameters.md) |  | `MPropertyFriendlyName Random number generator controls` |
