...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_ConstrainLineLength
...
| `0x1d8` | `m_flMinDistance` | float32 |  | `MPropertyFriendlyName minimum length` |
| `0x1dc` | `m_flMaxDistance` | float32 |  | `MPropertyFriendlyName maximum length` |
