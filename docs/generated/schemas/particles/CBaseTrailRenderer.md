...
| `0x2df0` | `m_nOrientationType` | [ParticleOrientationChoiceList_t](../!GlobalTypes/ParticleOrientationChoiceList_t.md) |  | `MPropertyFriendlyName orientation type` `MPropertySortPriority 750` `MPropertyStartGroup Orientation` |
