...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_ChaoticAttractor
...
| `0x1e0` | `m_flAParm` | float32 |  | `MPropertyFriendlyName pickover A parameter` |
| `0x1e4` | `m_flBParm` | float32 |  | `MPropertyFriendlyName pickover B parameter` |
| `0x1e8` | `m_flCParm` | float32 |  | `MPropertyFriendlyName pickover C parameter` |
| `0x1ec` | `m_flDParm` | float32 |  | `MPropertyFriendlyName pickover D parameter` |
| `0x1f0` | `m_flScale` | float32 |  | `MPropertyFriendlyName scale` |
| `0x1f4` | `m_flSpeedMin` | float32 |  | `MPropertyFriendlyName speed min` |
| `0x1f8` | `m_flSpeedMax` | float32 |  | `MPropertyFriendlyName speed max` |
| `0x1fc` | `m_nBaseCP` | int32 |  | `MPropertyFriendlyName relative control point number` |
| `0x200` | `m_bUniformSpeed` | bool |  | `MPropertyFriendlyName uniform speed` |
