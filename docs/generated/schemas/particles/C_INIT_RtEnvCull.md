...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RtEnvCull

# C_INIT_RtEnvCull

**Kind:** class · **Size:** 648 bytes (`0x288`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_vecTestDir` | Vector |  | `MPropertyFriendlyName test direction` `MVectorIsCoordinate` |
| `0x1ec` | `m_vecTestNormal` | Vector |  | `MPropertyFriendlyName cull normal` `MVectorIsCoordinate` |
| `0x1f8` | `m_bUseVelocity` | bool |  | `MPropertyFriendlyName use velocity for test direction` |
| `0x1f9` | `m_bCullOnMiss` | bool |  | `MPropertyFriendlyName cull on miss` |
| `0x1fa` | `m_bLifeAdjust` | bool |  | `MPropertyFriendlyName velocity test adjust lifespan` |
| `0x1fb` | `m_RtEnvName` | char[128] |  | `MPropertyFriendlyName ray trace environment name` |
| `0x27c` | `m_nRTEnvCP` | int32 |  | `MPropertyFriendlyName ray trace environment cp` |
| `0x280` | `m_nComponent` | int32 |  | `MPropertyAttributeChoiceName vector_component` `MPropertyFriendlyName rt env control point component` |
