...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SelectivelyEnableChildren
...
| `0x1e0` | `m_nChildGroupID` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName group ID to affect` |
| `0x350` | `m_nFirstChild` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName first child to enable` |
| `0x4c0` | `m_nNumChildrenToEnable` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName # of children to enable` |
| `0x630` | `m_bPlayEndcapOnStop` | bool |  | `MPropertyFriendlyName play endcap when children are removed` |
| `0x631` | `m_bDestroyImmediately` | bool |  | `MPropertyFriendlyName destroy particles immediately when child is removed` |
