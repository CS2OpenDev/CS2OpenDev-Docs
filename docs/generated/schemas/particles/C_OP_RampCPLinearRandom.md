...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RampCPLinearRandom
...
| `0x1e4` | `m_vecRateMin` | Vector |  | `MPropertyFriendlyName ramp rate min` |
| `0x1f0` | `m_vecRateMax` | Vector |  | `MPropertyFriendlyName ramp rate max` |
