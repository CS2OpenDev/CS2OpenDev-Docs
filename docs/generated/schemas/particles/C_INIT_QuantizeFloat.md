...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_QuantizeFloat
...
| `0x1e0` | `m_InputValue` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName interval to snap to` |
