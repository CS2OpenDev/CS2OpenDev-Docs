...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_InitFromVectorFieldSnapshot
...
| `0x1e4` | `m_nLocalSpaceCP` | int32 |  | `MPropertyFriendlyName local space control point number` |
| `0x1e8` | `m_nWeightUpdateCP` | int32 |  | `MPropertyFriendlyName weight update control point` |
| `0x1ec` | `m_bUseVerticalVelocity` | bool |  | `MPropertyFriendlyName use vertical velocity for weighting` |
| `0x1f0` | `m_vecScale` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName Component Scale` |
