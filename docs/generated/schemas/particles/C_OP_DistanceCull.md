...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_DistanceCull
...
| `0x1d8` | `m_nControlPoint` | int32 |  | `MPropertyFriendlyName control point` |
| `0x1dc` | `m_vecPointOffset` | Vector |  | `MPropertyFriendlyName control point offset` `MVectorIsCoordinate` |
| `0x1e8` | `m_flDistance` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName cull distance` |
| `0x358` | `m_bCullInside` | bool |  | `MPropertyFriendlyName cull inside instead of outside` |
| `0x35c` | `m_nAttribute` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_vector` `MPropertyFriendlyName Attribute to Test` |
