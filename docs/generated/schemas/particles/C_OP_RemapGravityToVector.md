...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapGravityToVector

# C_OP_RemapGravityToVector

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2304 bytes (`0x900`) · **Align:** 16 · **Module:** particles
...
| `0x1d8` | `m_vInput1` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName position input` |
...
| `0x898` | `m_bNormalizedOutput` | bool |  | `MPropertyFriendlyName normalize result` |
