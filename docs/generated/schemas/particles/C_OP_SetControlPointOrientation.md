...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointOrientation

# C_OP_SetControlPointOrientation

**Kind:** class · **Size:** 888 bytes (`0x378`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_bUseWorldLocation` | bool |  | `MPropertyFriendlyName set orientation in world space` |
| `0x1e2` | `m_bRandomize` | bool |  | `MPropertyFriendlyName randomize` |
| `0x1e3` | `m_bSetOnce` | bool |  | `MPropertyFriendlyName only set orientation once` |
| `0x1e4` | `m_nCP` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e8` | `m_nHeadLocation` | int32 |  | `MPropertyFriendlyName control point to offset orientation from` |
| `0x1ec` | `m_vecRotation` | QAngle |  | `MPropertyFriendlyName pitch yaw roll` |
| `0x1f8` | `m_vecRotationB` | QAngle |  | `MPropertyFriendlyName pitch yaw roll max` |
| `0x208` | `m_flInterpolation` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName interpolation` |
