...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_TimeVaryingForce
...
| `0x1e8` | `m_flStartLerpTime` | float32 |  | `MPropertyFriendlyName time to start transition` |
| `0x1ec` | `m_StartingForce` | Vector |  | `MPropertyFriendlyName starting force` `MVectorIsCoordinate` |
| `0x1f8` | `m_flEndLerpTime` | float32 |  | `MPropertyFriendlyName time to end transition` |
| `0x1fc` | `m_EndingForce` | Vector |  | `MPropertyFriendlyName ending force` `MVectorIsCoordinate` |
