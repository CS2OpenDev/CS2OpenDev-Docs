...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MovementRotateParticleAroundAxis

# C_OP_MovementRotateParticleAroundAxis

**Kind:** class · **Size:** 2672 bytes (`0xa70`) · **Align:** 8 · **Module:** particles
...
| `0x1d8` | `m_vecRotAxis` | [CParticleCollectionVecInput](../particleslib/CParticleCollectionVecInput.md) |  | `MPropertyFriendlyName rotation axis` `MVectorIsCoordinate` |
| `0x890` | `m_flRotRate` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName rotation rate` |
| `0xa00` | `m_TransformInput` | [CParticleTransformInput](../particleslib/CParticleTransformInput.md) |  | `MPropertyFriendlyName transform input` |
| `0xa68` | `m_bLocalSpace` | bool |  | `MPropertyFriendlyName use local space` |
