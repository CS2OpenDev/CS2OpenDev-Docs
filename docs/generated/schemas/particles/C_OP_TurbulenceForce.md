...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_TurbulenceForce
...
| `0x1e8` | `m_flNoiseCoordScale0` | float32 |  | `MPropertyFriendlyName noise scale 0` |
| `0x1ec` | `m_flNoiseCoordScale1` | float32 |  | `MPropertyFriendlyName noise scale 1` |
| `0x1f0` | `m_flNoiseCoordScale2` | float32 |  | `MPropertyFriendlyName noise scale 2` |
| `0x1f4` | `m_flNoiseCoordScale3` | float32 |  | `MPropertyFriendlyName noise scale 3` |
| `0x1f8` | `m_vecNoiseAmount0` | Vector |  | `MPropertyFriendlyName noise amount 0` `MVectorIsCoordinate` |
| `0x204` | `m_vecNoiseAmount1` | Vector |  | `MPropertyFriendlyName noise amount 1` `MVectorIsCoordinate` |
| `0x210` | `m_vecNoiseAmount2` | Vector |  | `MPropertyFriendlyName noise amount 2` `MVectorIsCoordinate` |
| `0x21c` | `m_vecNoiseAmount3` | Vector |  | `MPropertyFriendlyName noise amount 3` `MVectorIsCoordinate` |
