...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_MoveBetweenPoints

# C_INIT_MoveBetweenPoints

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2328 bytes (`0x918`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_flSpeedMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName minimum speed` |
| `0x350` | `m_flSpeedMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName maximum speed` |
| `0x4c0` | `m_flEndSpread` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName end spread` |
| `0x630` | `m_flStartOffset` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName start offset` |
| `0x7a0` | `m_flEndOffset` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName end offset` |
| `0x910` | `m_nEndControlPointNumber` | int32 |  | `MPropertyFriendlyName end control point` |
| `0x914` | `m_bTrailBias` | bool |  | `MPropertyFriendlyName bias lifetime by trail length` |
