...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointToCenter
...
| `0x1e0` | `m_nCP1` | int32 |  | `MPropertyFriendlyName control point number to set` |
| `0x1e4` | `m_vecCP1Pos` | Vector |  | `MPropertyFriendlyName center offset` `MVectorIsCoordinate` |
| `0x1f0` | `m_bUseAvgParticlePos` | bool |  | `MPropertyFriendlyName use average particle position` `MVectorIsCoordinate` |
| `0x1f4` | `m_nSetParent` | [ParticleParentSetMode_t](../!GlobalTypes/ParticleParentSetMode_t.md) |  | `MPropertyFriendlyName set parent` |
