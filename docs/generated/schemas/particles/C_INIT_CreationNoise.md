...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_CreationNoise
...
| `0x1e4` | `m_bAbsVal` | bool |  | `MPropertyFriendlyName absolute value` |
| `0x1e5` | `m_bAbsValInv` | bool |  | `MPropertyFriendlyName invert absolute value` |
| `0x1e8` | `m_flOffset` | float32 |  | `MPropertyFriendlyName time coordinate offset` |
...
| `0x1f4` | `m_flNoiseScale` | float32 |  | `MPropertyFriendlyName time noise coordinate scale` |
| `0x1f8` | `m_flNoiseScaleLoc` | float32 |  | `MPropertyFriendlyName spatial noise coordinate scale` |
| `0x1fc` | `m_vecOffsetLoc` | Vector |  | `MPropertyFriendlyName spatial coordinate offset` `MVectorIsCoordinate` |
| `0x208` | `m_flWorldTimeScale` | float32 |  | `MPropertyFriendlyName world time noise coordinate scale` |
