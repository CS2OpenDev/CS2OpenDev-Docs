...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_VelocityFromNormal
...
| `0x1e0` | `m_fSpeedMin` | float32 |  | `MPropertyFriendlyName random speed min` |
| `0x1e4` | `m_fSpeedMax` | float32 |  | `MPropertyFriendlyName random speed max` |
| `0x1e8` | `m_bIgnoreDt` | bool |  | `MPropertyFriendlyName ignore delta time` |
