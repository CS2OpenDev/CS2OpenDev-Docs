...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetControlPointToImpactPoint

# C_OP_SetControlPointToImpactPoint

**Kind:** class · **Size:** 1024 bytes (`0x400`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nCPOut` | int32 |  | `MPropertyFriendlyName control point to set` |
| `0x1e4` | `m_nCPIn` | int32 |  | `MPropertyFriendlyName control point to trace from` |
| `0x1e8` | `m_flUpdateRate` | float32 |  | `MPropertyFriendlyName trace update rate` |
| `0x1f0` | `m_flTraceLength` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName max trace length` |
| `0x360` | `m_flStartOffset` | float32 |  | `MPropertyFriendlyName offset start point amount` |
| `0x364` | `m_flOffset` | float32 |  | `MPropertyFriendlyName offset end point amount` |
| `0x368` | `m_vecTraceDir` | Vector |  | `MPropertyFriendlyName trace direction override` `MVectorIsCoordinate` |
| `0x374` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName trace collision group` |
| `0x3f4` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x3f8` | `m_bSetToEndpoint` | bool |  | `MPropertyFriendlyName set to trace endpoint if no collision` |
| `0x3f9` | `m_bTraceToClosestSurface` | bool |  | `MPropertyFriendlyName trace to closest surface along all cardinal directions` |
| `0x3fa` | `m_bIncludeWater` | bool |  | `MPropertyFriendlyName include water` |
