...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_LerpScalar
...
| `0x1e0` | `m_flOutput` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName value to lerp to` |
| `0x350` | `m_flStartTime` | float32 |  | `MPropertyFriendlyName start time` |
| `0x354` | `m_flEndTime` | float32 |  | `MPropertyFriendlyName end time` |
