...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_CurlNoiseForce

# C_OP_CurlNoiseForce

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 8112 bytes (`0x1fb0`) · **Align:** 8 · **Module:** particles
...
| `0x1e8` | `m_nNoiseType` | [ParticleDirectionNoiseType_t](../particleslib/ParticleDirectionNoiseType_t.md) |  | `MPropertyFriendlyName noise type` |
| `0x1f0` | `m_vecNoiseFreq` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName noise frequency` `MVectorIsCoordinate` |
| `0x8a8` | `m_vecNoiseScale` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName noise amplitude` `MVectorIsCoordinate` |
| `0xf60` | `m_vecOffset` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName offset` `MVectorIsCoordinate` |
| `0x1618` | `m_vecOffsetRate` | [CPerParticleVecInput](../particleslib/CPerParticleVecInput.md) |  | `MPropertyFriendlyName offset rate` `MVectorIsCoordinate` |
| `0x1cd0` | `m_flWorleySeed` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName worley seed` |
| `0x1e40` | `m_flWorleyJitter` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName worley jitter` |
