...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_PlayEndCapWhenFinished
...
| `0x1e0` | `m_bFireOnEmissionEnd` | bool |  | `MPropertyFriendlyName play when emission ends` |
| `0x1e1` | `m_bIncludeChildren` | bool |  | `MPropertyFriendlyName wait for children to finish` |
