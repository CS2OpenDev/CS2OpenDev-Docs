...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_MaxVelocity
...
| `0x1d8` | `m_flMaxVelocity` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName maximum velocity` |
| `0x348` | `m_flMinVelocity` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName minimum velocity` |
