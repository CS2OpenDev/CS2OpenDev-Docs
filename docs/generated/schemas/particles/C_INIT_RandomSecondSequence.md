...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_RandomSecondSequence
...
| `0x1e0` | `m_nSequenceMin` | int32 |  | `MPropertyAttributeEditor SequencePicker( 2 )` `MPropertyFriendlyName sequence min` |
| `0x1e4` | `m_nSequenceMax` | int32 |  | `MPropertyAttributeEditor SequencePicker( 2 )` `MPropertyFriendlyName sequence max` |
