...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_SetRandomControlPointPosition
...
| `0x1e4` | `m_nCP1` | int32 |  | `MPropertyFriendlyName control point number` |
| `0x1e8` | `m_nHeadLocation` | int32 |  | `MPropertyFriendlyName control point to offset positions from` |
| `0x1f0` | `m_flReRandomRate` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName re-randomize rate (-1 for once only)` |
| `0x360` | `m_vecCPMinPos` | Vector |  | `MPropertyFriendlyName control point min` |
| `0x36c` | `m_vecCPMaxPos` | Vector |  | `MPropertyFriendlyName control point max` |
| `0x378` | `m_flInterpolation` | [CParticleCollectionFloatInput](../particleslib/CParticleCollectionFloatInput.md) |  | `MPropertyFriendlyName Interpolation` |
