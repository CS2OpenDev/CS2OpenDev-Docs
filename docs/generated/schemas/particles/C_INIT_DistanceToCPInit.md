...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_INIT_DistanceToCPInit

# C_INIT_DistanceToCPInit

**Kind:** class · **Size:** 2504 bytes (`0x9c8`) · **Align:** 8 · **Module:** particles
...
| `0x1e0` | `m_nFieldOutput` | [ParticleAttributeIndex_t](../particles/ParticleAttributeIndex_t.md) |  | `MPropertyAttributeChoiceName particlefield_scalar` `MPropertyFriendlyName output field` |
| `0x1e8` | `m_flInputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance minimum` |
| `0x358` | `m_flInputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName distance maximum` |
| `0x4c8` | `m_flOutputMin` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output minimum` |
| `0x638` | `m_flOutputMax` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName output maximum` |
| `0x7a8` | `m_nStartCP` | int32 |  | `MPropertyFriendlyName control point` |
| `0x7ac` | `m_bLOS` | bool |  | `MPropertyFriendlyName ensure line of sight` |
| `0x7ad` | `m_CollisionGroupName` | char[128] |  | `MPropertyFriendlyName LOS collision group` |
| `0x830` | `m_nTraceSet` | [ParticleTraceSet_t](../!GlobalTypes/ParticleTraceSet_t.md) |  | `MPropertyFriendlyName Trace Set` |
| `0x838` | `m_flMaxTraceLength` | [CPerParticleFloatInput](../particleslib/CPerParticleFloatInput.md) |  | `MPropertyFriendlyName Maximum Trace Length` |
| `0x9a8` | `m_flLOSScale` | float32 |  | `MPropertyFriendlyName LOS Failure Scalar` |
| `0x9ac` | `m_nSetMethod` | [ParticleSetMethod_t](../!GlobalTypes/ParticleSetMethod_t.md) |  | `MPropertyFriendlyName set value method` |
| `0x9b0` | `m_bActiveRange` | bool |  | `MPropertyFriendlyName only active within specified distance` |
| `0x9b4` | `m_vecDistanceScale` | Vector |  | `MPropertyFriendlyName distance component scale` |
| `0x9c0` | `m_flRemapBias` | float32 |  | `MPropertyFriendlyName remap bias` |
