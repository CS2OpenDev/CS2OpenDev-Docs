...
[Schemas](../../schemas.md) / [particles](../particles.md) / C_OP_RemapTransformOrientationToRotations
...
| `0x240` | `m_vecRotation` | Vector |  | `MPropertyFriendlyName offset pitch/yaw/roll` |
| `0x24c` | `m_bUseQuat` | bool |  | `MPropertyFriendlyName Use Quaternians Internally` |
| `0x24d` | `m_bWriteNormal` | bool |  | `MPropertyFriendlyName Write normal instead of rotation` |
