...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointWorldText

# C_PointWorldText

**Kind:** class · **Size:** 4744 bytes (`0x1288`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_ModelPointEntity](../client/C_ModelPointEntity.md)
...
148 fields (19 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb8` | `m_bForceRecreateNextUpdate` | bool |  | `MNotSaved` |
| `0xfd0` | `m_nTextWidthPx` | int32 |  |  |
| `0xfd4` | `m_nTextHeightPx` | int32 |  |  |
| `0xfd8` | `m_messageText` | char[512] |  |  |
| `0x11d8` | `m_FontName` | char[64] |  | `MNotSaved` |
| `0x1218` | `m_BackgroundMaterialName` | char[64] |  | `MNotSaved` |
| `0x1258` | `m_bEnabled` | bool |  | `MNotSaved` |
| `0x1259` | `m_bFullbright` | bool |  | `MNotSaved` |
| `0x125c` | `m_flWorldUnitsPerPx` | float32 |  | `MNotSaved` |
| `0x1260` | `m_flFontSize` | float32 |  | `MNotSaved` |
| `0x1264` | `m_flDepthOffset` | float32 |  | `MNotSaved` |
| `0x1268` | `m_bDrawBackground` | bool |  | `MNotSaved` |
| `0x126c` | `m_flBackgroundBorderWidth` | float32 |  | `MNotSaved` |
| `0x1270` | `m_flBackgroundBorderHeight` | float32 |  | `MNotSaved` |
| `0x1274` | `m_flBackgroundWorldToUV` | float32 |  | `MNotSaved` |
| `0x1278` | `m_Color` | Color |  | `MNotSaved` |
| `0x127c` | `m_nJustifyHorizontal` | [PointWorldTextJustifyHorizontal_t](../!GlobalTypes/PointWorldTextJustifyHorizontal_t.md) |  | `MNotSaved` |
| `0x1280` | `m_nJustifyVertical` | [PointWorldTextJustifyVertical_t](../!GlobalTypes/PointWorldTextJustifyVertical_t.md) |  | `MNotSaved` |
| `0x1284` | `m_nReorientMode` | [PointWorldTextReorientMode_t](../!GlobalTypes/PointWorldTextReorientMode_t.md) |  | `MNotSaved` |
