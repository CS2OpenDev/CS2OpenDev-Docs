...
| `0x127c` | `m_nJustifyHorizontal` | [PointWorldTextJustifyHorizontal_t](../server/PointWorldTextJustifyHorizontal_t.md) |  | `MNotSaved` |
| `0x1280` | `m_nJustifyVertical` | [PointWorldTextJustifyVertical_t](../server/PointWorldTextJustifyVertical_t.md) |  | `MNotSaved` |
| `0x1284` | `m_nReorientMode` | [PointWorldTextReorientMode_t](../server/PointWorldTextReorientMode_t.md) |  | `MNotSaved` |
