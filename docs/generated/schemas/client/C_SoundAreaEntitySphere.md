...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundAreaEntitySphere
...
**Inherits from:** [C_SoundAreaEntityBase](../client/C_SoundAreaEntityBase.md)
...
90 fields (1 declared here, 89 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_bDisabled` | bool | [C_SoundAreaEntityBase](../client/C_SoundAreaEntityBase.md) |  |
| `0x608` | `m_bWasEnabled` | bool | [C_SoundAreaEntityBase](../client/C_SoundAreaEntityBase.md) | `MNotSaved` |
| `0x610` | `m_iszSoundAreaType` | CUtlSymbolLarge | [C_SoundAreaEntityBase](../client/C_SoundAreaEntityBase.md) |  |
| `0x618` | `m_vPos` | Vector | [C_SoundAreaEntityBase](../client/C_SoundAreaEntityBase.md) |  |
| `0x628` | `m_flRadius` | float32 |  |  |
