...
[Schemas](../../schemas.md) / [client](../client.md) / C_LocalTempEntity

# C_LocalTempEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4648 bytes (`0x1228`) · **Align:** 8 · **Module:** client
...
171 fields (25 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `flags` | int32 |  | `MNotSaved` |
| `0x1184` | `die` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x1188` | `m_flFrameMax` | float32 |  | `MNotSaved` |
| `0x118c` | `x` | float32 |  | `MNotSaved` |
| `0x1190` | `y` | float32 |  | `MNotSaved` |
| `0x1194` | `fadeSpeed` | float32 |  | `MNotSaved` |
| `0x1198` | `bounceFactor` | float32 |  | `MNotSaved` |
| `0x119c` | `hitSound` | int32 |  | `MNotSaved` |
| `0x11a0` | `priority` | int32 |  | `MNotSaved` |
| `0x11a4` | `tentOffset` | Vector |  | `MNotSaved` |
| `0x11b0` | `m_vecTempEntAngVelocity` | QAngle |  | `MNotSaved` |
| `0x11bc` | `tempent_renderamt` | int32 |  | `MNotSaved` |
| `0x11c0` | `m_vecNormal` | Vector |  | `MNotSaved` |
| `0x11cc` | `m_flSpriteScale` | float32 |  | `MNotSaved` |
| `0x11d0` | `m_nFlickerFrame` | int32 |  | `MNotSaved` |
| `0x11d4` | `m_flFrameRate` | float32 |  | `MNotSaved` |
| `0x11d8` | `m_flFrame` | float32 |  | `MNotSaved` |
| `0x11e0` | `m_pszImpactEffect` | char* |  | `MNotSaved` |
| `0x11e8` | `m_pszParticleEffect` | char* |  | `MNotSaved` |
| `0x11f0` | `m_bParticleCollision` | bool |  | `MNotSaved` |
| `0x11f4` | `m_iLastCollisionFrame` | int32 |  | `MNotSaved` |
| `0x11f8` | `m_vLastCollisionOrigin` | VectorWS |  | `MNotSaved` |
| `0x1204` | `m_vecTempEntVelocity` | Vector |  | `MNotSaved` |
| `0x1210` | `m_vecPrevAbsOrigin` | VectorWS |  | `MNotSaved` |
| `0x121c` | `m_vecTempEntAcceleration` | Vector |  | `MNotSaved` |
