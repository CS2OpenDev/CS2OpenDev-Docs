---
layout: default
title: CSkyboxReference (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CSkyboxReference
...
**Twin:** [CSkyboxReference (server)](../server/CSkyboxReference.md)
...
| `0x600` | `m_worldGroupId` | WorldGroupId_t |  |  |
| `0x604` | `m_hSkyCamera` | CHandle< [C_SkyCamera](../client/C_SkyCamera.md) > |  | `MNotSaved` |
