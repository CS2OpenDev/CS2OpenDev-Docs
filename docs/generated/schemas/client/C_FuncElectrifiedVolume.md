...
[Schemas](../../schemas.md) / [client](../client.md) / C_FuncElectrifiedVolume

# C_FuncElectrifiedVolume

**Kind:** class · **Size:** 4040 bytes (`0xfc8`) · **Align:** 8 · **Module:** client
...
132 fields (3 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_nAmbientEffect` | [ParticleIndex_t](../server/ParticleIndex_t.md) |  | `MNotSaved` |
| `0xfb8` | `m_EffectName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xfc0` | `m_bState` | bool |  | `MNotSaved` |
