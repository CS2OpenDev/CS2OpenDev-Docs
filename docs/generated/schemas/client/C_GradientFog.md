...
[Schemas](../../schemas.md) / [client](../client.md) / C_GradientFog
...
| `0x600` | `m_hGradientFogTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x608` | `m_flFogStartDistance` | float32 |  |  |
| `0x60c` | `m_flFogEndDistance` | float32 |  |  |
| `0x610` | `m_bHeightFogEnabled` | bool |  |  |
| `0x614` | `m_flFogStartHeight` | float32 |  |  |
| `0x618` | `m_flFogEndHeight` | float32 |  |  |
| `0x61c` | `m_flFarZ` | float32 |  |  |
| `0x620` | `m_flFogMaxOpacity` | float32 |  |  |
| `0x624` | `m_flFogFalloffExponent` | float32 |  |  |
| `0x628` | `m_flFogVerticalExponent` | float32 |  |  |
| `0x62c` | `m_fogColor` | Color |  |  |
| `0x630` | `m_flFogStrength` | float32 |  |  |
| `0x634` | `m_flFadeTime` | float32 |  |  |
| `0x638` | `m_bStartDisabled` | bool |  |  |
| `0x639` | `m_bIsEnabled` | bool |  |  |
| `0x63a` | `m_bGradientFogNeedsTextures` | bool |  |  |
