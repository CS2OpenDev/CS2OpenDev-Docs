...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSGO_MapPreviewCameraPath

# C_CSGO_MapPreviewCameraPath

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1672 bytes (`0x688`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_BaseEntity](../client/C_BaseEntity.md)

**Derived by:** [C_CSGO_TeamPreviewCamera](../client/C_CSGO_TeamPreviewCamera.md)
...
| `0x600` | `m_flZFar` | float32 |  |  |
| `0x604` | `m_flZNear` | float32 |  |  |
| `0x608` | `m_bLoop` | bool |  |  |
| `0x609` | `m_bVerticalFOV` | bool |  |  |
| `0x60a` | `m_bConstantSpeed` | bool |  |  |
| `0x60c` | `m_flDuration` | float32 |  |  |
| `0x650` | `m_flPathLength` | float32 |  |  |
| `0x654` | `m_flPathDuration` | float32 |  |  |
| `0x66c` | `m_bDofEnabled` | bool |  |  |
| `0x670` | `m_flDofNearBlurry` | float32 |  |  |
| `0x674` | `m_flDofNearCrisp` | float32 |  |  |
| `0x678` | `m_flDofFarCrisp` | float32 |  |  |
| `0x67c` | `m_flDofFarBlurry` | float32 |  |  |
| `0x680` | `m_flDofTiltToGround` | float32 |  |  |
