...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundEventEntity
...
**Derived by:** [C_SoundEventAABBEntity](../client/C_SoundEventAABBEntity.md), [C_SoundEventConeEntity](../client/C_SoundEventConeEntity.md), [C_SoundEventEntityAlias_snd_event_point](../client/C_SoundEventEntityAlias_snd_event_point.md), [C_SoundEventOBBEntity](../client/C_SoundEventOBBEntity.md), [C_SoundEventPathCornerEntity](../client/C_SoundEventPathCornerEntity.md), [C_SoundEventSphereEntity](../client/C_SoundEventSphereEntity.md)
...
100 fields (15 declared here, 85 inherited). Offsets are absolute from the object base.

| Offset | Field | Type | From | Annotations |
|--------|-------|------|------|-------------|
| `0x0` bit 0 | `m_bClientSideOnly` | bitfield:1 |  | `MNotSaved` |
...
| `0x600` | `m_bStartOnSpawn` | bool |  |  |
| `0x601` | `m_bToLocalPlayer` | bool |  |  |
| `0x602` | `m_bStopOnNew` | bool |  |  |
| `0x603` | `m_bSaveRestore` | bool |  |  |
| `0x604` | `m_bSavedIsPlaying` | bool |  |  |
| `0x608` | `m_flSavedElapsedTime` | float32 |  |  |
| `0x610` | `m_iszSourceEntityName` | CUtlSymbolLarge |  |  |
| `0x618` | `m_iszAttachmentName` | CUtlSymbolLarge |  |  |
| `0x620` | `m_onGUIDChanged` | CEntityOutputTemplate< SndOpEventGuid_t > |  |  |
| `0x650` | `m_onSoundFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x668` | `m_flClientCullRadius` | float32 |  |  |
| `0x698` | `m_iszSoundName` | CUtlSymbolLarge |  |  |
| `0x6b4` | `m_hSource` | CEntityHandle |  |  |
| `0x6b8` | `m_nEntityIndexSelection` | int32 |  |  |
