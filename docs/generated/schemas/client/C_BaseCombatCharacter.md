...
[Schemas](../../schemas.md) / [client](../client.md) / C_BaseCombatCharacter

# C_BaseCombatCharacter

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4616 bytes (`0x1208`) · **Align:** 8 · **Module:** client

**Inherits from:** [CBaseAnimGraph](../client/CBaseAnimGraph.md)

**Derived by:** [C_BasePlayerPawn](../client/C_BasePlayerPawn.md), [C_Hostage](../client/C_Hostage.md), [C_NetTestBaseCombatCharacter](../client/C_NetTestBaseCombatCharacter.md)
...
classDiagram
    ...
    C_BaseCombatCharacter *-- `C_BaseCombatCharacter::WaterWakeMode_t`
```

## Memory layout

152 fields (6 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_hMyWearables` | C_NetworkUtlVectorBase< CHandle< [C_EconWearable](../client/C_EconWearable.md) > > |  | `MNotSaved` |
| `0x1198` | `m_leftFootAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  | `MNotSaved` |
| `0x1199` | `m_rightFootAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  | `MNotSaved` |
| `0x119c` | `m_nWaterWakeMode` | [C_BaseCombatCharacter::WaterWakeMode_t](../client/C_BaseCombatCharacter.WaterWakeMode_t.md) |  | `MNotSaved` |
| `0x11a0` | `m_flWaterWorldZ` | float32 |  | `MNotSaved` |
| `0x11a4` | `m_flWaterNextTraceTime` | float32 |  | `MNotSaved` |
