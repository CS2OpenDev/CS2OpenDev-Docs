---
layout: default
title: CEnvSoundscapeProxy (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CEnvSoundscapeProxy

# CEnvSoundscapeProxy

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1688 bytes (`0x698`) · **Align:** 8 · **Module:** client

**Twin:** [CEnvSoundscapeProxy (server)](../server/CEnvSoundscapeProxy.md)

**Inherits from:** [CEnvSoundscape](../client/CEnvSoundscape.md)

**Derived by:** [CEnvSoundscapeProxyAlias_snd_soundscape_proxy](../client/CEnvSoundscapeProxyAlias_snd_soundscape_proxy.md)
...
97 fields (1 declared here, 96 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_OnPlay` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x618` | `m_flRadius` | float32 | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x620` | `m_soundEventName` | CGameSoundEventName | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x628` | `m_bOverrideWithEvent` | bool | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x62c` | `m_soundscapeIndex` | int32 | [CEnvSoundscape](../client/CEnvSoundscape.md) | `MNotSaved` |
| `0x630` | `m_soundscapeEntityListId` | int32 | [CEnvSoundscape](../client/CEnvSoundscape.md) | `MNotSaved` |
| `0x638` | `m_positionNames` | CUtlSymbolLarge[8] | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x678` | `m_hProxySoundscape` | CHandle< [CEnvSoundscape](../client/CEnvSoundscape.md) > | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x67c` | `m_bDisabled` | bool | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x680` | `m_soundscapeName` | CUtlSymbolLarge | [CEnvSoundscape](../client/CEnvSoundscape.md) |  |
| `0x688` | `m_soundEventHash` | uint32 | [CEnvSoundscape](../client/CEnvSoundscape.md) | `MNotSaved` |
| `0x690` | `m_MainSoundscapeName` | CUtlSymbolLarge |  |  |
