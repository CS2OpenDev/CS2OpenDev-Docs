---
title: CCitadelSoundOpvarSetOBB (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CCitadelSoundOpvarSetOBB
...
**Twin:** [CCitadelSoundOpvarSetOBB (server)](../server/CCitadelSoundOpvarSetOBB.md)
...
| `0x618` | `m_iszStackName` | CUtlSymbolLarge |  |  |
| `0x620` | `m_iszOperatorName` | CUtlSymbolLarge |  |  |
| `0x628` | `m_iszOpvarName` | CUtlSymbolLarge |  |  |
| `0x630` | `m_vDistanceInnerMins` | Vector |  |  |
| `0x63c` | `m_vDistanceInnerMaxs` | Vector |  |  |
| `0x648` | `m_vDistanceOuterMins` | Vector |  |  |
| `0x654` | `m_vDistanceOuterMaxs` | Vector |  |  |
| `0x660` | `m_nAABBDirection` | int32 |  |  |
