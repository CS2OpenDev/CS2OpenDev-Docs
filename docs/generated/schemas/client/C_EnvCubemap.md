...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvCubemap
...
**Derived by:** [C_EnvCubemapBox](../client/C_EnvCubemapBox.md)
...
103 fields (18 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x680` | `m_Entity_hCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x688` | `m_Entity_bCustomCubemapTexture` | bool |  |  |
| `0x68c` | `m_Entity_flInfluenceRadius` | float32 |  |  |
| `0x690` | `m_Entity_vBoxProjectMins` | Vector |  |  |
| `0x69c` | `m_Entity_vBoxProjectMaxs` | Vector |  |  |
| `0x6a8` | `m_Entity_bMoveable` | bool |  |  |
| `0x6ac` | `m_Entity_nHandshake` | int32 |  |  |
| `0x6b0` | `m_Entity_nEnvCubeMapArrayIndex` | int32 |  |  |
| `0x6b4` | `m_Entity_nPriority` | int32 |  |  |
| `0x6b8` | `m_Entity_flEdgeFadeDist` | float32 |  |  |
| `0x6bc` | `m_Entity_vEdgeFadeDists` | Vector |  |  |
| `0x6c8` | `m_Entity_flDiffuseScale` | float32 |  |  |
| `0x6cc` | `m_Entity_bStartDisabled` | bool |  |  |
| `0x6cd` | `m_Entity_bDefaultEnvMap` | bool |  |  |
| `0x6ce` | `m_Entity_bDefaultSpecEnvMap` | bool |  |  |
| `0x6cf` | `m_Entity_bIndoorCubeMap` | bool |  |  |
| `0x6d0` | `m_Entity_bCopyDiffuseFromDefaultCubemap` | bool |  |  |
| `0x6e0` | `m_Entity_bEnabled` | bool |  |  |
