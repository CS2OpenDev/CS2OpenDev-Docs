...
[Schemas](../../schemas.md) / [client](../client.md) / C_Inferno
...
**Derived by:** [C_FireCrackerBlast](../client/C_FireCrackerBlast.md)
...
153 fields (24 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xff0` | `m_nfxFireDamageEffect` | [ParticleIndex_t](../server/ParticleIndex_t.md) |  |  |
| `0xff8` | `m_hInfernoPointsSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1000` | `m_hInfernoFillerPointsSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1008` | `m_hInfernoOutlinePointsSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1010` | `m_hInfernoClimbingOutlinePointsSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1018` | `m_hInfernoDecalsSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1020` | `m_firePositions` | VectorWS[64] |  |  |
| `0x1320` | `m_fireParentPositions` | VectorWS[64] |  |  |
| `0x1620` | `m_bFireIsBurning` | bool[64] |  |  |
| `0x1660` | `m_BurnNormal` | Vector[64] |  |  |
| `0x1960` | `m_fireCount` | int32 |  |  |
| `0x1964` | `m_nInfernoType` | int32 |  |  |
| `0x1968` | `m_nFireLifetime` | float32 |  |  |
| `0x196c` | `m_bInPostEffectTime` | bool |  |  |
| `0x1970` | `m_lastFireCount` | int32 |  |  |
| `0x1974` | `m_nFireEffectTickBegin` | int32 |  |  |
| `0x8580` | `m_drawableCount` | int32 |  |  |
| `0x8584` | `m_blosCheck` | bool |  |  |
| `0x8588` | `m_nlosperiod` | int32 |  |  |
| `0x858c` | `m_maxFireHalfWidth` | float32 |  |  |
| `0x8590` | `m_maxFireHeight` | float32 |  |  |
| `0x8594` | `m_minBounds` | VectorWS |  |  |
| `0x85a0` | `m_maxBounds` | VectorWS |  |  |
| `0x85ac` | `m_flLastGrassBurnThink` | float32 |  |  |
