---
title: CMapInfo (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CMapInfo
...
**Twin:** [CMapInfo (server)](../server/CMapInfo.md)
...
| `0x600` | `m_iBuyingStatus` | int32 |  |  |
| `0x604` | `m_flBombRadius` | float32 |  |  |
| `0x608` | `m_iPetPopulation` | int32 |  |  |
| `0x60c` | `m_bUseNormalSpawnsForDM` | bool |  |  |
| `0x60d` | `m_bDisableAutoGeneratedDMSpawns` | bool |  |  |
| `0x610` | `m_flBotMaxVisionDistance` | float32 |  |  |
| `0x614` | `m_iHostageCount` | int32 |  |  |
| `0x618` | `m_bFadePlayerVisibilityFarZ` | bool |  |  |
| `0x619` | `m_bRainTraceToSkyEnabled` | bool |  |  |
| `0x61a` | `m_bGPUCullSkybox` | bool |  |  |
| `0x61c` | `m_flEnvRainStrength` | float32 |  |  |
| `0x620` | `m_flEnvPuddleRippleStrength` | float32 |  |  |
| `0x624` | `m_flEnvPuddleRippleDirection` | float32 |  |  |
| `0x628` | `m_flEnvWetnessCoverage` | float32 |  |  |
| `0x62c` | `m_flEnvWetnessDryingAmount` | float32 |  |  |
