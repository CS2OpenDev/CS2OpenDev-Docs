...
[Schemas](../../schemas.md) / [client](../client.md) / C_TriggerPhysics

# C_TriggerPhysics

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4328 bytes (`0x10e8`) · **Align:** 8 · **Module:** client
...
154 fields (13 declared here, 141 inherited). Offsets are absolute from the object base.
...
| `0x1098` | `m_gravityScale` | float32 |  |  |
| `0x109c` | `m_linearLimit` | float32 |  |  |
| `0x10a0` | `m_linearDamping` | float32 |  |  |
| `0x10a4` | `m_angularLimit` | float32 |  |  |
| `0x10a8` | `m_angularDamping` | float32 |  |  |
| `0x10ac` | `m_linearForce` | float32 |  |  |
| `0x10b0` | `m_flFrequency` | float32 |  |  |
| `0x10b4` | `m_flDampingRatio` | float32 |  |  |
| `0x10b8` | `m_vecLinearForcePointAt` | Vector |  |  |
| `0x10c4` | `m_bCollapseToForcePoint` | bool |  |  |
| `0x10c8` | `m_vecLinearForcePointAtWorld` | VectorWS |  |  |
| `0x10d4` | `m_vecLinearForceDirection` | Vector |  |  |
| `0x10e0` | `m_bConvertToDebrisWhenPossible` | bool |  |  |
