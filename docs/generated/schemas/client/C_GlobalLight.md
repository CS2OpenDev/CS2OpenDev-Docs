...
[Schemas](../../schemas.md) / [client](../client.md) / C_GlobalLight

# C_GlobalLight

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2800 bytes (`0xaf0`) · **Align:** 16 · **Module:** client

**Inherits from:** [C_BaseEntity](../client/C_BaseEntity.md), [CGlobalLightBase](../client/CGlobalLightBase.md)
...
86 fields (1 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0xac0` | `m_WindClothForceHandle` | uint16 |  | `MNotSaved` |

**Also inherits (secondary base classes):** [CGlobalLightBase](../client/CGlobalLightBase.md) — additional-base fields sit at a shifted offset the schema does not record; see each base's own page for its layout.
