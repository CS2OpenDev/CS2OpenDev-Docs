...
[Schemas](../../schemas.md) / [client](../client.md) / C_PathParticleRope
...
**Derived by:** [C_PathParticleRopeAlias_path_particle_rope_clientside](../client/C_PathParticleRopeAlias_path_particle_rope_clientside.md)
...
101 fields (16 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x608` | `m_bStartActive` | bool |  |  |
| `0x60c` | `m_flMaxSimulationTime` | float32 |  |  |
| `0x610` | `m_iszEffectName` | CUtlSymbolLarge |  |  |
| `0x618` | `m_PathNodes_Name` | CUtlVector< CUtlSymbolLarge > |  |  |
| `0x630` | `m_flParticleSpacing` | float32 |  |  |
| `0x634` | `m_flSlack` | float32 |  |  |
| `0x638` | `m_flRadius` | float32 |  |  |
| `0x63c` | `m_ColorTint` | Color |  |  |
| `0x640` | `m_nEffectState` | int32 |  |  |
| `0x648` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0x650` | `m_PathNodes_Position` | C_NetworkUtlVectorBase< Vector > |  |  |
| `0x668` | `m_PathNodes_TangentIn` | C_NetworkUtlVectorBase< Vector > |  |  |
| `0x680` | `m_PathNodes_TangentOut` | C_NetworkUtlVectorBase< Vector > |  |  |
| `0x698` | `m_PathNodes_Color` | C_NetworkUtlVectorBase< Vector > |  |  |
| `0x6b0` | `m_PathNodes_PinEnabled` | C_NetworkUtlVectorBase< bool > |  |  |
| `0x6c8` | `m_PathNodes_RadiusScale` | C_NetworkUtlVectorBase< float32 > |  |  |
