...
[Schemas](../../schemas.md) / [client](../client.md) / C_BreakableProp

# C_BreakableProp

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4848 bytes (`0x12f0`) · **Align:** 16 · **Module:** client

**Inherits from:** [CBaseProp](../client/CBaseProp.md)

**Derived by:** [C_DynamicProp](../client/C_DynamicProp.md), [C_PhysPropClientside](../client/C_PhysPropClientside.md), [C_PhysicsProp](../client/C_PhysicsProp.md)
...
179 fields (29 declared here, 150 inherited). Offsets are absolute from the object base.
...
| `0x11b0` | `m_CPropDataComponent` | [CPropDataComponent](../client/CPropDataComponent.md) |  |  |
| `0x11f0` | `m_OnStartDeath` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1208` | `m_OnBreak` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1220` | `m_OnHealthChanged` | CEntityOutputTemplate< float32 > |  |  |
| `0x1240` | `m_OnTakeDamage` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1258` | `m_impactEnergyScale` | float32 |  |  |
| `0x125c` | `m_iMinHealthDmg` | int32 |  |  |
| `0x1260` | `m_flPressureDelay` | float32 |  |  |
| `0x1264` | `m_flDefBurstScale` | float32 |  |  |
| `0x1268` | `m_vDefBurstOffset` | Vector |  |  |
| `0x1274` | `m_hBreaker` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x1278` | `m_PerformanceMode` | [PerformanceMode_t](../server/PerformanceMode_t.md) |  |  |
| `0x127c` | `m_flPreventDamageBeforeTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1280` | `m_BreakableContentsType` | [BreakableContentsType_t](../server/BreakableContentsType_t.md) |  |  |
| `0x1288` | `m_strBreakableContentsPropGroupOverride` | CUtlString |  |  |
| `0x1290` | `m_strBreakableContentsParticleOverride` | CUtlString |  |  |
| `0x1298` | `m_bHasBreakPiecesOrCommands` | bool |  |  |
| `0x129c` | `m_explodeDamage` | float32 |  |  |
| `0x12a0` | `m_explodeRadius` | float32 |  |  |
| `0x12a8` | `m_sExplosionType` | CGlobalSymbol |  |  |
| `0x12b0` | `m_explosionDelay` | float32 |  |  |
| `0x12b8` | `m_explosionBuildupSound` | CUtlSymbolLarge |  |  |
| `0x12c0` | `m_explosionCustomEffect` | CUtlSymbolLarge |  |  |
| `0x12c8` | `m_explosionCustomSound` | CUtlSymbolLarge |  |  |
| `0x12d0` | `m_explosionModifier` | CUtlSymbolLarge |  |  |
| `0x12d8` | `m_hPhysicsAttacker` | CHandle< [C_BasePlayerPawn](../client/C_BasePlayerPawn.md) > |  |  |
| `0x12dc` | `m_flLastPhysicsInfluenceTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x12e0` | `m_flDefaultFadeScale` | float32 |  |  |
| `0x12e4` | `m_hLastAttacker` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
