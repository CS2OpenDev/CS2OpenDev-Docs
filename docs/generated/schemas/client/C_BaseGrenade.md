...
[Schemas](../../schemas.md) / [client](../client.md) / C_BaseGrenade

# C_BaseGrenade

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4552 bytes (`0x11c8`) · **Align:** 8 · **Module:** client

**Inherits from:** [CBaseAnimGraph](../client/CBaseAnimGraph.md)

**Derived by:** [C_BaseCSGrenadeProjectile](../client/C_BaseCSGrenadeProjectile.md)
...
158 fields (12 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_bHasWarnedAI` | bool |  |  |
| `0x1181` | `m_bIsSmokeGrenade` | bool |  |  |
| `0x1182` | `m_bIsLive` | bool |  |  |
| `0x1184` | `m_DmgRadius` | float32 |  |  |
| `0x1188` | `m_flDetonateTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x118c` | `m_flWarnAITime` | float32 |  |  |
| `0x1190` | `m_flDamage` | float32 |  |  |
| `0x1198` | `m_iszBounceSound` | CUtlSymbolLarge |  |  |
| `0x11a0` | `m_ExplosionSound` | CUtlString |  |  |
| `0x11a8` | `m_hThrower` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x11c0` | `m_flNextAttack` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11c4` | `m_hOriginalThrower` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
