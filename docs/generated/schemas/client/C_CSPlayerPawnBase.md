...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSPlayerPawnBase

# C_CSPlayerPawnBase

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5248 bytes (`0x1480`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_BasePlayerPawn](../client/C_BasePlayerPawn.md)

**Derived by:** [C_CSObserverPawn](../client/C_CSObserverPawn.md), [C_CSPlayerPawn](../client/C_CSPlayerPawn.md)
...
206 fields (26 declared here, 180 inherited). Offsets are absolute from the object base.
...
| `0x13f0` | `m_pPingServices` | [CCSPlayer_PingServices](../client/CCSPlayer_PingServices.md)* |  |  |
| `0x13f8` | `m_previousPlayerState` | [CSPlayerState](../server/CSPlayerState.md) |  |  |
| `0x13fc` | `m_iPlayerState` | [CSPlayerState](../server/CSPlayerState.md) |  |  |
| `0x1400` | `m_bHasMovedSinceSpawn` | bool |  |  |
| `0x1404` | `m_flLastSpawnTimeIndex` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1408` | `m_iProgressBarDuration` | int32 |  |  |
| `0x140c` | `m_flProgressBarStartTime` | float32 |  |  |
| `0x1410` | `m_flClientDeathTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1414` | `m_flFlashBangTime` | float32 |  |  |
| `0x1418` | `m_flFlashScreenshotAlpha` | float32 |  |  |
| `0x141c` | `m_flFlashOverlayAlpha` | float32 |  |  |
| `0x1420` | `m_bFlashBuildUp` | bool |  |  |
| `0x1421` | `m_bFlashDspHasBeenCleared` | bool |  |  |
| `0x1422` | `m_bFlashScreenshotHasBeenGrabbed` | bool |  |  |
| `0x1424` | `m_flFlashMaxAlpha` | float32 |  |  |
| `0x1428` | `m_flFlashDuration` | float32 |  |  |
| `0x142c` | `m_flClientHealthFadeChangeTimestamp` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1430` | `m_nClientHealthFadeParityValue` | int32 |  |  |
| `0x1434` | `m_fNextThinkPushAway` | float32 |  |  |
| `0x143c` | `m_flCurrentMusicStartTime` | float32 |  |  |
| `0x1440` | `m_flMusicRoundStartTime` | float32 |  |  |
| `0x1444` | `m_bDeferStartMusicOnWarmup` | bool |  |  |
| `0x1448` | `m_flLastSmokeOverlayAlpha` | float32 |  |  |
| `0x144c` | `m_flLastSmokeAge` | float32 |  |  |
| `0x1450` | `m_vLastSmokeOverlayColor` | Vector |  |  |
| `0x1478` | `m_hOriginalController` | CHandle< [CCSPlayerController](../client/CCSPlayerController.md) > |  |  |
