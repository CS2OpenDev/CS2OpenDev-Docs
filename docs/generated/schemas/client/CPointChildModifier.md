---
layout: default
title: CPointChildModifier (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CPointChildModifier
...
**Twin:** [CPointChildModifier (server)](../server/CPointChildModifier.md)
...
| `0x600` | `m_bOrphanInsteadOfDeletingChildrenOnRemove` | bool |  |  |
