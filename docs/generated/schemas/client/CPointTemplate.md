...
| `0x620` | `m_clientOnlyEntityBehavior` | [PointTemplateClientOnlyEntityBehavior_t](../!GlobalTypes/PointTemplateClientOnlyEntityBehavior_t.md) |  | `MNotSaved` |
| `0x624` | `m_ownerSpawnGroupType` | [PointTemplateOwnerSpawnGroupType_t](../!GlobalTypes/PointTemplateOwnerSpawnGroupType_t.md) |  | `MNotSaved` |
