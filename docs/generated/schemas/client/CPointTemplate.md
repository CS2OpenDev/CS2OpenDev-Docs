---
title: CPointTemplate (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CPointTemplate
...
**Twin:** [CPointTemplate (server)](../server/CPointTemplate.md)
...
97 fields (12 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_iszWorldName` | CUtlSymbolLarge |  |  |
| `0x608` | `m_iszSource2EntityLumpName` | CUtlSymbolLarge |  |  |
| `0x610` | `m_iszEntityFilterName` | CUtlSymbolLarge |  |  |
| `0x618` | `m_flTimeoutInterval` | float32 |  |  |
| `0x61c` | `m_bAsynchronouslySpawnEntities` | bool |  |  |
| `0x620` | `m_clientOnlyEntityBehavior` | [PointTemplateClientOnlyEntityBehavior_t](../server/PointTemplateClientOnlyEntityBehavior_t.md) |  | `MNotSaved` |
| `0x624` | `m_ownerSpawnGroupType` | [PointTemplateOwnerSpawnGroupType_t](../server/PointTemplateOwnerSpawnGroupType_t.md) |  | `MNotSaved` |
| `0x628` | `m_createdSpawnGroupHandles` | CUtlVector< uint32 > |  |  |
| `0x640` | `m_SpawnedEntityHandles` | CUtlVector< CEntityHandle > |  |  |
| `0x658` | `m_ScriptSpawnCallback` | HSCRIPT |  | `MNotSaved` |
| `0x660` | `m_ScriptCallbackScope` | HSCRIPT |  | `MNotSaved` |
| `0x668` | `m_OnEntitySpawned` | CEntityOutputTemplate< CUtlVector< CEntityHandle > > |  |  |
