...
[Schemas](../../schemas.md) / [client](../client.md) / C_ShatterGlassShardPhysics

# C_ShatterGlassShardPhysics

**Kind:** class · **Size:** 4152 bytes (`0x1038`) · **Align:** 8 · **Module:** client
...
| `0xfb8` | `m_ShardDesc` | shard_model_desc_t |  | `MNotSaved` |
