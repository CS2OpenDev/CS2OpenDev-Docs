...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvSky

# C_EnvSky

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4112 bytes (`0x1010`) · **Align:** 8 · **Module:** client
...
| `0xfb0` | `m_hSkyMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0xfb8` | `m_hSkyMaterialLightingOnly` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0xfc0` | `m_bStartDisabled` | bool |  |  |
| `0xfc1` | `m_vTintColor` | Color |  |  |
| `0xfc5` | `m_vTintColorLightingOnly` | Color |  |  |
| `0xfcc` | `m_flBrightnessScale` | float32 |  |  |
| `0xfd0` | `m_nFogType` | int32 |  |  |
| `0xfd4` | `m_flFogMinStart` | float32 |  |  |
| `0xfd8` | `m_flFogMinEnd` | float32 |  |  |
| `0xfdc` | `m_flFogMaxStart` | float32 |  |  |
| `0xfe0` | `m_flFogMaxEnd` | float32 |  |  |
| `0xfe4` | `m_bEnabled` | bool |  |  |
