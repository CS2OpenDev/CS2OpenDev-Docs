...
[Schemas](../../schemas.md) / [client](../client.md) / C_BarnLight

# C_BarnLight

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4800 bytes (`0x12c0`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_BaseModelEntity](../client/C_BaseModelEntity.md)

**Derived by:** [C_OmniLight](../client/C_OmniLight.md), [C_RectLight](../client/C_RectLight.md)
...
205 fields (76 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_bEnabled` | bool |  |  |
| `0xfb4` | `m_nColorMode` | int32 |  |  |
| `0xfb8` | `m_Color` | Color |  |  |
| `0xfbc` | `m_flColorTemperature` | float32 |  |  |
| `0xfc0` | `m_flBrightness` | float32 |  |  |
| `0xfc4` | `m_flBrightnessScale` | float32 |  |  |
| `0xfc8` | `m_nDirectLight` | int32 |  |  |
| `0xfcc` | `m_nBakedShadowIndex` | int32 |  |  |
| `0xfd0` | `m_nLightPathUniqueId` | int32 |  |  |
| `0xfd4` | `m_nLightMapUniqueId` | int32 |  |  |
| `0xfd8` | `m_nLuminaireShape` | int32 |  |  |
| `0xfdc` | `m_flLuminaireSize` | float32 |  |  |
| `0xfe0` | `m_flLuminaireAnisotropy` | float32 |  |  |
| `0xfe8` | `m_LightStyleString` | CUtlString |  |  |
| `0xff0` | `m_flLightStyleStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xff8` | `m_QueuedLightStyleStrings` | C_NetworkUtlVectorBase< CUtlString > |  |  |
| `0x1010` | `m_LightStyleEvents` | C_NetworkUtlVectorBase< CUtlString > |  |  |
| `0x1028` | `m_LightStyleTargets` | C_NetworkUtlVectorBase< CHandle< [C_BaseModelEntity](../client/C_BaseModelEntity.md) > > |  |  |
| `0x1040` | `m_StyleEvent` | [CEntityIOOutput](../entity2/CEntityIOOutput.md)[4] |  |  |
| `0x10a0` | `m_hLightCookie` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x10a8` | `m_flShape` | float32 |  |  |
| `0x10ac` | `m_flSoftX` | float32 |  |  |
| `0x10b0` | `m_flSoftY` | float32 |  |  |
| `0x10b4` | `m_flSkirt` | float32 |  |  |
| `0x10b8` | `m_flSkirtNear` | float32 |  |  |
| `0x10bc` | `m_vSizeParams` | Vector |  |  |
| `0x10c8` | `m_flRange` | float32 |  |  |
| `0x10cc` | `m_vShear` | Vector |  |  |
| `0x10d8` | `m_nBakeSpecularToCubemaps` | int32 |  |  |
| `0x10dc` | `m_vBakeSpecularToCubemapsSize` | Vector |  |  |
| `0x10e8` | `m_flBakeSpecularToCubemapsScale` | float32 |  |  |
| `0x10ec` | `m_nCastShadows` | int32 |  |  |
| `0x10f0` | `m_nShadowMapSize` | int32 |  |  |
| `0x10f4` | `m_nShadowPriority` | int32 |  |  |
| `0x10f8` | `m_bContactShadow` | bool |  |  |
| `0x10f9` | `m_bForceShadowsEnabled` | bool |  |  |
| `0x10fc` | `m_nBounceLight` | int32 |  |  |
| `0x1100` | `m_flBounceScale` | float32 |  |  |
| `0x1104` | `m_flMinRoughness` | float32 |  |  |
| `0x1108` | `m_vAlternateColor` | Vector |  |  |
| `0x1114` | `m_fAlternateColorBrightness` | float32 |  |  |
| `0x1118` | `m_nFog` | int32 |  |  |
| `0x111c` | `m_flFogStrength` | float32 |  |  |
| `0x1120` | `m_nFogShadows` | int32 |  |  |
| `0x1124` | `m_flFogScale` | float32 |  |  |
| `0x1128` | `m_flFadeSizeStart` | float32 |  |  |
| `0x112c` | `m_flFadeSizeEnd` | float32 |  |  |
| `0x1130` | `m_flShadowFadeSizeStart` | float32 |  |  |
| `0x1134` | `m_flShadowFadeSizeEnd` | float32 |  |  |
| `0x1138` | `m_bPrecomputedFieldsValid` | bool |  |  |
| `0x113c` | `m_vPrecomputedBoundsMins` | Vector |  |  |
| `0x1148` | `m_vPrecomputedBoundsMaxs` | Vector |  |  |
| `0x1154` | `m_vPrecomputedOBBOrigin` | Vector |  |  |
| `0x1160` | `m_vPrecomputedOBBAngles` | QAngle |  |  |
| `0x116c` | `m_vPrecomputedOBBExtent` | Vector |  |  |
| `0x1178` | `m_nPrecomputedSubFrusta` | int32 |  |  |
| `0x117c` | `m_vPrecomputedOBBOrigin0` | Vector |  |  |
| `0x1188` | `m_vPrecomputedOBBAngles0` | QAngle |  |  |
| `0x1194` | `m_vPrecomputedOBBExtent0` | Vector |  |  |
| `0x11a0` | `m_vPrecomputedOBBOrigin1` | Vector |  |  |
| `0x11ac` | `m_vPrecomputedOBBAngles1` | QAngle |  |  |
| `0x11b8` | `m_vPrecomputedOBBExtent1` | Vector |  |  |
| `0x11c4` | `m_vPrecomputedOBBOrigin2` | Vector |  |  |
| `0x11d0` | `m_vPrecomputedOBBAngles2` | QAngle |  |  |
| `0x11dc` | `m_vPrecomputedOBBExtent2` | Vector |  |  |
| `0x11e8` | `m_vPrecomputedOBBOrigin3` | Vector |  |  |
| `0x11f4` | `m_vPrecomputedOBBAngles3` | QAngle |  |  |
| `0x1200` | `m_vPrecomputedOBBExtent3` | Vector |  |  |
| `0x120c` | `m_vPrecomputedOBBOrigin4` | Vector |  |  |
| `0x1218` | `m_vPrecomputedOBBAngles4` | QAngle |  |  |
| `0x1224` | `m_vPrecomputedOBBExtent4` | Vector |  |  |
| `0x1230` | `m_vPrecomputedOBBOrigin5` | Vector |  |  |
| `0x123c` | `m_vPrecomputedOBBAngles5` | QAngle |  |  |
| `0x1248` | `m_vPrecomputedOBBExtent5` | Vector |  |  |
| `0x1298` | `m_bInitialBoneSetup` | bool |  | `MNotSaved` |
| `0x12a0` | `m_VisClusters` | C_NetworkUtlVectorBase< uint16 > |  |  |
