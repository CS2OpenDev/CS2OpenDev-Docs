...
**Kind:** class · **Size:** 1808 bytes (`0x710`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_PathParticleRope](../client/C_PathParticleRope.md)
...
101 fields (0 declared here, 101 inherited). Offsets are absolute from the object base.
...
| `0x608` | `m_bStartActive` | bool | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x60c` | `m_flMaxSimulationTime` | float32 | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x610` | `m_iszEffectName` | CUtlSymbolLarge | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x618` | `m_PathNodes_Name` | CUtlVector< CUtlSymbolLarge > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x630` | `m_flParticleSpacing` | float32 | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x634` | `m_flSlack` | float32 | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x638` | `m_flRadius` | float32 | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x63c` | `m_ColorTint` | Color | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x640` | `m_nEffectState` | int32 | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x648` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > | [C_PathParticleRope](../client/C_PathParticleRope.md) | `MNotSaved` |
| `0x650` | `m_PathNodes_Position` | C_NetworkUtlVectorBase< Vector > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x668` | `m_PathNodes_TangentIn` | C_NetworkUtlVectorBase< Vector > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x680` | `m_PathNodes_TangentOut` | C_NetworkUtlVectorBase< Vector > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x698` | `m_PathNodes_Color` | C_NetworkUtlVectorBase< Vector > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x6b0` | `m_PathNodes_PinEnabled` | C_NetworkUtlVectorBase< bool > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
| `0x6c8` | `m_PathNodes_RadiusScale` | C_NetworkUtlVectorBase< float32 > | [C_PathParticleRope](../client/C_PathParticleRope.md) |  |
