---
title: VPhysicsCollisionAttribute_t (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / VPhysicsCollisionAttribute_t
...
**Twin:** [VPhysicsCollisionAttribute_t (server)](../server/VPhysicsCollisionAttribute_t.md)
