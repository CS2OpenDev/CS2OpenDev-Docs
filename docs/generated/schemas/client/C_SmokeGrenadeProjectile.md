...
[Schemas](../../schemas.md) / [client](../client.md) / C_SmokeGrenadeProjectile

# C_SmokeGrenadeProjectile

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5144 bytes (`0x1418`) · **Align:** 8 · **Module:** client
...
184 fields (10 declared here, 174 inherited). Offsets are absolute from the object base.
...
| `0x1278` | `m_nSmokeEffectTickBegin` | int32 |  |  |
| `0x127c` | `m_bDidSmokeEffect` | bool |  |  |
| `0x1280` | `m_nRandomSeed` | int32 |  |  |
| `0x1284` | `m_vSmokeColor` | Vector |  |  |
| `0x1290` | `m_vSmokeDetonationPos` | VectorWS |  |  |
| `0x12a0` | `m_VoxelFrameData` | C_NetworkUtlVectorBase< uint8 > |  |  |
| `0x12b8` | `m_nVoxelFrameDataSize` | int32 |  |  |
| `0x12bc` | `m_nVoxelUpdate` | int32 |  |  |
| `0x12c0` | `m_bSmokeVolumeDataReceived` | bool |  |  |
| `0x12c1` | `m_bSmokeEffectSpawned` | bool |  |  |
