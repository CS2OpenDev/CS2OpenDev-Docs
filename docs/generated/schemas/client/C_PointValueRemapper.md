...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointValueRemapper

# C_PointValueRemapper

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1656 bytes (`0x678`) · **Align:** 8 · **Module:** client
...
110 fields (25 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x661` | `m_bFirstUpdate` | bool |  |  |
| `0x664` | `m_flPreviousValue` | float32 |  |  |
| `0x668` | `m_flPreviousUpdateTickTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x66c` | `m_vecPreviousTestPoint` | VectorWS |  |  |
