...
[Schemas](../../schemas.md) / [client](../client.md) / C_DynamicProp

# C_DynamicProp

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5056 bytes (`0x13c0`) · **Align:** 16 · **Module:** client

**Inherits from:** [C_BreakableProp](../client/C_BreakableProp.md)

**Derived by:** [CFuncRetakeBarrier](../client/CFuncRetakeBarrier.md), [C_BasePropDoor](../client/C_BasePropDoor.md), [C_Chicken](../client/C_Chicken.md), [C_DynamicPropAlias_cable_dynamic](../client/C_DynamicPropAlias_cable_dynamic.md), [C_DynamicPropAlias_dynamic_prop](../client/C_DynamicPropAlias_dynamic_prop.md), [C_DynamicPropAlias_prop_dynamic_override](../client/C_DynamicPropAlias_prop_dynamic_override.md)
...
203 fields (24 declared here, 179 inherited). Offsets are absolute from the object base.
...
| `0x1278` | `m_PerformanceMode` | [PerformanceMode_t](../server/PerformanceMode_t.md) | [C_BreakableProp](../client/C_BreakableProp.md) |  |
| `0x127c` | `m_flPreventDamageBeforeTime` | [GameTime_t](../entity2/GameTime_t.md) | [C_BreakableProp](../client/C_BreakableProp.md) |  |
| `0x1280` | `m_BreakableContentsType` | [BreakableContentsType_t](../server/BreakableContentsType_t.md) | [C_BreakableProp](../client/C_BreakableProp.md) |  |
...
| `0x12f0` | `m_bUseHitboxesForRenderBox` | bool |  |  |
| `0x12f1` | `m_bUseAnimGraph` | bool |  |  |
| `0x12f8` | `m_pOutputAnimBegun` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1310` | `m_pOutputAnimOver` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1328` | `m_pOutputAnimLoopCycleOver` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1340` | `m_OnAnimReachedStart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1358` | `m_OnAnimReachedEnd` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1370` | `m_iszIdleAnim` | CUtlSymbolLarge |  |  |
| `0x1378` | `m_nIdleAnimLoopMode` | [AnimLoopMode_t](../server/AnimLoopMode_t.md) |  |  |
| `0x137c` | `m_bRandomizeCycle` | bool |  |  |
| `0x137d` | `m_bStartDisabled` | bool |  |  |
| `0x137e` | `m_bFiredStartEndOutput` | bool |  |  |
| `0x137f` | `m_bForceNpcExclude` | bool |  | `MNotSaved` |
| `0x1380` | `m_bCreateMovableSurfaceGraph` | bool |  |  |
| `0x1381` | `m_bCreateNonSolid` | bool |  | `MNotSaved` |
| `0x1382` | `m_bIsOverrideProp` | bool |  | `MNotSaved` |
| `0x1384` | `m_iInitialGlowState` | int32 |  |  |
| `0x1388` | `m_nGlowRange` | int32 |  |  |
| `0x138c` | `m_nGlowRangeMin` | int32 |  |  |
| `0x1390` | `m_glowColor` | Color |  |  |
| `0x1394` | `m_nGlowTeam` | int32 |  |  |
| `0x1398` | `m_iCachedFrameCount` | int32 |  | `MNotSaved` |
| `0x139c` | `m_vecCachedRenderMins` | Vector |  | `MNotSaved` |
| `0x13a8` | `m_vecCachedRenderMaxs` | Vector |  | `MNotSaved` |
