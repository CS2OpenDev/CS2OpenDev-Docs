...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointClientUIHUD

# C_PointClientUIHUD

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4520 bytes (`0x11a8`) · **Align:** 8 · **Module:** client
...
146 fields (13 declared here, 133 inherited). Offsets are absolute from the object base.
...
| `0xfe8` | `m_bCheckCSSClasses` | bool |  | `MNotSaved` |
| `0x1160` | `m_bIgnoreInput` | bool |  |  |
| `0x1164` | `m_flWidth` | float32 |  |  |
| `0x1168` | `m_flHeight` | float32 |  |  |
| `0x116c` | `m_flDPI` | float32 |  |  |
| `0x1170` | `m_flInteractDistance` | float32 |  |  |
| `0x1174` | `m_flDepthOffset` | float32 |  |  |
| `0x1178` | `m_unOwnerContext` | uint32 |  |  |
| `0x117c` | `m_unHorizontalAlign` | uint32 |  |  |
| `0x1180` | `m_unVerticalAlign` | uint32 |  |  |
| `0x1184` | `m_unOrientation` | uint32 |  |  |
| `0x1188` | `m_bAllowInteractionFromAllSceneWorlds` | bool |  |  |
| `0x1190` | `m_vecCSSClasses` | C_NetworkUtlVectorBase< CUtlSymbolLarge > |  |  |
