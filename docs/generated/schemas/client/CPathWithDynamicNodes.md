...
[Schemas](../../schemas.md) / [client](../client.md) / CPathWithDynamicNodes
...
| `0x610` | `m_CPathQueryComponent` | [CPathQueryComponent](../client/CPathQueryComponent.md) | [CPathSimple](../client/CPathSimple.md) |  |
| `0x700` | `m_pathString` | CUtlString | [CPathSimple](../client/CPathSimple.md) |  |
| `0x708` | `m_bClosedLoop` | bool | [CPathSimple](../client/CPathSimple.md) |  |
| `0x710` | `m_vecPathNodes` | C_NetworkUtlVectorBase< CHandle< [CPathNode](../client/CPathNode.md) > > |  |  |
| `0x730` | `m_xInitialPathWorldToLocal` | CTransform |  |  |
