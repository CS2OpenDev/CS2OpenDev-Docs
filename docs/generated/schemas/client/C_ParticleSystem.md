...
[Schemas](../../schemas.md) / [client](../client.md) / C_ParticleSystem
...
**Derived by:** [C_EnvParticleGlow](../client/C_EnvParticleGlow.md), [C_MapPreviewParticleSystem](../client/C_MapPreviewParticleSystem.md)
...
155 fields (26 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_szSnapshotFileName` | char[512] |  |  |
| `0x11b0` | `m_bActive` | bool |  |  |
| `0x11b1` | `m_bFrozen` | bool |  |  |
| `0x11b4` | `m_flFreezeTransitionDuration` | float32 |  |  |
| `0x11b8` | `m_nStopType` | int32 |  | `MNotSaved` |
| `0x11bc` | `m_bAnimateDuringGameplayPause` | bool |  |  |
| `0x11c0` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0x11c8` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11cc` | `m_flPreSimTime` | float32 |  |  |
| `0x11d0` | `m_vServerControlPoints` | Vector[4] |  |  |
| `0x1200` | `m_iServerControlPointAssignments` | uint8[4] |  |  |
| `0x1204` | `m_hControlPointEnts` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) >[64] |  |  |
| `0x1304` | `m_bDataStringLocalized` | bool |  |  |
| `0x1308` | `m_strDataString` | CUtlString |  |  |
| `0x1310` | `m_bNoSave` | bool |  |  |
| `0x1311` | `m_bNoFreeze` | bool |  |  |
| `0x1312` | `m_bNoRamp` | bool |  |  |
| `0x1313` | `m_bStartActive` | bool |  |  |
| `0x1318` | `m_iszEffectName` | CUtlSymbolLarge |  |  |
| `0x1320` | `m_iszControlPointNames` | CUtlSymbolLarge[64] |  |  |
| `0x1520` | `m_nDataCP` | int32 |  |  |
| `0x1524` | `m_vecDataCPValue` | Vector |  |  |
| `0x1530` | `m_nTintCP` | int32 |  |  |
| `0x1534` | `m_clrTint` | Color |  |  |
| `0x1558` | `m_bOldActive` | bool |  | `MNotSaved` |
| `0x1559` | `m_bOldFrozen` | bool |  | `MNotSaved` |
