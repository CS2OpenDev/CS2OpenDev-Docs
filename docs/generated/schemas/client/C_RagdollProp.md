...
[Schemas](../../schemas.md) / [client](../client.md) / C_RagdollProp
...
**Derived by:** [C_RagdollPropAttached](../client/C_RagdollPropAttached.md)
...
155 fields (9 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_ragEnabled` | C_NetworkUtlVectorBase< bool > |  | `MNotSaved` |
| `0x1198` | `m_ragPos` | C_NetworkUtlVectorBase< Vector > |  | `MNotSaved` |
| `0x11b0` | `m_ragAngles` | C_NetworkUtlVectorBase< QAngle > |  | `MNotSaved` |
| `0x11c8` | `m_flBlendWeight` | float32 |  | `MNotSaved` |
| `0x11cc` | `m_hRagdollSource` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  | `MNotSaved` |
| `0x11d0` | `m_iEyeAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  | `MNotSaved` |
| `0x11d4` | `m_flBlendWeightCurrent` | float32 |  | `MNotSaved` |
| `0x11d8` | `m_parentPhysicsBoneIndices` | CUtlVector< int32 > |  | `MNotSaved` |
| `0x11f0` | `m_worldSpaceBoneComputationOrder` | CUtlVector< int32 > |  | `MNotSaved` |
