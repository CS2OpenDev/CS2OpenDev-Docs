---
title: CCSObserver_MovementServices (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CCSObserver_MovementServices
...
**Twin:** [CCSObserver_MovementServices (server)](../server/CCSObserver_MovementServices.md)
