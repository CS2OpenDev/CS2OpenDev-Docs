...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointCommentaryNode

# C_PointCommentaryNode

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4576 bytes (`0x11e0`) · **Align:** 8 · **Module:** client
...
160 fields (14 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1198` | `m_bActive` | bool |  |  |
| `0x1199` | `m_bWasActive` | bool |  |  |
| `0x119c` | `m_flEndTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11a0` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11a4` | `m_flStartTimeInCommentary` | float32 |  |  |
| `0x11a8` | `m_iszCommentaryFile` | CUtlSymbolLarge |  |  |
| `0x11b0` | `m_iszTitle` | CUtlSymbolLarge |  |  |
| `0x11b8` | `m_iszSpeakers` | CUtlSymbolLarge |  |  |
| `0x11c0` | `m_iNodeNumber` | int32 |  |  |
| `0x11c4` | `m_iNodeNumberMax` | int32 |  |  |
| `0x11c8` | `m_bListenedTo` | bool |  |  |
| `0x11d0` | `m_sndCommentary` | [CSoundPatch](../server/CSoundPatch.md)* |  |  |
| `0x11d8` | `m_hViewPosition` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x11dc` | `m_bRestartAfterRestore` | bool |  | `MNotSaved` |
