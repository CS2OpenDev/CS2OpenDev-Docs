...
[Schemas](../../schemas.md) / [client](../client.md) / C_PlayerSprayDecal

# C_PlayerSprayDecal

**Kind:** class · **Size:** 4288 bytes (`0x10c0`) · **Align:** 8 · **Module:** client
...
145 fields (16 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_nUniqueID` | int32 |  |  |
| `0xfb4` | `m_unAccountID` | uint32 |  |  |
| `0xfb8` | `m_unTraceID` | uint32 |  |  |
| `0xfbc` | `m_rtGcTime` | uint32 |  |  |
| `0xfc0` | `m_vecEndPos` | VectorWS |  |  |
| `0xfcc` | `m_vecStart` | VectorWS |  |  |
| `0xfd8` | `m_vecLeft` | Vector |  |  |
| `0xfe4` | `m_vecNormal` | Vector |  |  |
| `0xff0` | `m_nPlayer` | int32 |  |  |
| `0xff4` | `m_nEntity` | int32 |  |  |
| `0xff8` | `m_nHitbox` | int32 |  |  |
| `0xffc` | `m_flCreationTime` | float32 |  |  |
| `0x1000` | `m_nTintID` | int32 |  |  |
| `0x1004` | `m_nVersion` | uint8 |  |  |
| `0x1005` | `m_ubSignature` | uint8[128] |  |  |
| `0x1090` | `m_SprayRenderHelper` | [CPlayerSprayDecalRenderHelper](../client/CPlayerSprayDecalRenderHelper.md) |  |  |
