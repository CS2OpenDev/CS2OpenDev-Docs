...
[Schemas](../../schemas.md) / [client](../client.md) / C_BasePlayerPawn

# C_BasePlayerPawn

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5088 bytes (`0x13e0`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_BaseCombatCharacter](../client/C_BaseCombatCharacter.md)

**Derived by:** [C_CSPlayerPawnBase](../client/C_CSPlayerPawnBase.md)
...
180 fields (28 declared here, 152 inherited). Offsets are absolute from the object base.
...
| `0x1208` | `m_pWeaponServices` | [CPlayer_WeaponServices](../client/CPlayer_WeaponServices.md)* |  |  |
| `0x1210` | `m_pItemServices` | [CPlayer_ItemServices](../client/CPlayer_ItemServices.md)* |  |  |
| `0x1218` | `m_pAutoaimServices` | [CPlayer_AutoaimServices](../client/CPlayer_AutoaimServices.md)* |  |  |
| `0x1220` | `m_pObserverServices` | [CPlayer_ObserverServices](../client/CPlayer_ObserverServices.md)* |  |  |
| `0x1228` | `m_pWaterServices` | [CPlayer_WaterServices](../client/CPlayer_WaterServices.md)* |  |  |
| `0x1230` | `m_pUseServices` | [CPlayer_UseServices](../client/CPlayer_UseServices.md)* |  |  |
| `0x1238` | `m_pFlashlightServices` | [CPlayer_FlashlightServices](../client/CPlayer_FlashlightServices.md)* |  |  |
| `0x1240` | `m_pCameraServices` | [CPlayer_CameraServices](../client/CPlayer_CameraServices.md)* |  |  |
| `0x1248` | `m_pMovementServices` | [CPlayer_MovementServices](../client/CPlayer_MovementServices.md)* |  |  |
| `0x1258` | `m_ServerViewAngleChanges` | C_UtlVectorEmbeddedNetworkVar< [ViewAngleServerChange_t](../client/ViewAngleServerChange_t.md) > |  | `MNotSaved` |
| `0x12c0` | `v_angle` | QAngle |  |  |
| `0x12cc` | `v_anglePrevious` | QAngle |  |  |
| `0x12d8` | `m_iHideHUD` | uint32 |  |  |
| `0x12e0` | `m_skybox3d` | sky3dparams_t |  |  |
| `0x1370` | `m_flDeathTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1374` | `m_vecPredictionError` | Vector |  | `MNotSaved` |
| `0x1380` | `m_flPredictionErrorTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x13a0` | `m_vecLastCameraSetupLocalOrigin` | Vector |  | `MNotSaved` |
| `0x13ac` | `m_flLastCameraSetupTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x13b0` | `m_flFOVSensitivityAdjust` | float32 |  | `MNotSaved` |
| `0x13b4` | `m_flMouseSensitivity` | float32 |  | `MNotSaved` |
| `0x13b8` | `m_vOldOrigin` | Vector |  | `MNotSaved` |
| `0x13c4` | `m_flOldSimulationTime` | float32 |  | `MNotSaved` |
| `0x13c8` | `m_nLastExecutedCommandNumber` | int32 |  | `MNotSaved` |
| `0x13cc` | `m_nLastExecutedCommandTick` | int32 |  | `MNotSaved` |
| `0x13d0` | `m_hController` | CHandle< [CBasePlayerController](../client/CBasePlayerController.md) > |  |  |
| `0x13d4` | `m_hDefaultController` | CHandle< [CBasePlayerController](../client/CBasePlayerController.md) > |  |  |
| `0x13d8` | `m_bIsSwappingToPredictableController` | bool |  | `MNotSaved` |
