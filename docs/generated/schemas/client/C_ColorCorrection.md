...
[Schemas](../../schemas.md) / [client](../client.md) / C_ColorCorrection

# C_ColorCorrection

**Kind:** class · **Size:** 2120 bytes (`0x848`) · **Align:** 8 · **Module:** client
...
| `0x600` | `m_vecOrigin` | VectorWS |  | `MNotSaved` |
| `0x60c` | `m_MinFalloff` | float32 |  | `MNotSaved` |
| `0x610` | `m_MaxFalloff` | float32 |  | `MNotSaved` |
| `0x614` | `m_flFadeInDuration` | float32 |  | `MNotSaved` |
| `0x618` | `m_flFadeOutDuration` | float32 |  | `MNotSaved` |
| `0x61c` | `m_flMaxWeight` | float32 |  | `MNotSaved` |
| `0x620` | `m_flCurWeight` | float32 |  | `MNotSaved` |
| `0x624` | `m_netlookupFilename` | char[512] |  | `MNotSaved` |
| `0x824` | `m_bEnabled` | bool |  | `MNotSaved` |
| `0x825` | `m_bMaster` | bool |  | `MNotSaved` |
| `0x826` | `m_bClientSide` | bool |  | `MNotSaved` |
| `0x827` | `m_bExclusive` | bool |  | `MNotSaved` |
| `0x828` | `m_bEnabledOnClient` | bool[1] |  | `MNotSaved` |
| `0x82c` | `m_flCurWeightOnClient` | float32[1] |  | `MNotSaved` |
| `0x830` | `m_bFadingIn` | bool[1] |  | `MNotSaved` |
| `0x834` | `m_flFadeStartWeight` | float32[1] |  | `MNotSaved` |
| `0x838` | `m_flFadeStartTime` | float32[1] |  | `MNotSaved` |
| `0x83c` | `m_flFadeDuration` | float32[1] |  | `MNotSaved` |
