---
title: CInfoDynamicShadowHint (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CInfoDynamicShadowHint
...
**Twin:** [CInfoDynamicShadowHint (server)](../server/CInfoDynamicShadowHint.md)

**Inherits from:** [C_PointEntity](../client/C_PointEntity.md)

**Derived by:** [CInfoDynamicShadowHintBox](../client/CInfoDynamicShadowHintBox.md)
...
| `0x604` | `m_flRange` | float32 |  |  |
| `0x608` | `m_nImportance` | int32 |  |  |
| `0x60c` | `m_nLightChoice` | int32 |  |  |
| `0x610` | `m_hLight` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
