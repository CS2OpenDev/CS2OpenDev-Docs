...
[Schemas](../../schemas.md) / [client](../client.md) / C_Hostage

# C_Hostage

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4824 bytes (`0x12d8`) · **Align:** 8 · **Module:** client
...
175 fields (23 declared here, 152 inherited). Offsets are absolute from the object base.
...
| `0x1208` | `m_entitySpottedState` | [EntitySpottedState_t](../client/EntitySpottedState_t.md) |  |  |
| `0x1220` | `m_leader` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x1228` | `m_reuseTimer` | [CountdownTimer](../client/CountdownTimer.md) |  |  |
| `0x1240` | `m_vel` | Vector |  |  |
| `0x124c` | `m_isRescued` | bool |  |  |
| `0x124d` | `m_jumpedThisFrame` | bool |  |  |
| `0x1250` | `m_nHostageState` | int32 |  |  |
| `0x1254` | `m_bHandsHaveBeenCut` | bool |  |  |
| `0x1258` | `m_hHostageGrabber` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x125c` | `m_fLastGrabTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1260` | `m_vecGrabbedPos` | VectorWS |  |  |
| `0x126c` | `m_flRescueStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1270` | `m_flGrabSuccessTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1274` | `m_flDropStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1278` | `m_flDeadOrRescuedTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1280` | `m_blinkTimer` | [CountdownTimer](../client/CountdownTimer.md) |  |  |
| `0x1298` | `m_lookAt` | VectorWS |  |  |
| `0x12a8` | `m_lookAroundTimer` | [CountdownTimer](../client/CountdownTimer.md) |  |  |
| `0x12c0` | `m_isInit` | bool |  |  |
| `0x12c1` | `m_eyeAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  |  |
| `0x12c2` | `m_chestAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  |  |
| `0x12c8` | `m_pPredictionOwner` | [CBasePlayerController](../client/CBasePlayerController.md)* |  |  |
| `0x12d0` | `m_fNewestAlphaThinkTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
