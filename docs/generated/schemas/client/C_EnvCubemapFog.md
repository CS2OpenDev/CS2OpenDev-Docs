...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvCubemapFog

# C_EnvCubemapFog

**Kind:** class · **Size:** 1792 bytes (`0x700`) · **Align:** 8 · **Module:** client
...
109 fields (24 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_flEndDistance` | float32 |  |  |
| `0x604` | `m_flStartDistance` | float32 |  |  |
| `0x608` | `m_flFogFalloffExponent` | float32 |  |  |
| `0x60c` | `m_bHeightFogEnabled` | bool |  |  |
| `0x610` | `m_flFogHeightWidth` | float32 |  |  |
| `0x614` | `m_flFogHeightEnd` | float32 |  |  |
| `0x618` | `m_flFogHeightStart` | float32 |  |  |
| `0x61c` | `m_flFogHeightExponent` | float32 |  |  |
| `0x620` | `m_flLODBias` | float32 |  |  |
| `0x624` | `m_bActive` | bool |  |  |
| `0x625` | `m_bStartDisabled` | bool |  |  |
| `0x628` | `m_flFogMaxOpacity` | float32 |  |  |
| `0x62c` | `m_nCubemapSourceType` | int32 |  |  |
| `0x630` | `m_hSkyMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0x638` | `m_iszSkyEntity` | CUtlSymbolLarge |  |  |
| `0x640` | `m_nHeightFogType` | int32 |  |  |
| `0x644` | `m_nFogHeightBlendMode` | int32 |  |  |
| `0x648` | `m_nFogHeightCoordinateSpace` | int32 |  |  |
| `0x64c` | `m_nDistanceFogType` | int32 |  |  |
| `0x650` | `m_DistanceFogCurveString` | CUtlSymbolLarge |  |  |
| `0x658` | `m_HeightFogCurveString` | CUtlSymbolLarge |  |  |
| `0x6f0` | `m_hFogCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x6f8` | `m_bHasHeightFogEnd` | bool |  |  |
| `0x6f9` | `m_bFirstTime` | bool |  |  |
