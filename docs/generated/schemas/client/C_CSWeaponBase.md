...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSWeaponBase

# C_CSWeaponBase

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 7392 bytes (`0x1ce0`) · **Align:** n/a (unspecified) · **Module:** client

**Inherits from:** [C_BasePlayerWeapon](../client/C_BasePlayerWeapon.md)

**Derived by:** [C_BaseCSGrenade](../client/C_BaseCSGrenade.md), [C_C4](../client/C_C4.md), [C_CSWeaponBaseGun](../client/C_CSWeaponBaseGun.md), [C_CSWeaponBaseShotgun](../client/C_CSWeaponBaseShotgun.md), [C_Knife](../client/C_Knife.md), [C_WeaponBaseItem](../client/C_WeaponBaseItem.md)
...
227 fields (54 declared here, 173 inherited). Offsets are absolute from the object base.
...
| `0x16d8` | `m_vecAttachedModels` | CUtlVector< [C_EconEntity::AttachedModelData_t](../client/C_EconEntity.AttachedModelData_t.md) > | [C_EconEntity](../client/C_EconEntity.md) |  |
...
| `0x1778` | `m_iWeaponGameplayAnimState` | [WeaponGameplayAnimState](../server/WeaponGameplayAnimState.md) |  |  |
| `0x177c` | `m_flWeaponGameplayAnimStateTimestamp` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1780` | `m_flInspectCancelCompleteTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1784` | `m_bInspectPending` | bool |  |  |
| `0x1785` | `m_bInspectShouldLoop` | bool |  |  |
| `0x17b0` | `m_flCrosshairDistance` | float32 |  |  |
| `0x17b4` | `m_iAmmoLastCheck` | int32 |  |  |
| `0x17b8` | `m_nLastEmptySoundCmdNum` | int32 |  |  |
| `0x17bc` | `m_bFireOnEmpty` | bool |  |  |
| `0x17c0` | `m_OnPlayerPickup` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x17d8` | `m_weaponMode` | [CSWeaponMode](../server/CSWeaponMode.md) |  |  |
| `0x17dc` | `m_flTurningInaccuracyDelta` | float32 |  |  |
| `0x17e0` | `m_vecTurningInaccuracyEyeDirLast` | Vector |  |  |
| `0x17ec` | `m_flTurningInaccuracy` | float32 |  |  |
| `0x17f0` | `m_fAccuracyPenalty` | float32 |  |  |
| `0x17f4` | `m_flLastAccuracyUpdateTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x17f8` | `m_fAccuracySmoothedForZoom` | float32 |  |  |
| `0x17fc` | `m_iRecoilIndex` | int32 |  |  |
| `0x1800` | `m_flRecoilIndex` | float32 |  |  |
| `0x1804` | `m_bBurstMode` | bool |  |  |
| `0x1808` | `m_flLastBurstModeChangeTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x180c` | `m_nPostponeFireReadyTicks` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x1810` | `m_flPostponeFireReadyFrac` | float32 |  |  |
| `0x1814` | `m_bInReload` | bool |  |  |
| `0x1818` | `m_nDeployTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x181c` | `m_flDroppedAtTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1824` | `m_bIsHauledBack` | bool |  |  |
| `0x1825` | `m_bSilencerOn` | bool |  |  |
| `0x1828` | `m_flTimeSilencerSwitchComplete` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x182c` | `m_flWeaponActionPlaybackRate` | float32 |  |  |
| `0x1830` | `m_iOriginalTeamNumber` | int32 |  |  |
| `0x1834` | `m_iMostRecentTeamNumber` | int32 |  |  |
| `0x1838` | `m_bDroppedNearBuyZone` | bool |  |  |
| `0x183c` | `m_flNextAttackRenderTimeOffset` | float32 |  |  |
| `0x18e8` | `m_bClearWeaponIdentifyingUGC` | bool |  |  |
| `0x18e9` | `m_bVisualsDataSet` | bool |  |  |
| `0x18ea` | `m_bUIWeapon` | bool |  |  |
| `0x18ec` | `m_nCustomEconReloadEventId` | int32 |  |  |
| `0x18f8` | `m_bCanBePickedUp` | bool |  |  |
| `0x18fc` | `m_nextPrevOwnerUseTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1900` | `m_hPrevOwner` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x1904` | `m_nDropTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x1908` | `m_bWasActiveWeaponWhenDropped` | bool |  |  |
| `0x192c` | `m_donated` | bool |  |  |
| `0x1930` | `m_fLastShotTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1934` | `m_bWasOwnedByCT` | bool |  |  |
| `0x1935` | `m_bWasOwnedByTerrorist` | bool |  |  |
| `0x1938` | `m_flNextClientFireBulletTime` | float32 |  |  |
| `0x193c` | `m_flNextClientFireBulletTime_Repredict` | float32 |  |  |
| `0x1990` | `m_IronSightController` | [C_IronSightController](../client/C_IronSightController.md) |  |  |
| `0x1a40` | `m_iIronSightMode` | int32 |  |  |
| `0x1ab8` | `m_flLastLOSTraceFailureTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1b18` | `m_flWatTickOffset` | float32 |  |  |
| `0x1b2c` | `m_flLastShakeTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
