---
title: CInfoDynamicShadowHintBox (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CInfoDynamicShadowHintBox

# CInfoDynamicShadowHintBox

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1584 bytes (`0x630`) · **Align:** 8 · **Module:** client

**Twin:** [CInfoDynamicShadowHintBox (server)](../server/CInfoDynamicShadowHintBox.md)

**Inherits from:** [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md)
...
92 fields (2 declared here, 90 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_bDisabled` | bool | [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md) |  |
| `0x604` | `m_flRange` | float32 | [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md) |  |
| `0x608` | `m_nImportance` | int32 | [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md) |  |
| `0x60c` | `m_nLightChoice` | int32 | [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md) |  |
| `0x610` | `m_hLight` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > | [CInfoDynamicShadowHint](../client/CInfoDynamicShadowHint.md) |  |
| `0x618` | `m_vBoxMins` | Vector |  |  |
| `0x624` | `m_vBoxMaxs` | Vector |  |  |
