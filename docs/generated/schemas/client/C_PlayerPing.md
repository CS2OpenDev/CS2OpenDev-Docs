...
[Schemas](../../schemas.md) / [client](../client.md) / C_PlayerPing
...
| `0x630` | `m_hPlayer` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x634` | `m_hPingedEntity` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x638` | `m_iType` | int32 |  |  |
| `0x63c` | `m_bUrgent` | bool |  |  |
| `0x63d` | `m_szPlaceName` | char[18] |  |  |
