...
[Schemas](../../schemas.md) / [client](../client.md) / C_FuncConveyor
...
| `0xfb8` | `m_vecMoveDirEntitySpace` | Vector |  |  |
| `0xfc4` | `m_flTargetSpeed` | float32 |  |  |
| `0xfc8` | `m_nTransitionStartTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0xfcc` | `m_nTransitionDurationTicks` | int32 |  |  |
| `0xfd0` | `m_flTransitionStartSpeed` | float32 |  |  |
| `0xfd8` | `m_hConveyorModels` | C_NetworkUtlVectorBase< CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > > |  |  |
| `0xff0` | `m_flCurrentConveyorOffset` | float32 |  |  |
| `0xff4` | `m_flCurrentConveyorSpeed` | float32 |  |  |
