...
[Schemas](../../schemas.md) / [client](../client.md) / C_ColorCorrectionVolume
...
150 fields (9 declared here, 141 inherited). Offsets are absolute from the object base.
...
| `0x1098` | `m_LastEnterWeight` | float32 |  | `MNotSaved` |
| `0x109c` | `m_LastEnterTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x10a0` | `m_LastExitWeight` | float32 |  | `MNotSaved` |
| `0x10a4` | `m_LastExitTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x10a8` | `m_bEnabled` | bool |  | `MNotSaved` |
| `0x10ac` | `m_MaxWeight` | float32 |  | `MNotSaved` |
| `0x10b0` | `m_FadeDuration` | float32 |  | `MNotSaved` |
| `0x10b4` | `m_Weight` | float32 |  | `MNotSaved` |
| `0x10b8` | `m_lookupFilename` | char[512] |  | `MNotSaved` |
