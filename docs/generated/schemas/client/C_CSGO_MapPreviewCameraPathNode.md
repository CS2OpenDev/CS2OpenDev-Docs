...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSGO_MapPreviewCameraPathNode

# C_CSGO_MapPreviewCameraPathNode

**Kind:** class · **Size:** 1616 bytes (`0x650`) · **Align:** 8 · **Module:** client
...
| `0x600` | `m_szParentPathUniqueID` | CUtlSymbolLarge |  |  |
| `0x608` | `m_nPathIndex` | int32 |  |  |
| `0x60c` | `m_vInTangentLocal` | Vector |  |  |
| `0x618` | `m_vOutTangentLocal` | Vector |  |  |
| `0x624` | `m_flFOV` | float32 |  |  |
| `0x628` | `m_flCameraSpeed` | float32 |  |  |
| `0x62c` | `m_flEaseIn` | float32 |  |  |
| `0x630` | `m_flEaseOut` | float32 |  |  |
| `0x634` | `m_vInTangentWorld` | Vector |  |  |
| `0x640` | `m_vOutTangentWorld` | Vector |  |  |
