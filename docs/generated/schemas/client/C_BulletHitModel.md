...
[Schemas](../../schemas.md) / [client](../client.md) / C_BulletHitModel

# C_BulletHitModel

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4560 bytes (`0x11d0`) · **Align:** 8 · **Module:** client
...
| `0x1180` | `m_matLocal` | matrix3x4_t |  |  |
| `0x11b0` | `m_iBoneIndex` | int32 |  |  |
| `0x11b4` | `m_hPlayerParent` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x11b8` | `m_bIsHit` | bool |  |  |
| `0x11bc` | `m_flTimeCreated` | float32 |  |  |
| `0x11c0` | `m_vecStartPos` | VectorWS |  |  |
