...
[Schemas](../../schemas.md) / [client](../client.md) / C_EconEntity

# C_EconEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5872 bytes (`0x16f0`) · **Align:** 8 · **Module:** client

**Inherits from:** [CBaseAnimGraph](../client/CBaseAnimGraph.md), [IHasAttributes](../server/IHasAttributes.md)

**Derived by:** [C_BasePlayerWeapon](../client/C_BasePlayerWeapon.md), [C_EconWearable](../client/C_EconWearable.md), [C_Item](../client/C_Item.md)
...
classDiagram
    ...
    C_EconEntity *-- `C_EconEntity::AttachedModelData_t`
```

## Memory layout

166 fields (20 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1190` | `m_flFlexDelayTime` | float32 |  |  |
| `0x1198` | `m_flFlexDelayedWeight` | float32* |  |  |
| `0x11a0` | `m_bAttributesInitialized` | bool |  |  |
| `0x11a8` | `m_AttributeManager` | [C_AttributeContainer](../client/C_AttributeContainer.md) |  |  |
| `0x1678` | `m_OriginalOwnerXuidLow` | uint32 |  |  |
| `0x167c` | `m_OriginalOwnerXuidHigh` | uint32 |  |  |
| `0x1680` | `m_nFallbackPaintKit` | int32 |  |  |
| `0x1684` | `m_nFallbackSeed` | int32 |  |  |
| `0x1688` | `m_flFallbackWear` | float32 |  |  |
| `0x168c` | `m_nFallbackStatTrak` | int32 |  |  |
| `0x1690` | `m_bClientside` | bool |  |  |
| `0x1691` | `m_bParticleSystemsCreated` | bool |  |  |
| `0x1698` | `m_vecAttachedParticles` | CUtlVector< int32 > |  |  |
| `0x16b0` | `m_hViewmodelAttachment` | CHandle< [CBaseAnimGraph](../client/CBaseAnimGraph.md) > |  |  |
| `0x16b4` | `m_iOldTeam` | int32 |  |  |
| `0x16b8` | `m_bAttachmentDirty` | bool |  |  |
| `0x16bc` | `m_nUnloadedModelIndex` | int32 |  |  |
| `0x16c0` | `m_iNumOwnerValidationRetries` | int32 |  |  |
| `0x16d0` | `m_hOldProvidee` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0x16d8` | `m_vecAttachedModels` | CUtlVector< [C_EconEntity::AttachedModelData_t](../client/C_EconEntity.AttachedModelData_t.md) > |  |  |
