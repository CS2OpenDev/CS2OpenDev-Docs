---
title: CFilterModel (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CFilterModel
...
**Twin:** [CFilterModel (server)](../server/CFilterModel.md)
...
| `0x638` | `m_iFilterModel` | CUtlSymbolLarge |  |  |
