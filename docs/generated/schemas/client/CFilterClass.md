---
title: CFilterClass (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CFilterClass
...
**Twin:** [CFilterClass (server)](../server/CFilterClass.md)
...
| `0x638` | `m_iFilterClass` | CUtlSymbolLarge |  |  |
