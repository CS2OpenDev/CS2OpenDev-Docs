...
[Schemas](../../schemas.md) / [client](../client.md) / C_PlayerVisibility
...
| `0x600` | `m_flVisibilityStrength` | float32 |  |  |
| `0x604` | `m_flFogDistanceMultiplier` | float32 |  |  |
| `0x608` | `m_flFogMaxDensityMultiplier` | float32 |  |  |
| `0x60c` | `m_flFadeTime` | float32 |  |  |
| `0x610` | `m_bStartDisabled` | bool |  |  |
| `0x611` | `m_bIsEnabled` | bool |  |  |
