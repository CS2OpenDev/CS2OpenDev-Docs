...
[Schemas](../../schemas.md) / [client](../client.md) / C_PlantedC4

# C_PlantedC4

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5936 bytes (`0x1730`) · **Align:** 8 · **Module:** client

**Inherits from:** [CBaseAnimGraph](../client/CBaseAnimGraph.md), [IHasAttributes](../server/IHasAttributes.md)
...
175 fields (29 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x11a0` | `m_bBombTicking` | bool |  |  |
| `0x11a4` | `m_nBombSite` | int32 |  |  |
| `0x11a8` | `m_nSourceSoundscapeHash` | int32 |  |  |
| `0x11b0` | `m_entitySpottedState` | [EntitySpottedState_t](../client/EntitySpottedState_t.md) |  |  |
| `0x11c8` | `m_flNextGlow` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11cc` | `m_flNextBeep` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11d0` | `m_flC4Blow` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11d4` | `m_bCannotBeDefused` | bool |  |  |
| `0x11d5` | `m_bHasExploded` | bool |  |  |
| `0x11d8` | `m_flTimerLength` | float32 |  |  |
| `0x11dc` | `m_bBeingDefused` | bool |  |  |
| `0x11e0` | `m_bTriggerWarning` | float32 |  |  |
| `0x11e4` | `m_bExplodeWarning` | float32 |  |  |
| `0x11e8` | `m_bC4Activated` | bool |  |  |
| `0x11e9` | `m_bTenSecWarning` | bool |  |  |
| `0x11ec` | `m_flDefuseLength` | float32 |  |  |
| `0x11f0` | `m_flDefuseCountDown` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x11f4` | `m_bBombDefused` | bool |  |  |
| `0x11f8` | `m_hBombDefuser` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x1200` | `m_AttributeManager` | [C_AttributeContainer](../client/C_AttributeContainer.md) |  |  |
| `0x16d0` | `m_hDefuserMultimeter` | CHandle< [C_Multimeter](../client/C_Multimeter.md) > |  |  |
| `0x16d4` | `m_flNextRadarFlashTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x16d8` | `m_bRadarFlash` | bool |  |  |
| `0x16dc` | `m_pBombDefuser` | CHandle< [C_CSPlayerPawn](../client/C_CSPlayerPawn.md) > |  |  |
| `0x16e0` | `m_fLastDefuseTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x16e8` | `m_pPredictionOwner` | [CBasePlayerController](../client/CBasePlayerController.md)* |  |  |
| `0x16f0` | `m_vecC4ExplodeSpectatePos` | VectorWS |  |  |
| `0x16fc` | `m_vecC4ExplodeSpectateAng` | QAngle |  |  |
| `0x1708` | `m_flC4ExplodeSpectateDuration` | float32 |  |  |
