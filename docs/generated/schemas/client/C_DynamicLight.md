...
[Schemas](../../schemas.md) / [client](../client.md) / C_DynamicLight

# C_DynamicLight

**Kind:** class · **Size:** 4056 bytes (`0xfd8`) · **Align:** 8 · **Module:** client
...
| `0xfb0` | `m_Flags` | uint8 |  | `MNotSaved` |
| `0xfb1` | `m_LightStyle` | uint8 |  | `MNotSaved` |
| `0xfb4` | `m_Radius` | float32 |  | `MNotSaved` |
| `0xfb8` | `m_Exponent` | int32 |  | `MNotSaved` |
| `0xfbc` | `m_InnerAngle` | float32 |  | `MNotSaved` |
| `0xfc0` | `m_OuterAngle` | float32 |  | `MNotSaved` |
| `0xfc4` | `m_SpotRadius` | float32 |  | `MNotSaved` |
