...
[Schemas](../../schemas.md) / [client](../client.md) / C_FogController

# C_FogController

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1648 bytes (`0x670`) · **Align:** 8 · **Module:** client
...
| `0x600` | `m_fog` | fogparams_t |  | `MNotSaved` |
| `0x668` | `m_bUseAngles` | bool |  |  |
| `0x66c` | `m_iChangedVariables` | int32 |  |  |
