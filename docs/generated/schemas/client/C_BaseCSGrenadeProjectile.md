...
[Schemas](../../schemas.md) / [client](../client.md) / C_BaseCSGrenadeProjectile
...
**Inherits from:** [C_BaseGrenade](../client/C_BaseGrenade.md)

**Derived by:** [C_DecoyProjectile](../client/C_DecoyProjectile.md), [C_FlashbangProjectile](../client/C_FlashbangProjectile.md), [C_HEGrenadeProjectile](../client/C_HEGrenadeProjectile.md), [C_MolotovProjectile](../client/C_MolotovProjectile.md), [C_SmokeGrenadeProjectile](../client/C_SmokeGrenadeProjectile.md)
...
174 fields (16 declared here, 158 inherited). Offsets are absolute from the object base.
...
| `0x11c8` | `m_vInitialPosition` | VectorWS |  |  |
| `0x11d4` | `m_vInitialVelocity` | Vector |  |  |
| `0x11e0` | `m_nBounces` | int32 |  |  |
| `0x11e8` | `m_nExplodeEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  |  |
| `0x11f0` | `m_nExplodeEffectTickBegin` | int32 |  |  |
| `0x11f4` | `m_vecExplodeEffectOrigin` | VectorWS |  |  |
| `0x1200` | `m_flSpawnTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1204` | `vecLastTrailLinePos` | Vector |  |  |
| `0x1210` | `flNextTrailLineTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1214` | `m_bExplodeEffectBegan` | bool |  |  |
| `0x1215` | `m_bCanCreateGrenadeTrail` | bool |  |  |
| `0x1218` | `m_nSnapshotTrajectoryEffectIndex` | [ParticleIndex_t](../server/ParticleIndex_t.md) |  |  |
| `0x1220` | `m_hSnapshotTrajectoryParticleSnapshot` | CStrongHandle< [InfoForResourceTypeIParticleSnapshot](../resourcesystem/InfoForResourceTypeIParticleSnapshot.md) > |  |  |
| `0x1228` | `m_arrTrajectoryTrailPoints` | CUtlVector< Vector > |  |  |
| `0x1240` | `m_arrTrajectoryTrailPointCreationTimes` | CUtlVector< float32 > |  |  |
| `0x1258` | `m_flTrajectoryTrailEffectCreationTime` | float32 |  |  |
