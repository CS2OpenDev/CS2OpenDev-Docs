...
[Schemas](../../schemas.md) / [client](../client.md) / C_Precipitation
...
149 fields (8 declared here, 141 inherited). Offsets are absolute from the object base.
...
| `0x1098` | `m_flDensity` | float32 |  | `MNotSaved` |
| `0x10a8` | `m_flParticleInnerDist` | float32 |  | `MNotSaved` |
| `0x10b0` | `m_pParticleDef` | char* |  | `MNotSaved` |
| `0x10c4` | `m_tParticlePrecipTraceTimer` | [TimedEvent](../client/TimedEvent.md)[1] |  | `MNotSaved` |
| `0x10cc` | `m_bActiveParticlePrecipEmitter` | bool[1] |  | `MNotSaved` |
| `0x10cd` | `m_bParticlePrecipInitialized` | bool |  | `MNotSaved` |
| `0x10ce` | `m_bHasSimulatedSinceLastSceneObjectUpdate` | bool |  | `MNotSaved` |
| `0x10d0` | `m_nAvailableSheetSequencesMaxIndex` | int32 |  | `MNotSaved` |
