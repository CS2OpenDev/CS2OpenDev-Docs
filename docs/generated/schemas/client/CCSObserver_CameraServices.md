...
[Schemas](../../schemas.md) / [client](../client.md) / CCSObserver_CameraServices
...
29 fields (1 declared here, 28 inherited). Offsets are absolute from the object base.
...
| `0x2a8` | `m_hPrevPostProcessingVolume` | CHandle< [C_PostProcessingVolume](../client/C_PostProcessingVolume.md) > |  |  |
