...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSTeam

# C_CSTeam

**Kind:** class · **Size:** 2408 bytes (`0x968`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_Team](../client/C_Team.md)
...
99 fields (10 declared here, 89 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_aPlayerControllers` | C_NetworkUtlVectorBase< CHandle< [CBasePlayerController](../client/CBasePlayerController.md) > > | [C_Team](../client/C_Team.md) |  |
| `0x618` | `m_aPlayers` | C_NetworkUtlVectorBase< CHandle< [C_BasePlayerPawn](../client/C_BasePlayerPawn.md) > > | [C_Team](../client/C_Team.md) |  |
| `0x630` | `m_iScore` | int32 | [C_Team](../client/C_Team.md) |  |
| `0x634` | `m_szTeamname` | char[129] | [C_Team](../client/C_Team.md) |  |
| `0x6b8` | `m_szTeamMatchStat` | char[512] |  |  |
| `0x8b8` | `m_numMapVictories` | int32 |  |  |
| `0x8bc` | `m_bSurrendered` | bool |  |  |
| `0x8c0` | `m_scoreFirstHalf` | int32 |  |  |
| `0x8c4` | `m_scoreSecondHalf` | int32 |  |  |
| `0x8c8` | `m_scoreOvertime` | int32 |  |  |
| `0x8cc` | `m_szClanTeamname` | char[129] |  |  |
| `0x950` | `m_iClanID` | uint32 |  |  |
| `0x954` | `m_szTeamFlagImage` | char[8] |  |  |
| `0x95c` | `m_szTeamLogoImage` | char[8] |  |  |
