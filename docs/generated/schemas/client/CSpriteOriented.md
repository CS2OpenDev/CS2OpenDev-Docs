---
layout: default
title: CSpriteOriented (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CSpriteOriented

# CSpriteOriented

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4144 bytes (`0x1030`) · **Align:** 8 · **Module:** client

**Twin:** [CSpriteOriented (server)](../server/CSpriteOriented.md)

**Inherits from:** [C_Sprite](../client/C_Sprite.md)
...
| `0xfb0` | `m_hSpriteMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfb8` | `m_hAttachedToEntity` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfbc` | `m_nAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfc0` | `m_flSpriteFramerate` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfc4` | `m_flFrame` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfc8` | `m_flDieTime` | [GameTime_t](../entity2/GameTime_t.md) | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfd8` | `m_nBrightness` | uint32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfdc` | `m_flBrightnessDuration` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfe0` | `m_flSpriteScale` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfe4` | `m_flScaleDuration` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfe8` | `m_bWorldSpaceScale` | bool | [C_Sprite](../client/C_Sprite.md) |  |
| `0xfec` | `m_flGlowProxySize` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xff0` | `m_flHDRColorScale` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xff4` | `m_flLastTime` | [GameTime_t](../entity2/GameTime_t.md) | [C_Sprite](../client/C_Sprite.md) |  |
| `0xff8` | `m_flMaxFrame` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0xffc` | `m_flStartScale` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0x1000` | `m_flDestScale` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0x1004` | `m_flScaleTimeStart` | [GameTime_t](../entity2/GameTime_t.md) | [C_Sprite](../client/C_Sprite.md) |  |
| `0x1008` | `m_nStartBrightness` | int32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0x100c` | `m_nDestBrightness` | int32 | [C_Sprite](../client/C_Sprite.md) |  |
| `0x1010` | `m_flBrightnessTimeStart` | [GameTime_t](../entity2/GameTime_t.md) | [C_Sprite](../client/C_Sprite.md) |  |
| `0x1020` | `m_nSpriteWidth` | int32 | [C_Sprite](../client/C_Sprite.md) | `MNotSaved` |
| `0x1024` | `m_nSpriteHeight` | int32 | [C_Sprite](../client/C_Sprite.md) | `MNotSaved` |
| `0x1028` | `m_flSpeed` | float32 | [C_Sprite](../client/C_Sprite.md) |  |
