---
title: CLogicRelay (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CLogicRelay
...
**Twin:** [CLogicRelay (server)](../server/CLogicRelay.md)
...
| `0x600` | `m_OnSpawn` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x618` | `m_OnTrigger` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x630` | `m_bDisabled` | bool |  |  |
| `0x631` | `m_bWaitForRefire` | bool |  |  |
| `0x632` | `m_bTriggerOnce` | bool |  |  |
| `0x633` | `m_bFastRetrigger` | bool |  |  |
| `0x634` | `m_bPassthoughCaller` | bool |  |  |
