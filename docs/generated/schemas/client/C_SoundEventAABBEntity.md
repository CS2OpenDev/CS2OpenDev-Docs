...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundEventAABBEntity
...
102 fields (2 declared here, 100 inherited). Offsets are absolute from the object base.
...
| `0x6c0` | `m_vMins` | Vector |  |  |
| `0x6cc` | `m_vMaxs` | Vector |  |  |
