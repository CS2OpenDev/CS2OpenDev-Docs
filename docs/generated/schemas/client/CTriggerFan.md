---
layout: default
title: CTriggerFan (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CTriggerFan

# CTriggerFan

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4352 bytes (`0x1100`) · **Align:** 16 · **Module:** client

**Twin:** [CTriggerFan (server)](../server/CTriggerFan.md)
...
| `0x1098` | `m_vFanOriginOffset` | Vector |  |  |
| `0x10a4` | `m_vDirection` | Vector |  |  |
| `0x10b0` | `m_bPushTowardsInfoTarget` | bool |  |  |
| `0x10b1` | `m_bPushAwayFromInfoTarget` | bool |  |  |
| `0x10c0` | `m_qNoiseDelta` | Quaternion |  |  |
| `0x10d0` | `m_hInfoFan` | CHandle< [CInfoFan](../client/CInfoFan.md) > |  |  |
| `0x10d4` | `m_flForce` | float32 |  |  |
| `0x10d8` | `m_bFalloff` | bool |  |  |
| `0x10e0` | `m_RampTimer` | [CountdownTimer](../client/CountdownTimer.md) |  |  |
