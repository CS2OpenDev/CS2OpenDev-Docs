...
[Schemas](../../schemas.md) / [client](../client.md) / C_VoteController
...
| `0x610` | `m_iActiveIssueIndex` | int32 |  |  |
| `0x614` | `m_iOnlyTeamToVote` | int32 |  |  |
| `0x618` | `m_nVoteOptionCount` | int32[5] |  |  |
| `0x62c` | `m_nPotentialVotes` | int32 |  |  |
| `0x630` | `m_bVotesDirty` | bool |  |  |
| `0x631` | `m_bTypeDirty` | bool |  |  |
| `0x632` | `m_bIsYesNoVote` | bool |  |  |
