...
[Schemas](../../schemas.md) / [client](../client.md) / C_SceneEntity
...
| `0x608` | `m_bIsPlayingBack` | bool |  | `MNotSaved` |
| `0x609` | `m_bPaused` | bool |  | `MNotSaved` |
| `0x60a` | `m_bMultiplayer` | bool |  | `MNotSaved` |
| `0x60b` | `m_bAutogenerated` | bool |  | `MNotSaved` |
| `0x60c` | `m_bAllRequirementsComplete` | bool |  | `MNotSaved` |
| `0x610` | `m_flForceClientTime` | float32 |  | `MNotSaved` |
| `0x614` | `m_nSceneStringIndex` | uint16 |  | `MNotSaved` |
| `0x616` | `m_bClientOnly` | bool |  | `MNotSaved` |
