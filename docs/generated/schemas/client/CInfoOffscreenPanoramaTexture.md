---
title: CInfoOffscreenPanoramaTexture (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CInfoOffscreenPanoramaTexture

# CInfoOffscreenPanoramaTexture

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2056 bytes (`0x808`) · **Align:** 8 · **Module:** client

**Twin:** [CInfoOffscreenPanoramaTexture (server)](../server/CInfoOffscreenPanoramaTexture.md)
...
| `0x604` | `m_nResolutionX` | int32 |  |  |
| `0x608` | `m_nResolutionY` | int32 |  |  |
| `0x610` | `m_szPanelType` | CUtlSymbolLarge |  |  |
| `0x618` | `m_szLayoutFileName` | CUtlSymbolLarge |  |  |
| `0x620` | `m_RenderAttrName` | CUtlSymbolLarge |  |  |
| `0x628` | `m_TargetEntities` | C_NetworkUtlVectorBase< CHandle< [C_BaseModelEntity](../client/C_BaseModelEntity.md) > > |  |  |
| `0x640` | `m_nTargetChangeCount` | int32 |  |  |
| `0x648` | `m_vecCSSClasses` | C_NetworkUtlVectorBase< CUtlSymbolLarge > |  |  |
| `0x660` | `m_szTargetsName` | CUtlSymbolLarge |  |  |
| `0x668` | `m_AdditionalTargetEntities` | CUtlVector< CHandle< [C_BaseModelEntity](../client/C_BaseModelEntity.md) > > |  |  |
| `0x7e0` | `m_bCheckCSSClasses` | bool |  | `MNotSaved` |
