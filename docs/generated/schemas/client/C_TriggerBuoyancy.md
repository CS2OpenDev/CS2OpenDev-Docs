...
[Schemas](../../schemas.md) / [client](../client.md) / C_TriggerBuoyancy

# C_TriggerBuoyancy

**Kind:** class · **Size:** 4536 bytes (`0x11b8`) · **Align:** 8 · **Module:** client
...
143 fields (2 declared here, 141 inherited). Offsets are absolute from the object base.
...
| `0x1098` | `m_BuoyancyHelper` | [CBuoyancyHelper](../client/CBuoyancyHelper.md) |  |  |
| `0x11b0` | `m_flFluidDensity` | float32 |  |  |
