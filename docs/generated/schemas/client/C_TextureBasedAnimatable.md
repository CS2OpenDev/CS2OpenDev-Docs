...
[Schemas](../../schemas.md) / [client](../client.md) / C_TextureBasedAnimatable
...
137 fields (8 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_bLoop` | bool |  |  |
| `0xfb4` | `m_flFPS` | float32 |  |  |
| `0xfb8` | `m_hPositionKeys` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0xfc0` | `m_hRotationKeys` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0xfc8` | `m_vAnimationBoundsMin` | Vector |  |  |
| `0xfd4` | `m_vAnimationBoundsMax` | Vector |  |  |
| `0xfe0` | `m_flStartTime` | float32 |  | `MNotSaved` |
| `0xfe4` | `m_flStartFrame` | float32 |  |  |
