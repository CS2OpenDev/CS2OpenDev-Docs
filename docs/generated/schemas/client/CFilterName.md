---
layout: default
title: CFilterName (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CFilterName
...
**Twin:** [CFilterName (server)](../server/CFilterName.md)
...
| `0x638` | `m_iFilterName` | CUtlSymbolLarge |  |  |
