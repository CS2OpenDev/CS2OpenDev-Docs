...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSGO_TeamPreviewCamera

# C_CSGO_TeamPreviewCamera

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1680 bytes (`0x690`) · **Align:** n/a (unspecified) · **Module:** client

**Inherits from:** [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md)

**Derived by:** [C_CSGO_CounterTerroristTeamIntroCamera](../client/C_CSGO_CounterTerroristTeamIntroCamera.md), [C_CSGO_CounterTerroristWingmanIntroCamera](../client/C_CSGO_CounterTerroristWingmanIntroCamera.md), [C_CSGO_EndOfMatchCamera](../client/C_CSGO_EndOfMatchCamera.md), [C_CSGO_TeamSelectCamera](../client/C_CSGO_TeamSelectCamera.md), [C_CSGO_TerroristTeamIntroCamera](../client/C_CSGO_TerroristTeamIntroCamera.md), [C_CSGO_TerroristWingmanIntroCamera](../client/C_CSGO_TerroristWingmanIntroCamera.md)
...
100 fields (1 declared here, 99 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_flZFar` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x604` | `m_flZNear` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x608` | `m_bLoop` | bool | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x609` | `m_bVerticalFOV` | bool | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x60a` | `m_bConstantSpeed` | bool | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x60c` | `m_flDuration` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x650` | `m_flPathLength` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x654` | `m_flPathDuration` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x66c` | `m_bDofEnabled` | bool | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x670` | `m_flDofNearBlurry` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x674` | `m_flDofNearCrisp` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x678` | `m_flDofFarCrisp` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x67c` | `m_flDofFarBlurry` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x680` | `m_flDofTiltToGround` | float32 | [C_CSGO_MapPreviewCameraPath](../client/C_CSGO_MapPreviewCameraPath.md) |  |
| `0x688` | `m_nVariant` | int32 |  |  |
