...
[Schemas](../../schemas.md) / [client](../client.md) / C_BaseTrigger
...
**Inherits from:** [C_BaseToggle](../client/C_BaseToggle.md)

**Derived by:** [CBombTarget](../client/CBombTarget.md), [CHostageRescueZoneShim](../client/CHostageRescueZoneShim.md), [CTriggerFan](../client/CTriggerFan.md), [C_ColorCorrectionVolume](../client/C_ColorCorrectionVolume.md), [C_FootstepControl](../client/C_FootstepControl.md), [C_PostProcessingVolume](../client/C_PostProcessingVolume.md), [C_Precipitation](../client/C_Precipitation.md), [C_TriggerBuoyancy](../client/C_TriggerBuoyancy.md), [C_TriggerLerpObject](../client/C_TriggerLerpObject.md), [C_TriggerMultiple](../client/C_TriggerMultiple.md), [C_TriggerPhysics](../client/C_TriggerPhysics.md)
...
141 fields (12 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_OnStartTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xfc8` | `m_OnStartTouchAll` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xfe0` | `m_OnEndTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xff8` | `m_OnEndTouchAll` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1010` | `m_OnTouching` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1028` | `m_OnTouchingEachEntity` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1040` | `m_OnNotTouching` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1058` | `m_OnTouchingChanged` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x1070` | `m_hTouchingEntities` | CUtlVector< CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > > |  |  |
| `0x1088` | `m_iFilterName` | CUtlSymbolLarge |  |  |
| `0x1090` | `m_hFilter` | CHandle< [CBaseFilter](../client/CBaseFilter.md) > |  |  |
| `0x1094` | `m_bDisabled` | bool |  |  |
