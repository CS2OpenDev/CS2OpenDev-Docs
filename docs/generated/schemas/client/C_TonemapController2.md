...
[Schemas](../../schemas.md) / [client](../client.md) / C_TonemapController2
...
**Derived by:** [C_TonemapController2Alias_env_tonemap_controller2](../client/C_TonemapController2Alias_env_tonemap_controller2.md)
...
90 fields (5 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_flAutoExposureMin` | float32 |  |  |
| `0x604` | `m_flAutoExposureMax` | float32 |  |  |
| `0x608` | `m_flExposureAdaptationSpeedUp` | float32 |  |  |
| `0x60c` | `m_flExposureAdaptationSpeedDown` | float32 |  |  |
| `0x610` | `m_flTonemapEVSmoothingRange` | float32 |  |  |
