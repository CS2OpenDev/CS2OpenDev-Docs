...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundEventConeEntity

# C_SoundEventConeEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1752 bytes (`0x6d8`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_SoundEventEntity](../client/C_SoundEventEntity.md)
...
105 fields (5 declared here, 100 inherited). Offsets are absolute from the object base.

| Offset | Field | Type | From | Annotations |
|--------|-------|------|------|-------------|
| `0x0` bit 0 | `m_bClientSideOnly` | bitfield:1 | [C_SoundEventEntity](../client/C_SoundEventEntity.md) | `MNotSaved` |
...
| `0x600` | `m_bStartOnSpawn` | bool | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x601` | `m_bToLocalPlayer` | bool | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x602` | `m_bStopOnNew` | bool | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x603` | `m_bSaveRestore` | bool | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x604` | `m_bSavedIsPlaying` | bool | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x608` | `m_flSavedElapsedTime` | float32 | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x610` | `m_iszSourceEntityName` | CUtlSymbolLarge | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x618` | `m_iszAttachmentName` | CUtlSymbolLarge | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x620` | `m_onGUIDChanged` | CEntityOutputTemplate< SndOpEventGuid_t > | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x650` | `m_onSoundFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x668` | `m_flClientCullRadius` | float32 | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x698` | `m_iszSoundName` | CUtlSymbolLarge | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x6b4` | `m_hSource` | CEntityHandle | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x6b8` | `m_nEntityIndexSelection` | int32 | [C_SoundEventEntity](../client/C_SoundEventEntity.md) |  |
| `0x6c0` | `m_flEmitterAngle` | float32 |  |  |
| `0x6c4` | `m_flSweetSpotAngle` | float32 |  |  |
| `0x6c8` | `m_flAttenMin` | float32 |  |  |
| `0x6cc` | `m_flAttenMax` | float32 |  |  |
| `0x6d0` | `m_iszParameterName` | CUtlSymbolLarge |  |  |
