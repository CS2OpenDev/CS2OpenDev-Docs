...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointClientUIWorldPanel

# C_PointClientUIWorldPanel

**Kind:** class · **Size:** 4624 bytes (`0x1210`) · **Align:** 16 · **Module:** client

**Inherits from:** [C_BaseClientUIEntity](../client/C_BaseClientUIEntity.md)

**Derived by:** [CPointOffScreenIndicatorUi](../client/CPointOffScreenIndicatorUi.md), [C_PointClientUIWorldTextPanel](../client/C_PointClientUIWorldTextPanel.md)
...
163 fields (30 declared here, 133 inherited). Offsets are absolute from the object base.
...
| `0xfe8` | `m_bForceRecreateNextUpdate` | bool |  | `MNotSaved` |
| `0xfe9` | `m_bMoveViewToPlayerNextThink` | bool |  | `MNotSaved` |
| `0xfea` | `m_bCheckCSSClasses` | bool |  | `MNotSaved` |
| `0xff0` | `m_anchorDeltaTransform` | CTransform |  | `MNotSaved` |
| `0x1180` | `m_pOffScreenIndicator` | [CPointOffScreenIndicatorUi](../client/CPointOffScreenIndicatorUi.md)* |  | `MNotSaved` |
| `0x11a8` | `m_bIgnoreInput` | bool |  |  |
| `0x11a9` | `m_bLit` | bool |  |  |
| `0x11aa` | `m_bFollowPlayerAcrossTeleport` | bool |  |  |
| `0x11ac` | `m_flWidth` | float32 |  |  |
| `0x11b0` | `m_flHeight` | float32 |  |  |
| `0x11b4` | `m_flDPI` | float32 |  |  |
| `0x11b8` | `m_flInteractDistance` | float32 |  |  |
| `0x11bc` | `m_flDepthOffset` | float32 |  |  |
| `0x11c0` | `m_unOwnerContext` | uint32 |  |  |
| `0x11c4` | `m_unHorizontalAlign` | uint32 |  |  |
| `0x11c8` | `m_unVerticalAlign` | uint32 |  |  |
| `0x11cc` | `m_unOrientation` | uint32 |  |  |
| `0x11d0` | `m_bAllowInteractionFromAllSceneWorlds` | bool |  |  |
| `0x11d8` | `m_vecCSSClasses` | C_NetworkUtlVectorBase< CUtlSymbolLarge > |  |  |
| `0x11f0` | `m_bOpaque` | bool |  |  |
| `0x11f1` | `m_bNoDepth` | bool |  |  |
| `0x11f2` | `m_bVisibleWhenParentNoDraw` | bool |  |  |
| `0x11f3` | `m_bRenderBackface` | bool |  |  |
| `0x11f4` | `m_bUseOffScreenIndicator` | bool |  |  |
| `0x11f5` | `m_bExcludeFromSaveGames` | bool |  |  |
| `0x11f6` | `m_bGrabbable` | bool |  |  |
| `0x11f7` | `m_bOnlyRenderToTexture` | bool |  |  |
| `0x11f8` | `m_bDisableMipGen` | bool |  |  |
| `0x11fc` | `m_nExplicitImageLayout` | int32 |  |  |
| `0x1200` | `m_bIgnoreParentOrientation` | bool |  |  |
