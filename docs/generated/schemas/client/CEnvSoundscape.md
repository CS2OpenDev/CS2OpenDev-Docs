---
title: CEnvSoundscape (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CEnvSoundscape
...
**Twin:** [CEnvSoundscape (server)](../server/CEnvSoundscape.md)

**Inherits from:** [C_BaseEntity](../client/C_BaseEntity.md)

**Derived by:** [CEnvSoundscapeAlias_snd_soundscape](../client/CEnvSoundscapeAlias_snd_soundscape.md), [CEnvSoundscapeProxy](../client/CEnvSoundscapeProxy.md), [CEnvSoundscapeTriggerable](../client/CEnvSoundscapeTriggerable.md)
...
96 fields (11 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_OnPlay` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x618` | `m_flRadius` | float32 |  |  |
| `0x620` | `m_soundEventName` | CGameSoundEventName |  |  |
| `0x628` | `m_bOverrideWithEvent` | bool |  |  |
| `0x62c` | `m_soundscapeIndex` | int32 |  | `MNotSaved` |
| `0x630` | `m_soundscapeEntityListId` | int32 |  | `MNotSaved` |
| `0x638` | `m_positionNames` | CUtlSymbolLarge[8] |  |  |
| `0x678` | `m_hProxySoundscape` | CHandle< [CEnvSoundscape](../client/CEnvSoundscape.md) > |  |  |
| `0x67c` | `m_bDisabled` | bool |  |  |
| `0x680` | `m_soundscapeName` | CUtlSymbolLarge |  |  |
| `0x688` | `m_soundEventHash` | uint32 |  | `MNotSaved` |
