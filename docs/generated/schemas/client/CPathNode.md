---
title: CPathNode (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CPathNode

# CPathNode

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1632 bytes (`0x660`) · **Align:** 16 · **Module:** client

**Twin:** [CPathNode (server)](../server/CPathNode.md)
...
| `0x600` | `m_vInTangentLocal` | Vector |  |  |
| `0x60c` | `m_vOutTangentLocal` | Vector |  |  |
| `0x618` | `m_strParentPathUniqueID` | CUtlString |  |  |
| `0x620` | `m_strPathNodeParameter` | CUtlString |  |  |
| `0x630` | `m_xWSPrevParent` | CTransformWS |  |  |
| `0x650` | `m_hPath` | CHandle< [CPathWithDynamicNodes](../client/CPathWithDynamicNodes.md) > |  |  |
