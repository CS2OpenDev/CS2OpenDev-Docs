...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundEventPathCornerEntity
...
101 fields (1 declared here, 100 inherited). Offsets are absolute from the object base.
...
| `0x6c0` | `m_vecCornerPairsNetworked` | C_NetworkUtlVectorBase< [SoundeventPathCornerPairNetworked_t](../server/SoundeventPathCornerPairNetworked_t.md) > |  | `MNotSaved` |
