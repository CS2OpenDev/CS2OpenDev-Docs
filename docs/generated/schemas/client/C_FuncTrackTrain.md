...
[Schemas](../../schemas.md) / [client](../client.md) / C_FuncTrackTrain
...
| `0xfb0` | `m_nLongAxis` | int32 |  | `MNotSaved` |
| `0xfb4` | `m_flRadius` | float32 |  | `MNotSaved` |
| `0xfb8` | `m_flLineLength` | float32 |  | `MNotSaved` |
