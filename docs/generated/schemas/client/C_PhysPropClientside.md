...
[Schemas](../../schemas.md) / [client](../client.md) / C_PhysPropClientside

# C_PhysPropClientside

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4896 bytes (`0x1320`) · **Align:** 16 · **Module:** client
...
184 fields (5 declared here, 179 inherited). Offsets are absolute from the object base.
...
| `0x12f0` | `m_flTouchDelta` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x12f4` | `m_fDeathTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x12f8` | `m_vecDamagePosition` | VectorWS |  | `MNotSaved` |
| `0x1304` | `m_vecDamageDirection` | Vector |  | `MNotSaved` |
| `0x1310` | `m_nDamageType` | [DamageTypes_t](../server/DamageTypes_t.md) |  | `MNotSaved` |
