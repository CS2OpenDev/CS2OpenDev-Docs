...
[Schemas](../../schemas.md) / [client](../client.md) / C_Team
...
**Derived by:** [C_CSTeam](../client/C_CSTeam.md)
...
89 fields (4 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_aPlayerControllers` | C_NetworkUtlVectorBase< CHandle< [CBasePlayerController](../client/CBasePlayerController.md) > > |  |  |
| `0x618` | `m_aPlayers` | C_NetworkUtlVectorBase< CHandle< [C_BasePlayerPawn](../client/C_BasePlayerPawn.md) > > |  |  |
| `0x630` | `m_iScore` | int32 |  |  |
| `0x634` | `m_szTeamname` | char[129] |  |  |
