...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvVolumetricFogVolume

# C_EnvVolumetricFogVolume

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1608 bytes (`0x648`) · **Align:** 8 · **Module:** client
...
| `0x600` | `m_bActive` | bool |  |  |
| `0x604` | `m_vBoxMins` | Vector |  |  |
| `0x610` | `m_vBoxMaxs` | Vector |  |  |
| `0x61c` | `m_bStartDisabled` | bool |  |  |
| `0x61d` | `m_bIndirectUseLPVs` | bool |  |  |
| `0x620` | `m_flStrength` | float32 |  |  |
| `0x624` | `m_nFalloffShape` | int32 |  |  |
| `0x628` | `m_flFalloffExponent` | float32 |  |  |
| `0x62c` | `m_flHeightFogDepth` | float32 |  |  |
| `0x630` | `m_fHeightFogEdgeWidth` | float32 |  |  |
| `0x634` | `m_fIndirectLightStrength` | float32 |  |  |
| `0x638` | `m_fSunLightStrength` | float32 |  |  |
| `0x63c` | `m_fNoiseStrength` | float32 |  |  |
| `0x640` | `m_TintColor` | Color |  |  |
| `0x644` | `m_bOverrideTintColor` | bool |  |  |
| `0x645` | `m_bOverrideIndirectLightStrength` | bool |  |  |
| `0x646` | `m_bOverrideSunLightStrength` | bool |  |  |
| `0x647` | `m_bOverrideNoiseStrength` | bool |  |  |
