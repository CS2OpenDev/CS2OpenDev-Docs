...
[Schemas](../../schemas.md) / [client](../client.md) / C_Sprite
...
**Derived by:** [CSpriteOriented](../client/CSpriteOriented.md)
...
| `0xfb0` | `m_hSpriteMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0xfb8` | `m_hAttachedToEntity` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0xfbc` | `m_nAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  |  |
| `0xfc0` | `m_flSpriteFramerate` | float32 |  |  |
| `0xfc4` | `m_flFrame` | float32 |  |  |
| `0xfc8` | `m_flDieTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xfd8` | `m_nBrightness` | uint32 |  |  |
| `0xfdc` | `m_flBrightnessDuration` | float32 |  |  |
| `0xfe0` | `m_flSpriteScale` | float32 |  |  |
| `0xfe4` | `m_flScaleDuration` | float32 |  |  |
| `0xfe8` | `m_bWorldSpaceScale` | bool |  |  |
| `0xfec` | `m_flGlowProxySize` | float32 |  |  |
| `0xff0` | `m_flHDRColorScale` | float32 |  |  |
| `0xff4` | `m_flLastTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xff8` | `m_flMaxFrame` | float32 |  |  |
| `0xffc` | `m_flStartScale` | float32 |  |  |
| `0x1000` | `m_flDestScale` | float32 |  |  |
| `0x1004` | `m_flScaleTimeStart` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1008` | `m_nStartBrightness` | int32 |  |  |
| `0x100c` | `m_nDestBrightness` | int32 |  |  |
| `0x1010` | `m_flBrightnessTimeStart` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x1020` | `m_nSpriteWidth` | int32 |  | `MNotSaved` |
| `0x1024` | `m_nSpriteHeight` | int32 |  | `MNotSaved` |
| `0x1028` | `m_flSpeed` | float32 |  |  |
