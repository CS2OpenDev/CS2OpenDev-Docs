---
title: CPathSimple (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CPathSimple

# CPathSimple

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1808 bytes (`0x710`) · **Align:** 16 · **Module:** client

**Twin:** [CPathSimple (server)](../server/CPathSimple.md)

**Inherits from:** [C_BaseEntity](../client/C_BaseEntity.md)

**Derived by:** [CPathWithDynamicNodes](../client/CPathWithDynamicNodes.md)
...
| `0x610` | `m_CPathQueryComponent` | [CPathQueryComponent](../client/CPathQueryComponent.md) |  |  |
| `0x700` | `m_pathString` | CUtlString |  |  |
| `0x708` | `m_bClosedLoop` | bool |  |  |
