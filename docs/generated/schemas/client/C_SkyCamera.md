...
[Schemas](../../schemas.md) / [client](../client.md) / C_SkyCamera
...
| `0x600` | `m_skyboxData` | sky3dparams_t |  | `MNotSaved` |
| `0x690` | `m_skyboxSlotToken` | CUtlStringToken |  |  |
| `0x694` | `m_bUseAngles` | bool |  |  |
| `0x698` | `m_pNext` | [C_SkyCamera](../client/C_SkyCamera.md)* |  | `MNotSaved` |
