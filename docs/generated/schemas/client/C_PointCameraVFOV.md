...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointCameraVFOV

# C_PointCameraVFOV

**Kind:** class · **Size:** 1640 bytes (`0x668`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_PointCamera](../client/C_PointCamera.md)
...
112 fields (1 declared here, 111 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_FOV` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x604` | `m_Resolution` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x608` | `m_bFogEnable` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x609` | `m_FogColor` | Color | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x610` | `m_flFogStart` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x614` | `m_flFogEnd` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x618` | `m_flFogMaxDensity` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x61c` | `m_bActive` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x61d` | `m_bUseScreenAspectRatio` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x620` | `m_flAspectRatio` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x624` | `m_bNoSky` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x628` | `m_fBrightness` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x62c` | `m_flZFar` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x630` | `m_flZNear` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x634` | `m_bCanHLTVUse` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x635` | `m_bAlignWithParent` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x636` | `m_bDofEnabled` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x638` | `m_flDofNearBlurry` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x63c` | `m_flDofNearCrisp` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x640` | `m_flDofFarCrisp` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x644` | `m_flDofFarBlurry` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x648` | `m_flDofTiltToGround` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x64c` | `m_TargetFOV` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x650` | `m_DegreesPerSecond` | float32 | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x654` | `m_bIsOn` | bool | [C_PointCamera](../client/C_PointCamera.md) |  |
| `0x658` | `m_pNext` | [C_PointCamera](../client/C_PointCamera.md)* | [C_PointCamera](../client/C_PointCamera.md) | `MNotSaved` |
| `0x660` | `m_flVerticalFOV` | float32 |  |  |
