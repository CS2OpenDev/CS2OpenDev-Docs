---
title: CRagdollManager (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CRagdollManager
...
**Twin:** [CRagdollManager (server)](../server/CRagdollManager.md)
...
| `0x600` | `m_iCurrentMaxRagdollCount` | int8 |  |  |
