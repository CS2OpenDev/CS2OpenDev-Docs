...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvWindController

# C_EnvWindController

**Kind:** class · **Size:** 1824 bytes (`0x720`) · **Align:** 8 · **Module:** client
...
| `0x600` | `m_EnvWindShared` | [C_EnvWindShared](../client/C_EnvWindShared.md) |  |  |
| `0x6f8` | `m_fDirectionVariation` | float32 |  |  |
| `0x6fc` | `m_fSpeedVariation` | float32 |  |  |
| `0x700` | `m_fTurbulence` | float32 |  |  |
| `0x704` | `m_fVolumeHalfExtentXY` | float32 |  |  |
| `0x708` | `m_fVolumeHalfExtentZ` | float32 |  |  |
| `0x70c` | `m_nVolumeResolutionXY` | int32 |  |  |
| `0x710` | `m_nVolumeResolutionZ` | int32 |  |  |
| `0x714` | `m_nClipmapLevels` | int32 |  |  |
| `0x718` | `m_bIsMaster` | bool |  |  |
| `0x719` | `m_bFirstTime` | bool |  |  |
