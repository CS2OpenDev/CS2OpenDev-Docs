---
layout: default
title: FilterHealth (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / FilterHealth
...
**Twin:** [FilterHealth (server)](../server/FilterHealth.md)
...
| `0x638` | `m_bAdrenalineActive` | bool |  |  |
| `0x63c` | `m_iHealthMin` | int32 |  |  |
| `0x640` | `m_iHealthMax` | int32 |  |  |
