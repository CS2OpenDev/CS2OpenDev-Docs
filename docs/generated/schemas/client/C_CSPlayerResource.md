...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSPlayerResource
...
95 fields (10 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_bHostageAlive` | bool[12] |  |  |
| `0x60c` | `m_isHostageFollowingSomeone` | bool[12] |  |  |
| `0x618` | `m_iHostageEntityIDs` | CEntityIndex[12] |  |  |
| `0x648` | `m_bombsiteCenterA` | VectorWS |  |  |
| `0x654` | `m_bombsiteCenterB` | VectorWS |  |  |
| `0x660` | `m_hostageRescueX` | int32[4] |  |  |
| `0x670` | `m_hostageRescueY` | int32[4] |  |  |
| `0x680` | `m_hostageRescueZ` | int32[4] |  |  |
| `0x690` | `m_bEndMatchNextMapAllVoted` | bool |  |  |
| `0x691` | `m_foundGoalPositions` | bool |  |  |
