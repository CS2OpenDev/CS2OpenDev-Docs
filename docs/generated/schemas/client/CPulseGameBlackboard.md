---
title: CPulseGameBlackboard (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CPulseGameBlackboard
...
**Twin:** [CPulseGameBlackboard (server)](../server/CPulseGameBlackboard.md)
...
87 fields (2 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x608` | `m_strGraphName` | CUtlString |  |  |
| `0x610` | `m_strStateBlob` | CUtlString |  |  |
