...
[Schemas](../../schemas.md) / [client](../client.md) / C_PointCamera

# C_PointCamera

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1632 bytes (`0x660`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_BaseEntity](../client/C_BaseEntity.md)

**Derived by:** [C_PointCameraVFOV](../client/C_PointCameraVFOV.md)
...
111 fields (26 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_FOV` | float32 |  |  |
| `0x604` | `m_Resolution` | float32 |  |  |
| `0x608` | `m_bFogEnable` | bool |  |  |
| `0x609` | `m_FogColor` | Color |  |  |
| `0x610` | `m_flFogStart` | float32 |  |  |
| `0x614` | `m_flFogEnd` | float32 |  |  |
| `0x618` | `m_flFogMaxDensity` | float32 |  |  |
| `0x61c` | `m_bActive` | bool |  |  |
| `0x61d` | `m_bUseScreenAspectRatio` | bool |  |  |
| `0x620` | `m_flAspectRatio` | float32 |  |  |
| `0x624` | `m_bNoSky` | bool |  |  |
| `0x628` | `m_fBrightness` | float32 |  |  |
| `0x62c` | `m_flZFar` | float32 |  |  |
| `0x630` | `m_flZNear` | float32 |  |  |
| `0x634` | `m_bCanHLTVUse` | bool |  |  |
| `0x635` | `m_bAlignWithParent` | bool |  |  |
| `0x636` | `m_bDofEnabled` | bool |  |  |
| `0x638` | `m_flDofNearBlurry` | float32 |  |  |
| `0x63c` | `m_flDofNearCrisp` | float32 |  |  |
| `0x640` | `m_flDofFarCrisp` | float32 |  |  |
| `0x644` | `m_flDofFarBlurry` | float32 |  |  |
| `0x648` | `m_flDofTiltToGround` | float32 |  |  |
| `0x64c` | `m_TargetFOV` | float32 |  |  |
| `0x650` | `m_DegreesPerSecond` | float32 |  |  |
| `0x654` | `m_bIsOn` | bool |  |  |
| `0x658` | `m_pNext` | [C_PointCamera](../client/C_PointCamera.md)* |  | `MNotSaved` |
