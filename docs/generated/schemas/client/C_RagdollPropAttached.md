...
[Schemas](../../schemas.md) / [client](../client.md) / C_RagdollPropAttached

# C_RagdollPropAttached

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4672 bytes (`0x1240`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_RagdollProp](../client/C_RagdollProp.md)
...
162 fields (7 declared here, 155 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_ragEnabled` | C_NetworkUtlVectorBase< bool > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x1198` | `m_ragPos` | C_NetworkUtlVectorBase< Vector > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11b0` | `m_ragAngles` | C_NetworkUtlVectorBase< QAngle > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11c8` | `m_flBlendWeight` | float32 | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11cc` | `m_hRagdollSource` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11d0` | `m_iEyeAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11d4` | `m_flBlendWeightCurrent` | float32 | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11d8` | `m_parentPhysicsBoneIndices` | CUtlVector< int32 > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x11f0` | `m_worldSpaceBoneComputationOrder` | CUtlVector< int32 > | [C_RagdollProp](../client/C_RagdollProp.md) | `MNotSaved` |
| `0x1208` | `m_boneIndexAttached` | uint32 |  | `MNotSaved` |
| `0x120c` | `m_ragdollAttachedObjectIndex` | uint32 |  | `MNotSaved` |
| `0x1210` | `m_attachmentPointBoneSpace` | Vector |  | `MNotSaved` |
| `0x121c` | `m_attachmentPointRagdollSpace` | Vector |  | `MNotSaved` |
| `0x1228` | `m_vecOffset` | Vector |  | `MNotSaved` |
| `0x1234` | `m_parentTime` | float32 |  | `MNotSaved` |
| `0x1238` | `m_bHasParent` | bool |  | `MNotSaved` |
