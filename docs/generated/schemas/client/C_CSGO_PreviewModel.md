...
[Schemas](../../schemas.md) / [client](../client.md) / C_CSGO_PreviewModel
...
**Derived by:** [C_CSGO_PreviewModelAlias_csgo_item_previewmodel](../client/C_CSGO_PreviewModelAlias_csgo_item_previewmodel.md)
...
150 fields (4 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_defaultAnim` | CUtlString |  |  |
| `0x1188` | `m_nDefaultAnimLoopMode` | [AnimLoopMode_t](../server/AnimLoopMode_t.md) |  |  |
| `0x118c` | `m_flInitialModelScale` | float32 |  |  |
| `0x1190` | `m_sInitialWeaponState` | CUtlString |  |  |
