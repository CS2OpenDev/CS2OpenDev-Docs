...
[Schemas](../../schemas.md) / [client](../client.md) / C_SoundOpvarSetPointBase
...
**Derived by:** [C_SoundOpvarSetOBBWindEntity](../client/C_SoundOpvarSetOBBWindEntity.md), [C_SoundOpvarSetPointEntity](../client/C_SoundOpvarSetPointEntity.md)
...
| `0x600` | `m_iszStackName` | CUtlSymbolLarge |  |  |
| `0x608` | `m_iszOperatorName` | CUtlSymbolLarge |  |  |
| `0x610` | `m_iszOpvarName` | CUtlSymbolLarge |  |  |
| `0x618` | `m_iOpvarIndex` | int32 |  |  |
| `0x61c` | `m_bUseAutoCompare` | bool |  |  |
| `0x61d` | `m_bFastRefresh` | bool |  |  |
