...
[Schemas](../../schemas.md) / [client](../client.md) / C_EntityDissolve

# C_EntityDissolve

**Kind:** class · **Size:** 4088 bytes (`0xff8`) · **Align:** 8 · **Module:** client
...
142 fields (13 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb8` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0xfbc` | `m_flFadeInStart` | float32 |  | `MNotSaved` |
| `0xfc0` | `m_flFadeInLength` | float32 |  | `MNotSaved` |
| `0xfc4` | `m_flFadeOutModelStart` | float32 |  | `MNotSaved` |
| `0xfc8` | `m_flFadeOutModelLength` | float32 |  | `MNotSaved` |
| `0xfcc` | `m_flFadeOutStart` | float32 |  | `MNotSaved` |
| `0xfd0` | `m_flFadeOutLength` | float32 |  | `MNotSaved` |
| `0xfd4` | `m_flNextSparkTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0xfd8` | `m_nDissolveType` | [EntityDissolveType_t](../!GlobalTypes/EntityDissolveType_t.md) |  | `MNotSaved` |
| `0xfdc` | `m_vDissolverOrigin` | VectorWS |  | `MNotSaved` |
| `0xfe8` | `m_nMagnitude` | uint32 |  | `MNotSaved` |
| `0xfec` | `m_bCoreExplode` | bool |  | `MNotSaved` |
| `0xfed` | `m_bLinkedToServerEnt` | bool |  | `MNotSaved` |
