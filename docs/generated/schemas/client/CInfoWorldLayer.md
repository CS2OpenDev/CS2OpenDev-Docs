---
layout: default
title: CInfoWorldLayer (client)
nav_exclude: true
---

[Schemas](../../schemas.md) / [client](../client.md) / CInfoWorldLayer
...
**Twin:** [CInfoWorldLayer (server)](../server/CInfoWorldLayer.md)
...
| `0x600` | `m_pOutputOnEntitiesSpawned` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x618` | `m_worldName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0x620` | `m_layerName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0x628` | `m_bWorldLayerVisible` | bool |  |  |
| `0x629` | `m_bEntitiesSpawned` | bool |  |  |
| `0x62a` | `m_bCreateAsChildSpawnGroup` | bool |  |  |
| `0x62c` | `m_hLayerSpawnGroup` | uint32 |  | `MNotSaved` |
| `0x630` | `m_bWorldLayerActuallyVisible` | bool |  | `MNotSaved` |
