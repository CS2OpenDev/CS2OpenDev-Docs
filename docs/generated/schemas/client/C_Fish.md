...
[Schemas](../../schemas.md) / [client](../client.md) / C_Fish

# C_Fish

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4720 bytes (`0x1270`) · **Align:** 8 · **Module:** client
...
169 fields (23 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_pos` | VectorWS |  | `MNotSaved` |
| `0x118c` | `m_vel` | Vector |  | `MNotSaved` |
| `0x1198` | `m_angles` | QAngle |  | `MNotSaved` |
| `0x11a4` | `m_localLifeState` | int32 |  | `MNotSaved` |
| `0x11a8` | `m_deathDepth` | float32 |  | `MNotSaved` |
| `0x11ac` | `m_deathAngle` | float32 |  | `MNotSaved` |
| `0x11b0` | `m_buoyancy` | float32 |  | `MNotSaved` |
| `0x11b8` | `m_wiggleTimer` | [CountdownTimer](../client/CountdownTimer.md) |  | `MNotSaved` |
| `0x11d0` | `m_wigglePhase` | float32 |  | `MNotSaved` |
| `0x11d4` | `m_wiggleRate` | float32 |  | `MNotSaved` |
| `0x11d8` | `m_actualPos` | VectorWS |  | `MNotSaved` |
| `0x11e4` | `m_actualAngles` | QAngle |  | `MNotSaved` |
| `0x11f0` | `m_poolOrigin` | VectorWS |  | `MNotSaved` |
| `0x11fc` | `m_waterLevel` | float32 |  | `MNotSaved` |
| `0x1200` | `m_gotUpdate` | bool |  | `MNotSaved` |
| `0x1204` | `m_x` | float32 |  | `MNotSaved` |
| `0x1208` | `m_y` | float32 |  | `MNotSaved` |
| `0x120c` | `m_z` | float32 |  | `MNotSaved` |
| `0x1210` | `m_angle` | float32 |  | `MNotSaved` |
| `0x1214` | `m_errorHistory` | float32[20] |  | `MNotSaved` |
| `0x1264` | `m_errorHistoryIndex` | int32 |  | `MNotSaved` |
| `0x1268` | `m_errorHistoryCount` | int32 |  | `MNotSaved` |
| `0x126c` | `m_averageError` | float32 |  | `MNotSaved` |
