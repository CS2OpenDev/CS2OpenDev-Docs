...
**Twin:** [CEnvSoundscapeProxyAlias_snd_soundscape_proxy (server)](../server/CEnvSoundscapeProxyAlias_snd_soundscape_proxy.md)

**Inherits from:** [CEnvSoundscapeProxy](../client/CEnvSoundscapeProxy.md)
...
97 fields (0 declared here, 97 inherited). Offsets are absolute from the object base.
...
| `0x690` | `m_MainSoundscapeName` | CUtlSymbolLarge | [CEnvSoundscapeProxy](../client/CEnvSoundscapeProxy.md) |  |
