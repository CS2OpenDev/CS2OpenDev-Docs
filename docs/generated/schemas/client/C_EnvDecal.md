...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvDecal
...
| `0xfb0` | `m_hDecalMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0xfb8` | `m_flWidth` | float32 |  |  |
| `0xfbc` | `m_flHeight` | float32 |  |  |
| `0xfc0` | `m_flDepth` | float32 |  |  |
| `0xfc4` | `m_nRenderOrder` | uint32 |  |  |
| `0xfc8` | `m_bProjectOnWorld` | bool |  |  |
| `0xfc9` | `m_bProjectOnCharacters` | bool |  |  |
| `0xfca` | `m_bProjectOnWater` | bool |  |  |
| `0xfcc` | `m_flDepthSortBias` | float32 |  |  |
