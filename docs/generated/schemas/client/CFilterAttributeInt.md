---
title: CFilterAttributeInt (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CFilterAttributeInt
...
**Twin:** [CFilterAttributeInt (server)](../server/CFilterAttributeInt.md)
...
89 fields (1 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x638` | `m_sAttributeName` | CUtlSymbolLarge |  |  |
