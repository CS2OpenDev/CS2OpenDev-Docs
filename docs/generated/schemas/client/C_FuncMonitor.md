...
[Schemas](../../schemas.md) / [client](../client.md) / C_FuncMonitor

# C_FuncMonitor

**Kind:** class · **Size:** 5168 bytes (`0x1430`) · **Align:** 16 · **Module:** client

**Inherits from:** [C_FuncBrush](../client/C_FuncBrush.md)
...
| `0xfb0` | `m_targetCamera` | CUtlString |  |  |
| `0xfb8` | `m_nResolutionEnum` | int32 |  |  |
| `0xfbc` | `m_bRenderShadows` | bool |  |  |
| `0xfbd` | `m_bUseUniqueColorTarget` | bool |  |  |
| `0xfc0` | `m_brushModelName` | CUtlString |  |  |
| `0xfc8` | `m_hTargetCamera` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > |  |  |
| `0xfcc` | `m_bEnabled` | bool |  |  |
| `0xfcd` | `m_bDraw3DSkybox` | bool |  |  |
