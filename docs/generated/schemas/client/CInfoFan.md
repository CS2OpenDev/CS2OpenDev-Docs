---
title: CInfoFan (client)
module: client
kind: class
---

[Schemas](../../schemas.md) / [client](../client.md) / CInfoFan

# CInfoFan

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1624 bytes (`0x658`) · **Align:** 8 · **Module:** client

**Twin:** [CInfoFan (server)](../server/CInfoFan.md)
...
| `0x640` | `m_fFanForceMaxRadius` | float32 |  |  |
| `0x644` | `m_fFanForceMinRadius` | float32 |  |  |
| `0x648` | `m_flCurveDistRange` | float32 |  |  |
| `0x650` | `m_FanForceCurveString` | CUtlSymbolLarge |  |  |
