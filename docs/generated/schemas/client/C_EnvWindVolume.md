...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvWindVolume
...
| `0x620` | `m_nShape` | int32 |  |  |
| `0x624` | `m_fWindSpeedMultiplier` | float32 |  |  |
| `0x628` | `m_fWindTurbulenceMultiplier` | float32 |  |  |
| `0x62c` | `m_fWindSpeedVariationMultiplier` | float32 |  |  |
| `0x630` | `m_fWindDirectionVariationMultiplier` | float32 |  |  |
