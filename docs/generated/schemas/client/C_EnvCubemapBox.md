...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvCubemapBox

# C_EnvCubemapBox

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1768 bytes (`0x6e8`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_EnvCubemap](../client/C_EnvCubemap.md)
...
103 fields (0 declared here, 103 inherited). Offsets are absolute from the object base.
...
| `0x680` | `m_Entity_hCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x688` | `m_Entity_bCustomCubemapTexture` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x68c` | `m_Entity_flInfluenceRadius` | float32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x690` | `m_Entity_vBoxProjectMins` | Vector | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x69c` | `m_Entity_vBoxProjectMaxs` | Vector | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6a8` | `m_Entity_bMoveable` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6ac` | `m_Entity_nHandshake` | int32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6b0` | `m_Entity_nEnvCubeMapArrayIndex` | int32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6b4` | `m_Entity_nPriority` | int32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6b8` | `m_Entity_flEdgeFadeDist` | float32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6bc` | `m_Entity_vEdgeFadeDists` | Vector | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6c8` | `m_Entity_flDiffuseScale` | float32 | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6cc` | `m_Entity_bStartDisabled` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6cd` | `m_Entity_bDefaultEnvMap` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6ce` | `m_Entity_bDefaultSpecEnvMap` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6cf` | `m_Entity_bIndoorCubeMap` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6d0` | `m_Entity_bCopyDiffuseFromDefaultCubemap` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
| `0x6e0` | `m_Entity_bEnabled` | bool | [C_EnvCubemap](../client/C_EnvCubemap.md) |  |
