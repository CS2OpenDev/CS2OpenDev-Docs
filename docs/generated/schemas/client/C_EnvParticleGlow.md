...
[Schemas](../../schemas.md) / [client](../client.md) / C_EnvParticleGlow

# C_EnvParticleGlow

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5528 bytes (`0x1598`) · **Align:** 8 · **Module:** client

**Inherits from:** [C_ParticleSystem](../client/C_ParticleSystem.md)
...
160 fields (5 declared here, 155 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_szSnapshotFileName` | char[512] | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11b0` | `m_bActive` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11b1` | `m_bFrozen` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11b4` | `m_flFreezeTransitionDuration` | float32 | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11b8` | `m_nStopType` | int32 | [C_ParticleSystem](../client/C_ParticleSystem.md) | `MNotSaved` |
| `0x11bc` | `m_bAnimateDuringGameplayPause` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11c0` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > | [C_ParticleSystem](../client/C_ParticleSystem.md) | `MNotSaved` |
| `0x11c8` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11cc` | `m_flPreSimTime` | float32 | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x11d0` | `m_vServerControlPoints` | Vector[4] | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1200` | `m_iServerControlPointAssignments` | uint8[4] | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1204` | `m_hControlPointEnts` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) >[64] | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1304` | `m_bDataStringLocalized` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1308` | `m_strDataString` | CUtlString | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1310` | `m_bNoSave` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1311` | `m_bNoFreeze` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1312` | `m_bNoRamp` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1313` | `m_bStartActive` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1318` | `m_iszEffectName` | CUtlSymbolLarge | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1320` | `m_iszControlPointNames` | CUtlSymbolLarge[64] | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1520` | `m_nDataCP` | int32 | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1524` | `m_vecDataCPValue` | Vector | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1530` | `m_nTintCP` | int32 | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1534` | `m_clrTint` | Color | [C_ParticleSystem](../client/C_ParticleSystem.md) |  |
| `0x1558` | `m_bOldActive` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) | `MNotSaved` |
| `0x1559` | `m_bOldFrozen` | bool | [C_ParticleSystem](../client/C_ParticleSystem.md) | `MNotSaved` |
| `0x1580` | `m_flAlphaScale` | float32 |  |  |
| `0x1584` | `m_flRadiusScale` | float32 |  |  |
| `0x1588` | `m_flSelfIllumScale` | float32 |  |  |
| `0x158c` | `m_ColorTint` | Color |  |  |
| `0x1590` | `m_hTextureOverride` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
