...
[Schemas](../../schemas.md) / [client](../client.md) / C_PhysMagnet

# C_PhysMagnet

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4528 bytes (`0x11b0`) · **Align:** 8 · **Module:** client
...
148 fields (2 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x1180` | `m_aAttachedObjectsFromServer` | CUtlVector< int32 > |  | `MNotSaved` |
| `0x1198` | `m_aAttachedObjects` | CUtlVector< CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > > |  | `MNotSaved` |
