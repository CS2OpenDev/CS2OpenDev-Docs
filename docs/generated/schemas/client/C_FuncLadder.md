...
[Schemas](../../schemas.md) / [client](../client.md) / C_FuncLadder

# C_FuncLadder

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 4104 bytes (`0x1008`) · **Align:** 8 · **Module:** client
...
138 fields (9 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0xfb0` | `m_vecLadderDir` | Vector |  |  |
| `0xfc0` | `m_Dismounts` | CUtlVector< CHandle< [C_InfoLadderDismount](../client/C_InfoLadderDismount.md) > > |  | `MNotSaved` |
| `0xfd8` | `m_vecLocalTop` | Vector |  |  |
| `0xfe4` | `m_vecPlayerMountPositionTop` | VectorWS |  |  |
| `0xff0` | `m_vecPlayerMountPositionBottom` | VectorWS |  |  |
| `0xffc` | `m_flAutoRideSpeed` | float32 |  |  |
| `0x1000` | `m_bDisabled` | bool |  |  |
| `0x1001` | `m_bFakeLadder` | bool |  |  |
| `0x1002` | `m_bHasSlack` | bool |  |  |
