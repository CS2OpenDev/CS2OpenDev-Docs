...
[Schemas](../../schemas.md) / [sounddoc_lib](../sounddoc_lib.md) / CMixControlOutput
...
**Metadata:** `MPropertyDescription Save the results of a control value (e.g. envelope level) so that code/stack can query it by name.`, `MPropertyFriendlyName VMix Control Output Node`
