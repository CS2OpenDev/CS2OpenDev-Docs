...
[Schemas](../../schemas.md) / [animgraphlib](../animgraphlib.md) / CSequenceFinishedAnimTag
...
**Metadata:** `MPropertyFriendlyName Sequence Finished Tag`
...
| `0x58` | `m_sequenceName` | CUtlString |  | `MPropertyAttributeChoiceName Sequence` `MPropertyFriendlyName Sequence` |
