...
[Schemas](../../schemas.md) / [animgraphlib](../animgraphlib.md) / CIntAnimParameter
...
**Metadata:** `MPropertyFriendlyName Int Parameter`
...
| `0x80` | `m_defaultValue` | int32 |  | `MPropertyFriendlyName Default Value` |
| `0x84` | `m_minValue` | int32 |  | `MPropertyFriendlyName Min Value` |
| `0x88` | `m_maxValue` | int32 |  | `MPropertyFriendlyName Max Value` |
