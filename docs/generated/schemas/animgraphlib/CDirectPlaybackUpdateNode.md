...
[Schemas](../../schemas.md) / [animgraphlib](../animgraphlib.md) / CDirectPlaybackUpdateNode
...
| `0x74` | `m_bFinishEarly` | bool |  |  |
| `0x75` | `m_bResetOnFinish` | bool |  |  |
| `0x78` | `m_allTags` | CUtlVector< [CDirectPlaybackTagData](../animgraphlib/CDirectPlaybackTagData.md) > |  |  |
