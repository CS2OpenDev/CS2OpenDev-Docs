...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncRotator

# CFuncRotator

**Kind:** class · **Size:** 2288 bytes (`0x8f0`) · **Align:** 16 · **Module:** server
...
166 fields (38 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_eRotateType` | [CFuncRotator](../server/CFuncRotator.md)::Rotate_t |  |  |
| `0x774` | `m_bIsRotating` | bool |  |  |
| `0x775` | `m_eSolidType` | [SolidType_t](../!GlobalTypes/SolidType_t.md) |  |  |
| `0x778` | `m_flSpeed` | float32 |  |  |
| `0x77c` | `m_flTimeToCompleteRotation` | float32 |  |  |
| `0x780` | `m_hRotatorTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x788` | `m_strRotatorTarget` | CUtlSymbolLarge |  |  |
| `0x790` | `m_vecLocalRotationHistory` | CUtlVector< Quaternion > |  |  |
| `0x7a8` | `m_OnRotationStarted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7c0` | `m_OnRotationCompleted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7d8` | `m_OnOscillate` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7f0` | `m_OnOscillateStartArrive` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x808` | `m_OnOscillateStartDepart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x820` | `m_OnOscillateEndArrive` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x838` | `m_OnOscillateEndDepart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x850` | `m_nTickRotateRan` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x854` | `m_bStartedRotating` | bool |  |  |
| `0x858` | `m_rotationSummary` | [FuncRotatorRotationSummary_t](../server/FuncRotatorRotationSummary_t.md) |  |  |
| `0x860` | `m_flTimeToReachMaxSpeed` | float32 |  |  |
| `0x864` | `m_flTimeToReachZeroSpeed` | float32 |  |  |
| `0x868` | `m_flTimeRotationStart` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x86c` | `m_flTimeRotationStop` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x870` | `m_flStartSpeed` | float32 |  |  |
| `0x880` | `m_qSpawnOrientation` | Quaternion |  |  |
| `0x890` | `m_bRecordHistory` | bool |  |  |
| `0x891` | `m_bReturningToPreviousRotation` | bool |  |  |
| `0x892` | `m_bReturningToInitialRotation` | bool |  |  |
| `0x894` | `m_flMinYawRotation` | float32 |  |  |
| `0x898` | `m_flMaxYawRotation` | float32 |  |  |
| `0x89c` | `m_nOscillationCount` | int32 |  |  |
| `0x8a0` | `m_bOscillationFromStart` | bool |  |  |
| `0x8a8` | `m_iszStartSound` | CGameSoundEventName |  |  |
| `0x8b0` | `m_iszLoopSound` | CGameSoundEventName |  |  |
| `0x8d0` | `m_iszStopSound` | CGameSoundEventName |  |  |
| `0x8d8` | `m_flTargetAngle` | float32 |  |  |
| `0x8dc` | `m_flCurrentAngle` | float32 |  |  |
| `0x8e0` | `m_eRotationAxis` | [CFuncRotator](../server/CFuncRotator.md)::RotationAxis_t |  |  |
| `0x8e4` | `m_flSpeedDriftFromOverRotate` | float32 |  |  |
