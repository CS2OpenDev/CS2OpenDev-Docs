...
classDiagram
    ...
    CFuncRotator *-- `CFuncRotator::Rotate_t`
    ...
    CFuncRotator *-- `CFuncRotator::RotationAxis_t`
```
...
| `0x770` | `m_eRotateType` | [CFuncRotator::Rotate_t](../server/CFuncRotator.Rotate_t.md) |  |  |
...
| `0x8e0` | `m_eRotationAxis` | [CFuncRotator::RotationAxis_t](../server/CFuncRotator.RotationAxis_t.md) |  |  |
