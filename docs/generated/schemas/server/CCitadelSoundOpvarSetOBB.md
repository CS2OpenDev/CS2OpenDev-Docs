---
title: CCitadelSoundOpvarSetOBB (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CCitadelSoundOpvarSetOBB
...
**Twin:** [CCitadelSoundOpvarSetOBB (client)](../client/CCitadelSoundOpvarSetOBB.md)
...
| `0x4a8` | `m_iszStackName` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_iszOperatorName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_iszOpvarName` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_vDistanceInnerMins` | Vector |  |  |
| `0x4cc` | `m_vDistanceInnerMaxs` | Vector |  |  |
| `0x4d8` | `m_vDistanceOuterMins` | Vector |  |  |
| `0x4e4` | `m_vDistanceOuterMaxs` | Vector |  |  |
| `0x4f0` | `m_nAABBDirection` | int32 |  |  |
