...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysWheelConstraint
...
114 fields (12 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x508` | `m_flSuspensionFrequency` | float32 |  |  |
| `0x50c` | `m_flSuspensionDampingRatio` | float32 |  |  |
| `0x510` | `m_flSuspensionHeightOffset` | float32 |  |  |
| `0x514` | `m_bEnableSuspensionLimit` | bool |  |  |
| `0x518` | `m_flMinSuspensionOffset` | float32 |  |  |
| `0x51c` | `m_flMaxSuspensionOffset` | float32 |  |  |
| `0x520` | `m_bEnableSteeringLimit` | bool |  |  |
| `0x524` | `m_flMinSteeringAngle` | float32 |  |  |
| `0x528` | `m_flMaxSteeringAngle` | float32 |  |  |
| `0x52c` | `m_flSteeringAxisFriction` | float32 |  |  |
| `0x530` | `m_flSpinAxisFriction` | float32 |  |  |
| `0x534` | `m_hSteeringMimicsEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
