...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetEntity
...
| `0x4c0` | `m_iszStackName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_iszOperatorName` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_iszOpvarName` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_nOpvarType` | int32 |  |  |
| `0x4dc` | `m_nOpvarIndex` | int32 |  |  |
| `0x4e0` | `m_flOpvarValue` | float32 |  |  |
| `0x4e8` | `m_OpvarValueString` | CUtlSymbolLarge |  |  |
| `0x4f0` | `m_bSetOnSpawn` | bool |  |  |
