...
[Schemas](../../schemas.md) / [server](../server.md) / CPointPrefab

# CPointPrefab

**Kind:** class · **Size:** 1328 bytes (`0x530`) · **Align:** 8 · **Module:** server

**Inherits from:** [CServerOnlyPointEntity](../server/CServerOnlyPointEntity.md)
...
| `0x4a8` | `m_targetMapName` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_forceWorldGroupID` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_associatedRelayTargetName` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_fixupNames` | bool |  |  |
| `0x4c1` | `m_bLoadDynamic` | bool |  |  |
| `0x4c4` | `m_associatedRelayEntity` | CHandle< [CPointPrefab](../server/CPointPrefab.md) > |  |  |
| `0x4c8` | `m_ProceduralRelaySources` | CUtlVector< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  |  |
