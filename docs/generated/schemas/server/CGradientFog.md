...
[Schemas](../../schemas.md) / [server](../server.md) / CGradientFog
...
| `0x4a8` | `m_hGradientFogTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x4b0` | `m_flFogStartDistance` | float32 |  |  |
| `0x4b4` | `m_flFogEndDistance` | float32 |  |  |
| `0x4b8` | `m_bHeightFogEnabled` | bool |  |  |
| `0x4bc` | `m_flFogStartHeight` | float32 |  |  |
| `0x4c0` | `m_flFogEndHeight` | float32 |  |  |
| `0x4c4` | `m_flFarZ` | float32 |  |  |
| `0x4c8` | `m_flFogMaxOpacity` | float32 |  |  |
| `0x4cc` | `m_flFogFalloffExponent` | float32 |  |  |
| `0x4d0` | `m_flFogVerticalExponent` | float32 |  |  |
| `0x4d4` | `m_fogColor` | Color |  |  |
| `0x4d8` | `m_flFogStrength` | float32 |  |  |
| `0x4dc` | `m_flFadeTime` | float32 |  |  |
| `0x4e0` | `m_bStartDisabled` | bool |  |  |
| `0x4e1` | `m_bIsEnabled` | bool |  |  |
| `0x4e2` | `m_bGradientFogNeedsTextures` | bool |  |  |
