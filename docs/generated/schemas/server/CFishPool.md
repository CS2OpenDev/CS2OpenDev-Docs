...
[Schemas](../../schemas.md) / [server](../server.md) / CFishPool
...
| `0x4b8` | `m_fishCount` | int32 |  |  |
| `0x4bc` | `m_maxRange` | float32 |  |  |
| `0x4c0` | `m_swimDepth` | float32 |  |  |
| `0x4c4` | `m_waterLevel` | float32 |  |  |
| `0x4c8` | `m_isDormant` | bool |  |  |
| `0x4d0` | `m_fishes` | CUtlVector< CHandle< [CFish](../server/CFish.md) > > |  |  |
| `0x4e8` | `m_visTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
