---
layout: default
title: CInfoWorldLayer (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CInfoWorldLayer
...
**Twin:** [CInfoWorldLayer (client)](../client/CInfoWorldLayer.md)
...
| `0x4a8` | `m_pOutputOnEntitiesSpawned` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_worldName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0x4c8` | `m_layerName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0x4d0` | `m_bWorldLayerVisible` | bool |  |  |
| `0x4d1` | `m_bEntitiesSpawned` | bool |  |  |
| `0x4d2` | `m_bCreateAsChildSpawnGroup` | bool |  |  |
| `0x4d4` | `m_hLayerSpawnGroup` | uint32 |  | `MNotSaved` |
