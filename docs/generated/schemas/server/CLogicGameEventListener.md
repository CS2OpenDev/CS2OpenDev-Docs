...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicGameEventListener
...
| `0x4b8` | `m_OnEventFired` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d0` | `m_iszGameEventName` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_iszGameEventItem` | CUtlSymbolLarge |  |  |
| `0x4e0` | `m_bEnabled` | bool |  |  |
| `0x4e1` | `m_bStartDisabled` | bool |  |  |
