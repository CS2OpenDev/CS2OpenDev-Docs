...
[Schemas](../../schemas.md) / [server](../server.md) / CDynamicNavConnectionsVolume

# CDynamicNavConnectionsVolume

**Kind:** class · **Size:** 2360 bytes (`0x938`) · **Align:** 8 · **Module:** server

**Inherits from:** [CTriggerMultiple](../server/CTriggerMultiple.md)
...
165 fields (7 declared here, 158 inherited). Offsets are absolute from the object base.
...
| `0x900` | `m_iszConnectionTarget` | CUtlSymbolLarge |  |  |
| `0x908` | `m_vecConnections` | CUtlVector< [DynamicVolumeDef_t](../server/DynamicVolumeDef_t.md) > |  |  |
| `0x920` | `m_sTransitionType` | CGlobalSymbol |  |  |
| `0x928` | `m_bConnectionsEnabled` | bool |  |  |
| `0x92c` | `m_flTargetAreaSearchRadius` | float32 |  |  |
| `0x930` | `m_flUpdateDistance` | float32 |  |  |
| `0x934` | `m_flMaxConnectionDistance` | float32 |  |  |
