...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncBrush
...
**Derived by:** [CFuncElectrifiedVolume](../server/CFuncElectrifiedVolume.md), [CFuncMonitor](../server/CFuncMonitor.md)
...
134 fields (6 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_iSolidity` | [BrushSolidities_e](../!GlobalTypes/BrushSolidities_e.md) |  |  |
| `0x774` | `m_iDisabled` | int32 |  |  |
| `0x778` | `m_bSolidBsp` | bool |  |  |
| `0x780` | `m_iszExcludedClass` | CUtlSymbolLarge |  |  |
| `0x788` | `m_bInvertExclusion` | bool |  |  |
| `0x789` | `m_bScriptedMovement` | bool |  |  |
