...
[Schemas](../../schemas.md) / [server](../server.md) / CGunTarget
...
148 fields (4 declared here, 144 inherited). Offsets are absolute from the object base.
...
| `0x7f0` | `m_flSpeed` | float32 |  |  |
| `0x7f4` | `m_on` | bool |  |  |
| `0x7f8` | `m_hTargetEnt` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x800` | `m_OnDeath` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
