...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicEventListener
...
| `0x4b8` | `m_strEventName` | CUtlString |  |  |
| `0x4c0` | `m_bIsEnabled` | bool |  |  |
| `0x4c4` | `m_nTeam` | int32 |  |  |
| `0x4c8` | `m_OnEventFired` | CEntityOutputTemplate< CUtlString > |  |  |
