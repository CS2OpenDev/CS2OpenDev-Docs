...
[Schemas](../../schemas.md) / [server](../server.md) / CPathParticleRope
...
**Derived by:** [CPathParticleRopeAlias_path_particle_rope_clientside](../server/CPathParticleRopeAlias_path_particle_rope_clientside.md)
...
104 fields (16 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4b0` | `m_bStartActive` | bool |  |  |
| `0x4b4` | `m_flMaxSimulationTime` | float32 |  |  |
| `0x4b8` | `m_iszEffectName` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_PathNodes_Name` | CUtlVector< CUtlSymbolLarge > |  |  |
| `0x4d8` | `m_flParticleSpacing` | float32 |  |  |
| `0x4dc` | `m_flSlack` | float32 |  |  |
| `0x4e0` | `m_flRadius` | float32 |  |  |
| `0x4e4` | `m_ColorTint` | Color |  |  |
| `0x4e8` | `m_nEffectState` | int32 |  |  |
| `0x4f0` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0x4f8` | `m_PathNodes_Position` | CNetworkUtlVectorBase< Vector > |  |  |
| `0x510` | `m_PathNodes_TangentIn` | CNetworkUtlVectorBase< Vector > |  |  |
| `0x528` | `m_PathNodes_TangentOut` | CNetworkUtlVectorBase< Vector > |  |  |
| `0x540` | `m_PathNodes_Color` | CNetworkUtlVectorBase< Vector > |  |  |
| `0x558` | `m_PathNodes_PinEnabled` | CNetworkUtlVectorBase< bool > |  |  |
| `0x570` | `m_PathNodes_RadiusScale` | CNetworkUtlVectorBase< float32 > |  |  |
