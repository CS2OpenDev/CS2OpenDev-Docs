---
title: CPlayer_MovementServices_Humanoid (server)
module: server
kind: class
---
...
**Kind:** class · **Size:** 656 bytes (`0x290`) · **Align:** n/a (unspecified) · **Module:** server

**Twin:** [CPlayer_MovementServices_Humanoid (client)](../client/CPlayer_MovementServices_Humanoid.md)
