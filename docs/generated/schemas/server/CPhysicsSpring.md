...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysicsSpring
...
| `0x4a8` | `m_pSpringJoint` | [IPhysicsJoint](../vphysics2/IPhysicsJoint.md)* |  | `MPhysPtr` |
| `0x4b0` | `m_flFrequency` | float32 |  |  |
| `0x4b4` | `m_flDampingRatio` | float32 |  |  |
| `0x4b8` | `m_flRestLength` | float32 |  |  |
| `0x4c0` | `m_nameAttachStart` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_nameAttachEnd` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_start` | VectorWS |  |  |
| `0x4dc` | `m_end` | VectorWS |  |  |
| `0x4e8` | `m_teleportTick` | uint32 |  | `MNotSaved` |
