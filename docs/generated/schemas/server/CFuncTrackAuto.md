...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncTrackAuto

# CFuncTrackAuto

**Kind:** class · **Size:** 2168 bytes (`0x878`) · **Align:** 8 · **Module:** server

**Inherits from:** [CFuncTrackChange](../server/CFuncTrackChange.md)
...
162 fields (0 declared here, 162 inherited). Offsets are absolute from the object base.
...
| `0x7f0` | `m_NoiseMoving` | CGameSoundEventName | [CBasePlatTrain](../server/CBasePlatTrain.md) |  |
| `0x7f8` | `m_NoiseArrived` | CGameSoundEventName | [CBasePlatTrain](../server/CBasePlatTrain.md) |  |
| `0x808` | `m_volume` | float32 | [CBasePlatTrain](../server/CBasePlatTrain.md) |  |
| `0x80c` | `m_flTWidth` | float32 | [CBasePlatTrain](../server/CBasePlatTrain.md) |  |
| `0x810` | `m_flTLength` | float32 | [CBasePlatTrain](../server/CBasePlatTrain.md) |  |
| `0x818` | `m_flSpeed` | float32 | [CFuncPlat](../server/CFuncPlat.md) |  |
| `0x820` | `m_sNoise` | CUtlSymbolLarge | [CFuncPlat](../server/CFuncPlat.md) |  |
| `0x828` | `m_end` | QAngle | [CFuncPlatRot](../server/CFuncPlatRot.md) |  |
| `0x834` | `m_start` | QAngle | [CFuncPlatRot](../server/CFuncPlatRot.md) |  |
| `0x840` | `m_trackTop` | CHandle< [CPathTrack](../server/CPathTrack.md) > | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x844` | `m_trackBottom` | CHandle< [CPathTrack](../server/CPathTrack.md) > | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x848` | `m_train` | CHandle< [CFuncTrackTrain](../server/CFuncTrackTrain.md) > | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x850` | `m_trackTopName` | CUtlSymbolLarge | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x858` | `m_trackBottomName` | CUtlSymbolLarge | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x860` | `m_trainName` | CUtlSymbolLarge | [CFuncTrackChange](../server/CFuncTrackChange.md) | `MSaveBehavior` |
| `0x868` | `m_code` | [TRAIN_CODE](../!GlobalTypes/TRAIN_CODE.md) | [CFuncTrackChange](../server/CFuncTrackChange.md) |  |
| `0x86c` | `m_targetState` | int32 | [CFuncTrackChange](../server/CFuncTrackChange.md) |  |
| `0x870` | `m_use` | int32 | [CFuncTrackChange](../server/CFuncTrackChange.md) |  |
