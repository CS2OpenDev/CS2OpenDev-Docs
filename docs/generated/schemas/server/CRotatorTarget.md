...
[Schemas](../../schemas.md) / [server](../server.md) / CRotatorTarget
...
| `0x4a8` | `m_OnArrivedAt` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_eSpace` | [RotatorTargetSpace_t](../!GlobalTypes/RotatorTargetSpace_t.md) |  |  |
