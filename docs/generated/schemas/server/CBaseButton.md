...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseButton
...
**Derived by:** [CPhysicalButton](../server/CPhysicalButton.md), [CRotButton](../server/CRotButton.md)
...
170 fields (26 declared here, 144 inherited). Offsets are absolute from the object base.
...
| `0x7f0` | `m_angMoveEntitySpace` | QAngle |  |  |
| `0x7fc` | `m_fStayPushed` | bool |  |  |
| `0x7fd` | `m_fRotating` | bool |  |  |
| `0x800` | `m_ls` | locksound_t |  | `MNotSaved` |
| `0x820` | `m_sUseSound` | CGameSoundEventName |  |  |
| `0x828` | `m_sLockedSound` | CGameSoundEventName |  |  |
| `0x830` | `m_sUnlockedSound` | CGameSoundEventName |  |  |
| `0x838` | `m_sOverrideAnticipationName` | CUtlSymbolLarge |  |  |
| `0x840` | `m_bLocked` | bool |  |  |
| `0x841` | `m_bDisabled` | bool |  |  |
| `0x844` | `m_flSpeed` | float32 |  |  |
| `0x848` | `m_flUseLockedTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x84c` | `m_bSolidBsp` | bool |  |  |
| `0x850` | `m_OnDamaged` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x868` | `m_OnPressed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x880` | `m_OnUseLocked` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x898` | `m_OnIn` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8b0` | `m_OnOut` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8c8` | `m_nState` | int32 |  | `MNotSaved` |
| `0x8cc` | `m_hConstraint` | CEntityHandle |  |  |
| `0x8d0` | `m_hConstraintParent` | CEntityHandle |  |  |
| `0x8d4` | `m_bForceNpcExclude` | bool |  | `MNotSaved` |
| `0x8d8` | `m_sGlowEntity` | CUtlSymbolLarge |  |  |
| `0x8e0` | `m_glowEntity` | CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > |  | `MNotSaved` |
| `0x8e4` | `m_usable` | bool |  |  |
| `0x8e8` | `m_szDisplayText` | CUtlSymbolLarge |  | `MNotSaved` |
