...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseAnimGraph
...
| `0x850` | `m_pChoreoServices` | [IChoreoServices](../server/IChoreoServices.md)* |  | `MKV3TransferSaveOpsForField GetChoreoServicesSaveRestoreOps` |
| `0x858` | `m_bAnimGraphUpdateEnabled` | bool |  |  |
| `0x859` | `m_bAnimationUpdateScheduled` | bool |  | `MNotSaved` |
| `0x85c` | `m_vecForce` | Vector |  | `MNotSaved` |
