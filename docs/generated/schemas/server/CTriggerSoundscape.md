...
**Kind:** class · **Size:** 2320 bytes (`0x910`) · **Align:** 8 · **Module:** server
...
160 fields (3 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_hSoundscape` | CHandle< [CEnvSoundscapeTriggerable](../server/CEnvSoundscapeTriggerable.md) > |  |  |
| `0x8f0` | `m_SoundscapeName` | CUtlSymbolLarge |  |  |
| `0x8f8` | `m_spectators` | CUtlVector< CHandle< [CBasePlayerPawn](../server/CBasePlayerPawn.md) > > |  |  |
