...
[Schemas](../../schemas.md) / [server](../server.md) / CHostageExpresserShim
...
**Derived by:** [CHostage](../server/CHostage.md)
...
154 fields (1 declared here, 153 inherited). Offsets are absolute from the object base.
...
| `0xa30` | `m_pExpresser` | [CAI_Expresser](../server/CAI_Expresser.md)* |  |  |
