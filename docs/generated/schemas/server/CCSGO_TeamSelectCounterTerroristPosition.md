...
[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_TeamSelectCounterTerroristPosition
...
**Inherits from:** [CCSGO_TeamSelectCharacterPosition](../server/CCSGO_TeamSelectCharacterPosition.md)
