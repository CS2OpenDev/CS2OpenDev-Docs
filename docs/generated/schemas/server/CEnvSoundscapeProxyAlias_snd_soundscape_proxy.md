...
**Twin:** [CEnvSoundscapeProxyAlias_snd_soundscape_proxy (client)](../client/CEnvSoundscapeProxyAlias_snd_soundscape_proxy.md)

**Inherits from:** [CEnvSoundscapeProxy](../server/CEnvSoundscapeProxy.md)
...
| `0x538` | `m_MainSoundscapeName` | CUtlSymbolLarge | [CEnvSoundscapeProxy](../server/CEnvSoundscapeProxy.md) |  |
