---
title: CPointOrient (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CPointOrient
...
**Twin:** [CPointOrient (client)](../client/CPointOrient.md)
...
| `0x4a8` | `m_iszSpawnTargetName` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_hTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4b4` | `m_bActive` | bool |  |  |
| `0x4b8` | `m_nGoalDirection` | [PointOrientGoalDirectionType_t](../server/PointOrientGoalDirectionType_t.md) |  |  |
| `0x4bc` | `m_nConstraint` | [PointOrientConstraint_t](../server/PointOrientConstraint_t.md) |  |  |
| `0x4c0` | `m_flMaxTurnRate` | float32 |  |  |
| `0x4c4` | `m_flLastGameTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
