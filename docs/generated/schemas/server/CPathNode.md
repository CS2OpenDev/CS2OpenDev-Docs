---
layout: default
title: CPathNode (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CPathNode

# CPathNode

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1280 bytes (`0x500`) · **Align:** 16 · **Module:** server

**Twin:** [CPathNode (client)](../client/CPathNode.md)

**Inherits from:** [CPointEntity](../server/CPointEntity.md)

**Derived by:** [CMoverPathNode](../server/CMoverPathNode.md)
...
| `0x4a8` | `m_vInTangentLocal` | Vector |  |  |
| `0x4b4` | `m_vOutTangentLocal` | Vector |  |  |
| `0x4c0` | `m_strParentPathUniqueID` | CUtlString |  |  |
| `0x4c8` | `m_strPathNodeParameter` | CUtlString |  |  |
| `0x4d0` | `m_xWSPrevParent` | CTransformWS |  |  |
| `0x4f0` | `m_hPath` | CHandle< [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md) > |  |  |
