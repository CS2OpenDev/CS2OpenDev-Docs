---
title: CInfoOffscreenPanoramaTexture (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CInfoOffscreenPanoramaTexture

# CInfoOffscreenPanoramaTexture

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1320 bytes (`0x528`) · **Align:** 8 · **Module:** server

**Twin:** [CInfoOffscreenPanoramaTexture (client)](../client/CInfoOffscreenPanoramaTexture.md)
...
| `0x4ac` | `m_nResolutionX` | int32 |  |  |
| `0x4b0` | `m_nResolutionY` | int32 |  |  |
| `0x4b8` | `m_szPanelType` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_szLayoutFileName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_RenderAttrName` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_TargetEntities` | CNetworkUtlVectorBase< CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > > |  |  |
| `0x4e8` | `m_nTargetChangeCount` | int32 |  |  |
| `0x4f0` | `m_vecCSSClasses` | CNetworkUtlVectorBase< CUtlSymbolLarge > |  |  |
| `0x508` | `m_szTargetsName` | CUtlSymbolLarge |  |  |
| `0x510` | `m_AdditionalTargetEntities` | CUtlVector< CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > > |  |  |
