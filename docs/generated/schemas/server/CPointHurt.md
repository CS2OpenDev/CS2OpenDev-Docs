...
[Schemas](../../schemas.md) / [server](../server.md) / CPointHurt
...
| `0x4a8` | `m_nDamage` | int32 |  |  |
| `0x4ac` | `m_bitsDamageType` | [DamageTypes_t](../!GlobalTypes/DamageTypes_t.md) |  |  |
| `0x4b0` | `m_flRadius` | float32 |  |  |
| `0x4b4` | `m_flDelay` | float32 |  |  |
| `0x4b8` | `m_strTarget` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_pActivator` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
