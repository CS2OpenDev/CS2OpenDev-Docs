...
[Schemas](../../schemas.md) / [server](../server.md) / CTankTrainAI
...
| `0x4a8` | `m_hTrain` | CHandle< [CFuncTrackTrain](../server/CFuncTrackTrain.md) > |  |  |
| `0x4ac` | `m_hTargetEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4b0` | `m_soundPlaying` | int32 |  |  |
| `0x4c8` | `m_startSoundName` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_engineSoundName` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_movementSoundName` | CUtlSymbolLarge |  |  |
| `0x4e0` | `m_targetEntityName` | CUtlSymbolLarge |  |  |
