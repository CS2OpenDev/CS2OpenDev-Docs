...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerPush

# CTriggerPush

**Kind:** class · **Size:** 2336 bytes (`0x920`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseTrigger](../server/CBaseTrigger.md)

**Derived by:** [CScriptTriggerPush](../server/CScriptTriggerPush.md)
...
165 fields (8 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_angPushEntitySpace` | QAngle |  |  |
| `0x8f4` | `m_vecPushDirEntitySpace` | Vector |  |  |
| `0x900` | `m_bTriggerOnStartTouch` | bool |  |  |
| `0x901` | `m_bUsePathSimple` | bool |  |  |
| `0x908` | `m_iszPathSimpleName` | CUtlSymbolLarge |  |  |
| `0x910` | `m_PathSimple` | CHandle< [CPathSimple](../server/CPathSimple.md) > |  |  |
| `0x914` | `m_splinePushType` | uint32 |  |  |
| `0x918` | `m_flSpeed` | float32 |  |  |
