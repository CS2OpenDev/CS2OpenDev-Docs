...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicActiveAutosave

# CLogicActiveAutosave

**Kind:** class · **Size:** 1224 bytes (`0x4c8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CLogicAutosave](../server/CLogicAutosave.md)
...
92 fields (4 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_bForceNewLevelUnit` | bool | [CLogicAutosave](../server/CLogicAutosave.md) |  |
| `0x4ac` | `m_minHitPoints` | int32 | [CLogicAutosave](../server/CLogicAutosave.md) |  |
| `0x4b0` | `m_minHitPointsToCommit` | int32 | [CLogicAutosave](../server/CLogicAutosave.md) |  |
| `0x4b8` | `m_TriggerHitPoints` | int32 |  |  |
| `0x4bc` | `m_flTimeToTrigger` | float32 |  |  |
| `0x4c0` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4c4` | `m_flDangerousTime` | float32 |  |  |
