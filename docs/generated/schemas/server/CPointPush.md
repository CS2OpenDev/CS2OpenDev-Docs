...
[Schemas](../../schemas.md) / [server](../server.md) / CPointPush
...
| `0x4a8` | `m_bEnabled` | bool |  |  |
| `0x4ac` | `m_flMagnitude` | float32 |  |  |
| `0x4b0` | `m_flRadius` | float32 |  |  |
| `0x4b4` | `m_flInnerRadius` | float32 |  |  |
| `0x4b8` | `m_flConeOfInfluence` | float32 |  |  |
| `0x4c0` | `m_iszFilterName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_hFilter` | CHandle< [CBaseFilter](../server/CBaseFilter.md) > |  |  |
