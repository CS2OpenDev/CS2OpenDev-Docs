...
[Schemas](../../schemas.md) / [server](../server.md) / CServerOnlyPointEntity
...
**Derived by:** [CInfoTargetServerOnly](../server/CInfoTargetServerOnly.md), [CPointPrefab](../server/CPointPrefab.md), [CPointTeleport](../server/CPointTeleport.md), [SpawnPoint](../server/SpawnPoint.md)
