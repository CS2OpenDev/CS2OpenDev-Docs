...
[Schemas](../../schemas.md) / [server](../server.md) / CMarkupVolumeTagged

# CMarkupVolumeTagged

**Kind:** class · **Size:** 1968 bytes (`0x7b0`) · **Align:** 255 · **Module:** server

**Inherits from:** [CMarkupVolume](../server/CMarkupVolume.md)

**Derived by:** [CMarkupVolumeTagged_Nav](../server/CMarkupVolumeTagged_Nav.md), [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md), [CSimpleMarkupVolumeTagged](../server/CSimpleMarkupVolumeTagged.md)
...
136 fields (7 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_GroupNames` | CUtlVector< CGlobalSymbol > |  |  |
| `0x790` | `m_Tags` | CUtlVector< CGlobalSymbol > |  |  |
| `0x7a8` | `m_bIsGroup` | bool |  | `MNotSaved` |
| `0x7a9` | `m_bGroupByPrefab` | bool |  |  |
| `0x7aa` | `m_bGroupByVolume` | bool |  |  |
| `0x7ab` | `m_bGroupOtherGroups` | bool |  |  |
| `0x7ac` | `m_bIsInGroup` | bool |  | `MNotSaved` |
