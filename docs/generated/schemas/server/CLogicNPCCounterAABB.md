...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicNPCCounterAABB
...
**Inherits from:** [CLogicNPCCounter](../server/CLogicNPCCounter.md)

**Derived by:** [CLogicNPCCounterOBB](../server/CLogicNPCCounterOBB.md)
...
140 fields (4 declared here, 136 inherited). Offsets are absolute from the object base.
...
| `0x728` | `m_vDistanceOuterMins` | Vector |  |  |
| `0x734` | `m_vDistanceOuterMaxs` | Vector |  |  |
| `0x740` | `m_vOuterMins` | VectorWS |  |  |
| `0x74c` | `m_vOuterMaxs` | VectorWS |  |  |
