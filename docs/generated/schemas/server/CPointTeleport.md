...
[Schemas](../../schemas.md) / [server](../server.md) / CPointTeleport
...
| `0x4a8` | `m_vSaveOrigin` | VectorWS |  |  |
| `0x4b4` | `m_vSaveAngles` | QAngle |  |  |
| `0x4c0` | `m_bTeleportParentedEntities` | bool |  |  |
| `0x4c1` | `m_bTeleportUseCurrentAngle` | bool |  |  |
