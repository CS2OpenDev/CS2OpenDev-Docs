...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvExplosion
...
143 fields (15 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_iMagnitude` | int32 |  |  |
| `0x774` | `m_flPlayerDamage` | float32 |  |  |
| `0x778` | `m_iRadiusOverride` | int32 |  |  |
| `0x77c` | `m_flInnerRadius` | float32 |  |  |
| `0x780` | `m_flDamageForce` | float32 |  |  |
| `0x784` | `m_hInflictor` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x788` | `m_iCustomDamageType` | [DamageTypes_t](../!GlobalTypes/DamageTypes_t.md) |  |  |
| `0x78c` | `m_bCreateDebris` | bool |  |  |
| `0x798` | `m_iszCustomEffectName` | CUtlSymbolLarge |  |  |
| `0x7a0` | `m_iszCustomSoundName` | CUtlSymbolLarge |  |  |
| `0x7a8` | `m_bSuppressParticleImpulse` | bool |  |  |
| `0x7ac` | `m_iClassIgnore` | [Class_T](../!GlobalTypes/Class_T.md) |  |  |
| `0x7b0` | `m_iClassIgnore2` | [Class_T](../!GlobalTypes/Class_T.md) |  |  |
| `0x7b8` | `m_iszEntityIgnoreName` | CUtlSymbolLarge |  |  |
| `0x7c0` | `m_hEntityIgnore` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
