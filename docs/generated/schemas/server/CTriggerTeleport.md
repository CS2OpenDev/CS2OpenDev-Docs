...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerTeleport

# CTriggerTeleport

**Kind:** class · **Size:** 2296 bytes (`0x8f8`) · **Align:** 8 · **Module:** server
...
161 fields (4 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_iLandmark` | CUtlSymbolLarge |  |  |
| `0x8f0` | `m_bUseLandmarkAngles` | bool |  |  |
| `0x8f1` | `m_bMirrorPlayer` | bool |  |  |
| `0x8f2` | `m_bCheckDestIfClearForPlayer` | bool |  |  |
