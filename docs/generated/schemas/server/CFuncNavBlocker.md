...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncNavBlocker
...
**Derived by:** [CScriptNavBlocker](../server/CScriptNavBlocker.md)
...
130 fields (2 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_bDisabled` | bool |  |  |
| `0x77c` | `m_nBlockedTeamNumber` | int32 |  |  |
