---
layout: default
title: FilterDamageType (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / FilterDamageType
...
**Twin:** [FilterDamageType (client)](../client/FilterDamageType.md)
