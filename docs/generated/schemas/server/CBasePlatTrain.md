...
[Schemas](../../schemas.md) / [server](../server.md) / CBasePlatTrain

# CBasePlatTrain

**Kind:** class · **Size:** 2072 bytes (`0x818`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseToggle](../server/CBaseToggle.md)

**Derived by:** [CFuncPlat](../server/CFuncPlat.md), [CFuncTrain](../server/CFuncTrain.md)
...
149 fields (5 declared here, 144 inherited). Offsets are absolute from the object base.
...
| `0x7f0` | `m_NoiseMoving` | CGameSoundEventName |  |  |
| `0x7f8` | `m_NoiseArrived` | CGameSoundEventName |  |  |
| `0x808` | `m_volume` | float32 |  |  |
| `0x80c` | `m_flTWidth` | float32 |  |  |
| `0x810` | `m_flTLength` | float32 |  |  |
