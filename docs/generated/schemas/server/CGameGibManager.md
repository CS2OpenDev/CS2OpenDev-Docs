...
[Schemas](../../schemas.md) / [server](../server.md) / CGameGibManager
...
| `0x4c0` | `m_bAllowNewGibs` | bool |  |  |
| `0x4c4` | `m_iCurrentMaxPieces` | int32 |  | `MNotSaved` |
| `0x4c8` | `m_iMaxPieces` | int32 |  |  |
| `0x4cc` | `m_iLastFrame` | int32 |  | `MNotSaved` |
