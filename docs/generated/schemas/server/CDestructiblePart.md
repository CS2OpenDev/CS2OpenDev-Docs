...
| `0x8` | `m_nHitGroup` | [HitGroup_t](../!GlobalTypes/HitGroup_t.md) |  | `MPropertyDescription The hitgroup this is related to.` `MPropertyStartGroup +Hitgroup` |
...
| `0x10` | `m_nOtherHitgroupsToDestroyWhenFullyDestructed` | CUtlVector< [HitGroup_t](../!GlobalTypes/HitGroup_t.md) > |  | `MPropertyDescription Other hitgroups to destroy when this one is fully destroyed.  Useful for chaining destructibles like blowing up the lower arm when the upper arm dies.` |
