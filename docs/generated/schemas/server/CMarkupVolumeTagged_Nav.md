...
[Schemas](../../schemas.md) / [server](../server.md) / CMarkupVolumeTagged_Nav

# CMarkupVolumeTagged_Nav

**Kind:** class · **Size:** 1976 bytes (`0x7b8`) · **Align:** 8 · **Module:** server
...
137 fields (1 declared here, 136 inherited). Offsets are absolute from the object base.
...
| `0x7b0` | `m_nScopes` | [NavScopeFlags_t](../!GlobalTypes/NavScopeFlags_t.md) |  |  |
