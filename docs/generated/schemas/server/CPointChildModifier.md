---
layout: default
title: CPointChildModifier (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CPointChildModifier
...
**Twin:** [CPointChildModifier (client)](../client/CPointChildModifier.md)
...
| `0x4a8` | `m_bOrphanInsteadOfDeletingChildrenOnRemove` | bool |  |  |
