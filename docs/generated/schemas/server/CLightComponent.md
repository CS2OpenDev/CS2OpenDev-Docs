...
[Schemas](../../schemas.md) / [server](../server.md) / CLightComponent
...
71 fields (71 declared here, 0 inherited). Offsets are absolute from the object base.
