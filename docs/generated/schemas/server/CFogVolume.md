...
[Schemas](../../schemas.md) / [server](../server.md) / CFogVolume
...
**Inherits from:** [CServerOnlyModelEntity](../server/CServerOnlyModelEntity.md)
...
| `0x770` | `m_fogName` | CUtlSymbolLarge |  |  |
| `0x778` | `m_postProcessName` | CUtlSymbolLarge |  |  |
| `0x780` | `m_colorCorrectionName` | CUtlSymbolLarge |  |  |
| `0x790` | `m_bDisabled` | bool |  |  |
| `0x791` | `m_bInFogVolumesList` | bool |  | `MNotSaved` |
