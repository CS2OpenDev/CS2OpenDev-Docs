---
layout: default
title: CCSGO_WingmanIntroCharacterPosition (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_WingmanIntroCharacterPosition

# CCSGO_WingmanIntroCharacterPosition

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 3264 bytes (`0xcc0`) · **Align:** n/a (unspecified) · **Module:** server

**Twin:** [CCSGO_WingmanIntroCharacterPosition (client)](../client/CCSGO_WingmanIntroCharacterPosition.md)

**Inherits from:** [CCSGO_TeamIntroCharacterPosition](../server/CCSGO_TeamIntroCharacterPosition.md)

**Derived by:** [CCSGO_WingmanIntroCounterTerroristPosition](../server/CCSGO_WingmanIntroCounterTerroristPosition.md), [CCSGO_WingmanIntroTerroristPosition](../server/CCSGO_WingmanIntroTerroristPosition.md)
...
| `0x4a8` | `m_nVariant` | int32 | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x4ac` | `m_nRandom` | int32 | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x4b0` | `m_nOrdinal` | int32 | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x4b8` | `m_sWeaponName` | CUtlString | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x4c0` | `m_xuid` | uint64 | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x4c8` | `m_agentItem` | [CEconItemView](../server/CEconItemView.md) | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0x770` | `m_glovesItem` | [CEconItemView](../server/CEconItemView.md) | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
| `0xa18` | `m_weaponItem` | [CEconItemView](../server/CEconItemView.md) | [CCSGO_TeamPreviewCharacterPosition](../server/CCSGO_TeamPreviewCharacterPosition.md) |  |
