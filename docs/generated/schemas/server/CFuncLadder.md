...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncLadder
...
**Derived by:** [CFuncLadderAlias_func_useableladder](../server/CFuncLadderAlias_func_useableladder.md)
...
140 fields (12 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_vecLadderDir` | Vector |  |  |
| `0x780` | `m_Dismounts` | CUtlVector< CHandle< [CInfoLadderDismount](../server/CInfoLadderDismount.md) > > |  | `MNotSaved` |
| `0x798` | `m_vecLocalTop` | Vector |  |  |
| `0x7a4` | `m_vecPlayerMountPositionTop` | VectorWS |  |  |
| `0x7b0` | `m_vecPlayerMountPositionBottom` | VectorWS |  |  |
| `0x7bc` | `m_flAutoRideSpeed` | float32 |  |  |
| `0x7c0` | `m_bDisabled` | bool |  |  |
| `0x7c1` | `m_bFakeLadder` | bool |  |  |
| `0x7c2` | `m_bHasSlack` | bool |  |  |
| `0x7c8` | `m_surfacePropName` | CUtlSymbolLarge |  |  |
| `0x7d0` | `m_OnPlayerGotOnLadder` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7e8` | `m_OnPlayerGotOffLadder` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
