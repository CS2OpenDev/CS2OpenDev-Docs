...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncTrain

# CFuncTrain

**Kind:** class · **Size:** 2112 bytes (`0x840`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBasePlatTrain](../server/CBasePlatTrain.md)
...
156 fields (7 declared here, 149 inherited). Offsets are absolute from the object base.
...
| `0x818` | `m_hCurrentTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x81c` | `m_activated` | bool |  |  |
| `0x820` | `m_hEnemy` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x824` | `m_flBlockDamage` | float32 |  |  |
| `0x828` | `m_flNextBlockTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x830` | `m_iszLastTarget` | CUtlSymbolLarge |  |  |
| `0x838` | `m_flSpeed` | float32 |  |  |
