---
layout: default
title: CPlayer_WaterServices (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CPlayer_WaterServices
...
**Twin:** [CPlayer_WaterServices (client)](../client/CPlayer_WaterServices.md)

**Inherits from:** [CPlayerPawnComponent](../server/CPlayerPawnComponent.md)

**Derived by:** [CCSPlayer_WaterServices](../server/CCSPlayer_WaterServices.md)
