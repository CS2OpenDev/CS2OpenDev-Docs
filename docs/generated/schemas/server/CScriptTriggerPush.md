...
[Schemas](../../schemas.md) / [server](../server.md) / CScriptTriggerPush

# CScriptTriggerPush

**Kind:** class · **Size:** 2352 bytes (`0x930`) · **Align:** 8 · **Module:** server

**Inherits from:** [CTriggerPush](../server/CTriggerPush.md)
...
166 fields (1 declared here, 165 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_angPushEntitySpace` | QAngle | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x8f4` | `m_vecPushDirEntitySpace` | Vector | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x900` | `m_bTriggerOnStartTouch` | bool | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x901` | `m_bUsePathSimple` | bool | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x908` | `m_iszPathSimpleName` | CUtlSymbolLarge | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x910` | `m_PathSimple` | CHandle< [CPathSimple](../server/CPathSimple.md) > | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x914` | `m_splinePushType` | uint32 | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x918` | `m_flSpeed` | float32 | [CTriggerPush](../server/CTriggerPush.md) |  |
| `0x920` | `m_vExtent` | Vector |  |  |
