...
[Schemas](../../schemas.md) / [server](../server.md) / CFlashbangProjectile

# CFlashbangProjectile

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2672 bytes (`0xa70`) · **Align:** 16 · **Module:** server
...
177 fields (3 declared here, 174 inherited). Offsets are absolute from the object base.
...
| `0x9f0` | `m_vInitialPosition` | VectorWS | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | World-space position from which the grenade was thrown. |
| `0x9fc` | `m_vInitialVelocity` | Vector | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | Initial velocity vector (world units per second) at the moment of throw. |
| `0xa08` | `m_nBounces` | int32 | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | Number of times the grenade has bounced off a surface so far. |
| `0xa10` | `m_nExplodeEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | Particle system definition handle for the detonation effect. |
| `0xa18` | `m_nExplodeEffectTickBegin` | int32 | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | Server tick at which the explosion particle effect started. |
| `0xa1c` | `m_vecExplodeEffectOrigin` | VectorWS | [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md) | World-space position of the explosion centre. |
...
| `0xa60` | `m_flTimeToDetonate` | float32 |  |  |
| `0xa64` | `m_numOpponentsHit` | uint8 |  |  |
| `0xa65` | `m_numTeammatesHit` | uint8 |  |  |
