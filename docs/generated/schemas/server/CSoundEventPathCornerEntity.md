...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundEventPathCornerEntity
...
**Inherits from:** [CSoundEventEntity](../server/CSoundEventEntity.md)
...
109 fields (7 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_bStartOnSpawn` | bool | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4a9` | `m_bToLocalPlayer` | bool | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4aa` | `m_bStopOnNew` | bool | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4ab` | `m_bSaveRestore` | bool | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4ac` | `m_bSavedIsPlaying` | bool | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4b0` | `m_flSavedElapsedTime` | float32 | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4b8` | `m_iszSourceEntityName` | CUtlSymbolLarge | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4c0` | `m_iszAttachmentName` | CUtlSymbolLarge | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4c8` | `m_onGUIDChanged` | CEntityOutputTemplate< SndOpEventGuid_t > | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x4f8` | `m_onSoundFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x510` | `m_flClientCullRadius` | float32 | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x540` | `m_iszSoundName` | CUtlSymbolLarge | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x55c` | `m_hSource` | CEntityHandle | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x560` | `m_nEntityIndexSelection` | int32 | [CSoundEventEntity](../server/CSoundEventEntity.md) |  |
| `0x568` | `m_iszPathCorner` | CUtlSymbolLarge |  |  |
| `0x570` | `m_iCountMax` | int32 |  |  |
| `0x574` | `m_flDistanceMax` | float32 |  |  |
| `0x578` | `m_flDistMaxSqr` | float32 |  |  |
| `0x57c` | `m_flDotProductMax` | float32 |  |  |
| `0x580` | `m_bPlaying` | bool |  |  |
| `0x5a8` | `m_vecCornerPairsNetworked` | CNetworkUtlVectorBase< [SoundeventPathCornerPairNetworked_t](../server/SoundeventPathCornerPairNetworked_t.md) > |  | `MNotSaved` |
