...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicMeasureMovement
...
94 fields (9 declared here, 85 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_strMeasureTarget` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_strMeasureReference` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_strTargetReference` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_hMeasureTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c4` | `m_hMeasureReference` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c8` | `m_hTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4cc` | `m_hTargetReference` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4d0` | `m_flScale` | float32 |  |  |
| `0x4d4` | `m_nMeasureType` | int32 |  |  |
