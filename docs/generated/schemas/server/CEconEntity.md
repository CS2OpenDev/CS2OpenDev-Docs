...
[Schemas](../../schemas.md) / [server](../server.md) / CEconEntity
...
**Derived by:** [CBasePlayerWeapon](../server/CBasePlayerWeapon.md), [CEconWearable](../server/CEconWearable.md)
...
152 fields (9 declared here, 143 inherited). Offsets are absolute from the object base.
...
| `0x978` | `m_AttributeManager` | [CAttributeContainer](../server/CAttributeContainer.md) |  |  |
