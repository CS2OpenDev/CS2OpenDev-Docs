...
[Schemas](../../schemas.md) / [server](../server.md) / CChangeLevel

# CChangeLevel

**Kind:** class · **Size:** 2328 bytes (`0x918`) · **Align:** 8 · **Module:** server
...
164 fields (7 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_sMapName` | CUtlString |  |  |
| `0x8f0` | `m_sLandmarkName` | CUtlString |  |  |
| `0x8f8` | `m_OnChangeLevel` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x910` | `m_bTouched` | bool |  |  |
| `0x911` | `m_bNoTouch` | bool |  |  |
| `0x912` | `m_bNewChapter` | bool |  |  |
| `0x913` | `m_bOnChangeLevelFired` | bool |  | `MNotSaved` |
