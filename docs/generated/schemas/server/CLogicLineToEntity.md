...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicLineToEntity
...
| `0x4a8` | `m_Line` | CEntityOutputTemplate< Vector > |  |  |
| `0x4d0` | `m_SourceName` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_StartEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4dc` | `m_EndEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
