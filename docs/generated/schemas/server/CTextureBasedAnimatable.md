...
[Schemas](../../schemas.md) / [server](../server.md) / CTextureBasedAnimatable

# CTextureBasedAnimatable

**Kind:** class · **Size:** 1960 bytes (`0x7a8`) · **Align:** 8 · **Module:** server
...
136 fields (8 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_bLoop` | bool |  |  |
| `0x774` | `m_flFPS` | float32 |  |  |
| `0x778` | `m_hPositionKeys` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x780` | `m_hRotationKeys` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x788` | `m_vAnimationBoundsMin` | Vector |  |  |
| `0x794` | `m_vAnimationBoundsMax` | Vector |  |  |
| `0x7a0` | `m_flStartTime` | float32 |  | `MNotSaved` |
| `0x7a4` | `m_flStartFrame` | float32 |  |  |
