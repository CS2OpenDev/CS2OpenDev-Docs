...
**Kind:** class · **Size:** 3488 bytes (`0xda0`) · **Align:** n/a (unspecified) · **Module:** server
...
242 fields (39 declared here, 203 inherited). Offsets are absolute from the object base.
...
| `0xbd8` | `m_eDoorState` | [DoorState_t](../server/DoorState_t.md) |  |  |
