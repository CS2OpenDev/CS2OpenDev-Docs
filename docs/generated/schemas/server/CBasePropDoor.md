...
[Schemas](../../schemas.md) / [server](../server.md) / CBasePropDoor

# CBasePropDoor

**Kind:** class · **Size:** 3488 bytes (`0xda0`) · **Align:** 255 · **Module:** server

**Inherits from:** [CDynamicProp](../server/CDynamicProp.md)

**Derived by:** [CPropDoorRotating](../server/CPropDoorRotating.md)
...
245 fields (39 declared here, 206 inherited). Offsets are absolute from the object base.
...
| `0xbb0` | `m_flAutoReturnDelay` | float32 |  |  |
| `0xbb8` | `m_hDoorList` | CUtlVector< CHandle< [CBasePropDoor](../server/CBasePropDoor.md) > > |  | `MNotSaved` |
| `0xbd0` | `m_nHardwareType` | int32 |  |  |
| `0xbd4` | `m_bNeedsHardware` | bool |  |  |
| `0xbd8` | `m_eDoorState` | [DoorState_t](../!GlobalTypes/DoorState_t.md) |  |  |
| `0xbdc` | `m_bLocked` | bool |  |  |
| `0xbdd` | `m_bNoNPCs` | bool |  |  |
| `0xbe0` | `m_closedPosition` | VectorWS |  |  |
| `0xbec` | `m_closedAngles` | QAngle |  |  |
| `0xbf8` | `m_hBlocker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0xbfc` | `m_bFirstBlocked` | bool |  |  |
| `0xc00` | `m_ls` | locksound_t |  |  |
| `0xc20` | `m_bForceClosed` | bool |  |  |
| `0xc24` | `m_vecLatchWorldPosition` | VectorWS |  |  |
| `0xc30` | `m_hActivator` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0xc34` | `m_flSpeed` | float32 |  |  |
| `0xc50` | `m_SoundMoving` | CGameSoundEventName |  |  |
| `0xc58` | `m_SoundOpen` | CGameSoundEventName |  |  |
| `0xc60` | `m_SoundClose` | CGameSoundEventName |  |  |
| `0xc68` | `m_SoundLock` | CGameSoundEventName |  |  |
| `0xc70` | `m_SoundUnlock` | CGameSoundEventName |  |  |
...
| `0xc78` | `m_SoundLatch` | CGameSoundEventName |  |  |
...
| `0xc80` | `m_SoundPound` | CGameSoundEventName |  | `MNotSaved` |
| `0xc88` | `m_SoundJiggle` | CGameSoundEventName |  |  |
| `0xc90` | `m_SoundLockedAnim` | CGameSoundEventName |  |  |
| `0xc98` | `m_numCloseAttempts` | int32 |  | `MNotSaved` |
| `0xc98` | `m_clrRender` | Color | [C_BaseModelEntity](../client/C_BaseModelEntity.md) |  |
| `0xc9c` | `m_nPhysicsMaterial` | CUtlStringToken |  | `MNotSaved` |
| `0xca0` | `m_SlaveName` | CUtlSymbolLarge |  |  |
...
| `0xca8` | `m_hMaster` | CHandle< [CBasePropDoor](../server/CBasePropDoor.md) > |  |  |
| `0xcb0` | `m_OnBlockedClosing` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xcc8` | `m_OnBlockedOpening` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xce0` | `m_OnUnblockedClosing` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xcf8` | `m_OnUnblockedOpening` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd10` | `m_OnFullyClosed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
...
| `0xd28` | `m_OnFullyOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd28` | `m_Collision` | [CCollisionProperty](../server/CCollisionProperty.md) | [C_BaseModelEntity](../client/C_BaseModelEntity.md) |  |
| `0xd40` | `m_OnClose` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd58` | `m_OnOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd70` | `m_OnLockedUse` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd88` | `m_OnAjarOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
