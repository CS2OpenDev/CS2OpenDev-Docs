...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicDistanceAutosave
...
| `0x4a8` | `m_iszTargetEntity` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_flDistanceToPlayer` | float32 |  |  |
| `0x4b4` | `m_bForceNewLevelUnit` | bool |  |  |
| `0x4b5` | `m_bCheckCough` | bool |  |  |
| `0x4b6` | `m_bThinkDangerous` | bool |  | `MNotSaved` |
| `0x4b8` | `m_flDangerousTime` | float32 |  | `MNotSaved` |
