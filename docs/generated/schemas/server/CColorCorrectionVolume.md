...
[Schemas](../../schemas.md) / [server](../server.md) / CColorCorrectionVolume

# CColorCorrectionVolume

**Kind:** class · **Size:** 2824 bytes (`0xb08`) · **Align:** 8 · **Module:** server
...
| `0x8e8` | `m_MaxWeight` | float32 |  |  |
| `0x8ec` | `m_FadeDuration` | float32 |  |  |
| `0x8f0` | `m_Weight` | float32 |  |  |
| `0x8f4` | `m_lookupFilename` | char[512] |  |  |
| `0xaf4` | `m_LastEnterWeight` | float32 |  |  |
| `0xaf8` | `m_LastEnterTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xafc` | `m_LastExitWeight` | float32 |  |  |
| `0xb00` | `m_LastExitTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
