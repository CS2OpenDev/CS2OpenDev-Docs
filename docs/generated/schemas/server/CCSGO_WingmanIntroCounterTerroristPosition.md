---
title: CCSGO_WingmanIntroCounterTerroristPosition (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_WingmanIntroCounterTerroristPosition

# CCSGO_WingmanIntroCounterTerroristPosition

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 3264 bytes (`0xcc0`) · **Align:** 8 · **Module:** server

**Twin:** [CCSGO_WingmanIntroCounterTerroristPosition (client)](../client/CCSGO_WingmanIntroCounterTerroristPosition.md)

**Inherits from:** [CCSGO_WingmanIntroCharacterPosition](../server/CCSGO_WingmanIntroCharacterPosition.md)
