...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysicsEntitySolver
...
| `0x4c0` | `m_hMovingEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c4` | `m_hPhysicsBlocker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c8` | `m_separationDuration` | float32 |  |  |
| `0x4cc` | `m_cancelTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
