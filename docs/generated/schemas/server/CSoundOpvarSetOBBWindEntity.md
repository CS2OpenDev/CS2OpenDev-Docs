...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetOBBWindEntity
...
107 fields (8 declared here, 99 inherited). Offsets are absolute from the object base.
...
| `0x550` | `m_vMins` | Vector |  |  |
| `0x55c` | `m_vMaxs` | Vector |  |  |
| `0x568` | `m_vDistanceMins` | Vector |  |  |
| `0x574` | `m_vDistanceMaxs` | Vector |  |  |
| `0x580` | `m_flWindMin` | float32 |  |  |
| `0x584` | `m_flWindMax` | float32 |  |  |
| `0x588` | `m_flWindMapMin` | float32 |  |  |
| `0x58c` | `m_flWindMapMax` | float32 |  |  |
