...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvVolumetricFogController

# CEnvVolumetricFogController

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1368 bytes (`0x558`) · **Align:** 8 · **Module:** server
...
124 fields (36 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_flScattering` | float32 |  |  |
| `0x4ac` | `m_TintColor` | Color |  |  |
| `0x4b0` | `m_flAnisotropy` | float32 |  |  |
| `0x4b4` | `m_flFadeSpeed` | float32 |  |  |
| `0x4b8` | `m_flDrawDistance` | float32 |  |  |
| `0x4bc` | `m_flFadeInStart` | float32 |  |  |
| `0x4c0` | `m_flFadeInEnd` | float32 |  |  |
| `0x4c4` | `m_flIndirectStrength` | float32 |  |  |
| `0x4c8` | `m_nVolumeDepth` | int32 |  |  |
| `0x4cc` | `m_fFirstVolumeSliceThickness` | float32 |  |  |
| `0x4d0` | `m_nIndirectTextureDimX` | int32 |  |  |
| `0x4d4` | `m_nIndirectTextureDimY` | int32 |  |  |
| `0x4d8` | `m_nIndirectTextureDimZ` | int32 |  |  |
| `0x4dc` | `m_vBoxMins` | Vector |  |  |
| `0x4e8` | `m_vBoxMaxs` | Vector |  |  |
| `0x4f4` | `m_bActive` | bool |  |  |
| `0x4f8` | `m_flStartAnisoTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4fc` | `m_flStartScatterTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x500` | `m_flStartDrawDistanceTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x504` | `m_flStartAnisotropy` | float32 |  |  |
| `0x508` | `m_flStartScattering` | float32 |  |  |
| `0x50c` | `m_flStartDrawDistance` | float32 |  |  |
| `0x510` | `m_flDefaultAnisotropy` | float32 |  |  |
| `0x514` | `m_flDefaultScattering` | float32 |  |  |
| `0x518` | `m_flDefaultDrawDistance` | float32 |  |  |
| `0x51c` | `m_bStartDisabled` | bool |  |  |
| `0x51d` | `m_bEnableIndirect` | bool |  |  |
| `0x51e` | `m_bIsMaster` | bool |  |  |
| `0x520` | `m_hFogIndirectTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x528` | `m_nForceRefreshCount` | int32 |  |  |
| `0x52c` | `m_fNoiseSpeed` | float32 |  |  |
| `0x530` | `m_fNoiseStrength` | float32 |  |  |
| `0x534` | `m_vNoiseScale` | Vector |  |  |
| `0x540` | `m_fWindSpeed` | float32 |  |  |
| `0x544` | `m_vWindDirection` | Vector |  |  |
| `0x550` | `m_bFirstTime` | bool |  |  |
