...
180 fields (34 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0xa60` | `m_nNavObstacleType` | [INavObstacle](../server/INavObstacle.md)::NavObstacleType_t |  |  |
