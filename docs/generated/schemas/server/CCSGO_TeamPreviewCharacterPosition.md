...
[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_TeamPreviewCharacterPosition
...
**Derived by:** [CCSGO_TeamIntroCharacterPosition](../server/CCSGO_TeamIntroCharacterPosition.md), [CCSGO_TeamSelectCharacterPosition](../server/CCSGO_TeamSelectCharacterPosition.md)
...
96 fields (8 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_nVariant` | int32 |  |  |
| `0x4ac` | `m_nRandom` | int32 |  |  |
| `0x4b0` | `m_nOrdinal` | int32 |  |  |
| `0x4b8` | `m_sWeaponName` | CUtlString |  |  |
| `0x4c0` | `m_xuid` | uint64 |  |  |
| `0x4c8` | `m_agentItem` | [CEconItemView](../server/CEconItemView.md) |  |  |
| `0x770` | `m_glovesItem` | [CEconItemView](../server/CEconItemView.md) |  |  |
| `0xa18` | `m_weaponItem` | [CEconItemView](../server/CEconItemView.md) |  |  |
