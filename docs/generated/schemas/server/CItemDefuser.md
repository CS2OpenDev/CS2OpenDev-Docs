...
[Schemas](../../schemas.md) / [server](../server.md) / CItemDefuser

# CItemDefuser

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2592 bytes (`0xa20`) · **Align:** 16 · **Module:** server

**Inherits from:** [CItem](../server/CItem.md)

**Derived by:** [CItemDefuserAlias_item_defuser](../server/CItemDefuserAlias_item_defuser.md)
...
| `0xa00` | `m_entitySpottedState` | [EntitySpottedState_t](../server/EntitySpottedState_t.md) |  |  |
| `0xa18` | `m_nSpotRules` | int32 |  |  |
