...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerMultiple
...
**Derived by:** [CDynamicNavConnectionsVolume](../server/CDynamicNavConnectionsVolume.md), [CScriptTriggerMultiple](../server/CScriptTriggerMultiple.md), [CTriggerImpact](../server/CTriggerImpact.md), [CTriggerOnce](../server/CTriggerOnce.md)
...
158 fields (1 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_OnTrigger` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
