...
[Schemas](../../schemas.md) / [server](../server.md) / CRagdollPropAttached
...
**Inherits from:** [CRagdollProp](../server/CRagdollProp.md)
...
183 fields (6 declared here, 177 inherited). Offsets are absolute from the object base.
...
| `0x970` | `m_CPropDataComponent` | [CPropDataComponent](../server/CPropDataComponent.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0x9b0` | `m_ragdoll` | ragdoll_t | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa00` | `m_bStartDisabled` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa04` | `m_massScale` | float32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa08` | `m_buoyancyScale` | float32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa10` | `m_ragEnabled` | CNetworkUtlVectorBase< bool > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa28` | `m_ragPos` | CNetworkUtlVectorBase< Vector > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa40` | `m_ragAngles` | CNetworkUtlVectorBase< QAngle > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa58` | `m_lastUpdateTickCount` | uint32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa5c` | `m_allAsleep` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa5d` | `m_bFirstCollisionAfterLaunch` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa60` | `m_nNavObstacleType` | [INavObstacle::NavObstacleType_t](../server/INavObstacle.NavObstacleType_t.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa64` | `m_bUpdateNavWhenMoving` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa65` | `m_bForceNavObstacleCut` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa66` | `m_bAttachedToReferenceFrame` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa68` | `m_hDamageEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa6c` | `m_hKiller` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa70` | `m_hPhysicsAttacker` | CHandle< [CBasePlayerPawn](../server/CBasePlayerPawn.md) > | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa74` | `m_flLastPhysicsInfluenceTime` | [GameTime_t](../entity2/GameTime_t.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa78` | `m_flFadeOutStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa7c` | `m_flFadeTime` | float32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa80` | `m_vecLastOrigin` | VectorWS | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa8c` | `m_flAwakeTime` | [GameTime_t](../entity2/GameTime_t.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa90` | `m_flLastOriginChangeTime` | [GameTime_t](../entity2/GameTime_t.md) | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xa98` | `m_strOriginClassName` | CUtlSymbolLarge | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xaa0` | `m_strSourceClassName` | CUtlSymbolLarge | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xaa8` | `m_bHasBeenPhysgunned` | bool | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xaa9` | `m_bAllowStretch` | bool | [CRagdollProp](../server/CRagdollProp.md) | `MNotSaved` |
| `0xaac` | `m_flBlendWeight` | float32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xab0` | `m_flDefaultFadeScale` | float32 | [CRagdollProp](../server/CRagdollProp.md) |  |
| `0xab8` | `m_ragdollMins` | CUtlVector< Vector > | [CRagdollProp](../server/CRagdollProp.md) | `MNotSaved` |
| `0xad0` | `m_ragdollMaxs` | CUtlVector< Vector > | [CRagdollProp](../server/CRagdollProp.md) | `MNotSaved` |
| `0xae8` | `m_bShouldDeleteActivationRecord` | bool | [CRagdollProp](../server/CRagdollProp.md) | `MNotSaved` |
| `0xb00` | `m_vecNavObstacles` | CUtlVector< [INavObstacle](../server/INavObstacle.md)* > | [CRagdollProp](../server/CRagdollProp.md) | `MNotSaved` |
| `0xb20` | `m_boneIndexAttached` | uint32 |  |  |
| `0xb24` | `m_ragdollAttachedObjectIndex` | uint32 |  |  |
| `0xb28` | `m_attachmentPointBoneSpace` | Vector |  |  |
| `0xb34` | `m_attachmentPointRagdollSpace` | Vector |  |  |
| `0xb40` | `m_bShouldDetach` | bool |  |  |
| `0xb50` | `m_bShouldDeleteAttachedActivationRecord` | bool |  | `MNotSaved` |
