...
**Kind:** class · **Size:** 2200 bytes (`0x898`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseModelEntity](../server/CBaseModelEntity.md)

**Derived by:** [CFuncTankTrain](../server/CFuncTankTrain.md)
...
| `0x770` | `m_ppath` | CHandle< [CPathTrack](../server/CPathTrack.md) > |  |  |
| `0x774` | `m_length` | float32 |  |  |
| `0x778` | `m_vPosPrev` | Vector |  |  |
| `0x784` | `m_angPrev` | QAngle |  |  |
| `0x790` | `m_flSpeed` | float32 |  |  |
| `0x794` | `m_controlMins` | Vector |  |  |
| `0x7a0` | `m_controlMaxs` | Vector |  |  |
| `0x7ac` | `m_lastBlockPos` | VectorWS |  | `MNotSaved` |
| `0x7b8` | `m_lastBlockTick` | int32 |  | `MNotSaved` |
| `0x7bc` | `m_flVolume` | float32 |  |  |
| `0x7c0` | `m_flBank` | float32 |  |  |
| `0x7c4` | `m_oldSpeed` | float32 |  |  |
| `0x7c8` | `m_flBlockDamage` | float32 |  |  |
| `0x7cc` | `m_height` | float32 |  |  |
| `0x7d0` | `m_maxSpeed` | float32 |  |  |
| `0x7d4` | `m_dir` | float32 |  |  |
| `0x7d8` | `m_iszSoundMove` | CGameSoundEventName |  |  |
| `0x7e0` | `m_iszSoundMovePing` | CGameSoundEventName |  |  |
| `0x7e8` | `m_iszSoundStart` | CGameSoundEventName |  |  |
| `0x7f0` | `m_iszSoundStop` | CGameSoundEventName |  |  |
| `0x7f8` | `m_strPathTarget` | CGameSoundEventName |  |  |
| `0x800` | `m_flMoveSoundMinDuration` | float32 |  |  |
| `0x804` | `m_flMoveSoundMaxDuration` | float32 |  |  |
| `0x808` | `m_flNextMoveSoundTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x80c` | `m_flMoveSoundMinPitch` | float32 |  |  |
| `0x810` | `m_flMoveSoundMaxPitch` | float32 |  |  |
| `0x814` | `m_eOrientationType` | [TrainOrientationType_t](../!GlobalTypes/TrainOrientationType_t.md) |  |  |
| `0x818` | `m_eVelocityType` | [TrainVelocityType_t](../!GlobalTypes/TrainVelocityType_t.md) |  |  |
| `0x830` | `m_OnStart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x848` | `m_OnNext` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x860` | `m_OnArrivedAtDestinationNode` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x878` | `m_bManualSpeedChanges` | bool |  |  |
| `0x87c` | `m_flDesiredSpeed` | float32 |  | `MNotSaved` |
| `0x880` | `m_flSpeedChangeTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0x884` | `m_flAccelSpeed` | float32 |  |  |
| `0x888` | `m_flDecelSpeed` | float32 |  |  |
| `0x88c` | `m_bAccelToSpeed` | bool |  | `MNotSaved` |
| `0x890` | `m_flNextMPSoundTime` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
