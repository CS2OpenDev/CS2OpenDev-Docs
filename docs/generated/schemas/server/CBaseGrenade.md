...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseGrenade

# CBaseGrenade

**Kind:** class · **Size:** 2544 bytes (`0x9f0`) · **Align:** 16 · **Module:** server

**Inherits from:** [CBaseAnimGraph](../server/CBaseAnimGraph.md)

**Derived by:** [CBaseCSGrenadeProjectile](../server/CBaseCSGrenadeProjectile.md)
...
161 fields (15 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x968` | `m_bDamageDetonating` | bool |  |  |
| `0x970` | `m_OnPlayerPickup` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x988` | `m_OnExplode` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x9a0` | `m_bHasWarnedAI` | bool |  |  |
| `0x9a1` | `m_bIsSmokeGrenade` | bool |  |  |
| `0x9a2` | `m_bIsLive` | bool |  |  |
| `0x9a4` | `m_DmgRadius` | float32 |  |  |
| `0x9a8` | `m_flDetonateTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x9ac` | `m_flWarnAITime` | float32 |  |  |
| `0x9b0` | `m_flDamage` | float32 |  |  |
| `0x9b8` | `m_iszBounceSound` | CUtlSymbolLarge |  |  |
| `0x9c0` | `m_ExplosionSound` | CUtlString |  |  |
| `0x9c8` | `m_hThrower` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > |  |  |
| `0x9e0` | `m_flNextAttack` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x9e4` | `m_hOriginalThrower` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > |  |  |
