...
196 fields (15 declared here, 181 inherited). Offsets are absolute from the object base.
...
| `0xc50` | `m_iPlayerState` | [CSPlayerState](../!GlobalTypes/CSPlayerState.md) |  | CSPlayerState enum: STATE_ACTIVE = 0 (alive), STATE_WELCOME = 1, STATE_PICKINGTEAM = 2, STATE_PICKINGCLASS = 3, STATE_DEATH_ANIM = 4, STATE_DEATH_WAIT_FOR_KEY = 5, STATE_OBSERVER_MODE = 6. |
