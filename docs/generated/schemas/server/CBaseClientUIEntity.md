...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseClientUIEntity

# CBaseClientUIEntity

**Kind:** class · **Size:** 2256 bytes (`0x8d0`) · **Align:** 255 · **Module:** server

**Inherits from:** [CBaseModelEntity](../server/CBaseModelEntity.md)

**Derived by:** [CPointClientUIDialog](../server/CPointClientUIDialog.md), [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md)
...
142 fields (14 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_DialogXMLName` | CUtlSymbolLarge |  |  |
| `0x780` | `m_PanelClassName` | CUtlSymbolLarge |  |  |
| `0x788` | `m_PanelID` | CUtlSymbolLarge |  |  |
| `0x790` | `m_CustomOutput0` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x7b0` | `m_CustomOutput1` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x7d0` | `m_CustomOutput2` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x7f0` | `m_CustomOutput3` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x810` | `m_CustomOutput4` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x830` | `m_CustomOutput5` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x850` | `m_CustomOutput6` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x870` | `m_CustomOutput7` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x890` | `m_CustomOutput8` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x8b0` | `m_CustomOutput9` | CEntityOutputTemplate< CUtlString > |  |  |
