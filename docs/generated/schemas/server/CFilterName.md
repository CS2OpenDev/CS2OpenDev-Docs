---
layout: default
title: CFilterName (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CFilterName
...
**Twin:** [CFilterName (client)](../client/CFilterName.md)
...
| `0x4e0` | `m_iFilterName` | CUtlSymbolLarge |  |  |
