...
[Schemas](../../schemas.md) / [server](../server.md) / CGamePlayerZone

# CGamePlayerZone

**Kind:** class · **Size:** 2024 bytes (`0x7e8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CRuleBrushEntity](../server/CRuleBrushEntity.md)
...
133 fields (4 declared here, 129 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_OnPlayerInZone` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x790` | `m_OnPlayerOutZone` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7a8` | `m_PlayersInCount` | CEntityOutputTemplate< int32 > |  |  |
| `0x7c8` | `m_PlayersOutCount` | CEntityOutputTemplate< int32 > |  |  |
