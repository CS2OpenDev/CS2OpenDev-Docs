...
[Schemas](../../schemas.md) / [server](../server.md) / CModelPointEntity
...
**Derived by:** [CEnvExplosion](../server/CEnvExplosion.md), [CPlayerSprayDecal](../server/CPlayerSprayDecal.md), [CPointWorldText](../server/CPointWorldText.md), [CRevertSaved](../server/CRevertSaved.md), [CShower](../server/CShower.md)
...
128 fields (0 declared here, 128 inherited). Offsets are absolute from the object base.
