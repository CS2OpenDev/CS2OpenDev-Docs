...
[Schemas](../../schemas.md) / [server](../server.md) / CInfoPlayerCounterterrorist

# CInfoPlayerCounterterrorist

**Kind:** class · **Size:** 1208 bytes (`0x4b8`) · **Align:** 8 · **Module:** server

**Inherits from:** [SpawnPoint](../server/SpawnPoint.md)
...
| `0x4a8` | `m_iPriority` | int32 | [SpawnPoint](../server/SpawnPoint.md) |  |
| `0x4ac` | `m_bEnabled` | bool | [SpawnPoint](../server/SpawnPoint.md) |  |
| `0x4b0` | `m_nType` | int32 | [SpawnPoint](../server/SpawnPoint.md) |  |
