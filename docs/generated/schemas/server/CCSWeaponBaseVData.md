...
| `0x4c6` | `m_iFlags` | [ItemFlagTypes_t](../server/ItemFlagTypes_t.md) | [CBasePlayerWeaponVData](../server/CBasePlayerWeaponVData.md) |  |
...
| `0x4e4` | `m_iRumbleEffect` | [RumbleEffect_t](../server/RumbleEffect_t.md) | [CBasePlayerWeaponVData](../server/CBasePlayerWeaponVData.md) | `MPropertyStartGroup UI` |
...
| `0x4f8` | `m_aShootSounds` | CUtlOrderedMap< [WeaponSound_t](../server/WeaponSound_t.md), CSoundEventName > | [CBasePlayerWeaponVData](../server/CBasePlayerWeaponVData.md) | `MPropertyStartGroup Sounds` |
