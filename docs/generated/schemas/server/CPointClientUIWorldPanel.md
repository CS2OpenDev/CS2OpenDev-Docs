...
[Schemas](../../schemas.md) / [server](../server.md) / CPointClientUIWorldPanel

# CPointClientUIWorldPanel

**Kind:** class · **Size:** 2352 bytes (`0x930`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseClientUIEntity](../server/CBaseClientUIEntity.md)

**Derived by:** [CPointClientUIWorldTextPanel](../server/CPointClientUIWorldTextPanel.md)
...
167 fields (25 declared here, 142 inherited). Offsets are absolute from the object base.
...
| `0x8d0` | `m_bIgnoreInput` | bool |  |  |
| `0x8d1` | `m_bLit` | bool |  |  |
| `0x8d2` | `m_bFollowPlayerAcrossTeleport` | bool |  |  |
| `0x8d4` | `m_flWidth` | float32 |  |  |
| `0x8d8` | `m_flHeight` | float32 |  |  |
| `0x8dc` | `m_flDPI` | float32 |  |  |
| `0x8e0` | `m_flInteractDistance` | float32 |  |  |
| `0x8e4` | `m_flDepthOffset` | float32 |  |  |
| `0x8e8` | `m_unOwnerContext` | uint32 |  |  |
| `0x8ec` | `m_unHorizontalAlign` | uint32 |  |  |
| `0x8f0` | `m_unVerticalAlign` | uint32 |  |  |
| `0x8f4` | `m_unOrientation` | uint32 |  |  |
| `0x8f8` | `m_bAllowInteractionFromAllSceneWorlds` | bool |  |  |
| `0x900` | `m_vecCSSClasses` | CNetworkUtlVectorBase< CUtlSymbolLarge > |  |  |
| `0x918` | `m_bOpaque` | bool |  |  |
| `0x919` | `m_bNoDepth` | bool |  |  |
| `0x91a` | `m_bVisibleWhenParentNoDraw` | bool |  |  |
| `0x91b` | `m_bRenderBackface` | bool |  |  |
| `0x91c` | `m_bUseOffScreenIndicator` | bool |  |  |
| `0x91d` | `m_bExcludeFromSaveGames` | bool |  |  |
| `0x91e` | `m_bGrabbable` | bool |  |  |
| `0x91f` | `m_bOnlyRenderToTexture` | bool |  |  |
| `0x920` | `m_bDisableMipGen` | bool |  |  |
| `0x924` | `m_nExplicitImageLayout` | int32 |  |  |
| `0x928` | `m_bIgnoreParentOrientation` | bool |  |  |
