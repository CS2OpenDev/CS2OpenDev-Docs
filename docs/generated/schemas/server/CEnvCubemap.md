...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvCubemap
...
**Derived by:** [CEnvCubemapBox](../server/CEnvCubemapBox.md)
...
106 fields (18 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x528` | `m_Entity_hCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x530` | `m_Entity_bCustomCubemapTexture` | bool |  |  |
| `0x534` | `m_Entity_flInfluenceRadius` | float32 |  |  |
| `0x538` | `m_Entity_vBoxProjectMins` | Vector |  |  |
| `0x544` | `m_Entity_vBoxProjectMaxs` | Vector |  |  |
| `0x550` | `m_Entity_bMoveable` | bool |  |  |
| `0x554` | `m_Entity_nHandshake` | int32 |  |  |
| `0x558` | `m_Entity_nEnvCubeMapArrayIndex` | int32 |  |  |
| `0x55c` | `m_Entity_nPriority` | int32 |  |  |
| `0x560` | `m_Entity_flEdgeFadeDist` | float32 |  |  |
| `0x564` | `m_Entity_vEdgeFadeDists` | Vector |  |  |
| `0x570` | `m_Entity_flDiffuseScale` | float32 |  |  |
| `0x574` | `m_Entity_bStartDisabled` | bool |  |  |
| `0x575` | `m_Entity_bDefaultEnvMap` | bool |  |  |
| `0x576` | `m_Entity_bDefaultSpecEnvMap` | bool |  |  |
| `0x577` | `m_Entity_bIndoorCubeMap` | bool |  |  |
| `0x578` | `m_Entity_bCopyDiffuseFromDefaultCubemap` | bool |  |  |
| `0x588` | `m_Entity_bEnabled` | bool |  |  |
