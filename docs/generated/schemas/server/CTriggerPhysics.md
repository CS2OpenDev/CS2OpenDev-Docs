...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerPhysics

# CTriggerPhysics

**Kind:** class · **Size:** 2376 bytes (`0x948`) · **Align:** 8 · **Module:** server
...
| `0x8f0` | `m_pController` | [IPhysicsMotionController](../vphysics2/IPhysicsMotionController.md)* |  | `MPhysPtr` |
| `0x8f8` | `m_gravityScale` | float32 |  |  |
| `0x8fc` | `m_linearLimit` | float32 |  |  |
| `0x900` | `m_linearDamping` | float32 |  |  |
| `0x904` | `m_angularLimit` | float32 |  |  |
| `0x908` | `m_angularDamping` | float32 |  |  |
| `0x90c` | `m_linearForce` | float32 |  |  |
| `0x910` | `m_flFrequency` | float32 |  |  |
| `0x914` | `m_flDampingRatio` | float32 |  |  |
| `0x918` | `m_vecLinearForcePointAt` | Vector |  |  |
| `0x924` | `m_bCollapseToForcePoint` | bool |  |  |
| `0x928` | `m_vecLinearForcePointAtWorld` | VectorWS |  |  |
| `0x934` | `m_vecLinearForceDirection` | Vector |  |  |
| `0x940` | `m_bConvertToDebrisWhenPossible` | bool |  |  |
