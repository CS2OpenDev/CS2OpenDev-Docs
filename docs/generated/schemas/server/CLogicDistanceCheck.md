...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicDistanceCheck
...
| `0x4a8` | `m_iszEntityA` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_iszEntityB` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_flZone1Distance` | float32 |  |  |
| `0x4bc` | `m_flZone2Distance` | float32 |  |  |
| `0x4c0` | `m_InZone1` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d8` | `m_InZone2` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4f0` | `m_InZone3` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
