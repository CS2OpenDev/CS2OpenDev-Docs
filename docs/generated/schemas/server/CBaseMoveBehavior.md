...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseMoveBehavior

# CBaseMoveBehavior

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1312 bytes (`0x520`) · **Align:** 16 · **Module:** server

**Inherits from:** [CPathKeyFrame](../server/CPathKeyFrame.md)
...
107 fields (11 declared here, 96 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_Origin` | Vector | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4b4` | `m_Angles` | QAngle | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4c0` | `m_qAngle` | Quaternion | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4d0` | `m_iNextKey` | CUtlSymbolLarge | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4d8` | `m_flNextTime` | float32 | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4dc` | `m_pNextKey` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4e0` | `m_pPrevKey` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4e4` | `m_flMoveSpeed` | float32 | [CPathKeyFrame](../server/CPathKeyFrame.md) |  |
| `0x4f0` | `m_iPositionInterpolator` | int32 |  |  |
| `0x4f4` | `m_iRotationInterpolator` | int32 |  |  |
| `0x4f8` | `m_flAnimStartTime` | float32 |  |  |
| `0x4fc` | `m_flAnimEndTime` | float32 |  |  |
| `0x500` | `m_flAverageSpeedAcrossFrame` | float32 |  |  |
| `0x504` | `m_pCurrentKeyFrame` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x508` | `m_pTargetKeyFrame` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x50c` | `m_pPreKeyFrame` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x510` | `m_pPostKeyFrame` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x514` | `m_flTimeIntoFrame` | float32 |  |  |
| `0x518` | `m_iDirection` | int32 |  |  |
