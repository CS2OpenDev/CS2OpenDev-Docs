...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncElectrifiedVolume
...
138 fields (4 declared here, 134 inherited). Offsets are absolute from the object base.
...
| `0x790` | `m_EffectName` | CUtlSymbolLarge |  |  |
| `0x798` | `m_EffectInterpenetrateName` | CUtlSymbolLarge |  |  |
| `0x7a0` | `m_EffectZapName` | CUtlSymbolLarge |  |  |
| `0x7a8` | `m_iszEffectSource` | CUtlSymbolLarge |  |  |
