...
[Schemas](../../schemas.md) / [server](../server.md) / CItemGeneric

# CItemGeneric

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2864 bytes (`0xb30`) · **Align:** 16 · **Module:** server

**Inherits from:** [CItem](../server/CItem.md)
...
183 fields (32 declared here, 151 inherited). Offsets are absolute from the object base.
...
| `0x968` | `m_OnPlayerTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CItem](../server/CItem.md) |  |
| `0x980` | `m_OnPlayerPickup` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CItem](../server/CItem.md) | Entity I/O output fired when a player picks the item up. |
| `0x998` | `m_bActivateWhenAtRest` | bool | [CItem](../server/CItem.md) | Whether the item only becomes pickup-able once it has come to rest. |
| `0x9a0` | `m_OnCacheInteraction` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CItem](../server/CItem.md) |  |
| `0x9b8` | `m_OnGlovePulled` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CItem](../server/CItem.md) |  |
| `0x9d0` | `m_vOriginalSpawnOrigin` | VectorWS | [CItem](../server/CItem.md) |  |
| `0x9dc` | `m_vOriginalSpawnAngles` | QAngle | [CItem](../server/CItem.md) |  |
| `0x9e8` | `m_bPhysStartAsleep` | bool | [CItem](../server/CItem.md) | `MNotSaved` |
| `0xa14` | `m_bHasTriggerRadius` | bool |  | `MNotSaved` |
| `0xa15` | `m_bHasPickupRadius` | bool |  | `MNotSaved` |
| `0xa18` | `m_flPickupRadiusSqr` | float32 |  | `MNotSaved` |
| `0xa1c` | `m_flTriggerRadiusSqr` | float32 |  | `MNotSaved` |
| `0xa20` | `m_flLastPickupCheck` | [GameTime_t](../entity2/GameTime_t.md) |  | `MNotSaved` |
| `0xa24` | `m_bPlayerCounterListenerAdded` | bool |  | `MNotSaved` |
| `0xa25` | `m_bPlayerInTriggerRadius` | bool |  | `MNotSaved` |
| `0xa28` | `m_hSpawnParticleEffect` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0xa30` | `m_pAmbientSoundEffect` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa38` | `m_bAutoStartAmbientSound` | bool |  | `MNotSaved` |
| `0xa40` | `m_pSpawnScriptFunction` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa48` | `m_hPickupParticleEffect` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0xa50` | `m_pPickupSoundEffect` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa58` | `m_pPickupScriptFunction` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa60` | `m_hTimeoutParticleEffect` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | `MNotSaved` |
| `0xa68` | `m_pTimeoutSoundEffect` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa70` | `m_pTimeoutScriptFunction` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa78` | `m_pPickupFilterName` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xa80` | `m_hPickupFilter` | CHandle< [CBaseFilter](../server/CBaseFilter.md) > |  | `MNotSaved` |
| `0xa88` | `m_OnPickup` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xaa0` | `m_OnTimeout` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xab8` | `m_OnTriggerStartTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xad0` | `m_OnTriggerTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xae8` | `m_OnTriggerEndTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xb00` | `m_pAllowPickupScriptFunction` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xb08` | `m_flPickupRadius` | float32 |  | `MNotSaved` |
| `0xb0c` | `m_flTriggerRadius` | float32 |  | `MNotSaved` |
| `0xb10` | `m_pTriggerSoundEffect` | CUtlSymbolLarge |  | `MNotSaved` |
| `0xb18` | `m_bGlowWhenInTrigger` | bool |  | `MNotSaved` |
| `0xb19` | `m_glowColor` | Color |  | `MNotSaved` |
| `0xb1d` | `m_bUseable` | bool |  | `MNotSaved` |
| `0xb20` | `m_hTriggerHelper` | CHandle< [CItemGenericTriggerHelper](../server/CItemGenericTriggerHelper.md) > |  | `MNotSaved` |
