...
[Schemas](../../schemas.md) / [server](../server.md) / CPathMover

# CPathMover

**Kind:** class · **Size:** 1600 bytes (`0x640`) · **Align:** 16 · **Module:** server

**Inherits from:** [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md)
...
96 fields (6 declared here, 90 inherited). Offsets are absolute from the object base.
...
| `0x5f0` | `m_vecMovers` | CUtlVector< CHandle< [CFuncMover](../server/CFuncMover.md) > > |  |  |
...
| `0x608` | `m_vecSpawners` | CUtlVector< CHandle< [CPathMoverEntitySpawner](../server/CPathMoverEntitySpawner.md) > > |  |  |
| `0x610` | `m_CPathQueryComponent` | [CPathQueryComponent](../server/CPathQueryComponent.md) | [CPathSimple](../server/CPathSimple.md) |  |
| `0x620` | `m_iszMoverSpawnerName` | CUtlSymbolLarge |  |  |
| `0x628` | `m_hMoverRouter` | CHandle< [CFuncMoverRouter](../server/CFuncMoverRouter.md) > |  |  |
| `0x630` | `m_iszMoverRouterName` | CUtlSymbolLarge |  |  |
| `0x638` | `m_flSampleSpacing` | float32 |  |  |
| `0x700` | `m_pathString` | CUtlString | [CPathSimple](../server/CPathSimple.md) |  |
| `0x708` | `m_bClosedLoop` | bool | [CPathSimple](../server/CPathSimple.md) |  |
| `0x710` | `m_vecPathNodes` | C_NetworkUtlVectorBase< CHandle< [CPathNode](../server/CPathNode.md) > > | [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md) |  |
| `0x730` | `m_xInitialPathWorldToLocal` | CTransform | [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md) |  |
