...
**Kind:** class · **Size:** 4176 bytes (`0x1050`) · **Align:** 255 · **Module:** server
...
215 fields (52 declared here, 163 inherited). Offsets are absolute from the object base.
...
| `0xcdc` | `m_iWeaponGameplayAnimState` | [WeaponGameplayAnimState](../!GlobalTypes/WeaponGameplayAnimState.md) |  | WeaponGameplayAnimState enum controlling the weapon's anim-graph state (idle, firing, reloading, inspecting, etc.). |
...
| `0xd50` | `m_weaponMode` | [CSWeaponMode](../!GlobalTypes/CSWeaponMode.md) |  | CSWeaponMode enum: Primary_Mode = 0, Secondary_Mode = 1. Governs which attack function runs on fire. |
