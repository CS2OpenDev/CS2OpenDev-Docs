...
[Schemas](../../schemas.md) / [server](../server.md) / CCSWeaponBase
...
**Kind:** class · **Size:** 4176 bytes (`0x1050`) · **Align:** n/a (unspecified) · **Module:** server

**Inherits from:** [CBasePlayerWeapon](../server/CBasePlayerWeapon.md)

**Derived by:** [CBaseCSGrenade](../server/CBaseCSGrenade.md), [CC4](../server/CC4.md), [CCSWeaponBaseGun](../server/CCSWeaponBaseGun.md), [CCSWeaponBaseShotgun](../server/CCSWeaponBaseShotgun.md), [CKnife](../server/CKnife.md), [CWeaponBaseItem](../server/CWeaponBaseItem.md)
...
212 fields (52 declared here, 160 inherited). Offsets are absolute from the object base.
...
| `0xcd8` | `m_bRemoveable` | bool |  |  |
| `0xcd9` | `m_bPlayerAmmoStockOnPickup` | bool |  |  |
| `0xcda` | `m_bRequireUseToTouch` | bool |  |  |
| `0xcdc` | `m_iWeaponGameplayAnimState` | [WeaponGameplayAnimState](../server/WeaponGameplayAnimState.md) |  | WeaponGameplayAnimState enum controlling the weapon's anim-graph state (idle, firing, reloading, inspecting, etc.). |
| `0xce0` | `m_flWeaponGameplayAnimStateTimestamp` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xce4` | `m_flInspectCancelCompleteTime` | [GameTime_t](../entity2/GameTime_t.md) |  | GameTime at which an in-progress inspect cancel animation will finish. |
| `0xce8` | `m_bInspectPending` | bool |  | True when an inspect animation has been queued but not yet started. |
| `0xce9` | `m_bInspectShouldLoop` | bool |  | True when the inspect animation should loop (held-inspect mode). |
| `0xd14` | `m_nLastEmptySoundCmdNum` | int32 |  |  |
| `0xd30` | `m_bFireOnEmpty` | bool |  |  |
| `0xd38` | `m_OnPlayerPickup` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xd50` | `m_weaponMode` | [CSWeaponMode](../server/CSWeaponMode.md) |  | CSWeaponMode enum: Primary_Mode = 0, Secondary_Mode = 1. Governs which attack function runs on fire. |
| `0xd54` | `m_flTurningInaccuracyDelta` | float32 |  |  |
| `0xd58` | `m_vecTurningInaccuracyEyeDirLast` | Vector |  |  |
| `0xd64` | `m_flTurningInaccuracy` | float32 |  |  |
| `0xd68` | `m_fAccuracyPenalty` | float32 |  | Additive inaccuracy penalty accumulated by recent shots; decays over time. Feeds into the cone-spread calculation. |
| `0xd6c` | `m_flLastAccuracyUpdateTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xd70` | `m_fAccuracySmoothedForZoom` | float32 |  |  |
| `0xd74` | `m_iRecoilIndex` | int32 |  | Integer index into the weapon's recoil table; incremented with each shot, decays when not firing. |
| `0xd78` | `m_flRecoilIndex` | float32 |  | Fractional recoil index for sub-step interpolation of the recoil pattern table. *Demo parsers often use this to reproduce exact spray patterns.* |
| `0xd7c` | `m_bBurstMode` | bool |  | True when the weapon is in burst-fire mode (e.g. Famas burst, Glock18 burst). |
| `0xd80` | `m_nPostponeFireReadyTicks` | [GameTick_t](../entity2/GameTick_t.md) |  | Tick after which a postponed shot will fire (used for the tick-aligned fire mechanism in sub-tick shooting). |
| `0xd84` | `m_flPostponeFireReadyFrac` | float32 |  | Fractional tick ratio for m_nPostponeFireReadyTicks. |
| `0xd88` | `m_bInReload` | bool |  | True while the weapon is performing its reload animation. |
| `0xd8c` | `m_nDeployTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0xd90` | `m_flDroppedAtTime` | [GameTime_t](../entity2/GameTime_t.md) |  | GameTime at which this weapon was dropped onto the ground. |
| `0xd98` | `m_bIsHauledBack` | bool |  | True while the player is winding up to throw a grenade (held throw). |
| `0xd99` | `m_bSilencerOn` | bool |  | True when the suppressor is attached (M4A1-S / USP-S). |
| `0xd9c` | `m_flTimeSilencerSwitchComplete` | [GameTime_t](../entity2/GameTime_t.md) |  | GameTime at which the suppressor attach/detach animation completes. |
| `0xda0` | `m_flWeaponActionPlaybackRate` | float32 |  |  |
| `0xda4` | `m_iOriginalTeamNumber` | int32 |  | Team that originally spawned this weapon; buy-zone weapon pools are filtered by this. |
| `0xda8` | `m_iMostRecentTeamNumber` | int32 |  | Team of the player most recently holding this weapon. |
| `0xdac` | `m_bDroppedNearBuyZone` | bool |  | True if the weapon was dropped close to a buy zone (affects whether bots will pick it up). |
| `0xdb0` | `m_flNextAttackRenderTimeOffset` | float32 |  |  |
| `0xdc8` | `m_bCanBePickedUp` | bool |  |  |
| `0xdc9` | `m_bUseCanOverrideNextOwnerTouchTime` | bool |  |  |
| `0xdcc` | `m_nextOwnerTouchTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xdd0` | `m_nextPrevOwnerTouchTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xdd8` | `m_nextPrevOwnerUseTime` | [GameTime_t](../entity2/GameTime_t.md) |  | GameTime before which the previous owner cannot pick this weapon back up (prevents instant re-pickup after dropping). |
| `0xddc` | `m_hPrevOwner` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > |  | CHandle to the CCSPlayerPawn that most recently owned this weapon before it was dropped. |
| `0xde0` | `m_nDropTick` | [GameTick_t](../entity2/GameTick_t.md) |  | Server tick on which the weapon was most recently dropped. |
| `0xde4` | `m_bWasActiveWeaponWhenDropped` | bool |  | True if the weapon was the active weapon at the moment it was dropped. |
| `0xe04` | `m_donated` | bool |  |  |
| `0xe08` | `m_fLastShotTime` | [GameTime_t](../entity2/GameTime_t.md) |  | GameTime of the most recent shot fired from this weapon. |
| `0xe0c` | `m_bWasOwnedByCT` | bool |  |  |
| `0xe0d` | `m_bWasOwnedByTerrorist` | bool |  |  |
| `0xe10` | `m_numRemoveUnownedWeaponThink` | int32 |  |  |
| `0xe70` | `m_IronSightController` | [CIronSightController](../server/CIronSightController.md) |  |  |
| `0xe88` | `m_iIronSightMode` | int32 |  | Iron-sight zoom state (0 = none, 1 = iron-sighted). |
| `0xe8c` | `m_flLastLOSTraceFailureTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xe90` | `m_flWatTickOffset` | float32 |  |  |
| `0xea0` | `m_flLastShakeTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
