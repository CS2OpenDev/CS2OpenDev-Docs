---
title: CFilterMultiple (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CFilterMultiple

# CFilterMultiple

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1376 bytes (`0x560`) · **Align:** 8 · **Module:** server

**Twin:** [CFilterMultiple (client)](../client/CFilterMultiple.md)

**Inherits from:** [CBaseFilter](../server/CBaseFilter.md)
...
94 fields (3 declared here, 91 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_bNegated` | bool | [CBaseFilter](../server/CBaseFilter.md) |  |
| `0x4b0` | `m_OnPass` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseFilter](../server/CBaseFilter.md) |  |
| `0x4c8` | `m_OnFail` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseFilter](../server/CBaseFilter.md) |  |
| `0x4e0` | `m_nFilterType` | filter_t |  |  |
| `0x4e8` | `m_iFilterName` | CUtlSymbolLarge[10] |  |  |
| `0x538` | `m_hFilter` | CHandle< [CBaseEntity](../server/CBaseEntity.md) >[10] |  |  |
