...
[Schemas](../../schemas.md) / [server](../server.md) / CMultiLightProxy
...
| `0x4a8` | `m_iszLightNameFilter` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_iszLightClassFilter` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_flLightRadiusFilter` | float32 |  |  |
| `0x4bc` | `m_flBrightnessDelta` | float32 |  |  |
| `0x4c0` | `m_bPerformScreenFade` | bool |  |  |
| `0x4c4` | `m_flTargetBrightnessMultiplier` | float32 |  |  |
| `0x4c8` | `m_flCurrentBrightnessMultiplier` | float32 |  |  |
| `0x4d0` | `m_vecLights` | CUtlVector< CHandle< [CLightEntity](../server/CLightEntity.md) > > |  |  |
