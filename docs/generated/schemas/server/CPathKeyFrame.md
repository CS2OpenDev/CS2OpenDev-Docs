...
[Schemas](../../schemas.md) / [server](../server.md) / CPathKeyFrame

# CPathKeyFrame

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1264 bytes (`0x4f0`) · **Align:** 16 · **Module:** server

**Inherits from:** [CLogicalEntity](../server/CLogicalEntity.md)

**Derived by:** [CBaseMoveBehavior](../server/CBaseMoveBehavior.md)
...
| `0x4a8` | `m_Origin` | Vector |  |  |
| `0x4b4` | `m_Angles` | QAngle |  |  |
| `0x4c0` | `m_qAngle` | Quaternion |  |  |
| `0x4d0` | `m_iNextKey` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_flNextTime` | float32 |  |  |
| `0x4dc` | `m_pNextKey` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x4e0` | `m_pPrevKey` | CHandle< [CPathKeyFrame](../server/CPathKeyFrame.md) > |  |  |
| `0x4e4` | `m_flMoveSpeed` | float32 |  |  |
