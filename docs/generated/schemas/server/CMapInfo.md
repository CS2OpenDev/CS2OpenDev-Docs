---
title: CMapInfo (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CMapInfo
...
**Twin:** [CMapInfo (client)](../client/CMapInfo.md)
...
| `0x4a8` | `m_iBuyingStatus` | int32 |  |  |
| `0x4ac` | `m_flBombRadius` | float32 |  |  |
| `0x4b0` | `m_iPetPopulation` | int32 |  |  |
| `0x4b4` | `m_bUseNormalSpawnsForDM` | bool |  |  |
| `0x4b5` | `m_bDisableAutoGeneratedDMSpawns` | bool |  |  |
| `0x4b8` | `m_flBotMaxVisionDistance` | float32 |  |  |
| `0x4bc` | `m_iHostageCount` | int32 |  |  |
| `0x4c0` | `m_bFadePlayerVisibilityFarZ` | bool |  |  |
| `0x4c1` | `m_bRainTraceToSkyEnabled` | bool |  |  |
| `0x4c2` | `m_bGPUCullSkybox` | bool |  |  |
| `0x4c4` | `m_flEnvRainStrength` | float32 |  |  |
| `0x4c8` | `m_flEnvPuddleRippleStrength` | float32 |  |  |
| `0x4cc` | `m_flEnvPuddleRippleDirection` | float32 |  |  |
| `0x4d0` | `m_flEnvWetnessCoverage` | float32 |  |  |
| `0x4d4` | `m_flEnvWetnessDryingAmount` | float32 |  |  |
