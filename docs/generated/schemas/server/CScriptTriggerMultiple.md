...
[Schemas](../../schemas.md) / [server](../server.md) / CScriptTriggerMultiple
...
159 fields (1 declared here, 158 inherited). Offsets are absolute from the object base.
