...
[Schemas](../../schemas.md) / [server](../server.md) / CSceneEntity

# CSceneEntity

**Kind:** class · **Size:** 2032 bytes (`0x7f0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CPointEntity](../server/CPointEntity.md)

**Derived by:** [CInstancedSceneEntity](../server/CInstancedSceneEntity.md), [CSceneEntityAlias_logic_choreographed_scene](../server/CSceneEntityAlias_logic_choreographed_scene.md)
...
153 fields (65 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4b0` | `m_iszSceneFile` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_iszTarget1` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_iszTarget2` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_iszTarget3` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_iszTarget4` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_iszTarget5` | CUtlSymbolLarge |  |  |
| `0x4e0` | `m_iszTarget6` | CUtlSymbolLarge |  |  |
| `0x4e8` | `m_iszTarget7` | CUtlSymbolLarge |  |  |
| `0x4f0` | `m_iszTarget8` | CUtlSymbolLarge |  |  |
| `0x4f8` | `m_hTarget1` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4fc` | `m_hTarget2` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x500` | `m_hTarget3` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x504` | `m_hTarget4` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x508` | `m_hTarget5` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x50c` | `m_hTarget6` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x510` | `m_hTarget7` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x514` | `m_hTarget8` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x518` | `m_hLocatorOrigin` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x520` | `m_sTargetAttachment` | CUtlSymbolLarge |  |  |
| `0x528` | `m_bIsPlayingBack` | bool |  |  |
| `0x529` | `m_bPaused` | bool |  |  |
| `0x52a` | `m_bMultiplayer` | bool |  |  |
| `0x52b` | `m_bAutogenerated` | bool |  |  |
| `0x52c` | `m_flForceClientTime` | float32 |  |  |
| `0x530` | `m_flCurrentTime` | float32 |  |  |
| `0x534` | `m_flFrameTime` | float32 |  |  |
| `0x538` | `m_bCancelAtNextInterrupt` | bool |  |  |
| `0x53c` | `m_fPitch` | float32 |  |  |
| `0x540` | `m_bAutomated` | bool |  |  |
| `0x544` | `m_nAutomatedAction` | int32 |  |  |
| `0x548` | `m_flAutomationDelay` | float32 |  |  |
| `0x54c` | `m_flAutomationTime` | float32 |  |  |
| `0x550` | `m_nSpeechPriority` | int32 |  |  |
| `0x554` | `m_bPausedViaInput` | bool |  |  |
| `0x555` | `m_bPauseAtNextInterrupt` | bool |  |  |
| `0x556` | `m_bWaitingForActor` | bool |  |  |
| `0x557` | `m_bWaitingForInterrupt` | bool |  |  |
| `0x558` | `m_bInterruptedActorsScenes` | bool |  |  |
| `0x559` | `m_bBreakOnNonIdle` | bool |  |  |
| `0x55a` | `m_bSceneFinished` | bool |  |  |
| `0x560` | `m_hActorList` | CNetworkUtlVectorBase< CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > > |  |  |
| `0x578` | `m_hRemoveActorList` | CUtlVector< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  |  |
| `0x5c0` | `m_nSceneStringIndex` | uint16 |  | `MNotSaved` |
| `0x5c8` | `m_OnStart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x5e0` | `m_OnCompletion` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x5f8` | `m_OnCanceled` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x610` | `m_OnPaused` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x628` | `m_OnResumed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x640` | `m_OnPulseRequirement` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x748` | `m_ActorMap` | CUtlVector< [ActorMapping_t](../server/ActorMapping_t.md) > |  |  |
| `0x788` | `m_hInterruptScene` | CHandle< [CSceneEntity](../server/CSceneEntity.md) > |  |  |
| `0x78c` | `m_nInterruptCount` | int32 |  |  |
| `0x790` | `m_bSceneMissing` | bool |  | `MNotSaved` |
| `0x791` | `m_bInterrupted` | bool |  |  |
| `0x792` | `m_bCompletedEarly` | bool |  |  |
| `0x793` | `m_bInterruptSceneFinished` | bool |  |  |
| `0x794` | `m_bRestoring` | bool |  | `MNotSaved` |
| `0x798` | `m_hNotifySceneCompletion` | CUtlVector< CHandle< [CSceneEntity](../server/CSceneEntity.md) > > |  |  |
| `0x7b0` | `m_hListManagers` | CUtlVector< CHandle< [CSceneListManager](../server/CSceneListManager.md) > > |  |  |
| `0x7c8` | `m_iszSoundName` | CUtlSymbolLarge |  |  |
| `0x7d0` | `m_iszSequenceName` | CUtlSymbolLarge |  |  |
| `0x7d8` | `m_hActor` | CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > |  |  |
| `0x7dc` | `m_hActivator` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x7e0` | `m_BusyActor` | int32 |  |  |
| `0x7e4` | `m_iPlayerDeathBehavior` | [SceneOnPlayerDeath_t](../!GlobalTypes/SceneOnPlayerDeath_t.md) |  |  |
