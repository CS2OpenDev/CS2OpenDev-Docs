...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvCubemapBox

# CEnvCubemapBox

**Kind:** class · **Size:** 1424 bytes (`0x590`) · **Align:** 8 · **Module:** server

**Inherits from:** [CEnvCubemap](../server/CEnvCubemap.md)
...
106 fields (0 declared here, 106 inherited). Offsets are absolute from the object base.
...
| `0x528` | `m_Entity_hCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x530` | `m_Entity_bCustomCubemapTexture` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x534` | `m_Entity_flInfluenceRadius` | float32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x538` | `m_Entity_vBoxProjectMins` | Vector | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x544` | `m_Entity_vBoxProjectMaxs` | Vector | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x550` | `m_Entity_bMoveable` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x554` | `m_Entity_nHandshake` | int32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x558` | `m_Entity_nEnvCubeMapArrayIndex` | int32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x55c` | `m_Entity_nPriority` | int32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x560` | `m_Entity_flEdgeFadeDist` | float32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x564` | `m_Entity_vEdgeFadeDists` | Vector | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x570` | `m_Entity_flDiffuseScale` | float32 | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x574` | `m_Entity_bStartDisabled` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x575` | `m_Entity_bDefaultEnvMap` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x576` | `m_Entity_bDefaultSpecEnvMap` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x577` | `m_Entity_bIndoorCubeMap` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x578` | `m_Entity_bCopyDiffuseFromDefaultCubemap` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
| `0x588` | `m_Entity_bEnabled` | bool | [CEnvCubemap](../server/CEnvCubemap.md) |  |
