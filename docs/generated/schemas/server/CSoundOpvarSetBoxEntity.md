---
layout: default
title: CSoundOpvarSetBoxEntity (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetBoxEntity

# CSoundOpvarSetBoxEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1704 bytes (`0x6a8`) · **Align:** n/a (unspecified) · **Module:** server

**Twin:** [CSoundOpvarSetBoxEntity (client)](../client/CSoundOpvarSetBoxEntity.md)

**Inherits from:** [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md)

**Derived by:** [CSoundOpvarSetAABBEntity](../server/CSoundOpvarSetAABBEntity.md)
...
132 fields (9 declared here, 123 inherited). Offsets are absolute from the object base.
...
| `0x640` | `m_vDistanceInnerMins` | Vector |  |  |
| `0x64c` | `m_vDistanceInnerMaxs` | Vector |  |  |
| `0x658` | `m_vDistanceOuterMins` | Vector |  |  |
| `0x664` | `m_vDistanceOuterMaxs` | Vector |  |  |
| `0x670` | `m_nBoxDirection` | int32 |  |  |
| `0x674` | `m_vInnerMins` | Vector |  |  |
| `0x680` | `m_vInnerMaxs` | Vector |  |  |
| `0x68c` | `m_vOuterMins` | Vector |  |  |
| `0x698` | `m_vOuterMaxs` | Vector |  |  |
