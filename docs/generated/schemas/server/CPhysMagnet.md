...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysMagnet

# CPhysMagnet

**Kind:** class · **Size:** 2512 bytes (`0x9d0`) · **Align:** 16 · **Module:** server
...
| `0x960` | `m_OnMagnetAttach` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x978` | `m_OnMagnetDetach` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x990` | `m_massScale` | float32 |  |  |
| `0x994` | `m_forceLimit` | float32 |  |  |
| `0x998` | `m_torqueLimit` | float32 |  |  |
| `0x9a0` | `m_MagnettedEntities` | CUtlVector< magnetted_objects_t > |  |  |
| `0x9b8` | `m_bActive` | bool |  |  |
| `0x9b9` | `m_bHasHitSomething` | bool |  |  |
| `0x9bc` | `m_flTotalMass` | float32 |  |  |
| `0x9c0` | `m_flRadius` | float32 |  |  |
| `0x9c4` | `m_flNextSuckTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x9c8` | `m_iMaxObjectsAttached` | int32 |  |  |
