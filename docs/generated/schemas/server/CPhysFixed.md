...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysFixed
...
110 fields (8 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x508` | `m_flLinearFrequency` | float32 |  |  |
| `0x50c` | `m_flLinearDampingRatio` | float32 |  |  |
| `0x510` | `m_flAngularFrequency` | float32 |  |  |
| `0x514` | `m_flAngularDampingRatio` | float32 |  |  |
| `0x518` | `m_bEnableLinearConstraint` | bool |  |  |
| `0x519` | `m_bEnableAngularConstraint` | bool |  |  |
| `0x520` | `m_sBoneName1` | CUtlSymbolLarge |  |  |
| `0x528` | `m_sBoneName2` | CUtlSymbolLarge |  |  |
