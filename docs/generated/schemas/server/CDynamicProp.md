...
[Schemas](../../schemas.md) / [server](../server.md) / CDynamicProp

# CDynamicProp

**Kind:** class · **Size:** 2976 bytes (`0xba0`) · **Align:** 16 · **Module:** server

**Inherits from:** [CBreakableProp](../server/CBreakableProp.md)

**Derived by:** [CBasePropDoor](../server/CBasePropDoor.md), [CChicken](../server/CChicken.md), [CDynamicPropAlias_cable_dynamic](../server/CDynamicPropAlias_cable_dynamic.md), [CDynamicPropAlias_dynamic_prop](../server/CDynamicPropAlias_dynamic_prop.md), [CDynamicPropAlias_prop_dynamic_override](../server/CDynamicPropAlias_prop_dynamic_override.md), [COrnamentProp](../server/COrnamentProp.md)
...
206 fields (23 declared here, 183 inherited). Offsets are absolute from the object base.
...
| `0xaf8` | `m_bCreateNavObstacle` | bool |  |  |
| `0xaf8` | `m_CHitboxComponent` | [CHitboxComponent](../server/CHitboxComponent.md) | [C_BaseModelEntity](../client/C_BaseModelEntity.md) |  |
| `0xaf9` | `m_bNavObstacleUpdatesOverridden` | bool |  |  |
| `0xafa` | `m_bUseHitboxesForRenderBox` | bool |  |  |
| `0xafb` | `m_bUseAnimGraph` | bool |  |  |
| `0xb00` | `m_pOutputAnimBegun` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xb10` | `m_pChoreoComponent` | [CChoreoComponent](../server/CChoreoComponent.md)* | [C_BaseModelEntity](../client/C_BaseModelEntity.md) |  |
| `0xb18` | `m_pOutputAnimOver` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
...
| `0xb30` | `m_pOutputAnimLoopCycleOver` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
...
| `0xb48` | `m_OnAnimReachedStart` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
...
| `0xb60` | `m_OnAnimReachedEnd` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0xb78` | `m_iszIdleAnim` | CUtlSymbolLarge |  |  |
| `0xb80` | `m_nIdleAnimLoopMode` | [AnimLoopMode_t](../!GlobalTypes/AnimLoopMode_t.md) |  |  |
| `0xb84` | `m_bRandomizeCycle` | bool |  |  |
| `0xb85` | `m_bStartDisabled` | bool |  |  |
| `0xb86` | `m_bFiredStartEndOutput` | bool |  |  |
| `0xb87` | `m_bForceNpcExclude` | bool |  | `MNotSaved` |
| `0xb88` | `m_bCreateMovableSurfaceGraph` | bool |  |  |
| `0xb89` | `m_bCreateNonSolid` | bool |  | `MNotSaved` |
| `0xb8a` | `m_bIsOverrideProp` | bool |  | `MNotSaved` |
| `0xb8c` | `m_iInitialGlowState` | int32 |  |  |
| `0xb90` | `m_nGlowRange` | int32 |  |  |
| `0xb94` | `m_nGlowRangeMin` | int32 |  |  |
| `0xb98` | `m_glowColor` | Color |  |  |
| `0xb9c` | `m_nGlowTeam` | int32 |  |  |
