...
203 fields (23 declared here, 180 inherited). Offsets are absolute from the object base.
...
| `0xb80` | `m_nIdleAnimLoopMode` | [AnimLoopMode_t](../server/AnimLoopMode_t.md) |  |  |
