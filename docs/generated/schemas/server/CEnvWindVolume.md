...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvWindVolume
...
| `0x4c8` | `m_nShape` | int32 |  |  |
| `0x4cc` | `m_fWindSpeedMultiplier` | float32 |  |  |
| `0x4d0` | `m_fWindTurbulenceMultiplier` | float32 |  |  |
| `0x4d4` | `m_fWindSpeedVariationMultiplier` | float32 |  |  |
| `0x4d8` | `m_fWindDirectionVariationMultiplier` | float32 |  |  |
