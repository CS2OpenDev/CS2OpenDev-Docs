...
[Schemas](../../schemas.md) / [server](../server.md) / CWeaponBaseItem

# CWeaponBaseItem

**Kind:** class · **Size:** 4192 bytes (`0x1060`) · **Align:** 255 · **Module:** server

**Inherits from:** [CCSWeaponBase](../server/CCSWeaponBase.md)

**Derived by:** [CItem_Healthshot](../server/CItem_Healthshot.md)
...
217 fields (2 declared here, 215 inherited). Offsets are absolute from the object base.
