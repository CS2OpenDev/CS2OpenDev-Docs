---
layout: default
title: CInfoFan (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CInfoFan
...
**Twin:** [CInfoFan (client)](../client/CInfoFan.md)
...
| `0x4e8` | `m_fFanForceMaxRadius` | float32 |  |  |
| `0x4ec` | `m_fFanForceMinRadius` | float32 |  |  |
| `0x4f0` | `m_flCurveDistRange` | float32 |  |  |
| `0x4f8` | `m_FanForceCurveString` | CUtlSymbolLarge |  |  |
