...
[Schemas](../../schemas.md) / [server](../server.md) / CMultiSource
...
| `0x4a8` | `m_rgEntities` | CHandle< [CBaseEntity](../server/CBaseEntity.md) >[32] |  |  |
...
| `0x5a8` | `m_OnTrigger` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
...
| `0x5c0` | `m_iTotal` | int32 |  |  |
| `0x5c8` | `m_globalstate` | CUtlSymbolLarge |  |  |
