...
[Schemas](../../schemas.md) / [server](../server.md) / CC4

# CC4

**Kind:** class · **Size:** 4304 bytes (`0x10d0`) · **Align:** 16 · **Module:** server
...
226 fields (11 declared here, 215 inherited). Offsets are absolute from the object base.
...
| `0x1080` | `m_vecLastValidPlayerHeldPosition` | VectorWS |  |  |
| `0x108c` | `m_vecLastValidDroppedPosition` | VectorWS |  |  |
| `0x1098` | `m_bDoValidDroppedPositionCheck` | bool |  |  |
| `0x1098` | `m_bAnimGraphUpdateEnabled` | bool | [CBaseAnimGraph](../server/CBaseAnimGraph.md) |  |
| `0x1099` | `m_bStartedArming` | bool |  |  |
| `0x1099` | `m_bAnimationUpdateScheduled` | bool | [CBaseAnimGraph](../server/CBaseAnimGraph.md) | `MNotSaved` |
| `0x109c` | `m_fArmedTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x109c` | `m_vecForce` | Vector | [CBaseAnimGraph](../server/CBaseAnimGraph.md) | `MNotSaved` |
| `0x10a0` | `m_bBombPlacedAnimation` | bool |  |  |
| `0x10a1` | `m_bIsPlantingViaUse` | bool |  |  |
| `0x10a8` | `m_entitySpottedState` | [EntitySpottedState_t](../server/EntitySpottedState_t.md) |  |  |
...
| `0x10c0` | `m_nSpotRules` | int32 |  |  |
| `0x10c4` | `m_bPlayedArmingBeeps` | bool[7] |  |  |
