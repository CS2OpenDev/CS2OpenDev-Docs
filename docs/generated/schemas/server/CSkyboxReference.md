---
title: CSkyboxReference (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CSkyboxReference
...
**Twin:** [CSkyboxReference (client)](../client/CSkyboxReference.md)
...
| `0x4a8` | `m_worldGroupId` | WorldGroupId_t |  |  |
| `0x4ac` | `m_hSkyCamera` | CHandle< [CSkyCamera](../server/CSkyCamera.md) > |  | `MNotSaved` |
