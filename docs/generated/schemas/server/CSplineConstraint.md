...
[Schemas](../../schemas.md) / [server](../server.md) / CSplineConstraint

# CSplineConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1464 bytes (`0x5b8`) · **Align:** 8 · **Module:** server
...
117 fields (15 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x558` | `m_vAnchorOffsetRestore` | Vector |  |  |
| `0x564` | `m_hSplineEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x568` | `m_pSplineBody` | [IPhysicsBody](../vphysics2/IPhysicsBody.md)* |  | `MPhysPtr` |
| `0x570` | `m_bEnableLateralConstraint` | bool |  |  |
| `0x571` | `m_bEnableVerticalConstraint` | bool |  |  |
| `0x572` | `m_bEnableAngularConstraint` | bool |  |  |
| `0x573` | `m_bEnableLimit` | bool |  |  |
| `0x574` | `m_bFireEventsOnPath` | bool |  |  |
| `0x578` | `m_flLinearFrequency` | float32 |  |  |
| `0x57c` | `m_flLinarDampingRatio` | float32 |  |  |
| `0x580` | `m_flJointFriction` | float32 |  |  |
| `0x584` | `m_flTransitionTime` | float32 |  |  |
| `0x598` | `m_vPreSolveAnchorPos` | VectorWS |  | `MNotSaved` |
| `0x5a4` | `m_StartTransitionTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x5a8` | `m_vTangentSpaceAnchorAtTransitionStart` | Vector |  |  |
