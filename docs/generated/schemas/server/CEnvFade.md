...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvFade
...
| `0x4a8` | `m_fadeColor` | Color |  |  |
| `0x4ac` | `m_Duration` | float32 |  |  |
| `0x4b0` | `m_HoldDuration` | float32 |  |  |
| `0x4b8` | `m_OnBeginFade` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
