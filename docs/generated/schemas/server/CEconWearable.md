...
[Schemas](../../schemas.md) / [server](../server.md) / CEconWearable

# CEconWearable

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 3232 bytes (`0xca0`) · **Align:** 16 · **Module:** server
...
154 fields (2 declared here, 152 inherited). Offsets are absolute from the object base.
...
| `0xc90` | `m_nForceSkin` | int32 |  |  |
| `0xc94` | `m_bAlwaysAllow` | bool |  |  |
