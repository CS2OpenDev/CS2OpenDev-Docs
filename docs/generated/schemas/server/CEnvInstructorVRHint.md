...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvInstructorVRHint
...
| `0x4b0` | `m_iszHintTargetEntity` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_iTimeout` | int32 |  |  |
| `0x4c0` | `m_iszCaption` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_iszStartSound` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_iLayoutFileType` | int32 |  |  |
| `0x4d8` | `m_iszCustomLayoutFile` | CUtlSymbolLarge |  |  |
| `0x4e0` | `m_iAttachType` | int32 |  |  |
| `0x4e4` | `m_flHeightOffset` | float32 |  |  |
