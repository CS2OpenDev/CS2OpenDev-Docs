---
title: CInfoDynamicShadowHint (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CInfoDynamicShadowHint
...
**Twin:** [CInfoDynamicShadowHint (client)](../client/CInfoDynamicShadowHint.md)

**Inherits from:** [CPointEntity](../server/CPointEntity.md)

**Derived by:** [CInfoDynamicShadowHintBox](../server/CInfoDynamicShadowHintBox.md)
...
| `0x4ac` | `m_flRange` | float32 |  |  |
| `0x4b0` | `m_nImportance` | int32 |  |  |
| `0x4b4` | `m_nLightChoice` | int32 |  |  |
| `0x4b8` | `m_hLight` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
