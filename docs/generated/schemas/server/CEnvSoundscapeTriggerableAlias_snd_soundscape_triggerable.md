---
title: CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable

# CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1336 bytes (`0x538`) · **Align:** 8 · **Module:** server

**Twin:** [CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable (client)](../client/CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable.md)

**Inherits from:** [CEnvSoundscapeTriggerable](../server/CEnvSoundscapeTriggerable.md)
...
99 fields (0 declared here, 99 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_OnPlay` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x4c0` | `m_flRadius` | float32 | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x4c8` | `m_soundEventName` | CGameSoundEventName | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x4d0` | `m_bOverrideWithEvent` | bool | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x4d4` | `m_soundscapeIndex` | int32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
| `0x4d8` | `m_soundscapeEntityListId` | int32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
| `0x4e0` | `m_positionNames` | CUtlSymbolLarge[8] | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x520` | `m_hProxySoundscape` | CHandle< [CEnvSoundscape](../server/CEnvSoundscape.md) > | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x524` | `m_bDisabled` | bool | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x528` | `m_soundscapeName` | CUtlSymbolLarge | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x530` | `m_soundEventHash` | uint32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
