...
[Schemas](../../schemas.md) / [server](../server.md) / CPointClientUIWorldTextPanel

# CPointClientUIWorldTextPanel

**Kind:** class · **Size:** 2864 bytes (`0xb30`) · **Align:** 8 · **Module:** server

**Inherits from:** [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md)
...
168 fields (1 declared here, 167 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_bEnabled` | bool | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x778` | `m_DialogXMLName` | CUtlSymbolLarge | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x780` | `m_PanelClassName` | CUtlSymbolLarge | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x788` | `m_PanelID` | CUtlSymbolLarge | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x790` | `m_CustomOutput0` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x7b0` | `m_CustomOutput1` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x7d0` | `m_CustomOutput2` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x7f0` | `m_CustomOutput3` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x810` | `m_CustomOutput4` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x830` | `m_CustomOutput5` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x850` | `m_CustomOutput6` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x870` | `m_CustomOutput7` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x890` | `m_CustomOutput8` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x8b0` | `m_CustomOutput9` | CEntityOutputTemplate< CUtlString > | [CBaseClientUIEntity](../server/CBaseClientUIEntity.md) |  |
| `0x8d0` | `m_bIgnoreInput` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8d1` | `m_bLit` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8d2` | `m_bFollowPlayerAcrossTeleport` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8d4` | `m_flWidth` | float32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8d8` | `m_flHeight` | float32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8dc` | `m_flDPI` | float32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8e0` | `m_flInteractDistance` | float32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8e4` | `m_flDepthOffset` | float32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8e8` | `m_unOwnerContext` | uint32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8ec` | `m_unHorizontalAlign` | uint32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8f0` | `m_unVerticalAlign` | uint32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8f4` | `m_unOrientation` | uint32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x8f8` | `m_bAllowInteractionFromAllSceneWorlds` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x900` | `m_vecCSSClasses` | CNetworkUtlVectorBase< CUtlSymbolLarge > | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x918` | `m_bOpaque` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x919` | `m_bNoDepth` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91a` | `m_bVisibleWhenParentNoDraw` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91b` | `m_bRenderBackface` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91c` | `m_bUseOffScreenIndicator` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91d` | `m_bExcludeFromSaveGames` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91e` | `m_bGrabbable` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x91f` | `m_bOnlyRenderToTexture` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x920` | `m_bDisableMipGen` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x924` | `m_nExplicitImageLayout` | int32 | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x928` | `m_bIgnoreParentOrientation` | bool | [CPointClientUIWorldPanel](../server/CPointClientUIWorldPanel.md) |  |
| `0x930` | `m_messageText` | char[512] |  |  |
