---
layout: default
title: CPointTemplate (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CPointTemplate
...
**Twin:** [CPointTemplate (client)](../client/CPointTemplate.md)
...
100 fields (12 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_iszWorldName` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_iszSource2EntityLumpName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_iszEntityFilterName` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_flTimeoutInterval` | float32 |  |  |
| `0x4c4` | `m_bAsynchronouslySpawnEntities` | bool |  |  |
| `0x4c8` | `m_clientOnlyEntityBehavior` | [PointTemplateClientOnlyEntityBehavior_t](../server/PointTemplateClientOnlyEntityBehavior_t.md) |  | `MNotSaved` |
| `0x4cc` | `m_ownerSpawnGroupType` | [PointTemplateOwnerSpawnGroupType_t](../server/PointTemplateOwnerSpawnGroupType_t.md) |  | `MNotSaved` |
| `0x4d0` | `m_createdSpawnGroupHandles` | CUtlVector< uint32 > |  |  |
| `0x4e8` | `m_SpawnedEntityHandles` | CUtlVector< CEntityHandle > |  |  |
| `0x500` | `m_ScriptSpawnCallback` | HSCRIPT |  | `MNotSaved` |
| `0x508` | `m_ScriptCallbackScope` | HSCRIPT |  | `MNotSaved` |
| `0x510` | `m_OnEntitySpawned` | CEntityOutputTemplate< CUtlVector< CEntityHandle > > |  |  |
