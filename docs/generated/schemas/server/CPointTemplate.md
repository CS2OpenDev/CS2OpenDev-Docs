...
| `0x4c8` | `m_clientOnlyEntityBehavior` | [PointTemplateClientOnlyEntityBehavior_t](../!GlobalTypes/PointTemplateClientOnlyEntityBehavior_t.md) |  | `MNotSaved` |
| `0x4cc` | `m_ownerSpawnGroupType` | [PointTemplateOwnerSpawnGroupType_t](../!GlobalTypes/PointTemplateOwnerSpawnGroupType_t.md) |  | `MNotSaved` |
