...
| `0x1052` | `m_bPinPulled` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) | True once the grenade's pin has been pulled. |
| `0x1053` | `m_bJumpThrow` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) | True when the pending throw is a jump-throw. |
| `0x1054` | `m_bThrowAnimating` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1058` | `m_fThrowTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBaseCSGrenade](../server/CBaseCSGrenade.md) | GameTime at which the grenade was thrown. |
| `0x105c` | `m_flThrowStrength` | float32 | [CBaseCSGrenade](../server/CBaseCSGrenade.md) | Normalised throw strength (affects throw distance). |
