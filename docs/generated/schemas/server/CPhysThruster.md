...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysThruster
...
**Inherits from:** [CPhysForce](../server/CPhysForce.md)
...
96 fields (1 declared here, 95 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_pController` | [IPhysicsMotionController](../vphysics2/IPhysicsMotionController.md)* | [CPhysForce](../server/CPhysForce.md) | `MPhysPtr` |
| `0x4b0` | `m_nameAttach` | CUtlSymbolLarge | [CPhysForce](../server/CPhysForce.md) |  |
| `0x4b8` | `m_force` | float32 | [CPhysForce](../server/CPhysForce.md) |  |
| `0x4bc` | `m_forceTime` | float32 | [CPhysForce](../server/CPhysForce.md) |  |
| `0x4c0` | `m_attachedObject` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CPhysForce](../server/CPhysForce.md) |  |
| `0x4c4` | `m_wasRestored` | bool | [CPhysForce](../server/CPhysForce.md) | `MNotSaved` |
| `0x4c8` | `m_integrator` | [CConstantForceController](../server/CConstantForceController.md) | [CPhysForce](../server/CPhysForce.md) |  |
| `0x508` | `m_localOrigin` | Vector |  |  |
