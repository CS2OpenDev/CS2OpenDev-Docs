...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicBranchList
...
classDiagram
    ...
    CLogicBranchList *-- `CLogicBranchList::LogicBranchListenerLastState_t`
...
| `0x4a8` | `m_nLogicBranchNames` | CUtlSymbolLarge[16] |  |  |
| `0x528` | `m_LogicBranchList` | CUtlVector< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  |  |
| `0x540` | `m_eLastState` | [CLogicBranchList::LogicBranchListenerLastState_t](../server/CLogicBranchList.LogicBranchListenerLastState_t.md) |  |  |
| `0x548` | `m_OnAllTrue` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x560` | `m_OnAllFalse` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x578` | `m_OnMixed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
