...
[Schemas](../../schemas.md) / [server](../server.md) / CMarkupVolumeTagged_NavGame

# CMarkupVolumeTagged_NavGame

**Kind:** class · **Size:** 2016 bytes (`0x7e0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md)
...
143 fields (3 declared here, 140 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_bDisabled` | bool | [CMarkupVolume](../server/CMarkupVolume.md) |  |
| `0x778` | `m_GroupNames` | CUtlVector< CGlobalSymbol > | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) |  |
| `0x790` | `m_Tags` | CUtlVector< CGlobalSymbol > | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) |  |
| `0x7a8` | `m_bIsGroup` | bool | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) | `MNotSaved` |
| `0x7a9` | `m_bGroupByPrefab` | bool | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) |  |
| `0x7aa` | `m_bGroupByVolume` | bool | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) |  |
| `0x7ab` | `m_bGroupOtherGroups` | bool | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) |  |
| `0x7ac` | `m_bIsInGroup` | bool | [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md) | `MNotSaved` |
| `0x7b8` | `m_bUseRef` | bool | [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md) |  |
| `0x7bc` | `m_vRefPosEntitySpace` | Vector | [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md) |  |
| `0x7c8` | `m_vRefPosWorldSpace` | VectorWS | [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md) |  |
| `0x7d4` | `m_flRefDot` | float32 | [CMarkupVolumeWithRef](../server/CMarkupVolumeWithRef.md) |  |
| `0x7d8` | `m_nScopes` | [NavScopeFlags_t](../!GlobalTypes/NavScopeFlags_t.md) |  |  |
| `0x7d9` | `m_bFloodFillAttribute` | bool |  |  |
| `0x7da` | `m_bSplitNavSpace` | bool |  |  |
