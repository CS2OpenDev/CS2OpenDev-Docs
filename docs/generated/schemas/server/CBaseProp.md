---
title: CBaseProp (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CBaseProp

# CBaseProp

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 2448 bytes (`0x990`) · **Align:** 16 · **Module:** server

**Twin:** [CBaseProp (client)](../client/CBaseProp.md)

**Inherits from:** [CBaseAnimGraph](../server/CBaseAnimGraph.md)

**Derived by:** [CBreakableProp](../server/CBreakableProp.md)
...
147 fields (4 declared here, 143 inherited). Offsets are absolute from the object base.
...
| `0x960` | `m_bModelOverrodeBlockLOS` | bool |  |  |
| `0x964` | `m_iShapeType` | int32 |  |  |
| `0x968` | `m_bConformToCollisionBounds` | bool |  |  |
| `0x970` | `m_mPreferredCatchTransform` | CTransform |  |  |
