...
[Schemas](../../schemas.md) / [server](../server.md) / CKeepUpright
...
| `0x4b0` | `m_worldGoalAxis` | Vector |  |  |
| `0x4bc` | `m_localTestAxis` | Vector |  |  |
| `0x4c8` | `m_pController` | [IPhysicsMotionController](../vphysics2/IPhysicsMotionController.md)* |  | `MPhysPtr` |
| `0x4d0` | `m_nameAttach` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_attachedObject` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4dc` | `m_angularLimit` | float32 |  |  |
| `0x4e0` | `m_bActive` | bool |  |  |
| `0x4e1` | `m_bDampAllRotation` | bool |  |  |
