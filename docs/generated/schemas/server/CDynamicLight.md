...
[Schemas](../../schemas.md) / [server](../server.md) / CDynamicLight

# CDynamicLight

**Kind:** class · **Size:** 1928 bytes (`0x788`) · **Align:** 8 · **Module:** server
...
| `0x770` | `m_ActualFlags` | uint8 |  |  |
| `0x771` | `m_Flags` | uint8 |  |  |
| `0x772` | `m_LightStyle` | uint8 |  |  |
| `0x773` | `m_On` | bool |  |  |
| `0x774` | `m_Radius` | float32 |  |  |
| `0x778` | `m_Exponent` | int32 |  |  |
| `0x77c` | `m_InnerAngle` | float32 |  |  |
| `0x780` | `m_OuterAngle` | float32 |  |  |
| `0x784` | `m_SpotRadius` | float32 |  |  |
