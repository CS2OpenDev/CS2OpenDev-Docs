...
[Schemas](../../schemas.md) / [server](../server.md) / CVoteController

# CVoteController

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1624 bytes (`0x658`) · **Align:** 8 · **Module:** server
...
| `0x4a8` | `m_iActiveIssueIndex` | int32 |  |  |
| `0x4ac` | `m_iOnlyTeamToVote` | int32 |  |  |
| `0x4b0` | `m_nVoteOptionCount` | int32[5] |  |  |
| `0x4c4` | `m_nPotentialVotes` | int32 |  |  |
| `0x4c8` | `m_bIsYesNoVote` | bool |  |  |
| `0x4d0` | `m_acceptingVotesTimer` | [CountdownTimer](../server/CountdownTimer.md) |  |  |
| `0x4e8` | `m_executeCommandTimer` | [CountdownTimer](../server/CountdownTimer.md) |  |  |
| `0x500` | `m_resetVoteTimer` | [CountdownTimer](../server/CountdownTimer.md) |  |  |
| `0x518` | `m_nVotesCast` | int32[64] |  |  |
| `0x618` | `m_playerHoldingVote` | CPlayerSlot |  |  |
| `0x61c` | `m_playerOverrideForVote` | CPlayerSlot |  |  |
| `0x620` | `m_nHighestCountIndex` | int32 |  |  |
| `0x628` | `m_potentialIssues` | CUtlVector< [CBaseIssue](../server/CBaseIssue.md)* > |  |  |
| `0x640` | `m_VoteOptions` | CUtlVector< char* > |  |  |
