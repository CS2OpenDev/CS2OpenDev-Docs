...
| `0x600` | `m_bDisabled` | bool | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x604` | `m_flRange` | float32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x608` | `m_nImportance` | int32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x60c` | `m_nLightChoice` | int32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x610` | `m_hLight` | CHandle< [C_BaseEntity](../client/C_BaseEntity.md) > | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
