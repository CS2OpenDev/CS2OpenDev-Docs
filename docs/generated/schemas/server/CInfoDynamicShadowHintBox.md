---
layout: default
title: CInfoDynamicShadowHintBox (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CInfoDynamicShadowHintBox

# CInfoDynamicShadowHintBox

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1240 bytes (`0x4d8`) · **Align:** 8 · **Module:** server

**Twin:** [CInfoDynamicShadowHintBox (client)](../client/CInfoDynamicShadowHintBox.md)

**Inherits from:** [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md)
...
95 fields (2 declared here, 93 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_bDisabled` | bool | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x4ac` | `m_flRange` | float32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x4b0` | `m_nImportance` | int32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x4b4` | `m_nLightChoice` | int32 | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x4b8` | `m_hLight` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md) |  |
| `0x4c0` | `m_vBoxMins` | Vector |  |  |
| `0x4cc` | `m_vBoxMaxs` | Vector |  |  |
