...
[Schemas](../../schemas.md) / [server](../server.md) / CWeaponSawedoff

# CWeaponSawedoff

**Kind:** class · **Size:** 4176 bytes (`0x1050`) · **Align:** 16 · **Module:** server

**Inherits from:** [CCSWeaponBaseShotgun](../server/CCSWeaponBaseShotgun.md)
...
215 fields (0 declared here, 215 inherited). Offsets are absolute from the object base.
