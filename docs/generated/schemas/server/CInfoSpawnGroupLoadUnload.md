...
[Schemas](../../schemas.md) / [server](../server.md) / CInfoSpawnGroupLoadUnload
...
101 fields (13 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_OnSpawnGroupLoadStarted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_OnSpawnGroupLoadFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d8` | `m_OnSpawnGroupUnloadStarted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4f0` | `m_OnSpawnGroupUnloadFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x508` | `m_iszSpawnGroupName` | CUtlSymbolLarge |  |  |
| `0x510` | `m_iszSpawnGroupFilterName` | CUtlSymbolLarge |  |  |
| `0x518` | `m_iszLandmarkName` | CUtlSymbolLarge |  |  |
| `0x520` | `m_sFixedSpawnGroupName` | CUtlString |  |  |
| `0x528` | `m_flTimeoutInterval` | float32 |  |  |
| `0x52c` | `m_bAutoActivate` | bool |  |  |
| `0x52d` | `m_bUnloadingStarted` | bool |  | `MNotSaved` |
| `0x52e` | `m_bQueueActiveSpawnGroupChange` | bool |  | `MNotSaved` |
| `0x52f` | `m_bQueueFinishLoading` | bool |  | `MNotSaved` |
