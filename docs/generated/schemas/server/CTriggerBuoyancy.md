...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerBuoyancy

# CTriggerBuoyancy

**Kind:** class · **Size:** 2568 bytes (`0xa08`) · **Align:** 8 · **Module:** server
...
| `0x8e8` | `m_BuoyancyHelper` | [CBuoyancyHelper](../server/CBuoyancyHelper.md) |  |  |
| `0xa00` | `m_flFluidDensity` | float32 |  |  |
