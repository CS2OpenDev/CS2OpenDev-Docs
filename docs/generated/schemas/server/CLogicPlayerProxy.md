...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicPlayerProxy
...
| `0x4a8` | `m_PlayerHasAmmo` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_PlayerHasNoAmmo` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d8` | `m_PlayerDied` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4f0` | `m_RequestedPlayerHealth` | CEntityOutputTemplate< int32 > |  |  |
| `0x510` | `m_hPlayer` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
