...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetAutoRoomEntity

# CSoundOpvarSetAutoRoomEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1664 bytes (`0x680`) · **Align:** 8 · **Module:** server
...
128 fields (5 declared here, 123 inherited). Offsets are absolute from the object base.
...
| `0x640` | `m_traceResults` | CUtlVector< [SoundOpvarTraceResult_t](../server/SoundOpvarTraceResult_t.md) > |  |  |
| `0x658` | `m_doorwayPairs` | CUtlVector< [AutoRoomDoorwayPairs_t](../server/AutoRoomDoorwayPairs_t.md) > |  |  |
| `0x670` | `m_flSize` | float32 |  |  |
| `0x674` | `m_flHeightTolerance` | float32 |  |  |
| `0x678` | `m_flSizeSqr` | float32 |  |  |
