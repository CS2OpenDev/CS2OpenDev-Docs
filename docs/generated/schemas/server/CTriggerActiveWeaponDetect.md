...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerActiveWeaponDetect

# CTriggerActiveWeaponDetect

**Kind:** class · **Size:** 2312 bytes (`0x908`) · **Align:** 8 · **Module:** server
...
159 fields (2 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_OnTouchedActiveWeapon` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x900` | `m_iszWeaponClassName` | CUtlSymbolLarge |  |  |
