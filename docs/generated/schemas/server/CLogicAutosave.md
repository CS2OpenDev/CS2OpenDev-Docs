...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicAutosave
...
**Derived by:** [CLogicActiveAutosave](../server/CLogicActiveAutosave.md)
...
| `0x4a8` | `m_bForceNewLevelUnit` | bool |  |  |
| `0x4ac` | `m_minHitPoints` | int32 |  |  |
| `0x4b0` | `m_minHitPointsToCommit` | int32 |  |  |
