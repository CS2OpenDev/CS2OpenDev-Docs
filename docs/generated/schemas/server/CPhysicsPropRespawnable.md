...
230 fields (5 declared here, 225 inherited). Offsets are absolute from the object base.
...
| `0xbcc` | `m_nDynamicContinuousContactBehavior` | [DynamicContinuousContactBehavior_t](../!GlobalTypes/DynamicContinuousContactBehavior_t.md) | [CPhysicsProp](../server/CPhysicsProp.md) |  |
