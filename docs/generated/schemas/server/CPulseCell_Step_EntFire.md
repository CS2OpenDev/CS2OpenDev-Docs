---
title: CPulseCell_Step_EntFire (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CPulseCell_Step_EntFire
...
**Twin:** [CPulseCell_Step_EntFire (client)](../client/CPulseCell_Step_EntFire.md)
