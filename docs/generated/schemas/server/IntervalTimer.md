---
layout: default
title: IntervalTimer (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / IntervalTimer
...
**Twin:** [IntervalTimer (client)](../client/IntervalTimer.md)

**Derived by:** [CTimeline](../server/CTimeline.md)
