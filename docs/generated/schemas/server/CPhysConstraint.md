...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysConstraint

# CPhysConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1288 bytes (`0x508`) · **Align:** n/a (unspecified) · **Module:** server

**Inherits from:** [CLogicalEntity](../server/CLogicalEntity.md)

**Derived by:** [CGenericConstraint](../server/CGenericConstraint.md), [CPhysBallSocket](../server/CPhysBallSocket.md), [CPhysFixed](../server/CPhysFixed.md), [CPhysHinge](../server/CPhysHinge.md), [CPhysLength](../server/CPhysLength.md), [CPhysPulley](../server/CPhysPulley.md), [CPhysSlideConstraint](../server/CPhysSlideConstraint.md), [CPhysWheelConstraint](../server/CPhysWheelConstraint.md), [CRagdollConstraint](../server/CRagdollConstraint.md), [CSplineConstraint](../server/CSplineConstraint.md)
...
102 fields (14 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_hJoint` | [IPhysicsJoint](../vphysics2/IPhysicsJoint.md)* |  | `MPhysPtr` |
| `0x4b0` | `m_nameAttach1` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_nameAttach2` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_hAttach1` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c4` | `m_hAttach2` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c8` | `m_nameAttachment1` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_nameAttachment2` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_breakSound` | CGameSoundEventName |  |  |
| `0x4e0` | `m_forceLimit` | float32 |  |  |
| `0x4e4` | `m_torqueLimit` | float32 |  |  |
| `0x4e8` | `m_minTeleportDistance` | float32 |  |  |
| `0x4ec` | `m_bSnapObjectPositions` | bool |  |  |
| `0x4ed` | `m_bTreatEntity1AsInfiniteMass` | bool |  |  |
| `0x4f0` | `m_OnBreak` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
