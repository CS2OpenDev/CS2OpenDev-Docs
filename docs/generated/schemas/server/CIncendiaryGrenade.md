...
[Schemas](../../schemas.md) / [server](../server.md) / CIncendiaryGrenade

# CIncendiaryGrenade

**Kind:** class · **Size:** 4240 bytes (`0x1090`) · **Align:** 16 · **Module:** server

**Inherits from:** [CMolotovGrenade](../server/CMolotovGrenade.md)
...
228 fields (0 declared here, 228 inherited). Offsets are absolute from the object base.
...
| `0x1050` | `m_bRedraw` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1050` | `m_bInitiallyPopulateInterpHistory` | bool | [CBaseAnimGraph](../server/CBaseAnimGraph.md) |  |
| `0x1051` | `m_bIsHeldByPlayer` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1052` | `m_bPinPulled` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1052` | `m_bSuppressAnimEventSounds` | bool | [CBaseAnimGraph](../server/CBaseAnimGraph.md) |  |
| `0x1053` | `m_bJumpThrow` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1054` | `m_bThrowAnimating` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1058` | `m_fThrowTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1058` | `m_OnLayerCycleUpdated` | CEntityOutputTemplate< float32 > | [CBaseAnimGraph](../server/CBaseAnimGraph.md) |  |
| `0x105c` | `m_flThrowStrength` | float32 | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1060` | `m_fDropTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1064` | `m_fPinPullTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1068` | `m_bJustPulledPin` | bool | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x106c` | `m_nNextHoldTick` | [GameTick_t](../entity2/GameTick_t.md) | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1070` | `m_flNextHoldFrac` | float32 | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
| `0x1074` | `m_hSwitchToWeaponAfterThrow` | CHandle< [CCSWeaponBase](../server/CCSWeaponBase.md) > | [CBaseCSGrenade](../server/CBaseCSGrenade.md) |  |
