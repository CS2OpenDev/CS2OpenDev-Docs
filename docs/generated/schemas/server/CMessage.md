...
[Schemas](../../schemas.md) / [server](../server.md) / CMessage
...
| `0x4a8` | `m_iszMessage` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_MessageVolume` | float32 |  |  |
| `0x4b4` | `m_MessageAttenuation` | int32 |  |  |
| `0x4b8` | `m_Radius` | float32 |  |  |
| `0x4c0` | `m_sNoise` | CGameSoundEventName |  |  |
| `0x4c8` | `m_OnShowMessage` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
