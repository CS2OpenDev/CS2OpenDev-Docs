---
title: CLogicRelay (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CLogicRelay
...
**Twin:** [CLogicRelay (client)](../client/CLogicRelay.md)
...
| `0x4a8` | `m_OnSpawn` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_OnTrigger` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d8` | `m_bDisabled` | bool |  |  |
| `0x4d9` | `m_bWaitForRefire` | bool |  |  |
| `0x4da` | `m_bTriggerOnce` | bool |  |  |
| `0x4db` | `m_bFastRetrigger` | bool |  |  |
| `0x4dc` | `m_bPassthoughCaller` | bool |  |  |
