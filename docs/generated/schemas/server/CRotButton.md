...
[Schemas](../../schemas.md) / [server](../server.md) / CRotButton

# CRotButton

**Kind:** class · **Size:** 2288 bytes (`0x8f0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseButton](../server/CBaseButton.md)

**Derived by:** [CMomentaryRotButton](../server/CMomentaryRotButton.md)
...
170 fields (0 declared here, 170 inherited). Offsets are absolute from the object base.
