---
title: FilterHealth (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / FilterHealth
...
**Twin:** [FilterHealth (client)](../client/FilterHealth.md)
...
| `0x4e0` | `m_bAdrenalineActive` | bool |  |  |
| `0x4e4` | `m_iHealthMin` | int32 |  |  |
| `0x4e8` | `m_iHealthMax` | int32 |  |  |
