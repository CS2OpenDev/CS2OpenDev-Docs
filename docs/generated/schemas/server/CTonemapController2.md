...
**Derived by:** [CTonemapController2Alias_env_tonemap_controller2](../server/CTonemapController2Alias_env_tonemap_controller2.md)
...
| `0x4a8` | `m_flAutoExposureMin` | float32 |  |  |
| `0x4ac` | `m_flAutoExposureMax` | float32 |  |  |
| `0x4b0` | `m_flExposureAdaptationSpeedUp` | float32 |  |  |
| `0x4b4` | `m_flExposureAdaptationSpeedDown` | float32 |  |  |
| `0x4b8` | `m_flTonemapEVSmoothingRange` | float32 |  |  |
