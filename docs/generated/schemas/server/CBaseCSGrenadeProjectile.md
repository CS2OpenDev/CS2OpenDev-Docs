...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseCSGrenadeProjectile
...
**Kind:** class · **Size:** 2656 bytes (`0xa60`) · **Align:** 16 · **Module:** server

**Inherits from:** [CBaseGrenade](../server/CBaseGrenade.md)

**Derived by:** [CDecoyProjectile](../server/CDecoyProjectile.md), [CFlashbangProjectile](../server/CFlashbangProjectile.md), [CHEGrenadeProjectile](../server/CHEGrenadeProjectile.md), [CMolotovProjectile](../server/CMolotovProjectile.md), [CSmokeGrenadeProjectile](../server/CSmokeGrenadeProjectile.md)
...
| `0x9f0` | `m_vInitialPosition` | VectorWS |  | World-space position from which the grenade was thrown. |
| `0x9fc` | `m_vInitialVelocity` | Vector |  | Initial velocity vector (world units per second) at the moment of throw. |
| `0xa08` | `m_nBounces` | int32 |  | Number of times the grenade has bounced off a surface so far. |
| `0xa10` | `m_nExplodeEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > |  | Particle system definition handle for the detonation effect. |
| `0xa18` | `m_nExplodeEffectTickBegin` | int32 |  | Server tick at which the explosion particle effect started. |
| `0xa1c` | `m_vecExplodeEffectOrigin` | VectorWS |  | World-space position of the explosion centre. |
| `0xa28` | `m_flSpawnTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xa2c` | `m_unOGSExtraFlags` | uint8 |  |  |
| `0xa2d` | `m_bDetonationRecorded` | bool |  |  |
| `0xa2e` | `m_nItemIndex` | uint16 |  |  |
| `0xa30` | `m_vecOriginalSpawnLocation` | VectorWS |  |  |
| `0xa3c` | `m_flLastBounceSoundTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0xa40` | `m_vecGrenadeSpin` | RotationVector |  |  |
| `0xa4c` | `m_vecLastHitSurfaceNormal` | Vector |  |  |
| `0xa58` | `m_nTicksAtZeroVelocity` | int32 |  |  |
| `0xa5c` | `m_bHasEverHitEnemy` | bool |  |  |
