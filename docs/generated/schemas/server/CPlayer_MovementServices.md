---
title: CPlayer_MovementServices (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CPlayer_MovementServices
...
**Twin:** [CPlayer_MovementServices (client)](../client/CPlayer_MovementServices.md)

**Inherits from:** [CPlayerPawnComponent](../server/CPlayerPawnComponent.md)

**Derived by:** [CCSObserver_MovementServices](../server/CCSObserver_MovementServices.md), [CPlayer_MovementServices_Humanoid](../server/CPlayer_MovementServices_Humanoid.md)
