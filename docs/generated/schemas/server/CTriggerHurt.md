...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerHurt

# CTriggerHurt

**Kind:** class · **Size:** 2416 bytes (`0x970`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseTrigger](../server/CBaseTrigger.md)

**Derived by:** [CScriptTriggerHurt](../server/CScriptTriggerHurt.md)
...
171 fields (14 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_flOriginalDamage` | float32 |  |  |
| `0x8ec` | `m_flDamage` | float32 |  |  |
| `0x8f0` | `m_flDamageCap` | float32 |  |  |
| `0x8f4` | `m_flLastDmgTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x8f8` | `m_flForgivenessDelay` | float32 |  |  |
| `0x8fc` | `m_bitsDamageInflict` | [DamageTypes_t](../!GlobalTypes/DamageTypes_t.md) |  |  |
| `0x900` | `m_damageModel` | int32 |  |  |
| `0x904` | `m_bNoDmgForce` | bool |  |  |
| `0x908` | `m_vDamageForce` | Vector |  |  |
| `0x914` | `m_thinkAlways` | bool |  |  |
| `0x918` | `m_hurtThinkPeriod` | float32 |  |  |
| `0x920` | `m_OnHurt` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x938` | `m_OnHurtPlayer` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x950` | `m_hurtEntities` | CUtlVector< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  |  |
