...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetPointEntity

# CSoundOpvarSetPointEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1600 bytes (`0x640`) · **Align:** 8 · **Module:** server

**Inherits from:** [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md)

**Derived by:** [CSoundOpvarSetAutoRoomEntity](../server/CSoundOpvarSetAutoRoomEntity.md), [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md), [CSoundOpvarSetPathCornerEntity](../server/CSoundOpvarSetPathCornerEntity.md)
...
123 fields (24 declared here, 99 inherited). Offsets are absolute from the object base.
...
| `0x550` | `m_OnEnter` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x568` | `m_OnExit` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x580` | `m_bAutoDisable` | bool |  |  |
| `0x5c4` | `m_flDistanceMin` | float32 |  |  |
| `0x5c8` | `m_flDistanceMax` | float32 |  |  |
| `0x5cc` | `m_flDistanceMapMin` | float32 |  |  |
| `0x5d0` | `m_flDistanceMapMax` | float32 |  |  |
| `0x5d4` | `m_flOcclusionRadius` | float32 |  |  |
| `0x5d8` | `m_flOcclusionMin` | float32 |  |  |
| `0x5dc` | `m_flOcclusionMax` | float32 |  |  |
| `0x5e0` | `m_flValSetOnDisable` | float32 |  |  |
| `0x5e4` | `m_bSetValueOnDisable` | bool |  |  |
| `0x5e5` | `m_bReloading` | bool |  | `MNotSaved` |
| `0x5e8` | `m_nSimulationMode` | int32 |  |  |
| `0x5ec` | `m_nVisibilitySamples` | int32 |  |  |
| `0x5f0` | `m_vDynamicProxyPoint` | Vector |  |  |
| `0x5fc` | `m_flDynamicMaximumOcclusion` | float32 |  |  |
| `0x600` | `m_hDynamicEntity` | CEntityHandle |  |  |
| `0x608` | `m_iszDynamicEntityName` | CUtlSymbolLarge |  |  |
| `0x610` | `m_flPathingDistanceNormFactor` | float32 |  | `MNotSaved` |
| `0x614` | `m_vPathingSourcePos` | VectorWS |  | `MNotSaved` |
| `0x620` | `m_vPathingListenerPos` | VectorWS |  | `MNotSaved` |
| `0x62c` | `m_vPathingDirection` | Vector |  | `MNotSaved` |
| `0x638` | `m_nPathingSourceIndex` | int32 |  | `MNotSaved` |
