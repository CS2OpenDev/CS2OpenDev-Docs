...
**Derived by:** [CSoundOpvarSetAutoRoomEntity](../server/CSoundOpvarSetAutoRoomEntity.md), [CSoundOpvarSetPathCornerEntity](../server/CSoundOpvarSetPathCornerEntity.md)
