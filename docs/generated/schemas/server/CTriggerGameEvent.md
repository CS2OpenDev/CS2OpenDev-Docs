...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerGameEvent
...
| `0x8e8` | `m_strStartTouchEventName` | CUtlString |  |  |
| `0x8f0` | `m_strEndTouchEventName` | CUtlString |  |  |
| `0x8f8` | `m_strTriggerID` | CUtlString |  |  |
