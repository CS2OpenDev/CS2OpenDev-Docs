---
layout: default
title: SellbackPurchaseEntry_t (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / SellbackPurchaseEntry_t
...
**Twin:** [SellbackPurchaseEntry_t (client)](../client/SellbackPurchaseEntry_t.md)
