...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysPulley
...
106 fields (4 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x508` | `m_position2` | VectorWS |  |  |
| `0x514` | `m_offset` | Vector[2] |  |  |
| `0x52c` | `m_addLength` | float32 |  |  |
| `0x530` | `m_gearRatio` | float32 |  |  |
