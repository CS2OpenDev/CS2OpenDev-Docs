---
title: CPulseGameBlackboard (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CPulseGameBlackboard
...
**Twin:** [CPulseGameBlackboard (client)](../client/CPulseGameBlackboard.md)
...
| `0x4b0` | `m_strGraphName` | CUtlString |  |  |
| `0x4b8` | `m_strStateBlob` | CUtlString |  |  |
