...
[Schemas](../../schemas.md) / [server](../server.md) / CPostProcessingVolume
...
169 fields (12 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8f8` | `m_hPostSettings` | CStrongHandle< [InfoForResourceTypeCPostProcessingResource](../resourcesystem/InfoForResourceTypeCPostProcessingResource.md) > |  |  |
| `0x900` | `m_flFadeDuration` | float32 |  |  |
| `0x904` | `m_flMinLogExposure` | float32 |  |  |
| `0x908` | `m_flMaxLogExposure` | float32 |  |  |
| `0x90c` | `m_flMinExposure` | float32 |  |  |
| `0x910` | `m_flMaxExposure` | float32 |  |  |
| `0x914` | `m_flExposureCompensation` | float32 |  |  |
| `0x918` | `m_flExposureFadeSpeedUp` | float32 |  |  |
| `0x91c` | `m_flExposureFadeSpeedDown` | float32 |  |  |
| `0x920` | `m_flTonemapEVSmoothingRange` | float32 |  |  |
| `0x924` | `m_bMaster` | bool |  |  |
| `0x925` | `m_bExposureControl` | bool |  |  |
