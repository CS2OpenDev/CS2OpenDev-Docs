...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncPlat
...
**Derived by:** [CFuncPlatRot](../server/CFuncPlatRot.md)
...
151 fields (2 declared here, 149 inherited). Offsets are absolute from the object base.
...
| `0x818` | `m_flSpeed` | float32 |  |  |
| `0x820` | `m_sNoise` | CUtlSymbolLarge |  |  |
