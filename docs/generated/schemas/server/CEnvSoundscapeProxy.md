...
| `0x600` | `m_OnPlay` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x618` | `m_flRadius` | float32 | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x620` | `m_soundEventName` | CGameSoundEventName | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x628` | `m_bOverrideWithEvent` | bool | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x62c` | `m_soundscapeIndex` | int32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
| `0x630` | `m_soundscapeEntityListId` | int32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
| `0x638` | `m_positionNames` | CUtlSymbolLarge[8] | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x678` | `m_hProxySoundscape` | CHandle< [CEnvSoundscape](../server/CEnvSoundscape.md) > | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x67c` | `m_bDisabled` | bool | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x680` | `m_soundscapeName` | CUtlSymbolLarge | [CEnvSoundscape](../server/CEnvSoundscape.md) |  |
| `0x688` | `m_soundEventHash` | uint32 | [CEnvSoundscape](../server/CEnvSoundscape.md) | `MNotSaved` |
