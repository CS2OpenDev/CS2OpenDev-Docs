---
layout: default
title: CEnvSoundscapeProxy (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CEnvSoundscapeProxy

# CEnvSoundscapeProxy

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1344 bytes (`0x540`) · **Align:** 8 · **Module:** server

**Twin:** [CEnvSoundscapeProxy (client)](../client/CEnvSoundscapeProxy.md)

**Inherits from:** [CEnvSoundscape](../server/CEnvSoundscape.md)

**Derived by:** [CEnvSoundscapeProxyAlias_snd_soundscape_proxy](../server/CEnvSoundscapeProxyAlias_snd_soundscape_proxy.md)
...
| `0x538` | `m_MainSoundscapeName` | CUtlSymbolLarge |  |  |
