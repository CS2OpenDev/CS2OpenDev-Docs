...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvInstructorHint
...
| `0x4a8` | `m_iszName` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_iszReplace_Key` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_iszHintTargetEntity` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_iTimeout` | int32 |  |  |
| `0x4c4` | `m_iDisplayLimit` | int32 |  |  |
| `0x4c8` | `m_iszIcon_Onscreen` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_iszIcon_Offscreen` | CUtlSymbolLarge |  |  |
| `0x4d8` | `m_iszCaption` | CUtlSymbolLarge |  |  |
| `0x4e0` | `m_iszActivatorCaption` | CUtlSymbolLarge |  |  |
| `0x4e8` | `m_Color` | Color |  |  |
| `0x4ec` | `m_fIconOffset` | float32 |  |  |
| `0x4f0` | `m_fRange` | float32 |  |  |
| `0x4f4` | `m_iPulseOption` | uint8 |  |  |
| `0x4f5` | `m_iAlphaOption` | uint8 |  |  |
| `0x4f6` | `m_iShakeOption` | uint8 |  |  |
| `0x4f7` | `m_bStatic` | bool |  |  |
| `0x4f8` | `m_bNoOffscreen` | bool |  |  |
| `0x4f9` | `m_bForceCaption` | bool |  |  |
| `0x4fc` | `m_iInstanceType` | int32 |  |  |
| `0x500` | `m_bSuppressRest` | bool |  |  |
| `0x508` | `m_iszBinding` | CUtlSymbolLarge |  |  |
| `0x510` | `m_bAllowNoDrawTarget` | bool |  |  |
| `0x511` | `m_bAutoStart` | bool |  |  |
| `0x512` | `m_bLocalPlayerOnly` | bool |  |  |
