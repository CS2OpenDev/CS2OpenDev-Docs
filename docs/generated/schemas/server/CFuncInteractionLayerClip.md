...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncInteractionLayerClip
...
| `0x770` | `m_bDisabled` | bool |  |  |
| `0x778` | `m_iszInteractsAs` | CUtlSymbolLarge |  |  |
| `0x780` | `m_iszInteractsWith` | CUtlSymbolLarge |  |  |
