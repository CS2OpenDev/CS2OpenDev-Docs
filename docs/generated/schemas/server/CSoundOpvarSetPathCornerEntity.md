...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetPathCornerEntity

# CSoundOpvarSetPathCornerEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1648 bytes (`0x670`) · **Align:** 8 · **Module:** server
...
127 fields (4 declared here, 123 inherited). Offsets are absolute from the object base.
...
| `0x658` | `m_bUseParentedPath` | bool |  |  |
| `0x65c` | `m_flDistMinSqr` | float32 |  |  |
| `0x660` | `m_flDistMaxSqr` | float32 |  |  |
| `0x668` | `m_iszPathCornerEntityName` | CUtlSymbolLarge |  |  |
