...
classDiagram
    ...
    CTestPulseIO *-- `CTestPulseIO::FloatStringArgs_t`
    CTestPulseIO *-- `CTestPulseIO::EntityNameStringArgs_t`
    CTestPulseIO *-- `CTestPulseIO::EntityHandleIntArgs_t`
    CTestPulseIO *-- `CTestPulseIO::ThreeStringArgs_t`
```

## Memory layout

111 fields (23 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x6e0` | `m_OnInternalTestSchemaEnum` | CEntityOutputTemplate< [TestInputOutputCombinationsEnum_t](../server/TestInputOutputCombinationsEnum_t.md) > |  |  |
| `0x700` | `m_OnInternalTestFloatString` | CEntityOutputTemplate< [CTestPulseIO::FloatStringArgs_t](../server/CTestPulseIO.FloatStringArgs_t.md) > |  |  |
| `0x728` | `m_OnInternalTestEntityNameString` | CEntityOutputTemplate< [CTestPulseIO::EntityNameStringArgs_t](../server/CTestPulseIO.EntityNameStringArgs_t.md) > |  |  |
| `0x750` | `m_OnInternalTestEntityHandleInt` | CEntityOutputTemplate< [CTestPulseIO::EntityHandleIntArgs_t](../server/CTestPulseIO.EntityHandleIntArgs_t.md) > |  |  |
| `0x770` | `m_OnInternalTestStringStringString` | CEntityOutputTemplate< [CTestPulseIO::ThreeStringArgs_t](../server/CTestPulseIO.ThreeStringArgs_t.md) > |  |  |
