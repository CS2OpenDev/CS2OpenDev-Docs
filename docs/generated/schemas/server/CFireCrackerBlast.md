...
[Schemas](../../schemas.md) / [server](../server.md) / CFireCrackerBlast

# CFireCrackerBlast

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 5112 bytes (`0x13f8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CInferno](../server/CInferno.md)
...
152 fields (0 declared here, 152 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_firePositions` | VectorWS[64] | [CInferno](../server/CInferno.md) | Array of up to 64 world-space positions of active fire cells. |
| `0xa70` | `m_fireParentPositions` | VectorWS[64] | [CInferno](../server/CInferno.md) | Array of parent fire-cell positions that spawned each fire cell (for spread graph). |
| `0xd70` | `m_bFireIsBurning` | bool[64] | [CInferno](../server/CInferno.md) | Per-cell boolean array; true when the corresponding fire cell is actively burning. |
| `0xdb0` | `m_BurnNormal` | Vector[64] | [CInferno](../server/CInferno.md) | Surface normal at each fire-cell position; used to orient flame effects. |
| `0x10b0` | `m_fireCount` | int32 | [CInferno](../server/CInferno.md) | Number of active fire cells currently burning. |
| `0x10b4` | `m_nInfernoType` | int32 | [CInferno](../server/CInferno.md) | Type of fire: 0 = molotov, 1 = incendiary grenade. |
| `0x10b8` | `m_nFireEffectTickBegin` | int32 | [CInferno](../server/CInferno.md) | Server tick on which the fire visual effects started; used by clients to synchronise particle timing. |
| `0x10bc` | `m_nFireLifetime` | float32 | [CInferno](../server/CInferno.md) | Total lifetime of the inferno entity in seconds. |
| `0x10c0` | `m_bInPostEffectTime` | bool | [CInferno](../server/CInferno.md) | True during the brief post-fire period after all flames have died but before the entity is removed (allows smoke and heat-shimmer to linger). |
| `0x10c1` | `m_bWasCreatedInSmoke` | bool | [CInferno](../server/CInferno.md) |  |
| `0x12c8` | `m_extent` | [Extent](../navlib/Extent.md) | [CInferno](../server/CInferno.md) |  |
| `0x12e0` | `m_damageTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CInferno](../server/CInferno.md) |  |
| `0x12f8` | `m_damageRampTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CInferno](../server/CInferno.md) |  |
| `0x1310` | `m_splashVelocity` | Vector | [CInferno](../server/CInferno.md) |  |
| `0x131c` | `m_InitialSplashVelocity` | Vector | [CInferno](../server/CInferno.md) |  |
| `0x1328` | `m_startPos` | VectorWS | [CInferno](../server/CInferno.md) |  |
| `0x1334` | `m_vecOriginalSpawnLocation` | VectorWS | [CInferno](../server/CInferno.md) |  |
| `0x1340` | `m_activeTimer` | [IntervalTimer](../server/IntervalTimer.md) | [CInferno](../server/CInferno.md) |  |
| `0x1350` | `m_fireSpawnOffset` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x1354` | `m_nMaxFlames` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x1358` | `m_nSpreadCount` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x1360` | `m_BookkeepingTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CInferno](../server/CInferno.md) |  |
| `0x1378` | `m_NextSpreadTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CInferno](../server/CInferno.md) |  |
| `0x1390` | `m_nSourceItemDefIndex` | uint16 | [CInferno](../server/CInferno.md) |  |
