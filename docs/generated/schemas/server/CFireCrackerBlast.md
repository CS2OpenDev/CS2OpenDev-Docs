...
| `0x770` | `m_firePositions` | VectorWS[64] | [CInferno](../server/CInferno.md) |  |
| `0xa70` | `m_fireParentPositions` | VectorWS[64] | [CInferno](../server/CInferno.md) |  |
| `0xd70` | `m_bFireIsBurning` | bool[64] | [CInferno](../server/CInferno.md) |  |
| `0xdb0` | `m_BurnNormal` | Vector[64] | [CInferno](../server/CInferno.md) |  |
| `0x10b0` | `m_fireCount` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x10b4` | `m_nInfernoType` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x10b8` | `m_nFireEffectTickBegin` | int32 | [CInferno](../server/CInferno.md) |  |
| `0x10bc` | `m_nFireLifetime` | float32 | [CInferno](../server/CInferno.md) |  |
| `0x10c0` | `m_bInPostEffectTime` | bool | [CInferno](../server/CInferno.md) |  |
