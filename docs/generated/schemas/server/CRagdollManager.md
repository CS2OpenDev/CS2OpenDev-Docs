---
layout: default
title: CRagdollManager (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CRagdollManager
...
**Twin:** [CRagdollManager (client)](../client/CRagdollManager.md)
...
| `0x4a8` | `m_iCurrentMaxRagdollCount` | int8 |  |  |
| `0x4ac` | `m_iMaxRagdollCount` | int32 |  |  |
| `0x4b0` | `m_bSaveImportant` | bool |  |  |
| `0x4b1` | `m_bCanTakeDamage` | bool |  |  |
