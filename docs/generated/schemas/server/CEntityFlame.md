...
[Schemas](../../schemas.md) / [server](../server.md) / CEntityFlame
...
| `0x4a8` | `m_hEntAttached` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4ac` | `m_bCheapEffect` | bool |  |  |
| `0x4b0` | `m_flSize` | float32 |  |  |
| `0x4b4` | `m_bUseHitboxes` | bool |  | `MNotSaved` |
| `0x4b8` | `m_iNumHitboxFires` | int32 |  | `MNotSaved` |
| `0x4bc` | `m_flHitboxFireScale` | float32 |  | `MNotSaved` |
| `0x4c0` | `m_flLifetime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4c4` | `m_hAttacker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  | `MNotSaved` |
| `0x4c8` | `m_flDirectDamagePerSecond` | float32 |  | `MNotSaved` |
| `0x4cc` | `m_iCustomDamageType` | int32 |  | `MNotSaved` |
