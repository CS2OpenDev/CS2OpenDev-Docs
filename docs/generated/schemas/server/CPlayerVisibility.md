...
[Schemas](../../schemas.md) / [server](../server.md) / CPlayerVisibility
...
| `0x4a8` | `m_flVisibilityStrength` | float32 |  |  |
| `0x4ac` | `m_flFogDistanceMultiplier` | float32 |  |  |
| `0x4b0` | `m_flFogMaxDensityMultiplier` | float32 |  |  |
| `0x4b4` | `m_flFadeTime` | float32 |  |  |
| `0x4b8` | `m_bStartDisabled` | bool |  |  |
| `0x4b9` | `m_bIsEnabled` | bool |  |  |
