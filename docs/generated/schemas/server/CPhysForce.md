...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysForce
...
**Derived by:** [CPhysThruster](../server/CPhysThruster.md), [CPhysTorque](../server/CPhysTorque.md)
...
| `0x4a8` | `m_pController` | [IPhysicsMotionController](../vphysics2/IPhysicsMotionController.md)* |  | `MPhysPtr` |
| `0x4b0` | `m_nameAttach` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_force` | float32 |  |  |
| `0x4bc` | `m_forceTime` | float32 |  |  |
| `0x4c0` | `m_attachedObject` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c4` | `m_wasRestored` | bool |  | `MNotSaved` |
| `0x4c8` | `m_integrator` | [CConstantForceController](../server/CConstantForceController.md) |  |  |
