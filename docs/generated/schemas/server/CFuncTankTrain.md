...
| `0x814` | `m_eOrientationType` | [TrainOrientationType_t](../server/TrainOrientationType_t.md) | [CFuncTrackTrain](../server/CFuncTrackTrain.md) |  |
| `0x818` | `m_eVelocityType` | [TrainVelocityType_t](../server/TrainVelocityType_t.md) | [CFuncTrackTrain](../server/CFuncTrackTrain.md) |  |
