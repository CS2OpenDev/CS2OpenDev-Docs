...
[Schemas](../../schemas.md) / [server](../server.md) / CPathTrack
...
98 fields (10 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_pnext` | CHandle< [CPathTrack](../server/CPathTrack.md) > |  |  |
| `0x4ac` | `m_pprevious` | CHandle< [CPathTrack](../server/CPathTrack.md) > |  |  |
| `0x4b0` | `m_paltpath` | CHandle< [CPathTrack](../server/CPathTrack.md) > |  |  |
| `0x4b4` | `m_flSpeed` | float32 |  |  |
| `0x4b8` | `m_flRadius` | float32 |  |  |
| `0x4bc` | `m_length` | float32 |  |  |
| `0x4c0` | `m_altName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_nIterVal` | int32 |  | `MNotSaved` |
| `0x4cc` | `m_eOrientationType` | [TrackOrientationType_t](../!GlobalTypes/TrackOrientationType_t.md) |  |  |
| `0x4d0` | `m_OnPass` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
