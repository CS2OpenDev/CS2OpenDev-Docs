...
[Schemas](../../schemas.md) / [server](../server.md) / CFilterEnemy

# CFilterEnemy

**Kind:** class · **Size:** 1280 bytes (`0x500`) · **Align:** 8 · **Module:** server
...
93 fields (5 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4e0` | `m_iszEnemyName` | CUtlSymbolLarge |  |  |
| `0x4e8` | `m_flRadius` | float32 |  |  |
| `0x4ec` | `m_flOuterRadius` | float32 |  |  |
| `0x4f0` | `m_nMaxSquadmatesPerEnemy` | int32 |  |  |
| `0x4f8` | `m_iszPlayerName` | CUtlSymbolLarge |  |  |
...
| `0x600` | `m_bNegated` | bool | [CBaseFilter](../server/CBaseFilter.md) |  |
| `0x608` | `m_OnPass` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseFilter](../server/CBaseFilter.md) |  |
| `0x620` | `m_OnFail` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseFilter](../server/CBaseFilter.md) |  |
