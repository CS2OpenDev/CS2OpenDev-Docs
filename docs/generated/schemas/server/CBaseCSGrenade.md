...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseCSGrenade
...
**Derived by:** [CDecoyGrenade](../server/CDecoyGrenade.md), [CFlashbang](../server/CFlashbang.md), [CHEGrenade](../server/CHEGrenade.md), [CMolotovGrenade](../server/CMolotovGrenade.md), [CSmokeGrenade](../server/CSmokeGrenade.md)
...
228 fields (13 declared here, 215 inherited). Offsets are absolute from the object base.
...
| `0x106c` | `m_nNextHoldTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x1070` | `m_flNextHoldFrac` | float32 |  |  |
| `0x1074` | `m_hSwitchToWeaponAfterThrow` | CHandle< [CCSWeaponBase](../server/CCSWeaponBase.md) > |  |  |
