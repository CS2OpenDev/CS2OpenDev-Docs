...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetPointBase

# CSoundOpvarSetPointBase

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1360 bytes (`0x550`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseEntity](../server/CBaseEntity.md)

**Derived by:** [CSoundOpvarSetOBBWindEntity](../server/CSoundOpvarSetOBBWindEntity.md), [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md)
...
| `0x4ac` | `m_hSource` | CEntityHandle |  |  |
| `0x4c8` | `m_iszSourceEntityName` | CUtlSymbolLarge |  |  |
| `0x520` | `m_vLastPosition` | VectorWS |  | `MNotSaved` |
| `0x52c` | `m_flRefreshTime` | float32 |  |  |
| `0x530` | `m_iszStackName` | CUtlSymbolLarge |  |  |
| `0x538` | `m_iszOperatorName` | CUtlSymbolLarge |  |  |
| `0x540` | `m_iszOpvarName` | CUtlSymbolLarge |  |  |
| `0x548` | `m_iOpvarIndex` | int32 |  |  |
| `0x54c` | `m_bUseAutoCompare` | bool |  |  |
| `0x54d` | `m_bFastRefresh` | bool |  |  |
