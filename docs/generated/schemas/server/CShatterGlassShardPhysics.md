...
132 fields (4 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_hParentShard` | uint32 |  |  |
| `0x778` | `m_ShardDesc` | shard_model_desc_t |  |  |
| `0x7f8` | `m_nPoolState` | [ShatterGlassEntityPoolState_t](../!GlobalTypes/ShatterGlassEntityPoolState_t.md) |  |  |
| `0x7fc` | `m_bTouchedByPlayer` | bool |  |  |
