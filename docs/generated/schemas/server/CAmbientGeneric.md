...
[Schemas](../../schemas.md) / [server](../server.md) / CAmbientGeneric
...
| `0x4a8` | `m_radius` | float32 |  |  |
| `0x4ac` | `m_flMaxRadius` | float32 |  |  |
| `0x4b0` | `m_iSoundLevel` | soundlevel_t |  |  |
| `0x4b4` | `m_dpv` | dynpitchvol_t |  |  |
| `0x518` | `m_fActive` | bool |  |  |
| `0x519` | `m_fLooping` | bool |  |  |
| `0x520` | `m_iszSound` | CGameSoundEventName |  |  |
| `0x528` | `m_sSourceEntName` | CUtlSymbolLarge |  |  |
| `0x530` | `m_hSoundSource` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  | `MNotSaved` |
| `0x534` | `m_nSoundSourceEntIndex` | CEntityIndex |  | `MNotSaved` |
