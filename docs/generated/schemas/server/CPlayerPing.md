...
[Schemas](../../schemas.md) / [server](../server.md) / CPlayerPing
...
| `0x4b0` | `m_hPlayer` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > |  |  |
| `0x4b4` | `m_hPingedEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4b8` | `m_iType` | int32 |  |  |
| `0x4bc` | `m_bUrgent` | bool |  |  |
| `0x4bd` | `m_szPlaceName` | char[18] |  |  |
