...
[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_TeamSelectCharacterPosition
...
**Derived by:** [CCSGO_TeamSelectCounterTerroristPosition](../server/CCSGO_TeamSelectCounterTerroristPosition.md), [CCSGO_TeamSelectTerroristPosition](../server/CCSGO_TeamSelectTerroristPosition.md)
