...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncMoveLinear
...
**Derived by:** [CFuncMoveLinearAlias_momentary_door](../server/CFuncMoveLinearAlias_momentary_door.md)
...
158 fields (14 declared here, 144 inherited). Offsets are absolute from the object base.
...
| `0x7f0` | `m_authoredPosition` | [MoveLinearAuthoredPos_t](../!GlobalTypes/MoveLinearAuthoredPos_t.md) |  |  |
| `0x7f4` | `m_angMoveEntitySpace` | QAngle |  |  |
| `0x800` | `m_vecMoveDirParentSpace` | Vector |  |  |
| `0x810` | `m_soundStart` | CGameSoundEventName |  |  |
| `0x818` | `m_soundStop` | CGameSoundEventName |  |  |
| `0x820` | `m_currentSound` | CUtlSymbolLarge |  |  |
| `0x828` | `m_flBlockDamage` | float32 |  |  |
| `0x82c` | `m_flStartPosition` | float32 |  |  |
| `0x838` | `m_OnFullyOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x850` | `m_OnFullyClosed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x868` | `m_flSpeed` | float32 |  |  |
| `0x86c` | `m_bCreateMovableNavMesh` | bool |  |  |
| `0x86d` | `m_bAllowMovableNavMeshDockingOnEntireEntity` | bool |  |  |
| `0x86e` | `m_bCreateNavObstacle` | bool |  |  |
