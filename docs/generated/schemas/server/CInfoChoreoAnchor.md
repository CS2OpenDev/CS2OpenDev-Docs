...
[Schemas](../../schemas.md) / [server](../server.md) / CInfoChoreoAnchor
...
| `0x4a8` | `m_vecTargetEntries` | CUtlVector< [CInfoChoreoAnchorPosition](../server/CInfoChoreoAnchorPosition.md) > |  |  |
| `0x4c0` | `m_vecTargetWarps` | CUtlVector< [CInfoChoreoAnchorPosition](../server/CInfoChoreoAnchorPosition.md) > |  |  |
