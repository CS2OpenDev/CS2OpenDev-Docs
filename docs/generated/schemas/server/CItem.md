...
[Schemas](../../schemas.md) / [server](../server.md) / CItem
...
**Derived by:** [CItemAssaultSuit](../server/CItemAssaultSuit.md), [CItemDefuser](../server/CItemDefuser.md), [CItemDogtags](../server/CItemDogtags.md), [CItemGeneric](../server/CItemGeneric.md), [CItemKevlar](../server/CItemKevlar.md), [CScriptItem](../server/CScriptItem.md)
...
154 fields (8 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x9dc` | `m_vOriginalSpawnAngles` | QAngle |  |  |
| `0x9e8` | `m_bPhysStartAsleep` | bool |  | `MNotSaved` |
