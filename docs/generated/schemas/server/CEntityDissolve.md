...
[Schemas](../../schemas.md) / [server](../server.md) / CEntityDissolve
...
| `0x770` | `m_flFadeInStart` | float32 |  |  |
| `0x774` | `m_flFadeInLength` | float32 |  |  |
| `0x778` | `m_flFadeOutModelStart` | float32 |  |  |
| `0x77c` | `m_flFadeOutModelLength` | float32 |  |  |
| `0x780` | `m_flFadeOutStart` | float32 |  |  |
| `0x784` | `m_flFadeOutLength` | float32 |  |  |
| `0x788` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x78c` | `m_nDissolveType` | [EntityDissolveType_t](../!GlobalTypes/EntityDissolveType_t.md) |  |  |
| `0x790` | `m_vDissolverOrigin` | VectorWS |  |  |
| `0x79c` | `m_nMagnitude` | uint32 |  |  |
