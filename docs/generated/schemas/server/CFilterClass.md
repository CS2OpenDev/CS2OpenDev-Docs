---
layout: default
title: CFilterClass (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CFilterClass
...
**Twin:** [CFilterClass (client)](../client/CFilterClass.md)
...
| `0x4e0` | `m_iFilterClass` | CUtlSymbolLarge |  |  |
