...
[Schemas](../../schemas.md) / [server](../server.md) / CRevertSaved
...
131 fields (3 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_loadTime` | float32 |  |  |
| `0x774` | `m_Duration` | float32 |  |  |
| `0x778` | `m_HoldTime` | float32 |  |  |
