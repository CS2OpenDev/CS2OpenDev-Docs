...
[Schemas](../../schemas.md) / [server](../server.md) / CRagdollConstraint
...
111 fields (9 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x508` | `m_xmin` | float32 |  |  |
| `0x50c` | `m_xmax` | float32 |  |  |
| `0x510` | `m_ymin` | float32 |  |  |
| `0x514` | `m_ymax` | float32 |  |  |
| `0x518` | `m_zmin` | float32 |  |  |
| `0x51c` | `m_zmax` | float32 |  |  |
| `0x520` | `m_xfriction` | float32 |  |  |
| `0x524` | `m_yfriction` | float32 |  |  |
| `0x528` | `m_zfriction` | float32 |  |  |
