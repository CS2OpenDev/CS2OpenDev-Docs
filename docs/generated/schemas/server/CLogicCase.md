...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicCase
...
| `0x4a8` | `m_nCase` | CUtlSymbolLarge[32] |  |  |
...
| `0x5a8` | `m_nShuffleCases` | int32 |  |  |
| `0x5a8` | `m_vecAngVelocity` | QAngle | [C_BaseEntity](../client/C_BaseEntity.md) |  |
| `0x5ac` | `m_nLastShuffleCase` | int32 |  |  |
| `0x5b0` | `m_uchShuffleCaseMap` | uint8[32] |  |  |
...
| `0x5d0` | `m_OnCase` | [CEntityIOOutput](../entity2/CEntityIOOutput.md)[32] |  |  |
...
| `0x8d0` | `m_OnDefault` | CEntityOutputTemplate< CUtlString > |  |  |
