---
title: CBaseAnimGraphAlias_baseanimating (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CBaseAnimGraphAlias_baseanimating
...
**Twin:** [CBaseAnimGraphAlias_baseanimating (client)](../client/CBaseAnimGraphAlias_baseanimating.md)
...
143 fields (0 declared here, 143 inherited). Offsets are absolute from the object base.
