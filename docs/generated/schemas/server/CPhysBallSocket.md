...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysBallSocket
...
108 fields (6 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x508` | `m_flJointFriction` | float32 |  |  |
| `0x50c` | `m_bEnableSwingLimit` | bool |  |  |
| `0x510` | `m_flSwingLimit` | float32 |  |  |
| `0x514` | `m_bEnableTwistLimit` | bool |  |  |
| `0x518` | `m_flMinTwistAngle` | float32 |  |  |
| `0x51c` | `m_flMaxTwistAngle` | float32 |  |  |
