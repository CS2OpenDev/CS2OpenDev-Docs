...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerLerpObject

# CTriggerLerpObject

**Kind:** class · **Size:** 2440 bytes (`0x988`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseTrigger](../server/CBaseTrigger.md)
...
173 fields (16 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_iszLerpTarget` | CUtlSymbolLarge |  |  |
| `0x8f0` | `m_hLerpTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x8f8` | `m_iszLerpTargetAttachment` | CUtlSymbolLarge |  |  |
| `0x900` | `m_hLerpTargetAttachment` | [AttachmentHandle_t](../modellib/AttachmentHandle_t.md) |  |  |
| `0x904` | `m_flLerpDuration` | float32 |  |  |
| `0x908` | `m_bAttachedEntityWasParented` | bool |  |  |
| `0x909` | `m_bLerpRestoreMoveType` | bool |  |  |
| `0x90a` | `m_bSingleLerpObject` | bool |  |  |
| `0x910` | `m_vecLerpingObjects` | CUtlVector< lerpdata_t > |  |  |
| `0x928` | `m_iszLerpEffect` | CUtlSymbolLarge |  |  |
| `0x930` | `m_iszLerpSound` | CUtlSymbolLarge |  |  |
| `0x938` | `m_bAttachTouchingObject` | bool |  |  |
| `0x93c` | `m_hEntityToWaitForDisconnect` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x940` | `m_OnLerpStarted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x958` | `m_OnLerpFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x970` | `m_OnDetached` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
