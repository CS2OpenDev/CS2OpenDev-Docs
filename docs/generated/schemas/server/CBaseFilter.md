---
layout: default
title: CBaseFilter (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CBaseFilter

# CBaseFilter

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1248 bytes (`0x4e0`) · **Align:** 8 · **Module:** server

**Twin:** [CBaseFilter (client)](../client/CBaseFilter.md)

**Inherits from:** [CLogicalEntity](../server/CLogicalEntity.md)

**Derived by:** [CFilterAttributeInt](../server/CFilterAttributeInt.md), [CFilterClass](../server/CFilterClass.md), [CFilterContext](../server/CFilterContext.md), [CFilterEnemy](../server/CFilterEnemy.md), [CFilterLOS](../server/CFilterLOS.md), [CFilterMassGreater](../server/CFilterMassGreater.md), [CFilterModel](../server/CFilterModel.md), [CFilterMultiple](../server/CFilterMultiple.md), [CFilterName](../server/CFilterName.md), [CFilterProximity](../server/CFilterProximity.md), [CFilterTeam](../server/CFilterTeam.md), [FilterDamageType](../server/FilterDamageType.md), [FilterHealth](../server/FilterHealth.md)
...
| `0x4a8` | `m_bNegated` | bool |  |  |
| `0x4b0` | `m_OnPass` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c8` | `m_OnFail` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
