...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvDecal

# CEnvDecal

**Kind:** class · **Size:** 1936 bytes (`0x790`) · **Align:** 8 · **Module:** server
...
137 fields (9 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_hDecalMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0x778` | `m_flWidth` | float32 |  |  |
| `0x77c` | `m_flHeight` | float32 |  |  |
| `0x780` | `m_flDepth` | float32 |  |  |
| `0x784` | `m_nRenderOrder` | uint32 |  |  |
| `0x788` | `m_bProjectOnWorld` | bool |  |  |
| `0x789` | `m_bProjectOnCharacters` | bool |  |  |
| `0x78a` | `m_bProjectOnWater` | bool |  |  |
| `0x78c` | `m_flDepthSortBias` | float32 |  |  |
