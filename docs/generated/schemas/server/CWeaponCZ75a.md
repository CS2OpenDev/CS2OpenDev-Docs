...
[Schemas](../../schemas.md) / [server](../server.md) / CWeaponCZ75a
...
223 fields (1 declared here, 222 inherited). Offsets are absolute from the object base.
...
| `0x1070` | `m_bMagazineRemoved` | bool |  |  |
