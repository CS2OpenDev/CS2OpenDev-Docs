...
[Schemas](../../schemas.md) / [server](../server.md) / CPointEntityFinder
...
| `0x4a8` | `m_hEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  | `MNotSaved` |
| `0x4b0` | `m_iFilterName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_hFilter` | CHandle< [CBaseFilter](../server/CBaseFilter.md) > |  |  |
| `0x4c0` | `m_iRefName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_hReference` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4cc` | `m_FindMethod` | [EntFinderMethod_t](../!GlobalTypes/EntFinderMethod_t.md) |  |  |
| `0x4d0` | `m_OnFoundEntity` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
