...
[Schemas](../../schemas.md) / [server](../server.md) / CMomentaryRotButton

# CMomentaryRotButton

**Kind:** class · **Size:** 2472 bytes (`0x9a8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CRotButton](../server/CRotButton.md)
...
184 fields (14 declared here, 170 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_toggle_state` | [TOGGLE_STATE](../!GlobalTypes/TOGGLE_STATE.md) | [CBaseToggle](../server/CBaseToggle.md) |  |
...
| `0x7f0` | `m_angMoveEntitySpace` | QAngle | [CBaseButton](../server/CBaseButton.md) |  |
| `0x7fc` | `m_fStayPushed` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x7fd` | `m_fRotating` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x800` | `m_ls` | locksound_t | [CBaseButton](../server/CBaseButton.md) | `MNotSaved` |
| `0x820` | `m_sUseSound` | CGameSoundEventName | [CBaseButton](../server/CBaseButton.md) |  |
| `0x828` | `m_sLockedSound` | CGameSoundEventName | [CBaseButton](../server/CBaseButton.md) |  |
| `0x830` | `m_sUnlockedSound` | CGameSoundEventName | [CBaseButton](../server/CBaseButton.md) |  |
| `0x838` | `m_sOverrideAnticipationName` | CUtlSymbolLarge | [CBaseButton](../server/CBaseButton.md) |  |
| `0x840` | `m_bLocked` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x841` | `m_bDisabled` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x844` | `m_flSpeed` | float32 | [CBaseButton](../server/CBaseButton.md) |  |
| `0x848` | `m_flUseLockedTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x84c` | `m_bSolidBsp` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x850` | `m_OnDamaged` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x868` | `m_OnPressed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x880` | `m_OnUseLocked` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x898` | `m_OnIn` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8b0` | `m_OnOut` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8c8` | `m_nState` | int32 | [CBaseButton](../server/CBaseButton.md) | `MNotSaved` |
| `0x8cc` | `m_hConstraint` | CEntityHandle | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8d0` | `m_hConstraintParent` | CEntityHandle | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8d4` | `m_bForceNpcExclude` | bool | [CBaseButton](../server/CBaseButton.md) | `MNotSaved` |
| `0x8d8` | `m_sGlowEntity` | CUtlSymbolLarge | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8e0` | `m_glowEntity` | CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > | [CBaseButton](../server/CBaseButton.md) | `MNotSaved` |
| `0x8e4` | `m_usable` | bool | [CBaseButton](../server/CBaseButton.md) |  |
| `0x8e8` | `m_szDisplayText` | CUtlSymbolLarge | [CBaseButton](../server/CBaseButton.md) | `MNotSaved` |
| `0x8f0` | `m_Position` | CEntityOutputTemplate< float32 > |  |  |
| `0x910` | `m_OnUnpressed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x928` | `m_OnFullyOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x940` | `m_OnFullyClosed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x958` | `m_OnReachedPosition` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x970` | `m_lastUsed` | int32 |  |  |
| `0x974` | `m_start` | QAngle |  |  |
| `0x980` | `m_end` | QAngle |  |  |
| `0x98c` | `m_IdealYaw` | float32 |  |  |
| `0x990` | `m_sNoise` | CUtlSymbolLarge |  |  |
| `0x998` | `m_bUpdateTarget` | bool |  |  |
| `0x99c` | `m_direction` | int32 |  |  |
| `0x9a0` | `m_returnSpeed` | float32 |  |  |
| `0x9a4` | `m_flStartPosition` | float32 |  |  |
