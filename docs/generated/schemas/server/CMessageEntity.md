...
[Schemas](../../schemas.md) / [server](../server.md) / CMessageEntity
...
| `0x4a8` | `m_radius` | int32 |  |  |
| `0x4b0` | `m_messageText` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_drawText` | bool |  |  |
| `0x4b9` | `m_bDeveloperOnly` | bool |  |  |
| `0x4ba` | `m_bEnabled` | bool |  |  |
