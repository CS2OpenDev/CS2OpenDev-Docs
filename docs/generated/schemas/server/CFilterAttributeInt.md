---
layout: default
title: CFilterAttributeInt (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CFilterAttributeInt
...
**Twin:** [CFilterAttributeInt (client)](../client/CFilterAttributeInt.md)
...
92 fields (1 declared here, 91 inherited). Offsets are absolute from the object base.
...
| `0x4e0` | `m_sAttributeName` | CUtlSymbolLarge |  |  |
