...
**Inherits from:** [CHostage](../server/CHostage.md)
...
193 fields (0 declared here, 193 inherited). Offsets are absolute from the object base.
...
| `0x968` | `m_hMyWearables` | CNetworkUtlVectorBase< CHandle< [CEconWearable](../server/CEconWearable.md) > > | [CBaseCombatCharacter](../server/CBaseCombatCharacter.md) | Handles to the character's equipped wearable items (gloves, agent model pieces). `MNotSaved` |
...
| `0xa58` | `m_OnHostageBeginGrab` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CHostage](../server/CHostage.md) |  |
| `0xa70` | `m_OnFirstPickedUp` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CHostage](../server/CHostage.md) |  |
| `0xa88` | `m_OnDroppedNotRescued` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CHostage](../server/CHostage.md) |  |
| `0xaa0` | `m_OnRescued` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CHostage](../server/CHostage.md) |  |
| `0xab8` | `m_entitySpottedState` | [EntitySpottedState_t](../server/EntitySpottedState_t.md) | [CHostage](../server/CHostage.md) | EntitySpottedState_t tracking which players have spotted (radar dot) this hostage. |
| `0xad0` | `m_nSpotRules` | int32 | [CHostage](../server/CHostage.md) |  |
| `0xad4` | `m_uiHostageSpawnExclusionGroupMask` | uint32 | [CHostage](../server/CHostage.md) |  |
| `0xad8` | `m_nHostageSpawnRandomFactor` | uint32 | [CHostage](../server/CHostage.md) |  |
| `0xadc` | `m_bRemove` | bool | [CHostage](../server/CHostage.md) |  |
| `0xae0` | `m_vel` | Vector | [CHostage](../server/CHostage.md) | Current velocity vector of the hostage entity. |
| `0xaec` | `m_isRescued` | bool | [CHostage](../server/CHostage.md) | True after the hostage has been delivered to the rescue zone. |
| `0xaed` | `m_jumpedThisFrame` | bool | [CHostage](../server/CHostage.md) | True if the hostage jumped this tick (used to trigger jump animation). |
| `0xaf0` | `m_nHostageState` | int32 | [CHostage](../server/CHostage.md) | State enum: 0 = Idle, 1 = Being grabbed, 2 = Being carried, 3 = Rescued, 4 = Dead. |
| `0xaf4` | `m_leader` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CHostage](../server/CHostage.md) | CHandle to the entity (usually CCSPlayerPawn) that is currently leading this hostage. |
| `0xaf8` | `m_lastLeader` | CHandle< [CCSPlayerPawnBase](../server/CCSPlayerPawnBase.md) > | [CHostage](../server/CHostage.md) |  |
| `0xb00` | `m_reuseTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) | CountdownTimer preventing another player from grabbing this hostage too quickly after it was released. |
| `0xb18` | `m_hasBeenUsed` | bool | [CHostage](../server/CHostage.md) |  |
| `0xb1c` | `m_accel` | Vector | [CHostage](../server/CHostage.md) |  |
| `0xb28` | `m_isRunning` | bool | [CHostage](../server/CHostage.md) |  |
| `0xb29` | `m_isCrouching` | bool | [CHostage](../server/CHostage.md) |  |
| `0xb30` | `m_jumpTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
| `0xb48` | `m_isWaitingForLeader` | bool | [CHostage](../server/CHostage.md) |  |
| `0x2b58` | `m_repathTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
| `0x2b70` | `m_inhibitDoorTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c00` | `m_inhibitObstacleAvoidanceTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c20` | `m_wiggleTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c3c` | `m_isAdjusted` | bool | [CHostage](../server/CHostage.md) |  |
| `0x2c3d` | `m_bHandsHaveBeenCut` | bool | [CHostage](../server/CHostage.md) | True once a CT has interacted with this hostage to free it (deprecated mechanic from CS:GO; retained for compatibility). |
| `0x2c40` | `m_hHostageGrabber` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > | [CHostage](../server/CHostage.md) | CHandle to the CCSPlayerPawn currently grabbing/carrying this hostage. |
| `0x2c44` | `m_fLastGrabTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c48` | `m_vecPositionWhenStartedDroppingToGround` | VectorWS | [CHostage](../server/CHostage.md) |  |
| `0x2c54` | `m_vecGrabbedPos` | VectorWS | [CHostage](../server/CHostage.md) |  |
| `0x2c60` | `m_flRescueStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) | GameTime at which the current rescue attempt began. |
| `0x2c64` | `m_flGrabSuccessTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) | GameTime at which the grab interaction successfully completed and carrying began. |
| `0x2c68` | `m_flDropStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) | GameTime at which the carrier started dropping the hostage. |
| `0x2c6c` | `m_nApproachRewardPayouts` | int32 | [CHostage](../server/CHostage.md) |  |
| `0x2c70` | `m_nPickupEventCount` | int32 | [CHostage](../server/CHostage.md) |  |
| `0x2c74` | `m_vecSpawnGroundPos` | VectorWS | [CHostage](../server/CHostage.md) |  |
| `0x2cac` | `m_vecHostageResetPosition` | VectorWS | [CHostage](../server/CHostage.md) |  |
