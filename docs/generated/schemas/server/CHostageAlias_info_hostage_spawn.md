...
196 fields (0 declared here, 196 inherited). Offsets are absolute from the object base.
...
| `0xab8` | `m_entitySpottedState` | [EntitySpottedState_t](../server/EntitySpottedState_t.md) | [CHostage](../server/CHostage.md) |  |
...
| `0xae0` | `m_vel` | Vector | [CHostage](../server/CHostage.md) |  |
| `0xaec` | `m_isRescued` | bool | [CHostage](../server/CHostage.md) |  |
| `0xaed` | `m_jumpedThisFrame` | bool | [CHostage](../server/CHostage.md) |  |
| `0xaf0` | `m_nHostageState` | int32 | [CHostage](../server/CHostage.md) |  |
...
| `0xaf4` | `m_leader` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CHostage](../server/CHostage.md) |  |
...
| `0xb00` | `m_reuseTimer` | [CountdownTimer](../server/CountdownTimer.md) | [CHostage](../server/CHostage.md) |  |
...
| `0x2c3d` | `m_bHandsHaveBeenCut` | bool | [CHostage](../server/CHostage.md) |  |
| `0x2c40` | `m_hHostageGrabber` | CHandle< [CCSPlayerPawn](../server/CCSPlayerPawn.md) > | [CHostage](../server/CHostage.md) |  |
...
| `0x2c60` | `m_flRescueStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c64` | `m_flGrabSuccessTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) |  |
| `0x2c68` | `m_flDropStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CHostage](../server/CHostage.md) |  |
