...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerOnce
...
**Derived by:** [CScriptTriggerOnce](../server/CScriptTriggerOnce.md), [CTriggerLook](../server/CTriggerLook.md)
...
158 fields (0 declared here, 158 inherited). Offsets are absolute from the object base.
