...
[Schemas](../../schemas.md) / [server](../server.md) / CCSWeaponBaseGun
...
**Derived by:** [CAK47](../server/CAK47.md), [CDEagle](../server/CDEagle.md), [CWeaponAWP](../server/CWeaponAWP.md), [CWeaponAug](../server/CWeaponAug.md), [CWeaponBizon](../server/CWeaponBizon.md), [CWeaponCZ75a](../server/CWeaponCZ75a.md), [CWeaponElite](../server/CWeaponElite.md), [CWeaponFamas](../server/CWeaponFamas.md), [CWeaponFiveSeven](../server/CWeaponFiveSeven.md), [CWeaponG3SG1](../server/CWeaponG3SG1.md), [CWeaponGalilAR](../server/CWeaponGalilAR.md), [CWeaponGlock](../server/CWeaponGlock.md), [CWeaponHKP2000](../server/CWeaponHKP2000.md), [CWeaponM249](../server/CWeaponM249.md), [CWeaponM4A1](../server/CWeaponM4A1.md), [CWeaponM4A1Silencer](../server/CWeaponM4A1Silencer.md), [CWeaponMAC10](../server/CWeaponMAC10.md), [CWeaponMP5SD](../server/CWeaponMP5SD.md), [CWeaponMP7](../server/CWeaponMP7.md), [CWeaponMP9](../server/CWeaponMP9.md), [CWeaponMag7](../server/CWeaponMag7.md), [CWeaponNegev](../server/CWeaponNegev.md), [CWeaponP250](../server/CWeaponP250.md), [CWeaponP90](../server/CWeaponP90.md), [CWeaponRevolver](../server/CWeaponRevolver.md), [CWeaponSCAR20](../server/CWeaponSCAR20.md), [CWeaponSG556](../server/CWeaponSG556.md), [CWeaponSSG08](../server/CWeaponSSG08.md), [CWeaponTaser](../server/CWeaponTaser.md), [CWeaponTec9](../server/CWeaponTec9.md), [CWeaponUMP45](../server/CWeaponUMP45.md), [CWeaponUSPSilencer](../server/CWeaponUSPSilencer.md)
...
225 fields (10 declared here, 215 inherited). Offsets are absolute from the object base.
...
| `0xcdc` | `m_iWeaponGameplayAnimState` | [WeaponGameplayAnimState](../server/WeaponGameplayAnimState.md) | [CCSWeaponBase](../server/CCSWeaponBase.md) |  |
...
| `0xd50` | `m_weaponMode` | [CSWeaponMode](../server/CSWeaponMode.md) | [CCSWeaponBase](../server/CCSWeaponBase.md) |  |
...
| `0x106c` | `m_bSkillReloadAvailable` | bool |  |  |
| `0x106d` | `m_bSkillReloadLiftedReloadKey` | bool |  |  |
| `0x106e` | `m_bSkillBoltInterruptAvailable` | bool |  |  |
| `0x106f` | `m_bSkillBoltLiftedFireKey` | bool |  |  |
