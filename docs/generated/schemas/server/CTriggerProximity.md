...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerProximity
...
162 fields (5 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_hMeasureTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x8f0` | `m_iszMeasureTarget` | CUtlSymbolLarge |  |  |
| `0x8f8` | `m_fRadius` | float32 |  |  |
| `0x8fc` | `m_nTouchers` | int32 |  |  |
| `0x900` | `m_NearestEntityDistance` | CEntityOutputTemplate< float32 > |  |  |
