---
title: CEnvSoundscape (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CEnvSoundscape
...
**Twin:** [CEnvSoundscape (client)](../client/CEnvSoundscape.md)

**Inherits from:** [CBaseEntity](../server/CBaseEntity.md)

**Derived by:** [CEnvSoundscapeAlias_snd_soundscape](../server/CEnvSoundscapeAlias_snd_soundscape.md), [CEnvSoundscapeProxy](../server/CEnvSoundscapeProxy.md), [CEnvSoundscapeTriggerable](../server/CEnvSoundscapeTriggerable.md)
...
99 fields (11 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_OnPlay` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_flRadius` | float32 |  |  |
| `0x4c8` | `m_soundEventName` | CGameSoundEventName |  |  |
| `0x4d0` | `m_bOverrideWithEvent` | bool |  |  |
| `0x4d4` | `m_soundscapeIndex` | int32 |  | `MNotSaved` |
| `0x4d8` | `m_soundscapeEntityListId` | int32 |  | `MNotSaved` |
| `0x4e0` | `m_positionNames` | CUtlSymbolLarge[8] |  |  |
| `0x520` | `m_hProxySoundscape` | CHandle< [CEnvSoundscape](../server/CEnvSoundscape.md) > |  |  |
| `0x524` | `m_bDisabled` | bool |  |  |
| `0x528` | `m_soundscapeName` | CUtlSymbolLarge |  |  |
| `0x530` | `m_soundEventHash` | uint32 |  | `MNotSaved` |
