---
title: CHostageRescueZone (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CHostageRescueZone
...
**Twin:** [CHostageRescueZone (client)](../client/CHostageRescueZone.md)

**Inherits from:** [CHostageRescueZoneShim](../server/CHostageRescueZoneShim.md)
