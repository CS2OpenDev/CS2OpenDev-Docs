...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysHinge
...
**Derived by:** [CPhysHingeAlias_phys_hinge_local](../server/CPhysHingeAlias_phys_hinge_local.md)
...
121 fields (19 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x510` | `m_soundInfo` | [ConstraintSoundInfo](../server/ConstraintSoundInfo.md) |  | `MNotSaved` |
| `0x5a8` | `m_NotifyMinLimitReached` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x5c0` | `m_NotifyMaxLimitReached` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x5d8` | `m_bAtMinLimit` | bool |  |  |
| `0x5d9` | `m_bAtMaxLimit` | bool |  |  |
| `0x5dc` | `m_hinge` | constraint_hingeparams_t |  |  |
| `0x61c` | `m_hingeFriction` | float32 |  |  |
| `0x620` | `m_systemLoadScale` | float32 |  |  |
| `0x624` | `m_bIsAxisLocal` | bool |  | `MNotSaved` |
| `0x628` | `m_flMinRotation` | float32 |  |  |
| `0x62c` | `m_flMaxRotation` | float32 |  |  |
| `0x630` | `m_flInitialRotation` | float32 |  |  |
| `0x634` | `m_flMotorFrequency` | float32 |  |  |
| `0x638` | `m_flMotorDampingRatio` | float32 |  |  |
| `0x63c` | `m_flAngleSpeed` | float32 |  |  |
| `0x640` | `m_flAngleSpeedThreshold` | float32 |  |  |
| `0x644` | `m_flLimitsDebugVisRotation` | float32 |  |  |
| `0x648` | `m_OnStartMoving` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x660` | `m_OnStopMoving` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
