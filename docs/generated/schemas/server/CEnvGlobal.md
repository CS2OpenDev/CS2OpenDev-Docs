...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvGlobal
...
| `0x4a8` | `m_outCounter` | CEntityOutputTemplate< int32 > |  |  |
| `0x4c8` | `m_globalstate` | CUtlSymbolLarge |  |  |
| `0x4d0` | `m_triggermode` | int32 |  |  |
| `0x4d4` | `m_initialstate` | int32 |  |  |
| `0x4d8` | `m_counter` | int32 |  |  |
