...
[Schemas](../../schemas.md) / [server](../server.md) / CItem_Healthshot

# CItem_Healthshot

**Kind:** class · **Size:** 4192 bytes (`0x1060`) · **Align:** 16 · **Module:** server

**Inherits from:** [CWeaponBaseItem](../server/CWeaponBaseItem.md)
...
217 fields (0 declared here, 217 inherited). Offsets are absolute from the object base.
...
| `0x1050` | `m_bSequenceInProgress` | bool | [CWeaponBaseItem](../server/CWeaponBaseItem.md) |  |
| `0x1050` | `m_bInitiallyPopulateInterpHistory` | bool | [CBaseAnimGraph](../server/CBaseAnimGraph.md) |  |
| `0x1051` | `m_bRedraw` | bool | [CWeaponBaseItem](../server/CWeaponBaseItem.md) |  |
