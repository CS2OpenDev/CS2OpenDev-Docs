...
[Schemas](../../schemas.md) / [server](../server.md) / CLightEntity
...
**Derived by:** [CLightDirectionalEntity](../server/CLightDirectionalEntity.md), [CLightOrthoEntity](../server/CLightOrthoEntity.md), [CLightSpotEntity](../server/CLightSpotEntity.md)
...
129 fields (1 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_CLightComponent` | [CLightComponent](../server/CLightComponent.md)* |  |  |
