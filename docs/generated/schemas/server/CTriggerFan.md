...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerFan

# CTriggerFan

**Kind:** class · **Size:** 2480 bytes (`0x9b0`) · **Align:** 16 · **Module:** server
...
182 fields (25 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_vFanOriginOffset` | Vector |  |  |
| `0x8f4` | `m_vDirection` | Vector |  |  |
| `0x900` | `m_bPushTowardsInfoTarget` | bool |  |  |
| `0x901` | `m_bPushAwayFromInfoTarget` | bool |  |  |
| `0x910` | `m_qNoiseDelta` | Quaternion |  |  |
| `0x920` | `m_hInfoFan` | CHandle< [CInfoFan](../server/CInfoFan.md) > |  |  |
| `0x924` | `m_flForce` | float32 |  |  |
| `0x928` | `m_bFalloff` | bool |  |  |
| `0x930` | `m_RampTimer` | [CountdownTimer](../server/CountdownTimer.md) |  |  |
| `0x948` | `m_vFanOriginWS` | VectorWS |  |  |
| `0x954` | `m_vFanOriginLS` | Vector |  |  |
| `0x960` | `m_vFanEndLS` | Vector |  |  |
| `0x96c` | `m_vNoiseDirectionTarget` | Vector |  |  |
| `0x978` | `m_iszInfoFan` | CUtlSymbolLarge |  |  |
| `0x980` | `m_flRopeForceScale` | float32 |  |  |
| `0x984` | `m_flParticleForceScale` | float32 |  |  |
| `0x988` | `m_flPlayerForce` | float32 |  |  |
| `0x98c` | `m_bPlayerWindblock` | bool |  |  |
| `0x990` | `m_flNPCForce` | float32 |  |  |
| `0x994` | `m_flRampTime` | float32 |  |  |
| `0x998` | `m_fNoiseDegrees` | float32 |  |  |
| `0x99c` | `m_fNoiseSpeed` | float32 |  |  |
| `0x9a0` | `m_bPushPlayer` | bool |  |  |
| `0x9a1` | `m_bRampDown` | bool |  |  |
| `0x9a4` | `m_nManagerFanIdx` | int32 |  |  |
