...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvParticleGlow

# CEnvParticleGlow

**Kind:** class · **Size:** 3344 bytes (`0xd10`) · **Align:** 8 · **Module:** server

**Inherits from:** [CParticleSystem](../server/CParticleSystem.md)
...
157 fields (5 declared here, 152 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_szSnapshotFileName` | char[512] | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x970` | `m_bActive` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x971` | `m_bFrozen` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x974` | `m_flFreezeTransitionDuration` | float32 | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x978` | `m_nStopType` | int32 | [CParticleSystem](../server/CParticleSystem.md) | `MNotSaved` |
| `0x97c` | `m_bAnimateDuringGameplayPause` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x980` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > | [CParticleSystem](../server/CParticleSystem.md) | `MNotSaved` |
| `0x988` | `m_flStartTime` | [GameTime_t](../entity2/GameTime_t.md) | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x98c` | `m_flPreSimTime` | float32 | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x990` | `m_vServerControlPoints` | Vector[4] | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x9c0` | `m_iServerControlPointAssignments` | uint8[4] | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0x9c4` | `m_hControlPointEnts` | CHandle< [CBaseEntity](../server/CBaseEntity.md) >[64] | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xac4` | `m_bDataStringLocalized` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xac8` | `m_strDataString` | CUtlString | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xad0` | `m_bNoSave` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xad1` | `m_bNoFreeze` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xad2` | `m_bNoRamp` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xad3` | `m_bStartActive` | bool | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xad8` | `m_iszEffectName` | CUtlSymbolLarge | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xae0` | `m_iszControlPointNames` | CUtlSymbolLarge[64] | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xce0` | `m_nDataCP` | int32 | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xce4` | `m_vecDataCPValue` | Vector | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xcf0` | `m_nTintCP` | int32 | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xcf4` | `m_clrTint` | Color | [CParticleSystem](../server/CParticleSystem.md) |  |
| `0xcf8` | `m_flAlphaScale` | float32 |  |  |
| `0xcfc` | `m_flRadiusScale` | float32 |  |  |
| `0xd00` | `m_flSelfIllumScale` | float32 |  |  |
| `0xd04` | `m_ColorTint` | Color |  |  |
| `0xd08` | `m_hTextureOverride` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
