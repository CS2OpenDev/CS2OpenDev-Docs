...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundEventEntity
...
**Derived by:** [CSoundEventAABBEntity](../server/CSoundEventAABBEntity.md), [CSoundEventConeEntity](../server/CSoundEventConeEntity.md), [CSoundEventEntityAlias_snd_event_point](../server/CSoundEventEntityAlias_snd_event_point.md), [CSoundEventOBBEntity](../server/CSoundEventOBBEntity.md), [CSoundEventPathCornerEntity](../server/CSoundEventPathCornerEntity.md), [CSoundEventSphereEntity](../server/CSoundEventSphereEntity.md)
...
| `0x4a8` | `m_bStartOnSpawn` | bool |  |  |
| `0x4a9` | `m_bToLocalPlayer` | bool |  |  |
| `0x4aa` | `m_bStopOnNew` | bool |  |  |
| `0x4ab` | `m_bSaveRestore` | bool |  |  |
| `0x4ac` | `m_bSavedIsPlaying` | bool |  |  |
| `0x4b0` | `m_flSavedElapsedTime` | float32 |  |  |
| `0x4b8` | `m_iszSourceEntityName` | CUtlSymbolLarge |  |  |
| `0x4c0` | `m_iszAttachmentName` | CUtlSymbolLarge |  |  |
| `0x4c8` | `m_onGUIDChanged` | CEntityOutputTemplate< SndOpEventGuid_t > |  |  |
| `0x4f8` | `m_onSoundFinished` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x510` | `m_flClientCullRadius` | float32 |  |  |
| `0x540` | `m_iszSoundName` | CUtlSymbolLarge |  |  |
| `0x55c` | `m_hSource` | CEntityHandle |  |  |
| `0x560` | `m_nEntityIndexSelection` | int32 |  |  |
