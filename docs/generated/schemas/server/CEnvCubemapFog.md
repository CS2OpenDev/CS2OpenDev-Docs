...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvCubemapFog

# CEnvCubemapFog

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1448 bytes (`0x5a8`) · **Align:** 8 · **Module:** server
...
112 fields (24 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_flEndDistance` | float32 |  |  |
| `0x4ac` | `m_flStartDistance` | float32 |  |  |
| `0x4b0` | `m_flFogFalloffExponent` | float32 |  |  |
| `0x4b4` | `m_bHeightFogEnabled` | bool |  |  |
| `0x4b8` | `m_flFogHeightWidth` | float32 |  |  |
| `0x4bc` | `m_flFogHeightEnd` | float32 |  |  |
| `0x4c0` | `m_flFogHeightStart` | float32 |  |  |
| `0x4c4` | `m_flFogHeightExponent` | float32 |  |  |
| `0x4c8` | `m_flLODBias` | float32 |  |  |
| `0x4cc` | `m_bActive` | bool |  |  |
| `0x4cd` | `m_bStartDisabled` | bool |  |  |
| `0x4d0` | `m_flFogMaxOpacity` | float32 |  |  |
| `0x4d4` | `m_nCubemapSourceType` | int32 |  |  |
| `0x4d8` | `m_hSkyMaterial` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0x4e0` | `m_iszSkyEntity` | CUtlSymbolLarge |  |  |
| `0x4e8` | `m_nHeightFogType` | int32 |  |  |
| `0x4ec` | `m_nFogHeightBlendMode` | int32 |  |  |
| `0x4f0` | `m_nFogHeightCoordinateSpace` | int32 |  |  |
| `0x4f4` | `m_nDistanceFogType` | int32 |  |  |
| `0x4f8` | `m_DistanceFogCurveString` | CUtlSymbolLarge |  |  |
| `0x500` | `m_HeightFogCurveString` | CUtlSymbolLarge |  |  |
| `0x598` | `m_hFogCubemapTexture` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x5a0` | `m_bHasHeightFogEnd` | bool |  |  |
| `0x5a1` | `m_bFirstTime` | bool |  |  |
