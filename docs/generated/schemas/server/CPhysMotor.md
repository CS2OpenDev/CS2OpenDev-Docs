...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysMotor
...
| `0x4a8` | `m_nameAttach` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_nameAnchor` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_hAttachedObject` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4bc` | `m_hAnchorObject` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c0` | `m_spinUp` | float32 |  |  |
| `0x4c4` | `m_spinDown` | float32 |  |  |
| `0x4c8` | `m_flMotorFriction` | float32 |  |  |
| `0x4cc` | `m_additionalAcceleration` | float32 |  |  |
| `0x4d0` | `m_angularAcceleration` | float32 |  |  |
| `0x4d4` | `m_flTorqueScale` | float32 |  |  |
| `0x4d8` | `m_flTargetSpeed` | float32 |  |  |
| `0x4dc` | `m_flSpeedWhenSpinUpOrSpinDownStarted` | float32 |  |  |
| `0x4e0` | `m_pFixedWorldBody` | [IPhysicsBody](../vphysics2/IPhysicsBody.md)* |  | `MPhysPtr` |
| `0x4e8` | `m_pMotorJoint` | [IPhysicsJoint](../vphysics2/IPhysicsJoint.md)* |  | `MPhysPtr` |
| `0x4f0` | `m_motor` | [CMotorController](../server/CMotorController.md) |  |  |
