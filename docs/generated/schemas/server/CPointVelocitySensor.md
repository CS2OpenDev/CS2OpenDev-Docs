...
[Schemas](../../schemas.md) / [server](../server.md) / CPointVelocitySensor
...
| `0x4ac` | `m_vecAxis` | Vector |  |  |
| `0x4b8` | `m_bEnabled` | bool |  |  |
| `0x4bc` | `m_fPrevVelocity` | float32 |  |  |
| `0x4c0` | `m_flAvgInterval` | float32 |  |  |
| `0x4c8` | `m_Velocity` | CEntityOutputTemplate< float32 > |  |  |
