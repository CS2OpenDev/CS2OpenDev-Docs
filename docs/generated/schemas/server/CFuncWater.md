...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncWater

# CFuncWater

**Kind:** class · **Size:** 2184 bytes (`0x888`) · **Align:** 8 · **Module:** server
...
| `0x770` | `m_BuoyancyHelper` | [CBuoyancyHelper](../server/CBuoyancyHelper.md) |  |  |
