...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvBeam

# CEnvBeam

**Kind:** class · **Size:** 2216 bytes (`0x8a8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBeam](../server/CBeam.md)
...
170 fields (19 declared here, 151 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_flFrameRate` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x774` | `m_flHDRColorScale` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x778` | `m_flFireTime` | [GameTime_t](../entity2/GameTime_t.md) | [CBeam](../server/CBeam.md) |  |
| `0x77c` | `m_flDamage` | float32 | [CBeam](../server/CBeam.md) |  |
...
| `0x7d4` | `m_fWidth` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7d8` | `m_fEndWidth` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7dc` | `m_fFadeLength` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7e0` | `m_fHaloScale` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7e4` | `m_fAmplitude` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7e8` | `m_fStartFrame` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7ec` | `m_fSpeed` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7f0` | `m_flFrame` | float32 | [CBeam](../server/CBeam.md) |  |
| `0x7f4` | `m_bTurnedOff` | bool | [CBeam](../server/CBeam.md) |  |
| `0x7f8` | `m_vecEndPos` | VectorWS | [CBeam](../server/CBeam.md) |  |
| `0x804` | `m_hEndEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > | [CBeam](../server/CBeam.md) |  |
| `0x808` | `m_nDissolveType` | int32 | [CBeam](../server/CBeam.md) |  |
| `0x810` | `m_active` | int32 |  |  |
| `0x818` | `m_spriteTexture` | CStrongHandle< [InfoForResourceTypeIMaterial2](../resourcesystem/InfoForResourceTypeIMaterial2.md) > |  |  |
| `0x820` | `m_iszStartEntity` | CUtlSymbolLarge |  |  |
| `0x828` | `m_iszEndEntity` | CUtlSymbolLarge |  |  |
| `0x830` | `m_life` | float32 |  |  |
| `0x834` | `m_boltWidth` | float32 |  |  |
| `0x838` | `m_noiseAmplitude` | float32 |  |  |
| `0x83c` | `m_speed` | int32 |  |  |
| `0x840` | `m_restrike` | float32 |  |  |
| `0x848` | `m_iszSpriteName` | CUtlSymbolLarge |  |  |
| `0x850` | `m_frameStart` | int32 |  |  |
| `0x854` | `m_vEndPointWorld` | VectorWS |  |  |
| `0x860` | `m_vEndPointRelative` | Vector |  | `MNotSaved` |
| `0x86c` | `m_radius` | float32 |  |  |
| `0x870` | `m_TouchType` | [Touch_t](../!GlobalTypes/Touch_t.md) |  |  |
| `0x878` | `m_iFilterName` | CUtlSymbolLarge |  |  |
| `0x880` | `m_hFilter` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x888` | `m_iszDecal` | CUtlSymbolLarge |  |  |
| `0x890` | `m_OnTouchedByEntity` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
