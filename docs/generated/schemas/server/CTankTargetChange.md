...
[Schemas](../../schemas.md) / [server](../server.md) / CTankTargetChange
...
| `0x4a8` | `m_newTarget` | CVariantBase< [CVariantDefaultAllocator](../entity2/CVariantDefaultAllocator.md) > |  | `MNotSaved` |
| `0x4b8` | `m_newTargetName` | CUtlSymbolLarge |  |  |
