...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerBrush
...
133 fields (5 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_OnStartTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x788` | `m_OnEndTouch` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7a0` | `m_OnUse` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7b8` | `m_iInputFilter` | int32 |  |  |
| `0x7bc` | `m_iDontMessageParent` | int32 |  |  |
