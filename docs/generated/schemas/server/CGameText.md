...
[Schemas](../../schemas.md) / [server](../server.md) / CGameText
...
132 fields (2 declared here, 130 inherited). Offsets are absolute from the object base.
...
| `0x780` | `m_iszMessage` | CUtlSymbolLarge |  |  |
| `0x788` | `m_textParms` | hudtextparms_t |  |  |
