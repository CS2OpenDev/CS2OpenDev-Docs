...
[Schemas](../../schemas.md) / [server](../server.md) / CTeam
...
**Derived by:** [CCSTeam](../server/CCSTeam.md)
...
| `0x4a8` | `m_aPlayerControllers` | CNetworkUtlVectorBase< CHandle< [CBasePlayerController](../server/CBasePlayerController.md) > > |  |  |
| `0x4c0` | `m_aPlayers` | CNetworkUtlVectorBase< CHandle< [CBasePlayerPawn](../server/CBasePlayerPawn.md) > > |  |  |
| `0x4d8` | `m_iScore` | int32 |  |  |
| `0x4dc` | `m_szTeamname` | char[129] |  |  |
