...
[Schemas](../../schemas.md) / [server](../server.md) / CPointAngleSensor

# CPointAngleSensor

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1352 bytes (`0x548`) · **Align:** 8 · **Module:** server
...
| `0x4b0` | `m_nLookAtName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_hTargetEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4bc` | `m_hLookAtEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c0` | `m_flDuration` | float32 |  |  |
| `0x4c4` | `m_flDotTolerance` | float32 |  |  |
| `0x4c8` | `m_flFacingTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4cc` | `m_bFired` | bool |  |  |
| `0x4d0` | `m_OnFacingLookat` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4e8` | `m_OnNotFacingLookat` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x500` | `m_TargetDir` | CEntityOutputTemplate< Vector > |  |  |
| `0x528` | `m_FacingPercentage` | CEntityOutputTemplate< float32 > |  |  |
