...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundAreaEntitySphere

# CSoundAreaEntitySphere

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1232 bytes (`0x4d0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CSoundAreaEntityBase](../server/CSoundAreaEntityBase.md)
...
| `0x4a8` | `m_bDisabled` | bool | [CSoundAreaEntityBase](../server/CSoundAreaEntityBase.md) |  |
| `0x4b0` | `m_iszSoundAreaType` | CUtlSymbolLarge | [CSoundAreaEntityBase](../server/CSoundAreaEntityBase.md) |  |
| `0x4b8` | `m_vPos` | Vector | [CSoundAreaEntityBase](../server/CSoundAreaEntityBase.md) |  |
| `0x4c8` | `m_flRadius` | float32 |  |  |
