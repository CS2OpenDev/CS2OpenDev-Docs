...
[Schemas](../../schemas.md) / [server](../server.md) / CAI_ChangeHintGroup
...
| `0x4a8` | `m_iSearchType` | int32 |  |  |
| `0x4b0` | `m_strSearchName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_strNewHintGroup` | CUtlSymbolLarge |  |  |
