...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerSndSosOpvar

# CTriggerSndSosOpvar

**Kind:** class · **Size:** 3144 bytes (`0xc48`) · **Align:** 8 · **Module:** server
...
| `0x8e8` | `m_hTouchingPlayers` | CUtlVector< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  | `MNotSaved` |
| `0x900` | `m_flPosition` | VectorWS |  | `MNotSaved` |
| `0x90c` | `m_flCenterSize` | float32 |  |  |
| `0x910` | `m_flMinVal` | float32 |  |  |
| `0x914` | `m_flMaxVal` | float32 |  |  |
| `0x918` | `m_opvarName` | CUtlSymbolLarge |  |  |
| `0x920` | `m_stackName` | CUtlSymbolLarge |  |  |
| `0x928` | `m_operatorName` | CUtlSymbolLarge |  |  |
| `0x930` | `m_bVolIs2D` | bool |  |  |
| `0x931` | `m_opvarNameChar` | char[256] |  | `MNotSaved` |
| `0xa31` | `m_stackNameChar` | char[256] |  | `MNotSaved` |
| `0xb31` | `m_operatorNameChar` | char[256] |  | `MNotSaved` |
| `0xc34` | `m_VecNormPos` | Vector |  | `MNotSaved` |
| `0xc40` | `m_flNormCenterSize` | float32 |  | `MNotSaved` |
