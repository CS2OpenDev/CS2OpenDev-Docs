...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundOpvarSetAABBEntity

# CSoundOpvarSetAABBEntity

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1704 bytes (`0x6a8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md)

**Derived by:** [CSoundOpvarSetOBBEntity](../server/CSoundOpvarSetOBBEntity.md)
...
132 fields (0 declared here, 132 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_bDisabled` | bool | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x4ac` | `m_hSource` | CEntityHandle | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x4c8` | `m_iszSourceEntityName` | CUtlSymbolLarge | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x520` | `m_vLastPosition` | VectorWS | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) | `MNotSaved` |
| `0x52c` | `m_flRefreshTime` | float32 | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x530` | `m_iszStackName` | CUtlSymbolLarge | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x538` | `m_iszOperatorName` | CUtlSymbolLarge | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x540` | `m_iszOpvarName` | CUtlSymbolLarge | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x548` | `m_iOpvarIndex` | int32 | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x54c` | `m_bUseAutoCompare` | bool | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x54d` | `m_bFastRefresh` | bool | [CSoundOpvarSetPointBase](../server/CSoundOpvarSetPointBase.md) |  |
| `0x550` | `m_OnEnter` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x568` | `m_OnExit` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x580` | `m_bAutoDisable` | bool | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5c4` | `m_flDistanceMin` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5c8` | `m_flDistanceMax` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5cc` | `m_flDistanceMapMin` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5d0` | `m_flDistanceMapMax` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5d4` | `m_flOcclusionRadius` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5d8` | `m_flOcclusionMin` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5dc` | `m_flOcclusionMax` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5e0` | `m_flValSetOnDisable` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5e4` | `m_bSetValueOnDisable` | bool | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5e5` | `m_bReloading` | bool | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x5e8` | `m_nSimulationMode` | int32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5ec` | `m_nVisibilitySamples` | int32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5f0` | `m_vDynamicProxyPoint` | Vector | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x5fc` | `m_flDynamicMaximumOcclusion` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x600` | `m_hDynamicEntity` | CEntityHandle | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x608` | `m_iszDynamicEntityName` | CUtlSymbolLarge | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) |  |
| `0x610` | `m_flPathingDistanceNormFactor` | float32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x614` | `m_vPathingSourcePos` | VectorWS | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x620` | `m_vPathingListenerPos` | VectorWS | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x62c` | `m_vPathingDirection` | Vector | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x638` | `m_nPathingSourceIndex` | int32 | [CSoundOpvarSetPointEntity](../server/CSoundOpvarSetPointEntity.md) | `MNotSaved` |
| `0x640` | `m_vDistanceInnerMins` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x64c` | `m_vDistanceInnerMaxs` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x658` | `m_vDistanceOuterMins` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x664` | `m_vDistanceOuterMaxs` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x670` | `m_nBoxDirection` | int32 | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x674` | `m_vInnerMins` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x680` | `m_vInnerMaxs` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x68c` | `m_vOuterMins` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
| `0x698` | `m_vOuterMaxs` | Vector | [CSoundOpvarSetBoxEntity](../server/CSoundOpvarSetBoxEntity.md) |  |
