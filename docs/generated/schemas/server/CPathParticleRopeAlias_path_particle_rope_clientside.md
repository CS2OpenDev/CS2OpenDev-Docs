...
**Kind:** class · **Size:** 1424 bytes (`0x590`) · **Align:** 8 · **Module:** server

**Inherits from:** [CPathParticleRope](../server/CPathParticleRope.md)
...
104 fields (0 declared here, 104 inherited). Offsets are absolute from the object base.
...
| `0x4b0` | `m_bStartActive` | bool | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4b4` | `m_flMaxSimulationTime` | float32 | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4b8` | `m_iszEffectName` | CUtlSymbolLarge | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4c0` | `m_PathNodes_Name` | CUtlVector< CUtlSymbolLarge > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4d8` | `m_flParticleSpacing` | float32 | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4dc` | `m_flSlack` | float32 | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4e0` | `m_flRadius` | float32 | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4e4` | `m_ColorTint` | Color | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4e8` | `m_nEffectState` | int32 | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x4f0` | `m_iEffectIndex` | CStrongHandle< [InfoForResourceTypeIParticleSystemDefinition](../resourcesystem/InfoForResourceTypeIParticleSystemDefinition.md) > | [CPathParticleRope](../server/CPathParticleRope.md) | `MNotSaved` |
| `0x4f8` | `m_PathNodes_Position` | CNetworkUtlVectorBase< Vector > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x510` | `m_PathNodes_TangentIn` | CNetworkUtlVectorBase< Vector > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x528` | `m_PathNodes_TangentOut` | CNetworkUtlVectorBase< Vector > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x540` | `m_PathNodes_Color` | CNetworkUtlVectorBase< Vector > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x558` | `m_PathNodes_PinEnabled` | CNetworkUtlVectorBase< bool > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
| `0x570` | `m_PathNodes_RadiusScale` | CNetworkUtlVectorBase< float32 > | [CPathParticleRope](../server/CPathParticleRope.md) |  |
