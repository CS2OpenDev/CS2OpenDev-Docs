...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicCollisionPair
...
| `0x4a8` | `m_nameAttach1` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_nameAttach2` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_includeHierarchy` | bool |  |  |
| `0x4b9` | `m_supportMultipleEntitiesWithSameName` | bool |  |  |
| `0x4ba` | `m_disabled` | bool |  |  |
| `0x4bb` | `m_succeeded` | bool |  |  |
| `0x4bc` | `m_allowMissing` | bool |  |  |
