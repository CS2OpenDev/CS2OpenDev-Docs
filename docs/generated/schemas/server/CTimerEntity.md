...
[Schemas](../../schemas.md) / [server](../server.md) / CTimerEntity
...
| `0x4a8` | `m_OnTimer` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4c0` | `m_OnTimerHigh` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4d8` | `m_OnTimerLow` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x4f0` | `m_iDisabled` | int32 |  |  |
| `0x4f4` | `m_flInitialDelay` | float32 |  |  |
| `0x4f8` | `m_flRefireTime` | float32 |  |  |
| `0x4fc` | `m_bUpDownState` | bool |  |  |
| `0x500` | `m_iUseRandomTime` | int32 |  |  |
| `0x504` | `m_bPauseAfterFiring` | bool |  |  |
| `0x508` | `m_flLowerRandomBound` | float32 |  |  |
| `0x50c` | `m_flUpperRandomBound` | float32 |  |  |
| `0x510` | `m_flRemainingTime` | float32 |  |  |
| `0x514` | `m_bPaused` | bool |  |  |
