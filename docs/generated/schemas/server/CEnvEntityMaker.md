...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvEntityMaker
...
| `0x4a8` | `m_vecEntityMins` | Vector |  | `MNotSaved` |
| `0x4b4` | `m_vecEntityMaxs` | Vector |  | `MNotSaved` |
| `0x4c0` | `m_hCurrentInstance` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c4` | `m_hCurrentBlocker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4c8` | `m_vecBlockerOrigin` | VectorWS |  |  |
| `0x4d4` | `m_angPostSpawnDirection` | QAngle |  |  |
| `0x4e0` | `m_flPostSpawnDirectionVariance` | float32 |  |  |
| `0x4e4` | `m_flPostSpawnSpeed` | float32 |  |  |
| `0x4e8` | `m_bPostSpawnUseAngles` | bool |  |  |
| `0x4f0` | `m_iszTemplate` | CUtlSymbolLarge |  |  |
| `0x4f8` | `m_pOutputOnSpawned` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x510` | `m_pOutputOnFailedSpawn` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
