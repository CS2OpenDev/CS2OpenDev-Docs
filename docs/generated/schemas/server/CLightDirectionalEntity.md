...
[Schemas](../../schemas.md) / [server](../server.md) / CLightDirectionalEntity

# CLightDirectionalEntity

**Kind:** class · **Size:** 1912 bytes (`0x778`) · **Align:** 8 · **Module:** server

**Inherits from:** [CLightEntity](../server/CLightEntity.md)

**Derived by:** [CLightEnvironmentEntity](../server/CLightEnvironmentEntity.md)
...
| `0x770` | `m_CLightComponent` | [CLightComponent](../server/CLightComponent.md)* | [CLightEntity](../server/CLightEntity.md) |  |
