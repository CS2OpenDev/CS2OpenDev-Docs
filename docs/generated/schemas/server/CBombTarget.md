...
[Schemas](../../schemas.md) / [server](../server.md) / CBombTarget
...
166 fields (9 declared here, 157 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_OnBombExplode` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x900` | `m_OnBombPlanted` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x918` | `m_OnBombDefused` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x930` | `m_bIsBombSiteB` | bool |  |  |
| `0x931` | `m_bIsHeistBombTarget` | bool |  |  |
| `0x932` | `m_bBombPlantedHere` | bool |  |  |
| `0x938` | `m_szMountTarget` | CUtlSymbolLarge |  |  |
| `0x940` | `m_hInstructorHint` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x944` | `m_nBombSiteDesignation` | int32 |  |  |
