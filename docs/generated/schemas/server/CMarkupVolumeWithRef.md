...
[Schemas](../../schemas.md) / [server](../server.md) / CMarkupVolumeWithRef

# CMarkupVolumeWithRef

**Kind:** class · **Size:** 2008 bytes (`0x7d8`) · **Align:** 8 · **Module:** server

**Inherits from:** [CMarkupVolumeTagged](../server/CMarkupVolumeTagged.md)

**Derived by:** [CMarkupVolumeTagged_NavGame](../server/CMarkupVolumeTagged_NavGame.md)
...
| `0x7b8` | `m_bUseRef` | bool |  |  |
| `0x7bc` | `m_vRefPosEntitySpace` | Vector |  |  |
| `0x7c8` | `m_vRefPosWorldSpace` | VectorWS |  |  |
| `0x7d4` | `m_flRefDot` | float32 |  |  |
