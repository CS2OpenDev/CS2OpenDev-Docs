...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncConveyor

# CFuncConveyor

**Kind:** class · **Size:** 1984 bytes (`0x7c0`) · **Align:** 8 · **Module:** server
...
138 fields (10 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_szConveyorModels` | CUtlSymbolLarge |  |  |
| `0x778` | `m_flTransitionDurationSeconds` | float32 |  |  |
| `0x77c` | `m_flSpeed` | float32 |  |  |
| `0x780` | `m_angMoveEntitySpace` | QAngle |  |  |
| `0x78c` | `m_vecMoveDirEntitySpace` | Vector |  |  |
| `0x798` | `m_flTargetSpeed` | float32 |  |  |
| `0x79c` | `m_nTransitionStartTick` | [GameTick_t](../entity2/GameTick_t.md) |  |  |
| `0x7a0` | `m_nTransitionDurationTicks` | int32 |  |  |
| `0x7a4` | `m_flTransitionStartSpeed` | float32 |  |  |
| `0x7a8` | `m_hConveyorModels` | CNetworkUtlVectorBase< CHandle< [CBaseEntity](../server/CBaseEntity.md) > > |  |  |
