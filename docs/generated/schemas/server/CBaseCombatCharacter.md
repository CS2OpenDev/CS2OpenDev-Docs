...
**Derived by:** [CBasePlayerPawn](../server/CBasePlayerPawn.md), [CHostageExpresserShim](../server/CHostageExpresserShim.md)
...
156 fields (10 declared here, 146 inherited). Offsets are absolute from the object base.
...
| `0x9e8` | `m_eHull` | [Hull_t](../!GlobalTypes/Hull_t.md) |  |  |
| `0x9ec` | `m_nNavHullIdx` | uint32 |  |  |
| `0x9f0` | `m_movementStats` | [CMovementStatsProperty](../server/CMovementStatsProperty.md) |  |  |
