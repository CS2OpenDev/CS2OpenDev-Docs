...
[Schemas](../../schemas.md) / [server](../server.md) / CCSPlayerResource
...
| `0x4a8` | `m_bHostageAlive` | bool[12] |  |  |
| `0x4b4` | `m_isHostageFollowingSomeone` | bool[12] |  |  |
| `0x4c0` | `m_iHostageEntityIDs` | CEntityIndex[12] |  |  |
| `0x4f0` | `m_bombsiteCenterA` | VectorWS |  |  |
| `0x4fc` | `m_bombsiteCenterB` | VectorWS |  |  |
| `0x508` | `m_hostageRescueX` | int32[4] |  |  |
| `0x518` | `m_hostageRescueY` | int32[4] |  |  |
| `0x528` | `m_hostageRescueZ` | int32[4] |  |  |
| `0x538` | `m_bEndMatchNextMapAllVoted` | bool |  |  |
| `0x539` | `m_foundGoalPositions` | bool |  |  |
