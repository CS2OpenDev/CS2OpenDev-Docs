...
[Schemas](../../schemas.md) / [server](../server.md) / CPointEntity
...
**Derived by:** [CAmbientGeneric](../server/CAmbientGeneric.md), [CBaseDMStart](../server/CBaseDMStart.md), [CBlood](../server/CBlood.md), [CChoreoInfoTarget](../server/CChoreoInfoTarget.md), [CCredits](../server/CCredits.md), [CEnvEntityMaker](../server/CEnvEntityMaker.md), [CEnvHudHint](../server/CEnvHudHint.md), [CEnvInstructorHint](../server/CEnvInstructorHint.md), [CEnvInstructorVRHint](../server/CEnvInstructorVRHint.md), [CEnvMuzzleFlash](../server/CEnvMuzzleFlash.md), [CEnvShake](../server/CEnvShake.md), [CEnvSpark](../server/CEnvSpark.md), [CEnvSplash](../server/CEnvSplash.md), [CEnvTilt](../server/CEnvTilt.md), [CEnvViewPunch](../server/CEnvViewPunch.md), [CInfoChoreoAnchor](../server/CInfoChoreoAnchor.md), [CInfoDynamicShadowHint](../server/CInfoDynamicShadowHint.md), [CInfoFan](../server/CInfoFan.md), [CInfoGameEventProxy](../server/CInfoGameEventProxy.md), [CInfoInstructorHintBombTargetA](../server/CInfoInstructorHintBombTargetA.md), [CInfoInstructorHintBombTargetB](../server/CInfoInstructorHintBombTargetB.md), [CInfoInstructorHintHostageRescueZone](../server/CInfoInstructorHintHostageRescueZone.md), [CInfoInstructorHintTarget](../server/CInfoInstructorHintTarget.md), [CInfoLandmark](../server/CInfoLandmark.md), [CInfoOffscreenPanoramaTexture](../server/CInfoOffscreenPanoramaTexture.md), [CInfoParticleTarget](../server/CInfoParticleTarget.md), [CInfoPlayerStart](../server/CInfoPlayerStart.md), [CInfoSpawnGroupLandmark](../server/CInfoSpawnGroupLandmark.md), [CInfoTarget](../server/CInfoTarget.md), [CInfoTeleportDestination](../server/CInfoTeleportDestination.md), [CInstructorEventEntity](../server/CInstructorEventEntity.md), [CKeepUpright](../server/CKeepUpright.md), [CLogicProximity](../server/CLogicProximity.md), [CLogicScript](../server/CLogicScript.md), [CMapInfo](../server/CMapInfo.md), [CMessage](../server/CMessage.md), [CMessageEntity](../server/CMessageEntity.md), [CNavSpaceInfo](../server/CNavSpaceInfo.md), [CNavWalkable](../server/CNavWalkable.md), [CPathCorner](../server/CPathCorner.md), [CPathNode](../server/CPathNode.md), [CPathTrack](../server/CPathTrack.md), [CPhysExplosion](../server/CPhysExplosion.md), [CPhysForce](../server/CPhysForce.md), [CPhysImpact](../server/CPhysImpact.md), [CPointAngleSensor](../server/CPointAngleSensor.md), [CPointAngularVelocitySensor](../server/CPointAngularVelocitySensor.md), [CPointBroadcastClientCommand](../server/CPointBroadcastClientCommand.md), [CPointChildModifier](../server/CPointChildModifier.md), [CPointClientCommand](../server/CPointClientCommand.md), [CPointGamestatsCounter](../server/CPointGamestatsCounter.md), [CPointGiveAmmo](../server/CPointGiveAmmo.md), [CPointHurt](../server/CPointHurt.md), [CPointProximitySensor](../server/CPointProximitySensor.md), [CPointPush](../server/CPointPush.md), [CPointServerCommand](../server/CPointServerCommand.md), [CPointVelocitySensor](../server/CPointVelocitySensor.md), [CRagdollMagnet](../server/CRagdollMagnet.md), [CRotatorTarget](../server/CRotatorTarget.md), [CSceneEntity](../server/CSceneEntity.md), [CTankTargetChange](../server/CTankTargetChange.md), [CTankTrainAI](../server/CTankTrainAI.md)
...
88 fields (0 declared here, 88 inherited). Offsets are absolute from the object base.
