...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvWindController

# CEnvWindController

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1536 bytes (`0x600`) · **Align:** 8 · **Module:** server
...
| `0x4a8` | `m_EnvWindShared` | [CEnvWindShared](../server/CEnvWindShared.md) |  |  |
| `0x5d8` | `m_fDirectionVariation` | float32 |  |  |
| `0x5dc` | `m_fSpeedVariation` | float32 |  |  |
| `0x5e0` | `m_fTurbulence` | float32 |  |  |
| `0x5e4` | `m_fVolumeHalfExtentXY` | float32 |  |  |
| `0x5e8` | `m_fVolumeHalfExtentZ` | float32 |  |  |
| `0x5ec` | `m_nVolumeResolutionXY` | int32 |  |  |
| `0x5f0` | `m_nVolumeResolutionZ` | int32 |  |  |
| `0x5f4` | `m_nClipmapLevels` | int32 |  |  |
| `0x5f8` | `m_bIsMaster` | bool |  |  |
| `0x5f9` | `m_bFirstTime` | bool |  |  |
