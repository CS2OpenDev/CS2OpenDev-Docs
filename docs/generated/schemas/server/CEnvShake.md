...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvShake

# CEnvShake

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1272 bytes (`0x4f8`) · **Align:** 8 · **Module:** server
...
| `0x4a8` | `m_limitToEntity` | CUtlSymbolLarge |  |  |
| `0x4b0` | `m_Amplitude` | float32 |  |  |
| `0x4b4` | `m_Frequency` | float32 |  |  |
| `0x4b8` | `m_Duration` | float32 |  |  |
| `0x4bc` | `m_Radius` | float32 |  |  |
| `0x4c0` | `m_stopTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4c4` | `m_nextShake` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4c8` | `m_currentAmp` | float32 |  |  |
| `0x4cc` | `m_maxForce` | Vector |  |  |
| `0x4d8` | `m_pShakeController` | [IPhysicsMotionController](../vphysics2/IPhysicsMotionController.md)* |  | `MPhysPtr` |
| `0x4e0` | `m_shakeCallback` | [CPhysicsShake](../server/CPhysicsShake.md) |  |  |
