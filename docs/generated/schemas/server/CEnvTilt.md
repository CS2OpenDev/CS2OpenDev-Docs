...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvTilt
...
| `0x4a8` | `m_Duration` | float32 |  |  |
| `0x4ac` | `m_Radius` | float32 |  |  |
| `0x4b0` | `m_TiltTime` | float32 |  |  |
| `0x4b4` | `m_stopTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
