...
[Schemas](../../schemas.md) / [server](../server.md) / CFish
...
167 fields (24 declared here, 143 inherited). Offsets are absolute from the object base.
...
| `0x960` | `m_pool` | CHandle< [CFishPool](../server/CFishPool.md) > |  |  |
| `0x964` | `m_id` | uint32 |  |  |
| `0x968` | `m_x` | float32 |  | `MNotSaved` |
| `0x96c` | `m_y` | float32 |  | `MNotSaved` |
| `0x970` | `m_z` | float32 |  | `MNotSaved` |
| `0x974` | `m_angle` | float32 |  |  |
| `0x978` | `m_angleChange` | float32 |  |  |
| `0x97c` | `m_forward` | Vector |  |  |
| `0x988` | `m_perp` | Vector |  |  |
| `0x994` | `m_poolOrigin` | VectorWS |  |  |
| `0x9a0` | `m_waterLevel` | float32 |  |  |
| `0x9a4` | `m_speed` | float32 |  |  |
| `0x9a8` | `m_desiredSpeed` | float32 |  |  |
| `0x9ac` | `m_calmSpeed` | float32 |  |  |
| `0x9b0` | `m_panicSpeed` | float32 |  |  |
| `0x9b4` | `m_avoidRange` | float32 |  |  |
| `0x9b8` | `m_turnTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0x9d0` | `m_turnClockwise` | bool |  |  |
| `0x9d8` | `m_goTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0x9f0` | `m_moveTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0xa08` | `m_panicTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0xa20` | `m_disperseTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0xa38` | `m_proximityTimer` | [CountdownTimer](../server/CountdownTimer.md) |  | `MNotSaved` |
| `0xa50` | `m_visible` | CUtlVector< [CFish](../server/CFish.md)* > |  | `MNotSaved` |
