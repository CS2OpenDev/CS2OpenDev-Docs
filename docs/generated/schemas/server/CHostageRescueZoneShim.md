...
[Schemas](../../schemas.md) / [server](../server.md) / CHostageRescueZoneShim
...
**Derived by:** [CHostageRescueZone](../server/CHostageRescueZone.md)
...
157 fields (0 declared here, 157 inherited). Offsets are absolute from the object base.
