---
title: CFilterMassGreater (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CFilterMassGreater
...
**Twin:** [CFilterMassGreater (client)](../client/CFilterMassGreater.md)
