...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysSlideConstraint

# CPhysSlideConstraint

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1488 bytes (`0x5d0`) · **Align:** 8 · **Module:** server
...
112 fields (10 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x510` | `m_axisEnd` | VectorWS |  |  |
| `0x51c` | `m_slideFriction` | float32 |  |  |
| `0x520` | `m_systemLoadScale` | float32 |  |  |
| `0x524` | `m_initialOffset` | float32 |  |  |
| `0x528` | `m_bEnableLinearConstraint` | bool |  |  |
| `0x529` | `m_bEnableAngularConstraint` | bool |  |  |
| `0x52c` | `m_flMotorFrequency` | float32 |  |  |
| `0x530` | `m_flMotorDampingRatio` | float32 |  |  |
| `0x534` | `m_bUseEntityPivot` | bool |  |  |
| `0x538` | `m_soundInfo` | [ConstraintSoundInfo](../server/ConstraintSoundInfo.md) |  | `MNotSaved` |
