...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicCompare
...
| `0x4a8` | `m_flInValue` | float32 |  |  |
| `0x4ac` | `m_flCompareValue` | float32 |  |  |
| `0x4b0` | `m_OnLessThan` | CEntityOutputTemplate< float32 > |  |  |
| `0x4d0` | `m_OnEqualTo` | CEntityOutputTemplate< float32 > |  |  |
| `0x4f0` | `m_OnNotEqualTo` | CEntityOutputTemplate< float32 > |  |  |
| `0x510` | `m_OnGreaterThan` | CEntityOutputTemplate< float32 > |  |  |
