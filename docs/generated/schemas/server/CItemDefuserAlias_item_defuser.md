...
**Inherits from:** [CItemDefuser](../server/CItemDefuser.md)
...
| `0xa00` | `m_entitySpottedState` | [EntitySpottedState_t](../server/EntitySpottedState_t.md) | [CItemDefuser](../server/CItemDefuser.md) |  |
| `0xa18` | `m_nSpotRules` | int32 | [CItemDefuser](../server/CItemDefuser.md) |  |
