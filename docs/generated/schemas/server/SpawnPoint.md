...
[Schemas](../../schemas.md) / [server](../server.md) / SpawnPoint
...
**Derived by:** [CInfoDeathmatchSpawn](../server/CInfoDeathmatchSpawn.md), [CInfoPlayerCounterterrorist](../server/CInfoPlayerCounterterrorist.md), [CInfoPlayerTerrorist](../server/CInfoPlayerTerrorist.md)
