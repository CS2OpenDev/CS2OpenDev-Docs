...
[Schemas](../../schemas.md) / [server](../server.md) / CColorCorrection

# CColorCorrection

**Kind:** class · **Size:** 1760 bytes (`0x6e0`) · **Align:** 8 · **Module:** server
...
105 fields (17 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_flFadeInDuration` | float32 |  |  |
| `0x4ac` | `m_flFadeOutDuration` | float32 |  |  |
| `0x4b0` | `m_flStartFadeInWeight` | float32 |  |  |
| `0x4b4` | `m_flStartFadeOutWeight` | float32 |  |  |
| `0x4b8` | `m_flTimeStartFadeIn` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4bc` | `m_flTimeStartFadeOut` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4c0` | `m_flMaxWeight` | float32 |  |  |
| `0x4c4` | `m_bStartDisabled` | bool |  |  |
| `0x4c5` | `m_bEnabled` | bool |  |  |
| `0x4c6` | `m_bMaster` | bool |  | `MNotSaved` |
| `0x4c7` | `m_bClientSide` | bool |  | `MNotSaved` |
| `0x4c8` | `m_bExclusive` | bool |  |  |
| `0x4cc` | `m_MinFalloff` | float32 |  |  |
| `0x4d0` | `m_MaxFalloff` | float32 |  |  |
| `0x4d4` | `m_flCurWeight` | float32 |  |  |
| `0x4d8` | `m_netlookupFilename` | char[512] |  | `MNotSaved` |
| `0x6d8` | `m_lookupFilename` | CUtlSymbolLarge |  |  |
