...
[Schemas](../../schemas.md) / [server](../server.md) / CBaseDoor

# CBaseDoor

**Kind:** class · **Size:** 2424 bytes (`0x978`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseToggle](../server/CBaseToggle.md)

**Derived by:** [CRotDoor](../server/CRotDoor.md)
...
173 fields (29 declared here, 144 inherited). Offsets are absolute from the object base.
...
| `0x800` | `m_angMoveEntitySpace` | QAngle |  |  |
| `0x80c` | `m_vecMoveDirParentSpace` | Vector |  |  |
| `0x818` | `m_ls` | locksound_t |  | `MNotSaved` |
| `0x838` | `m_bForceClosed` | bool |  |  |
| `0x839` | `m_bDoorGroup` | bool |  |  |
| `0x83a` | `m_bLocked` | bool |  |  |
| `0x83b` | `m_bIgnoreDebris` | bool |  |  |
| `0x83c` | `m_bNoNPCs` | bool |  |  |
| `0x840` | `m_eSpawnPosition` | [FuncDoorSpawnPos_t](../!GlobalTypes/FuncDoorSpawnPos_t.md) |  |  |
| `0x844` | `m_flBlockDamage` | float32 |  |  |
| `0x848` | `m_NoiseMoving` | CGameSoundEventName |  |  |
| `0x850` | `m_NoiseArrived` | CGameSoundEventName |  |  |
| `0x858` | `m_NoiseMovingClosed` | CGameSoundEventName |  |  |
| `0x860` | `m_NoiseArrivedClosed` | CGameSoundEventName |  |  |
| `0x868` | `m_ChainTarget` | CUtlSymbolLarge |  |  |
| `0x870` | `m_OnBlockedClosing` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x888` | `m_OnBlockedOpening` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8a0` | `m_OnUnblockedClosing` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8b8` | `m_OnUnblockedOpening` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8d0` | `m_OnFullyClosed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x8e8` | `m_OnFullyOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x900` | `m_OnClose` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x918` | `m_OnOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x930` | `m_OnLockedUse` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x948` | `m_bLoopMoveSound` | bool |  |  |
| `0x968` | `m_bCreateNavObstacle` | bool |  |  |
| `0x96c` | `m_flSpeed` | float32 |  |  |
| `0x970` | `m_isChaining` | bool |  | `MNotSaved` |
| `0x971` | `m_bIsUsable` | bool |  | `MNotSaved` |
