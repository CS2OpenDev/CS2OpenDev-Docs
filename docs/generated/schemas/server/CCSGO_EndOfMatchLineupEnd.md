---
layout: default
title: CCSGO_EndOfMatchLineupEnd (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CCSGO_EndOfMatchLineupEnd
...
**Twin:** [CCSGO_EndOfMatchLineupEnd (client)](../client/CCSGO_EndOfMatchLineupEnd.md)

**Inherits from:** [CCSGO_EndOfMatchLineupEndpoint](../server/CCSGO_EndOfMatchLineupEndpoint.md)
