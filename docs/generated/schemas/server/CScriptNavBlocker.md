...
[Schemas](../../schemas.md) / [server](../server.md) / CScriptNavBlocker

# CScriptNavBlocker

**Kind:** class · **Size:** 1944 bytes (`0x798`) · **Align:** 8 · **Module:** server

**Inherits from:** [CFuncNavBlocker](../server/CFuncNavBlocker.md)
...
131 fields (1 declared here, 130 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_bDisabled` | bool | [CFuncNavBlocker](../server/CFuncNavBlocker.md) |  |
| `0x77c` | `m_nBlockedTeamNumber` | int32 | [CFuncNavBlocker](../server/CFuncNavBlocker.md) |  |
| `0x788` | `m_vExtent` | Vector |  |  |
