...
[Schemas](../../schemas.md) / [server](../server.md) / CBarnLight

# CBarnLight

**Kind:** class · **Size:** 2648 bytes (`0xa58`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseModelEntity](../server/CBaseModelEntity.md)

**Derived by:** [COmniLight](../server/COmniLight.md), [CRectLight](../server/CRectLight.md)
...
205 fields (77 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x770` | `m_bEnabled` | bool |  |  |
| `0x774` | `m_nColorMode` | int32 |  |  |
| `0x778` | `m_Color` | Color |  |  |
| `0x77c` | `m_flColorTemperature` | float32 |  |  |
| `0x780` | `m_flBrightness` | float32 |  |  |
| `0x784` | `m_flBrightnessScale` | float32 |  |  |
| `0x788` | `m_nDirectLight` | int32 |  |  |
| `0x78c` | `m_nBakedShadowIndex` | int32 |  |  |
| `0x790` | `m_nLightPathUniqueId` | int32 |  |  |
| `0x794` | `m_nLightMapUniqueId` | int32 |  |  |
| `0x798` | `m_nLuminaireShape` | int32 |  |  |
| `0x79c` | `m_flLuminaireSize` | float32 |  |  |
| `0x7a0` | `m_flLuminaireAnisotropy` | float32 |  |  |
| `0x7a8` | `m_LightStyleString` | CUtlString |  |  |
| `0x7b0` | `m_flLightStyleStartTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x7b8` | `m_QueuedLightStyleStrings` | CNetworkUtlVectorBase< CUtlString > |  |  |
| `0x7d0` | `m_LightStyleEvents` | CNetworkUtlVectorBase< CUtlString > |  |  |
| `0x7e8` | `m_LightStyleTargets` | CNetworkUtlVectorBase< CHandle< [CBaseModelEntity](../server/CBaseModelEntity.md) > > |  |  |
| `0x800` | `m_StyleEvent` | [CEntityIOOutput](../entity2/CEntityIOOutput.md)[4] |  |  |
| `0x880` | `m_hLightCookie` | CStrongHandle< [InfoForResourceTypeCTextureBase](../resourcesystem/InfoForResourceTypeCTextureBase.md) > |  |  |
| `0x888` | `m_flShape` | float32 |  |  |
| `0x88c` | `m_flSoftX` | float32 |  |  |
| `0x890` | `m_flSoftY` | float32 |  |  |
| `0x894` | `m_flSkirt` | float32 |  |  |
| `0x898` | `m_flSkirtNear` | float32 |  |  |
| `0x89c` | `m_vSizeParams` | Vector |  |  |
| `0x8a8` | `m_flRange` | float32 |  |  |
| `0x8ac` | `m_vShear` | Vector |  |  |
| `0x8b8` | `m_nBakeSpecularToCubemaps` | int32 |  |  |
| `0x8bc` | `m_vBakeSpecularToCubemapsSize` | Vector |  |  |
| `0x8c8` | `m_flBakeSpecularToCubemapsScale` | float32 |  |  |
| `0x8cc` | `m_nCastShadows` | int32 |  |  |
| `0x8d0` | `m_nShadowMapSize` | int32 |  |  |
| `0x8d4` | `m_nShadowPriority` | int32 |  |  |
| `0x8d8` | `m_bContactShadow` | bool |  |  |
| `0x8d9` | `m_bForceShadowsEnabled` | bool |  |  |
| `0x8dc` | `m_nBounceLight` | int32 |  |  |
| `0x8e0` | `m_flBounceScale` | float32 |  |  |
| `0x8e4` | `m_flMinRoughness` | float32 |  |  |
| `0x8e8` | `m_vAlternateColor` | Vector |  |  |
| `0x8f4` | `m_fAlternateColorBrightness` | float32 |  |  |
| `0x8f8` | `m_nFog` | int32 |  |  |
| `0x8fc` | `m_flFogStrength` | float32 |  |  |
| `0x900` | `m_nFogShadows` | int32 |  |  |
| `0x904` | `m_flFogScale` | float32 |  |  |
| `0x908` | `m_flFadeSizeStart` | float32 |  |  |
| `0x90c` | `m_flFadeSizeEnd` | float32 |  |  |
| `0x910` | `m_flShadowFadeSizeStart` | float32 |  |  |
| `0x914` | `m_flShadowFadeSizeEnd` | float32 |  |  |
| `0x918` | `m_bPrecomputedFieldsValid` | bool |  |  |
| `0x91c` | `m_vPrecomputedBoundsMins` | Vector |  |  |
| `0x928` | `m_vPrecomputedBoundsMaxs` | Vector |  |  |
| `0x934` | `m_vPrecomputedOBBOrigin` | Vector |  |  |
| `0x940` | `m_vPrecomputedOBBAngles` | QAngle |  |  |
| `0x94c` | `m_vPrecomputedOBBExtent` | Vector |  |  |
| `0x958` | `m_nPrecomputedSubFrusta` | int32 |  |  |
| `0x95c` | `m_vPrecomputedOBBOrigin0` | Vector |  |  |
| `0x968` | `m_vPrecomputedOBBAngles0` | QAngle |  |  |
| `0x974` | `m_vPrecomputedOBBExtent0` | Vector |  |  |
| `0x980` | `m_vPrecomputedOBBOrigin1` | Vector |  |  |
| `0x98c` | `m_vPrecomputedOBBAngles1` | QAngle |  |  |
| `0x998` | `m_vPrecomputedOBBExtent1` | Vector |  |  |
| `0x9a4` | `m_vPrecomputedOBBOrigin2` | Vector |  |  |
| `0x9b0` | `m_vPrecomputedOBBAngles2` | QAngle |  |  |
| `0x9bc` | `m_vPrecomputedOBBExtent2` | Vector |  |  |
| `0x9c8` | `m_vPrecomputedOBBOrigin3` | Vector |  |  |
| `0x9d4` | `m_vPrecomputedOBBAngles3` | QAngle |  |  |
| `0x9e0` | `m_vPrecomputedOBBExtent3` | Vector |  |  |
| `0x9ec` | `m_vPrecomputedOBBOrigin4` | Vector |  |  |
| `0x9f8` | `m_vPrecomputedOBBAngles4` | QAngle |  |  |
| `0xa04` | `m_vPrecomputedOBBExtent4` | Vector |  |  |
| `0xa10` | `m_vPrecomputedOBBOrigin5` | Vector |  |  |
| `0xa1c` | `m_vPrecomputedOBBAngles5` | QAngle |  |  |
| `0xa28` | `m_vPrecomputedOBBExtent5` | Vector |  |  |
| `0xa34` | `m_bPvsModifyEntity` | bool |  |  |
| `0xa35` | `m_bTransmitAlways` | bool |  |  |
| `0xa38` | `m_VisClusters` | CNetworkUtlVectorBase< uint16 > |  |  |
