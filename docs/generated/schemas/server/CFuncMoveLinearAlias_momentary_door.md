...
**Inherits from:** [CFuncMoveLinear](../server/CFuncMoveLinear.md)
...
| `0x7f0` | `m_authoredPosition` | [MoveLinearAuthoredPos_t](../!GlobalTypes/MoveLinearAuthoredPos_t.md) | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x7f4` | `m_angMoveEntitySpace` | QAngle | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x800` | `m_vecMoveDirParentSpace` | Vector | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x810` | `m_soundStart` | CGameSoundEventName | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x818` | `m_soundStop` | CGameSoundEventName | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x820` | `m_currentSound` | CUtlSymbolLarge | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x828` | `m_flBlockDamage` | float32 | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x82c` | `m_flStartPosition` | float32 | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x838` | `m_OnFullyOpen` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x850` | `m_OnFullyClosed` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x868` | `m_flSpeed` | float32 | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x86c` | `m_bCreateMovableNavMesh` | bool | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x86d` | `m_bAllowMovableNavMeshDockingOnEntireEntity` | bool | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
| `0x86e` | `m_bCreateNavObstacle` | bool | [CFuncMoveLinear](../server/CFuncMoveLinear.md) |  |
