...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundEventConeEntity

# CSoundEventConeEntity

**Kind:** class · **Size:** 1408 bytes (`0x580`) · **Align:** 8 · **Module:** server
...
107 fields (5 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x568` | `m_flEmitterAngle` | float32 |  |  |
| `0x56c` | `m_flSweetSpotAngle` | float32 |  |  |
| `0x570` | `m_flAttenMin` | float32 |  |  |
| `0x574` | `m_flAttenMax` | float32 |  |  |
| `0x578` | `m_iszParameterName` | CUtlSymbolLarge |  |  |
