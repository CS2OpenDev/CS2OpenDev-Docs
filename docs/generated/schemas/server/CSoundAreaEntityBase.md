...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundAreaEntityBase

# CSoundAreaEntityBase

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1224 bytes (`0x4c8`) · **Align:** n/a (unspecified) · **Module:** server

**Inherits from:** [CBaseEntity](../server/CBaseEntity.md)

**Derived by:** [CSoundAreaEntityOrientedBox](../server/CSoundAreaEntityOrientedBox.md), [CSoundAreaEntitySphere](../server/CSoundAreaEntitySphere.md)
...
| `0x4b0` | `m_iszSoundAreaType` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_vPos` | Vector |  |  |
