...
[Schemas](../../schemas.md) / [server](../server.md) / CBreakable
...
**Derived by:** [CPhysBox](../server/CPhysBox.md), [CPushable](../server/CPushable.md)
...
144 fields (16 declared here, 128 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_CPropDataComponent` | [CPropDataComponent](../server/CPropDataComponent.md) |  |  |
| `0x7b8` | `m_Material` | [Materials](../!GlobalTypes/Materials.md) |  |  |
| `0x7bc` | `m_hBreaker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x7c0` | `m_Explosion` | [Explosions](../!GlobalTypes/Explosions.md) |  |  |
| `0x7c8` | `m_iszSpawnObject` | CUtlSymbolLarge |  |  |
| `0x7d0` | `m_flPressureDelay` | float32 |  |  |
| `0x7d4` | `m_iMinHealthDmg` | int32 |  |  |
| `0x7d8` | `m_iszPropData` | CUtlSymbolLarge |  |  |
| `0x7e0` | `m_impactEnergyScale` | float32 |  |  |
| `0x7e4` | `m_nOverrideBlockLOS` | [EOverrideBlockLOS_t](../!GlobalTypes/EOverrideBlockLOS_t.md) |  |  |
| `0x7e8` | `m_OnStartDeath` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x800` | `m_OnBreak` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x818` | `m_OnHealthChanged` | CEntityOutputTemplate< float32 > |  |  |
| `0x838` | `m_PerformanceMode` | [PerformanceMode_t](../!GlobalTypes/PerformanceMode_t.md) |  |  |
| `0x83c` | `m_hPhysicsAttacker` | CHandle< [CBasePlayerPawn](../server/CBasePlayerPawn.md) > |  |  |
| `0x840` | `m_flLastPhysicsInfluenceTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
