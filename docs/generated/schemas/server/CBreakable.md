...
| `0x7b8` | `m_Material` | [Materials](../server/Materials.md) |  |  |
| `0x7bc` | `m_hBreaker` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x7c0` | `m_Explosion` | [Explosions](../server/Explosions.md) |  |  |
...
| `0x7e4` | `m_nOverrideBlockLOS` | [EOverrideBlockLOS_t](../server/EOverrideBlockLOS_t.md) |  |  |
...
| `0x838` | `m_PerformanceMode` | [PerformanceMode_t](../server/PerformanceMode_t.md) |  |  |
