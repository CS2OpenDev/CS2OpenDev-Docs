...
[Schemas](../../schemas.md) / [server](../server.md) / CPhysLength
...
| `0x508` | `m_offset` | Vector[2] |  |  |
| `0x520` | `m_vecAttach` | VectorWS |  |  |
| `0x52c` | `m_addLength` | float32 |  |  |
| `0x530` | `m_minLength` | float32 |  |  |
| `0x534` | `m_totalLength` | float32 |  |  |
