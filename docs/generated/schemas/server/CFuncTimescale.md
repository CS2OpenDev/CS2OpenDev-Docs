...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncTimescale
...
| `0x4a8` | `m_flDesiredTimescale` | float32 |  |  |
| `0x4ac` | `m_flAcceleration` | float32 |  |  |
| `0x4b0` | `m_flMinBlendRate` | float32 |  |  |
| `0x4b4` | `m_flBlendDeltaMultiplier` | float32 |  |  |
| `0x4b8` | `m_isStarted` | bool |  | `MNotSaved` |
