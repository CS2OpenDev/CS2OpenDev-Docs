...
[Schemas](../../schemas.md) / [server](../server.md) / CSceneListManager
...
| `0x4a8` | `m_hListManagers` | CUtlVector< CHandle< [CSceneListManager](../server/CSceneListManager.md) > > |  |  |
| `0x4c0` | `m_iszScenes` | CUtlSymbolLarge[16] |  |  |
| `0x540` | `m_hScenes` | CHandle< [CBaseEntity](../server/CBaseEntity.md) >[16] |  |  |
