...
[Schemas](../../schemas.md) / [server](../server.md) / CPointAngularVelocitySensor

# CPointAngularVelocitySensor

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1400 bytes (`0x578`) · **Align:** 8 · **Module:** server
...
| `0x4a8` | `m_hTargetEntity` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x4ac` | `m_flThreshold` | float32 |  |  |
| `0x4b0` | `m_nLastCompareResult` | int32 |  |  |
| `0x4b4` | `m_nLastFireResult` | int32 |  |  |
| `0x4b8` | `m_flFireTime` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x4bc` | `m_flFireInterval` | float32 |  |  |
| `0x4c0` | `m_flLastAngVelocity` | float32 |  |  |
| `0x4c4` | `m_lastOrientation` | QAngle |  |  |
| `0x4d0` | `m_vecAxis` | VectorWS |  |  |
| `0x4dc` | `m_bUseHelper` | bool |  |  |
| `0x4e0` | `m_AngularVelocity` | CEntityOutputTemplate< float32 > |  |  |
| `0x500` | `m_OnLessThan` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x518` | `m_OnLessThanOrEqualTo` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x530` | `m_OnGreaterThan` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x548` | `m_OnGreaterThanOrEqualTo` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x560` | `m_OnEqualTo` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
