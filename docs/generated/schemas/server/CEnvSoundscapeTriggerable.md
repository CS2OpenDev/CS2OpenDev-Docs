---
title: CEnvSoundscapeTriggerable (server)
module: server
kind: class
---

[Schemas](../../schemas.md) / [server](../server.md) / CEnvSoundscapeTriggerable
...
**Twin:** [CEnvSoundscapeTriggerable (client)](../client/CEnvSoundscapeTriggerable.md)

**Inherits from:** [CEnvSoundscape](../server/CEnvSoundscape.md)

**Derived by:** [CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable](../server/CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable.md)
