...
[Schemas](../../schemas.md) / [server](../server.md) / CBlood
...
| `0x4a8` | `m_vecSprayAngles` | QAngle |  |  |
| `0x4b4` | `m_vecSprayDir` | Vector |  |  |
| `0x4c0` | `m_flAmount` | float32 |  |  |
| `0x4c4` | `m_Color` | [BloodType](../!GlobalTypes/BloodType.md) |  |  |
