...
[Schemas](../../schemas.md) / [server](../server.md) / CGameMoney

# CGameMoney

**Kind:** class · **Size:** 1984 bytes (`0x7c0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CRulePointEntity](../server/CRulePointEntity.md)
...
134 fields (4 declared here, 130 inherited). Offsets are absolute from the object base.
...
| `0x778` | `m_Score` | int32 | [CRulePointEntity](../server/CRulePointEntity.md) |  |
| `0x780` | `m_OnMoneySpent` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x798` | `m_OnMoneySpentFail` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x7b0` | `m_nMoney` | int32 |  |  |
| `0x7b8` | `m_strAwardText` | CUtlString |  |  |
