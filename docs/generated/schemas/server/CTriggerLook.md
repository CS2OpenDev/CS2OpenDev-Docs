...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerLook

# CTriggerLook

**Kind:** class · **Size:** 2408 bytes (`0x968`) · **Align:** 8 · **Module:** server

**Inherits from:** [CTriggerOnce](../server/CTriggerOnce.md)
...
173 fields (15 declared here, 158 inherited). Offsets are absolute from the object base.
...
| `0x8e8` | `m_OnTrigger` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) | [CTriggerMultiple](../server/CTriggerMultiple.md) |  |
| `0x900` | `m_hLookTarget` | CHandle< [CBaseEntity](../server/CBaseEntity.md) > |  |  |
| `0x904` | `m_flFieldOfView` | float32 |  |  |
| `0x908` | `m_flLookTime` | float32 |  |  |
| `0x90c` | `m_flLookTimeTotal` | float32 |  |  |
| `0x910` | `m_flLookTimeLast` | [GameTime_t](../entity2/GameTime_t.md) |  |  |
| `0x914` | `m_flTimeoutDuration` | float32 |  |  |
| `0x918` | `m_bTimeoutFired` | bool |  |  |
| `0x919` | `m_bIsLooking` | bool |  |  |
| `0x91a` | `m_b2DFOV` | bool |  |  |
| `0x91b` | `m_bUseVelocity` | bool |  |  |
| `0x91c` | `m_bTestOcclusion` | bool |  |  |
| `0x91d` | `m_bTestAllVisibleOcclusion` | bool |  |  |
| `0x920` | `m_OnTimeout` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x938` | `m_OnStartLook` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
| `0x950` | `m_OnEndLook` | [CEntityIOOutput](../entity2/CEntityIOOutput.md) |  |  |
