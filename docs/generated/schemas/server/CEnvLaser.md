...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvLaser

# CEnvLaser

**Kind:** class · **Size:** 2104 bytes (`0x838`) · **Align:** 8 · **Module:** server
...
156 fields (5 declared here, 151 inherited). Offsets are absolute from the object base.
...
| `0x810` | `m_iszLaserTarget` | CUtlSymbolLarge |  |  |
| `0x818` | `m_pSprite` | CHandle< [CSprite](../server/CSprite.md) > |  |  |
| `0x820` | `m_iszSpriteName` | CUtlSymbolLarge |  |  |
| `0x828` | `m_firePosition` | Vector |  |  |
| `0x834` | `m_flStartFrame` | float32 |  |  |
