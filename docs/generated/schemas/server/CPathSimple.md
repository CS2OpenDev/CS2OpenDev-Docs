---
layout: default
title: CPathSimple (server)
nav_exclude: true
---

[Schemas](../../schemas.md) / [server](../server.md) / CPathSimple

# CPathSimple

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1456 bytes (`0x5b0`) · **Align:** 16 · **Module:** server

**Twin:** [CPathSimple (client)](../client/CPathSimple.md)

**Inherits from:** [CBaseEntity](../server/CBaseEntity.md)

**Derived by:** [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md)
...
| `0x4b0` | `m_CPathQueryComponent` | [CPathQueryComponent](../server/CPathQueryComponent.md) |  |  |
| `0x5a0` | `m_pathString` | CUtlString |  |  |
| `0x5a8` | `m_bClosedLoop` | bool |  |  |
