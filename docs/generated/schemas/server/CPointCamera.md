...
[Schemas](../../schemas.md) / [server](../server.md) / CPointCamera

# CPointCamera

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1288 bytes (`0x508`) · **Align:** 8 · **Module:** server

**Inherits from:** [CBaseEntity](../server/CBaseEntity.md)

**Derived by:** [CPointCameraVFOV](../server/CPointCameraVFOV.md)
...
114 fields (26 declared here, 88 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_FOV` | float32 |  |  |
| `0x4ac` | `m_Resolution` | float32 |  |  |
| `0x4b0` | `m_bFogEnable` | bool |  |  |
| `0x4b1` | `m_FogColor` | Color |  |  |
| `0x4b8` | `m_flFogStart` | float32 |  |  |
| `0x4bc` | `m_flFogEnd` | float32 |  |  |
| `0x4c0` | `m_flFogMaxDensity` | float32 |  |  |
| `0x4c4` | `m_bActive` | bool |  |  |
| `0x4c5` | `m_bUseScreenAspectRatio` | bool |  |  |
| `0x4c8` | `m_flAspectRatio` | float32 |  |  |
| `0x4cc` | `m_bNoSky` | bool |  |  |
| `0x4d0` | `m_fBrightness` | float32 |  |  |
| `0x4d4` | `m_flZFar` | float32 |  |  |
| `0x4d8` | `m_flZNear` | float32 |  |  |
| `0x4dc` | `m_bCanHLTVUse` | bool |  |  |
| `0x4dd` | `m_bAlignWithParent` | bool |  |  |
| `0x4de` | `m_bDofEnabled` | bool |  |  |
| `0x4e0` | `m_flDofNearBlurry` | float32 |  |  |
| `0x4e4` | `m_flDofNearCrisp` | float32 |  |  |
| `0x4e8` | `m_flDofFarCrisp` | float32 |  |  |
| `0x4ec` | `m_flDofFarBlurry` | float32 |  |  |
| `0x4f0` | `m_flDofTiltToGround` | float32 |  |  |
| `0x4f4` | `m_TargetFOV` | float32 |  |  |
| `0x4f8` | `m_DegreesPerSecond` | float32 |  |  |
| `0x4fc` | `m_bIsOn` | bool |  |  |
| `0x500` | `m_pNext` | [CPointCamera](../server/CPointCamera.md)* |  | `MNotSaved` |
