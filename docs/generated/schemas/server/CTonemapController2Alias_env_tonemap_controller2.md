...
**Kind:** class · **Size:** 1216 bytes (`0x4c0`) · **Align:** 8 · **Module:** server

**Inherits from:** [CTonemapController2](../server/CTonemapController2.md)
...
| `0x4a8` | `m_flAutoExposureMin` | float32 | [CTonemapController2](../server/CTonemapController2.md) |  |
| `0x4ac` | `m_flAutoExposureMax` | float32 | [CTonemapController2](../server/CTonemapController2.md) |  |
| `0x4b0` | `m_flExposureAdaptationSpeedUp` | float32 | [CTonemapController2](../server/CTonemapController2.md) |  |
| `0x4b4` | `m_flExposureAdaptationSpeedDown` | float32 | [CTonemapController2](../server/CTonemapController2.md) |  |
| `0x4b8` | `m_flTonemapEVSmoothingRange` | float32 | [CTonemapController2](../server/CTonemapController2.md) |  |
