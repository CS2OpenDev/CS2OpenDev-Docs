...
[Schemas](../../schemas.md) / [server](../server.md) / CPulseCell_Outflow_PlayVCDBase
...
**Derived by:** [CPulseCell_Outflow_PlayDynamicVCD](../server/CPulseCell_Outflow_PlayDynamicVCD.md), [CPulseCell_Outflow_PlayVCD](../server/CPulseCell_Outflow_PlayVCD.md)
