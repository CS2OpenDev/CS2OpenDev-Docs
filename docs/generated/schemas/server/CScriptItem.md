...
155 fields (1 declared here, 154 inherited). Offsets are absolute from the object base.
...
| `0xa00` | `m_MoveTypeOverride` | [MoveType_t](../!GlobalTypes/MoveType_t.md) |  | `MNotSaved` |
