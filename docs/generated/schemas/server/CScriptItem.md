...
[Schemas](../../schemas.md) / [server](../server.md) / CScriptItem
...
152 fields (1 declared here, 151 inherited). Offsets are absolute from the object base.
...
| `0xa00` | `m_MoveTypeOverride` | [MoveType_t](../server/MoveType_t.md) |  | `MNotSaved` |
