...
[Schemas](../../schemas.md) / [server](../server.md) / CSoundEventOBBEntity
...
104 fields (2 declared here, 102 inherited). Offsets are absolute from the object base.
...
| `0x568` | `m_vMins` | Vector |  |  |
| `0x574` | `m_vMaxs` | Vector |  |  |
