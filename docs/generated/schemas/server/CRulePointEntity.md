...
[Schemas](../../schemas.md) / [server](../server.md) / CRulePointEntity

# CRulePointEntity

**Kind:** class · **Size:** 1920 bytes (`0x780`) · **Align:** 8 · **Module:** server

**Inherits from:** [CRuleEntity](../server/CRuleEntity.md)

**Derived by:** [CGameEnd](../server/CGameEnd.md), [CGameMoney](../server/CGameMoney.md), [CGamePlayerEquip](../server/CGamePlayerEquip.md), [CGameText](../server/CGameText.md)
...
130 fields (1 declared here, 129 inherited). Offsets are absolute from the object base.
