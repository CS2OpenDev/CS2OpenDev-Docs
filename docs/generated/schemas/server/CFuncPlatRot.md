...
[Schemas](../../schemas.md) / [server](../server.md) / CFuncPlatRot

# CFuncPlatRot

**Kind:** class · **Size:** 2112 bytes (`0x840`) · **Align:** 8 · **Module:** server

**Inherits from:** [CFuncPlat](../server/CFuncPlat.md)

**Derived by:** [CFuncTrackChange](../server/CFuncTrackChange.md)
...
153 fields (2 declared here, 151 inherited). Offsets are absolute from the object base.
