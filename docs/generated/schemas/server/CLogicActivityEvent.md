...
[Schemas](../../schemas.md) / [server](../server.md) / CLogicActivityEvent
...
| `0x4a8` | `m_nEventType` | int32 |  |  |
| `0x4ac` | `m_flDuration` | float32 |  |  |
| `0x4b0` | `m_iszSourceEntityName` | CUtlSymbolLarge |  |  |
| `0x4b8` | `m_hSource` | CEntityHandle |  |  |
