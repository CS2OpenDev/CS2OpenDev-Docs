...
[Schemas](../../schemas.md) / [server](../server.md) / CEnvVolumetricFogVolume

# CEnvVolumetricFogVolume

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1264 bytes (`0x4f0`) · **Align:** 8 · **Module:** server
...
| `0x4a8` | `m_bActive` | bool |  |  |
| `0x4ac` | `m_vBoxMins` | Vector |  |  |
| `0x4b8` | `m_vBoxMaxs` | Vector |  |  |
| `0x4c4` | `m_bStartDisabled` | bool |  |  |
| `0x4c5` | `m_bIndirectUseLPVs` | bool |  |  |
| `0x4c8` | `m_flStrength` | float32 |  |  |
| `0x4cc` | `m_nFalloffShape` | int32 |  |  |
| `0x4d0` | `m_flFalloffExponent` | float32 |  |  |
| `0x4d4` | `m_flHeightFogDepth` | float32 |  |  |
| `0x4d8` | `m_fHeightFogEdgeWidth` | float32 |  |  |
| `0x4dc` | `m_fIndirectLightStrength` | float32 |  |  |
| `0x4e0` | `m_fSunLightStrength` | float32 |  |  |
| `0x4e4` | `m_fNoiseStrength` | float32 |  |  |
| `0x4e8` | `m_TintColor` | Color |  |  |
| `0x4ec` | `m_bOverrideTintColor` | bool |  |  |
| `0x4ed` | `m_bOverrideIndirectLightStrength` | bool |  |  |
| `0x4ee` | `m_bOverrideSunLightStrength` | bool |  |  |
| `0x4ef` | `m_bOverrideNoiseStrength` | bool |  |  |
