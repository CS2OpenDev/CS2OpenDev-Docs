...
[Schemas](../../schemas.md) / [server](../server.md) / CRuleEntity
...
**Derived by:** [CRuleBrushEntity](../server/CRuleBrushEntity.md), [CRulePointEntity](../server/CRulePointEntity.md)
...
| `0x770` | `m_iszMaster` | CUtlSymbolLarge |  |  |
