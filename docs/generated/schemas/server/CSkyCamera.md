...
[Schemas](../../schemas.md) / [server](../server.md) / CSkyCamera
...
| `0x4a8` | `m_skyboxData` | sky3dparams_t |  | `MNotSaved` |
| `0x538` | `m_skyboxSlotToken` | CUtlStringToken |  |  |
| `0x53c` | `m_bUseAngles` | bool |  |  |
| `0x540` | `m_pNext` | [CSkyCamera](../server/CSkyCamera.md)* |  | `MNotSaved` |
