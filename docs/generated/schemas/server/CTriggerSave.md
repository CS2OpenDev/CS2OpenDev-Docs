...
[Schemas](../../schemas.md) / [server](../server.md) / CTriggerSave
...
| `0x8e8` | `m_bForceNewLevelUnit` | bool |  |  |
| `0x8ec` | `m_fDangerousTimer` | float32 |  |  |
| `0x8f0` | `m_minHitPoints` | int32 |  |  |
| `0x8f4` | `m_flRetriggerDelay` | float32 |  |  |
