...
[Schemas](../../schemas.md) / [server](../server.md) / CMoverPathNode

# CMoverPathNode

> Source: **Build 25000182** · 2026-08-28 · `windows-x86_64` · schema `0.10.0`

**Kind:** class · **Size:** 1440 bytes (`0x5a0`) · **Align:** 16 · **Module:** server

**Inherits from:** [CPathNode](../server/CPathNode.md)
...
99 fields (5 declared here, 94 inherited). Offsets are absolute from the object base.
...
| `0x4a8` | `m_vInTangentLocal` | Vector | [CPathNode](../server/CPathNode.md) |  |
| `0x4b4` | `m_vOutTangentLocal` | Vector | [CPathNode](../server/CPathNode.md) |  |
| `0x4c0` | `m_strParentPathUniqueID` | CUtlString | [CPathNode](../server/CPathNode.md) |  |
| `0x4c8` | `m_strPathNodeParameter` | CUtlString | [CPathNode](../server/CPathNode.md) |  |
| `0x4d0` | `m_xWSPrevParent` | CTransformWS | [CPathNode](../server/CPathNode.md) |  |
| `0x4f0` | `m_hPath` | CHandle< [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md) > | [CPathNode](../server/CPathNode.md) |  |
| `0x500` | `m_OnStartFromOrInSegment` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x520` | `m_OnStoppedAtOrInSegment` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x540` | `m_OnPassThrough` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x560` | `m_OnPassThroughForward` | CEntityOutputTemplate< CUtlString > |  |  |
| `0x580` | `m_OnPassThroughReverse` | CEntityOutputTemplate< CUtlString > |  |  |
