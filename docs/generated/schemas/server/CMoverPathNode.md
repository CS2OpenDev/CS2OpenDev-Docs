...
96 fields (5 declared here, 91 inherited). Offsets are absolute from the object base.
...
| `0x600` | `m_vInTangentLocal` | Vector | [CPathNode](../server/CPathNode.md) |  |
| `0x60c` | `m_vOutTangentLocal` | Vector | [CPathNode](../server/CPathNode.md) |  |
| `0x618` | `m_strParentPathUniqueID` | CUtlString | [CPathNode](../server/CPathNode.md) |  |
| `0x620` | `m_strPathNodeParameter` | CUtlString | [CPathNode](../server/CPathNode.md) |  |
| `0x630` | `m_xWSPrevParent` | CTransformWS | [CPathNode](../server/CPathNode.md) |  |
| `0x650` | `m_hPath` | CHandle< [CPathWithDynamicNodes](../server/CPathWithDynamicNodes.md) > | [CPathNode](../server/CPathNode.md) |  |
