...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocVelocityBlendNode
...
| `0x100` | `m_bAllowLooping` | bool |  | `MPropertyDescription When not being driven by a sync time, control looping behavior` |
