...
| `0x100` | `m_phaseCondition` | [NmFootPhaseCondition_t](../!GlobalTypes/NmFootPhaseCondition_t.md) |  |  |
| `0x101` | `m_priorityRule` | [NmEventPriorityRule_t](../!GlobalTypes/NmEventPriorityRule_t.md) |  | `MPropertyGroupName +Advanced Search Rules` |
