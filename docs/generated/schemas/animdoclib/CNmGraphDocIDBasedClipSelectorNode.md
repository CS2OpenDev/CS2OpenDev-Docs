...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocIDBasedClipSelectorNode
...
| `0x118` | `m_bIgnoreInvalidOptions` | bool |  | `MPropertyDescription Should we ignore any invalid option and remove them from the selection. This is useful if different variations has different sets of options filled` `MPropertyGroupName Advanced` |
