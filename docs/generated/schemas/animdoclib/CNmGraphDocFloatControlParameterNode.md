...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocFloatControlParameterNode
...
13 fields (3 declared here, 10 inherited). Offsets are absolute from the object base.
...
| `0x118` | `m_previewStartValue` | float32 |  |  |
| `0x11c` | `m_previewMin` | float32 |  |  |
| `0x120` | `m_previewMax` | float32 |  |  |
