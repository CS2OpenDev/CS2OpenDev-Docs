...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocBoneMaskSelectorNode
...
| `0x100` | `m_switchDynamically` | bool |  |  |
| `0x108` | `m_options` | CUtlVector< CGlobalSymbol > |  | `MPropertyAutoExpandSelf` `MPropertyResizable` |
| `0x120` | `m_flBlendTimeSeconds` | float32 |  |  |
