...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocIDSelectorNode
...
| `0x100` | `m_options` | CUtlVector< CGlobalSymbol > |  | `MPropertyAttributeEditor AnimGraphID()` `MPropertyAutoExpandSelf` `MPropertyResizable` |
| `0x118` | `m_defaultID` | CGlobalSymbol |  | `MPropertyAttributeEditor AnimGraphID()` |
