...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocFloatAngleMathNode
...
classDiagram
    ...
    CNmGraphDocFloatAngleMathNode *-- `CNmFloatAngleMathNode::Operation_t`
```
...
| `0x100` | `m_operation` | [CNmFloatAngleMathNode::Operation_t](../animlib/CNmFloatAngleMathNode.Operation_t.md) |  |  |
