---
layout: default
title: "CNmGraphDocParameterizedClipSelectorNode::CData"
nav_exclude: true
---

[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocParameterizedClipSelectorNode::CData
...
|--------|-------|------|------|-------------|
| `0x8` | `m_optionWeights` | CUtlVector< uint8 > |  | `MPropertyAutoExpandSelf` `MPropertyGroupName Advanced` `MPropertyResizable` |
