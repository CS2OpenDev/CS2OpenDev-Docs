...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocVectorInfoNode
...
classDiagram
    ...
    CNmGraphDocVectorInfoNode *-- `CNmVectorInfoNode::Info_t`
```
...
| `0x100` | `m_desiredInfo` | [CNmVectorInfoNode::Info_t](../animlib/CNmVectorInfoNode.Info_t.md) |  |  |
