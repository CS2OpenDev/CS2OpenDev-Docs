...
[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocTargetOffsetNode
...
| `0x100` | `m_bIsBoneSpaceOffset` | bool |  |  |
| `0x104` | `m_rotationOffset` | QAngle |  |  |
| `0x110` | `m_translationOffset` | Vector |  |  |
