---
layout: default
title: "CNmGraphDocReferencedGraphNode::CData"
nav_exclude: true
---

[Schemas](../../schemas.md) / [animdoclib](../animdoclib.md) / CNmGraphDocReferencedGraphNode::CData
...
|--------|-------|------|------|-------------|
| `0x8` | `m_variation` | CUtlString |  | `MPropertyAttributeEditor AssetBrowse( vnmgraph, *requiredoubleclick )` |
