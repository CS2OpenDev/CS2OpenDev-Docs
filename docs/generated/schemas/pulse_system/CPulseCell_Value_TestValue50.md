...
[Schemas](../../schemas.md) / [pulse_system](../pulse_system.md) / CPulseCell_Value_TestValue50
...
**Metadata:** `MPropertyDescription Test node that just generates the integer 50. Nothing to see here!`, `MPropertyFriendlyName [Test] Int Value 50`
