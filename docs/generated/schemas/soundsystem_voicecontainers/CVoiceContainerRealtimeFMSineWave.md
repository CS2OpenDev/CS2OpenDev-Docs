...
[Schemas](../../schemas.md) / [soundsystem_voicecontainers](../soundsystem_voicecontainers.md) / CVoiceContainerRealtimeFMSineWave
...
**Metadata:** `MPropertyDescription Real time FM Synthesis`, `MPropertyFriendlyName TESTBED: FM Synth Container`
...
| `0x70` | `m_flCarrierFrequency` | float32 |  | `MPropertyDescription The frequency of this sine tone.` `MPropertyFriendlyName Frequency (Hz)` |
| `0x74` | `m_flModulatorFrequency` | float32 |  | `MPropertyDescription The frequency of the sine tone modulating this sine tone.` `MPropertyFriendlyName Mod Frequency (Hz)` |
| `0x78` | `m_flModulatorAmount` | float32 |  | `MPropertyDescription The amount the modulating sine tone modulates this sine tone.` `MPropertyFriendlyName Mod Amount (Hz)` |
