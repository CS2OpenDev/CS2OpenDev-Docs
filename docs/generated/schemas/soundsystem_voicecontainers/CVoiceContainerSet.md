...
| `0x70` | `m_soundsToPlay` | CUtlVector< [CVoiceContainerSetElement](../soundsystem_voicecontainers/CVoiceContainerSetElement.md) > |  | `MPropertyFriendlyName Container List` |
