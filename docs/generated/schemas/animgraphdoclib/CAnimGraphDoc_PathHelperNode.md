...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_PathHelperNode
...
**Metadata:** `MPropertyFriendlyName Path Helper`
...
| `0x48` | `m_flStoppingRadius` | float32 |  | `MPropertyFriendlyName Stopping Radius` |
| `0x4c` | `m_flStoppingSpeedScale` | float32 |  | `MPropertyFriendlyName Stopping Min Speed Scale` |
