...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_FollowAttachmentNode
...
| `0x50` | `m_attachmentName` | CUtlString |  | `MPropertyAttributeChoiceName Attachment` `MPropertyFriendlyName Target Attachment` |
| `0x58` | `m_bMatchTranslation` | bool |  | `MPropertyFriendlyName Match Translation` |
| `0x59` | `m_bMatchRotation` | bool |  | `MPropertyFriendlyName Match Rotation` |
