...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_SlowDownOnSlopesNode
...
**Metadata:** `MPropertyFriendlyName Slow Down On Slopes`
...
| `0x48` | `m_flSlowDownStrength` | float32 |  | `MPropertyAttributeRange 0.1 2` `MPropertyFriendlyName Slow Down Strength` |
