...
| `0x48` | `m_eMode` | [OrientationWarpMode_t](../!GlobalTypes/OrientationWarpMode_t.md) |  | `MPropertyAutoRebuildOnChange` `MPropertyFriendlyName Orient To` |
...
| `0x58` | `m_eTargetOffsetMode` | [OrientationWarpTargetOffsetMode_t](../!GlobalTypes/OrientationWarpTargetOffsetMode_t.md) |  | `MPropertyAutoRebuildOnChange` `MPropertyFriendlyName Offset Mode` |
...
| `0x68` | `m_eRootMotionSource` | [OrientationWarpRootMotionSource_t](../!GlobalTypes/OrientationWarpRootMotionSource_t.md) |  | `MPropertyFriendlyName Root Motion Source` |
...
| `0x8c` | `m_ePreferredRotationDirection` | [AnimValueSource](../!GlobalTypes/AnimValueSource.md) |  | `MPropertyAttrStateCallback` `MPropertyDescription An angle relative to the entity's forward. ( Facing Heading, Look Heading ... )` `MPropertyFriendlyName Preferred Rotation Direction` |
