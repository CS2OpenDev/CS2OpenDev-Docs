...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_CommentNode
...
| `0x40` | `m_commentText` | CUtlString |  | `MPropertySuppressField` |
| `0x48` | `m_size` | Vector2D |  | `MPropertySuppressField` |
| `0x50` | `m_color` | Color |  | `MPropertyFriendlyName Color` |
