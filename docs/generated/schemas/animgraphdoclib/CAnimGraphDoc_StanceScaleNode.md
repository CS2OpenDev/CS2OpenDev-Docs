...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_StanceScaleNode
...
**Metadata:** `MPropertyFriendlyName Stance Scale`
...
| `0x48` | `m_paramName` | CUtlString |  | `MPropertySuppressField` |
| `0x50` | `m_param` | [AnimParamID](../modellib/AnimParamID.md) |  | `MPropertyAttributeChoiceName FloatParameter` `MPropertyFriendlyName Parameter` |
