...
[Schemas](../../schemas.md) / [animgraphdoclib](../animgraphdoclib.md) / CAnimGraphDoc_DirectPlaybackNode
...
**Metadata:** `MPropertyFriendlyName Direct Playback`
...
| `0x48` | `m_bFinishEarly` | bool |  | `MPropertyFriendlyName Finish Early` |
| `0x49` | `m_bResetOnFinish` | bool |  | `MPropertyFriendlyName Reset Child On Finish` |
