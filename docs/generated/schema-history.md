...
- **Transitions:** 380 total, **140 with structural changes** (240 no-op builds)
...
| `22627914` → `22876476` | 164 / 28 / 4630 | 36 / 3 / 16 | 11112 |
...
| `21529689` → `21593048` | 437 / 16 / 1087 | 32 / 3 / 18 | 7627 |
| `20670159` → `20775075` | 0 / 0 / 10 | 0 / 0 / 1 | 35 |
| `20596740` → `20670159` | 0 / 0 / 4 | 0 / 0 / 0 | 6 |
| `20535897` → `20596740` | 2 / 2 / 32 | 0 / 0 / 0 | 95 |
| `20442176` → `20503857` | 2 / 0 / 7 | 0 / 0 / 0 | 155 |
| `20392228` → `20410358` | 0 / 0 / 3 | 0 / 0 / 0 | 44 |
| `20278147` → `20392228` | 90 / 15 / 1373 | 9 / 1 / 13 | 5927 |
...
| `19932965` → `20007038` | 20 / 49 / 1634 | 11 / 5 / 8 | 2941 |
...
| `16382602` → `16398395` | 1 / 0 / 16 | 1 / 0 / 1 | 203 |
...
| `15656858` → `15908369` | 251 / 10 / 1417 | 38 / 1 / 20 | 8801 |
...
| `14446408` → `14470938` | 224 / 41 / 1049 | 40 / 2 / 26 | 6767 |
...
| `13481434` → `13593156` | 0 / 0 / 10 | 0 / 0 / 1 | 113 |
...
|-------|-----------|--------|
| `!GlobalTypes/dynpitchvol_base_t` | — | — |
| `!GlobalTypes/dynpitchvol_t` | — | — |
